{ pkgs, self, repo ? builtins.fetchGit {
  ...
  custom-compiler = rec {
    ...
    opam = "${src}/custom-compiler.opam";
    depends = with self; [ fmt ocaml ocaml-option-flambda ];
  ...
  ocaml-option-flambda = {
    ...
    depends = with self; [ ocaml-variants ];
  };
  ocaml-variants = {
    name = "ocaml-variants";
    ...
    src = pkgs.fetchurl {
      ...
      sha256 = "1r8vh2jiz608b9dchwi4zdk7aw1n4vxgnw76gv6ip1jnpy0mdfk7";
    };
    ...
    depends = with self; [
      ...
      base-unix
      ocaml
      (self.ocaml-option-32bit or null)
