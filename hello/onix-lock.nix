{ pkgs, self, repo ? builtins.fetchGit {
  ...
  ocaml = {
    ...
    depends = with self; [ ocaml-base-compiler ocaml-config ];
  };
  ocaml-base-compiler = {
    ...
    opam =
      "${repo}/packages/ocaml-base-compiler/ocaml-base-compiler.4.14.0/opam";
  };
  ocaml-config = {
    name = "ocaml-config";
    version = "2";
    opam = "${repo}/packages/ocaml-config/ocaml-config.2/opam";
    depends = with self; [ ocaml-base-compiler ];
  };
  ocamlbuild = {
    name = "ocamlbuild";
    version = "0.14.1";
