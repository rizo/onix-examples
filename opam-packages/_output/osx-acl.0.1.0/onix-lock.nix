...
} }:
{
  ...
  osx-acl = {
    ...
    opam = "${repo}/packages/osx-acl/osx-acl.0.1.0/opam";
    depends = with self; [ base-unix ctypes ocaml osx-membership unix-errno
                           unix-type-representations (self.lwt or null) ];
  ...
  osx-membership = {
    ...
    opam = "${repo}/packages/osx-membership/osx-membership.0.1.0/opam";
    depends = with self; [ base-unix ctypes ocaml posix-types unix-errno
                           (self.lwt or null) ];
    buildDepends = with self; [ ocaml ocamlbuild ocamlfind ];
  };
  posix-base = {
