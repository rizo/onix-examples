...
} }:
{
  ...
  lt-code = {
    ...
    version = "0.1.1";
    src = pkgs.fetchurl {
      url = "https://github.com/darrenldl/ocaml-lt-code/releases/download/v0.1.1/v0.1.1.tar.gz";
      sha256 = "59c8c4022413d5cf28439b08fbded9c408fdf8dcfe77a92c84391769c7be78b9";
    };
    opam = "${repo}/packages/lt-code/lt-code.0.1.1/opam";
    depends = with self; [ containers cstruct dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  ocaml = {
    name = "ocaml";
