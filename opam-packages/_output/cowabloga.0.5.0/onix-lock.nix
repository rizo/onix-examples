...
} }:
{
  ...
  cowabloga = {
    ...
    version = "0.5.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/cowabloga/releases/download/0.5.0/cowabloga-0.5.0.tbz";
      sha256 = "0ccc45811a8f88d46db11009179ac03e90fa04a942c9db55c417470a1e28a636";
    };
    opam = "${repo}/packages/cowabloga/cowabloga.0.5.0/opam";
    depends = with self; [ cow cstruct lwt magic-mime ocaml omd re ];
    buildDepends = with self; [ dune ocaml ];
  };
  cppo = {
    name = "cppo";
