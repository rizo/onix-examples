...
} }:
{
  ahrocksdb = {
    ...
    version = "0.2.2";
    src = pkgs.fetchurl {
      url = "https://github.com/ahrefs/ocaml-ahrocksdb/releases/download/0.2.2/ahrocksdb-0.2.2.tbz";
      sha256 = "06l04ch9ls3xb52vyb2r3q92ckbx16zzq1q0s04j55dsray688nz";
    };
    opam = "${repo}/packages/ahrocksdb/ahrocksdb.0.2.2/opam";
    depends = with self; [ astring conf-rocksdb ctypes dune dune-configurator
                           ocaml rresult ];
  ...
  conf-rocksdb = {
    name = "conf-rocksdb";
    version = "1";
    opam = "${repo}/packages/conf-rocksdb/conf-rocksdb.1/opam";
    depexts = with pkgs; [ (pkgs.librocksdb-dev or null) ];
  };
  csexp = {
    name = "csexp";
    version = "1.5.1";
