...
} }:
{
  ...
  ppx_deriving_scad = {
    ...
    version = "1.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/geoffder/ppx_deriving_scad/releases/download/v1.0.0/ppx_deriving_scad-v1.0.0.tbz";
      sha256 = "2b1ec77fefe7770ac04efd9cbbb92aa864f4843070ef0fc3937880e593d591b2";
    };
    opam = "${repo}/packages/ppx_deriving_scad/ppx_deriving_scad.1.0.0/opam";
