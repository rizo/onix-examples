...
} }:
{
  ...
  bech32 = {
    ...
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/vbmithr/ocaml-bech32/releases/download/0.1/bech32-0.1.tbz";
      sha256 = "1c858f8e155c57b8f98d40f02e93076db3fcebbc41ee8f2236a8c4abf9ab1ce5";
    };
    opam = "${repo}/packages/bech32/bech32.0.1/opam";
    depends = with self; [ astring dune ocaml rresult ];
