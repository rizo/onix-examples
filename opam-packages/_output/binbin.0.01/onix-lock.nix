...
} }:
{
  binbin = {
    ...
    version = "0.01";
    src = pkgs.fetchurl {
      url = "https://github.com/aaronwinter/binbin/archive/0.1b.tar.gz";
      sha256 = "0qrf8z07n3240j7vypr9qf2bkn406ycljidvr3znq57s5w2ppwhn";
    };
    opam = "${repo}/packages/binbin/binbin.0.01/opam";
