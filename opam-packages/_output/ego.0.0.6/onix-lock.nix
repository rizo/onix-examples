...
} }:
{
  ...
  ego = {
    ...
    version = "0.0.6";
    src = pkgs.fetchurl {
      url = "https://github.com/verse-lab/ego/archive/refs/tags/0.0.6.tar.gz";
      sha256 = "1wya9p1i0mxfq4mzksld43kh301j2nkx8mg0h8p2h7m5k5vn23vp";
    };
    opam = "${repo}/packages/ego/ego.0.0.6/opam";
    depends = with self; [ containers containers-data dune iter ocaml
                           ocamldot ppx_deriving ppx_inline_alcotest ppxlib
                           sexplib ];
    buildDepends = with self; [ dune ocaml ];
  };
  either = {
