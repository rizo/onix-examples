...
} }:
{
  ...
  modular-arithmetic = {
    ...
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/sonologico/modular-arithmetic/archive/modular-arithmetic-0.1.tar.gz";
      sha256 = "0llf7917xdzvma2amncl1yb5misj56c70dg3cbqw0mvxs8d4hbvz";
    };
    opam = "${repo}/packages/modular-arithmetic/modular-arithmetic.0.1/opam";
