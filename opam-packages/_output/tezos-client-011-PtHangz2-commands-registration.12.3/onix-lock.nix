...
} }:
{
  ...
  tezos-client-011-PtHangz2-commands = {
    name = "tezos-client-011-PtHangz2-commands";
    version = "12.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v12.3/tezos-v12.3.tar.bz2";
      sha256 = "296bb5674bc6050afe6330326fbdd0dfc2255d414bfd6b79cc7666ac6b39316d";
    };
    opam = "${repo}/packages/tezos-client-011-PtHangz2-commands/tezos-client-011-PtHangz2-commands.12.3/opam";
    depends = with self; [ dune tezos-client-011-PtHangz2
                           tezos-client-base-unix ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-011-PtHangz2-commands-registration = {
    name = "tezos-client-011-PtHangz2-commands-registration";
    version = "12.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v12.3/tezos-v12.3.tar.bz2";
      sha256 = "296bb5674bc6050afe6330326fbdd0dfc2255d414bfd6b79cc7666ac6b39316d";
    };
    opam = "${repo}/packages/tezos-client-011-PtHangz2-commands-registration/tezos-client-011-PtHangz2-commands-registration.12.3/opam";
    depends = with self; [ dune tezos-client-sapling-011-PtHangz2 ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-base = {
  ...
  tezos-client-sapling-011-PtHangz2 = {
    name = "tezos-client-sapling-011-PtHangz2";
    version = "12.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v12.3/tezos-v12.3.tar.bz2";
      sha256 = "296bb5674bc6050afe6330326fbdd0dfc2255d414bfd6b79cc7666ac6b39316d";
    };
    opam = "${repo}/packages/tezos-client-sapling-011-PtHangz2/tezos-client-sapling-011-PtHangz2.12.3/opam";
    depends = with self; [ dune tezos-client-011-PtHangz2-commands ];
    buildDepends = with self; [ dune ];
  };
  tezos-context = {
    name = "tezos-context";
