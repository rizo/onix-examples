...
} }:
{
  ...
  orgeat = {
    ...
    version = "0.0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/lrand-nl/orgeat/archive/0.0.1.tar.gz";
    ...
    opam = "${repo}/packages/orgeat/orgeat.0.0.1/opam";
    depends = with self; [ data-encoding dune ocaml smol zarith ];
    buildDepends = with self; [ dune ocaml ];
  };
  result = {
    name = "result";
  ...
  smol = {
    ...
    version = "0.0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/lrand-nl/smol/archive/0.0.1.tar.gz";
    ...
    opam = "${repo}/packages/smol/smol.0.0.1/opam";
    depends = with self; [ dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  stringext = {
