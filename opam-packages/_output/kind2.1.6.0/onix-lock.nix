...
} }:
{
  ...
  kind2 = {
    ...
    version = "1.6.0";
    src = pkgs.fetchurl {
      url = "https://github.com/kind2-mc/kind2/archive/v1.6.0.tar.gz";
      sha512 = "7bf688042c823f485bbed807529bbcc4fc6cfd2f48011ecba62dfecf2d96328c34cb34a632ec027babeb1999a6936ba57dbd45e5a2a0f0882bcf1ffb8a1266e6";
    };
    opam = "${repo}/packages/kind2/kind2.1.6.0/opam";
    depends = with self; [ dune dune-build-info menhir num ocaml yojson zmq ];
    buildDepends = with self; [ dune ocaml ];
  };
  menhir = {
    name = "menhir";
