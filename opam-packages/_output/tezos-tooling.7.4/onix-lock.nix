...
} }:
{
  ...
  ocamlformat = {
    ...
    opam = "${repo}/packages/ocamlformat/ocamlformat.0.10/opam";
    depends = with self; [ base base-unix cmdliner dune fpath ocaml
                           ocaml-migrate-parsetree octavius stdio uuseg uutf ];
    buildDepends = with self; [ dune ocaml ];
  };
  octavius = {
    name = "octavius";
  ...
  tezos-tooling = {
    ...
    opam = "${repo}/packages/tezos-tooling/tezos-tooling.7.4/opam";
    depends = with self; [ dune ocaml ocamlformat ];
    buildDepends = with self; [ dune ocaml ];
  };
  topkg = {
    name = "topkg";
