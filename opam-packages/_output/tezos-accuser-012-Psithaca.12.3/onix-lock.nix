...
} }:
{
  ...
  bls12-381 = {
    ...
    version = "1.1.1";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/dannywillems/ocaml-bls12-381/-/archive/1.1.1/ocaml-bls12-381-1.1.1.tar.bz2";
    ...
    opam = "${repo}/packages/bls12-381/bls12-381.1.1.1/opam";
  ...
  bls12-381-unix = {
    ...
    opam = "${repo}/packages/bls12-381-unix/bls12-381-unix.1.1.1/opam";
  ...
  tezos-accuser-012-Psithaca = {
    name = "tezos-accuser-012-Psithaca";
    version = "12.3";
    src = pkgs.fetchurl {
    ...
    opam = "${repo}/packages/tezos-accuser-012-Psithaca/tezos-accuser-012-Psithaca.12.3/opam";
    depends = with self; [ dune tezos-baking-012-Psithaca-commands
                           tezos-client-base-unix ];
    buildDepends = with self; [ dune ];
  };
  tezos-baking-012-Psithaca = {
    name = "tezos-baking-012-Psithaca";
    version = "12.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v12.3/tezos-v12.3.tar.bz2";
      sha256 = "296bb5674bc6050afe6330326fbdd0dfc2255d414bfd6b79cc7666ac6b39316d";
    };
    opam = "${repo}/packages/tezos-baking-012-Psithaca/tezos-baking-012-Psithaca.12.3/opam";
    depends = with self; [ dune lwt-exit tezos-client-012-Psithaca
                           tezos-client-base-unix tezos-client-commands
                           tezos-shell-context ];
    buildDepends = with self; [ dune ];
  };
  tezos-baking-012-Psithaca-commands = {
    name = "tezos-baking-012-Psithaca-commands";
    version = "12.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v12.3/tezos-v12.3.tar.bz2";
      sha256 = "296bb5674bc6050afe6330326fbdd0dfc2255d414bfd6b79cc7666ac6b39316d";
    };
    opam = "${repo}/packages/tezos-baking-012-Psithaca-commands/tezos-baking-012-Psithaca-commands.12.3/opam";
    depends = with self; [ dune tezos-baking-012-Psithaca ];
    buildDepends = with self; [ dune ];
  };
  tezos-base = {
    name = "tezos-base";
  ...
  tezos-client-012-Psithaca = {
    name = "tezos-client-012-Psithaca";
    version = "12.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v12.3/tezos-v12.3.tar.bz2";
      sha256 = "296bb5674bc6050afe6330326fbdd0dfc2255d414bfd6b79cc7666ac6b39316d";
    };
    opam = "${repo}/packages/tezos-client-012-Psithaca/tezos-client-012-Psithaca.12.3/opam";
    depends = with self; [ dune ppx_inline_test tezos-mockup-registration
                           tezos-protocol-012-Psithaca-parameters
                           tezos-protocol-plugin-012-Psithaca tezos-proxy
  ...
  tezos-client-base = {
    ...
    opam = "${repo}/packages/tezos-client-base/tezos-client-base.12.3/opam";
  ...
  tezos-client-base-unix = {
    ...
    opam = "${repo}/packages/tezos-client-base-unix/tezos-client-base-unix.12.3/opam";
  ...
  tezos-client-commands = {
    ...
    opam = "${repo}/packages/tezos-client-commands/tezos-client-commands.12.3/opam";
  ...
  tezos-context = {
    ...
    opam = "${repo}/packages/tezos-context/tezos-context.12.3/opam";
    depends = with self; [ bigstringaf digestif dune irmin irmin-pack
                           tezos-base tezos-shell-services ];
    buildDepends = with self; [ dune ];
  };
  tezos-crypto = {
    name = "tezos-crypto";
  ...
  tezos-mockup = {
    ...
    opam = "${repo}/packages/tezos-mockup/tezos-mockup.12.3/opam";
  ...
  tezos-mockup-commands = {
    ...
    opam = "${repo}/packages/tezos-mockup-commands/tezos-mockup-commands.12.3/opam";
  ...
  tezos-mockup-proxy = {
    ...
    opam = "${repo}/packages/tezos-mockup-proxy/tezos-mockup-proxy.12.3/opam";
  ...
  tezos-mockup-registration = {
    ...
    opam = "${repo}/packages/tezos-mockup-registration/tezos-mockup-registration.12.3/opam";
  ...
  tezos-p2p = {
    ...
    opam = "${repo}/packages/tezos-p2p/tezos-p2p.12.3/opam";
  ...
  tezos-p2p-services = {
    ...
    opam = "${repo}/packages/tezos-p2p-services/tezos-p2p-services.12.3/opam";
    depends = with self; [ dune tezos-base ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-012-Psithaca = {
    name = "tezos-protocol-012-Psithaca";
    version = "12.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v12.3/tezos-v12.3.tar.bz2";
      sha256 = "296bb5674bc6050afe6330326fbdd0dfc2255d414bfd6b79cc7666ac6b39316d";
    };
    opam = "${repo}/packages/tezos-protocol-012-Psithaca/tezos-protocol-012-Psithaca.12.3/opam";
    depends = with self; [ dune tezos-protocol-compiler ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-012-Psithaca-parameters = {
    name = "tezos-protocol-012-Psithaca-parameters";
    version = "12.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v12.3/tezos-v12.3.tar.bz2";
      sha256 = "296bb5674bc6050afe6330326fbdd0dfc2255d414bfd6b79cc7666ac6b39316d";
    };
    opam = "${repo}/packages/tezos-protocol-012-Psithaca-parameters/tezos-protocol-012-Psithaca-parameters.12.3/opam";
    depends = with self; [ dune tezos-protocol-012-Psithaca ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-compiler = {
    ...
    opam = "${repo}/packages/tezos-protocol-compiler/tezos-protocol-compiler.12.3/opam";
  ...
  tezos-protocol-environment = {
    ...
    opam = "${repo}/packages/tezos-protocol-environment/tezos-protocol-environment.12.3/opam";
  ...
  tezos-protocol-environment-packer = {
    ...
    opam = "${repo}/packages/tezos-protocol-environment-packer/tezos-protocol-environment-packer.12.3/opam";
    depends = with self; [ dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  tezos-protocol-environment-sigs = {
    ...
    opam = "${repo}/packages/tezos-protocol-environment-sigs/tezos-protocol-environment-sigs.12.3/opam";
  ...
  tezos-protocol-environment-structs = {
    ...
    opam = "${repo}/packages/tezos-protocol-environment-structs/tezos-protocol-environment-structs.12.3/opam";
    depends = with self; [ bls12-381-legacy dune tezos-crypto
                           tezos-protocol-environment-packer ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-plugin-012-Psithaca = {
    name = "tezos-protocol-plugin-012-Psithaca";
    version = "12.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v12.3/tezos-v12.3.tar.bz2";
      sha256 = "296bb5674bc6050afe6330326fbdd0dfc2255d414bfd6b79cc7666ac6b39316d";
    };
    opam = "${repo}/packages/tezos-protocol-plugin-012-Psithaca/tezos-protocol-plugin-012-Psithaca.12.3/opam";
    depends = with self; [ dune tezos-base tezos-protocol-012-Psithaca
                           tezos-stdlib-unix ];
    buildDepends = with self; [ dune ];
  };
  tezos-proxy = {
    ...
    opam = "${repo}/packages/tezos-proxy/tezos-proxy.12.3/opam";
  ...
  tezos-rpc-http = {
    ...
    opam = "${repo}/packages/tezos-rpc-http/tezos-rpc-http.12.3/opam";
    depends = with self; [ dune resto-cohttp tezos-base ];
    buildDepends = with self; [ dune ];
  };
  tezos-rpc-http-client = {
    ...
    opam = "${repo}/packages/tezos-rpc-http-client/tezos-rpc-http-client.12.3/opam";
  ...
  tezos-rpc-http-client-unix = {
    ...
    opam = "${repo}/packages/tezos-rpc-http-client-unix/tezos-rpc-http-client-unix.12.3/opam";
  ...
  tezos-sapling = {
    ...
    opam = "${repo}/packages/tezos-sapling/tezos-sapling.12.3/opam";
  ...
  tezos-shell-context = {
    ...
    opam = "${repo}/packages/tezos-shell-context/tezos-shell-context.12.3/opam";
  ...
  tezos-shell-services = {
    ...
    opam = "${repo}/packages/tezos-shell-services/tezos-shell-services.12.3/opam";
  ...
  tezos-signer-backends = {
    ...
    opam = "${repo}/packages/tezos-signer-backends/tezos-signer-backends.12.3/opam";
  ...
  tezos-signer-services = {
    ...
    opam = "${repo}/packages/tezos-signer-services/tezos-signer-services.12.3/opam";
  ...
  tezos-version = {
    ...
    opam = "${repo}/packages/tezos-version/tezos-version.12.3/opam";
    depends = with self; [ dune tezos-base ];
    buildDepends = with self; [ dune ];
  };
  tezos-workers = {
    ...
    opam = "${repo}/packages/tezos-workers/tezos-workers.12.3/opam";
    depends = with self; [ dune tezos-base ];
    buildDepends = with self; [ dune ];
  };
  time_now = {
