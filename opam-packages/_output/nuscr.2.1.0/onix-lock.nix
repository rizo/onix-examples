...
} }:
{
  ...
  nuscr = {
    ...
    version = "2.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/nuscr/nuscr/releases/download/2.1.0/nuscr-2.1.0.tbz";
      sha256 = "4798916862412a0ac4721f63b77c243d7d7327c8ff2d18d379eb2f4202d43e4d";
    };
    opam = "${repo}/packages/nuscr/nuscr.2.1.0/opam";
    depends = with self; [ base cmdliner dune menhir ocaml ocamlgraph
                           ppx_deriving ppx_here ppx_sexp_conv ppxlib process
                           stdio ];
    buildDepends = with self; [ dune ocaml ];
  };
  ocaml = {
