...
} }:
{
  ...
  dream-cli = {
    ...
    version = "0.2.0";
    src = pkgs.fetchurl {
      url = "https://github.com/tmattio/dream-cli/releases/download/0.2.0/dream-cli-0.2.0.tbz";
      sha256 = "918293fbe8870b382a0e4a8a8c34bf4316851aa5111406b66db83ad5d4bd3aeb";
    };
    opam = "${repo}/packages/dream-cli/dream-cli.0.2.0/opam";
    depends = with self; [ cmdliner dream dune fmt logs ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  dream-httpaf = {
    name = "dream-httpaf";
