...
} }:
{
  ...
  fzf = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/fzf-v0.15.0.tar.gz";
      sha256 = "3940ee57d29aa2a70704c43a140dd53bfa59718b3e6ce377ddd56f63b5444c4b";
    };
    opam = "${repo}/packages/fzf/fzf.v0.15.0/opam";
    depends = with self; [ async core_kernel dune ocaml ppx_jane ];
    buildDepends = with self; [ dune ocaml ];
  };
  int_repr = {
    name = "int_repr";
