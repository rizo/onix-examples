...
} }:
{
  ...
  shapefile = {
    ...
    version = "0.2.1";
    src = pkgs.fetchurl {
      url = "https://github.com/cyril-allignol/ocaml-shapefile/archive/v0.2.1.tar.gz";
      sha256 = "064pwzzq1i4ii5fny39x097wkfxasd1q94ak3nsj7l4hnhfblv2x";
    };
    opam = "${repo}/packages/shapefile/shapefile.0.2.1/opam";
    depends = with self; [ bitstring dune ocaml ppx_bitstring ];
