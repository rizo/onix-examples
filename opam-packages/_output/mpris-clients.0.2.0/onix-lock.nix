...
} }:
{
  ...
  mpris = {
    ...
    version = "0.2.0";
    src = pkgs.fetchurl {
      url = "https://github.com/johnelse/ocaml-mpris/archive/mpris.0.2.0.tar.gz";
      sha256 = "1y60s7d8lj15fxf025gr3q9a2kz623pxvd790gr9gz6pqryrcnyh";
    };
    opam = "${repo}/packages/mpris/mpris.0.2.0/opam";
    depends = with self; [ dune obus ocaml ];
    buildDepends = with self; [ dune lwt_ppx ocaml ];
  };
  mpris-clients = {
    name = "mpris-clients";
    version = "0.2.0";
    ...
    opam = "${repo}/packages/mpris-clients/mpris-clients.0.2.0/opam";
    depends = with self; [ dune mpris obus ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  obus = {
    name = "obus";
    ...
    opam = "${repo}/packages/obus/obus.1.2.3/opam";
    depends = with self; [ dune lwt lwt_log lwt_ppx lwt_react ppxlib xmlm ];
