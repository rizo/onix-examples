...
} }:
{
  ...
  oskel = {
    ...
    version = "0.3.0";
    src = pkgs.fetchurl {
      url = "https://github.com/CraigFe/oskel/releases/download/0.3.0/oskel-0.3.0.tbz";
      sha256 = "e7d1abb7cb501334ca495757ef10744883f3773cac8ac67de54394ad5f6dc71b";
    };
    opam = "${repo}/packages/oskel/oskel.0.3.0/opam";
    depends = with self; [ cmdliner dune fmt logs lwt ocaml-syntax-shims
                           stdlib-shims ];
