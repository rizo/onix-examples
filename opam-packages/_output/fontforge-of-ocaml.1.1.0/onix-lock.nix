...
} }:
{
  ...
  fontforge-of-ocaml = {
    ...
    version = "1.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/pbaudin/fontforge-of-ocaml/releases/download/v1.1.0/fontforge-of-ocaml-1.1.0.tbz";
      sha256 = "af7c59bea65ac5844c04ea7ae5347c4ab2016a217d54a3c1d806020dffad064f";
    };
    opam = "${repo}/packages/fontforge-of-ocaml/fontforge-of-ocaml.1.1.0/opam";
    depends = with self; [ base dune fmt ocaml ppx_python pyml
                           (self.headache or null) ];
    buildDepends = with self; [ dune ocaml ];
  };
  ocaml = {
    name = "ocaml";
  ...
  ppx_python = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/ppx_python-v0.15.0.tar.gz";
      sha256 = "471f4d2bffb46e540ee59c1d8f1f7fb0285f8e4a3bece3e875fe040ffb2fc415";
    };
    opam = "${repo}/packages/ppx_python/ppx_python.v0.15.0/opam";
    depends = with self; [ base dune ocaml ppx_base ppxlib pyml ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppx_sexp_conv = {
    name = "ppx_sexp_conv";
