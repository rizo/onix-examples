...
} }:
{
  ...
  reason-standard = {
    ...
    src = pkgs.fetchurl {
      url = "https://github.com/Dean177/reason-standard/archive/0.1.0-alpha.1.tar.gz";
    ...
    opam = "${repo}/packages/reason-standard/reason-standard.0.1.0~alpha.1/opam";
    depends = with self; [ base dune ocaml reason zarith ];
    buildDepends = with self; [ dune ocaml ];
  };
  result = {
    name = "result";
  ...
  zarith = {
    ...
    opam = "${repo}/packages/zarith/zarith.1.10/opam";
