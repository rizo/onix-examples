...
} }:
{
  ...
  override = {
    ...
    version = "0.4.0";
    src = pkgs.fetchurl {
      url = "https://github.com/thierry-martinez/override/archive/refs/tags/v0.4.0.tar.gz";
      sha512 = "43025432d632d4e88e2e9912fcce0e12c64ecd1e8cff78887e9c847bd90b14a859c6b776e027e155d462834d8a372489c86fbd543d6b23d8b239c213e4078b85";
    };
    opam = "${repo}/packages/override/override.0.4.0/opam";
    depends = with self; [ dune metapp metaquot ocaml ppxlib refl stdcompat ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppx_derivers = {
    name = "ppx_derivers";
