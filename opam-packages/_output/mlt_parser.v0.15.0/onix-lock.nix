...
} }:
{
  ...
  mlt_parser = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/mlt_parser-v0.15.0.tar.gz";
      sha256 = "fd4b8885f7a9fbb2336c1d761842fdbc49cc1f8a04bbc324eb1060a1094b335d";
    };
    opam = "${repo}/packages/mlt_parser/mlt_parser.v0.15.0/opam";
    depends = with self; [ core dune ocaml ppx_expect ppx_jane ppxlib ];
    buildDepends = with self; [ dune ocaml ];
  };
  num = {
    name = "num";
