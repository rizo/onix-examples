...
} }:
{
  ...
  mirage-net-unix = {
    ...
    version = "3.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/mirage-net-unix/releases/download/v3.0.0/mirage-net-unix-3.0.0.tbz";
      sha256 = "87a9ea89634d24707952c5bfa1bda1be17e030377c90dca4ed0feadee55293cc";
    };
    opam = "${repo}/packages/mirage-net-unix/mirage-net-unix.3.0.0/opam";
    depends = with self; [ cstruct cstruct-lwt dune logs lwt macaddr
                           mirage-net ocaml tuntap ];
    buildDepends = with self; [ dune ocaml ];
  };
  mmap = {
    name = "mmap";
