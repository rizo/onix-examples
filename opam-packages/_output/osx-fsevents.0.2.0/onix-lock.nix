...
} }:
{
  ...
  osx-cf = {
    ...
    opam = "${repo}/packages/osx-cf/osx-cf.0.1.1/opam";
    depends = with self; [ base-bytes ctypes ctypes-foreign ocaml
                           (self.base-threads or null) (self.lwt or null) ];
    buildDepends = with self; [ ocaml ocamlfind topkg ];
  };
  osx-fsevents = {
    name = "osx-fsevents";
    version = "0.2.0";
    ...
    opam = "${repo}/packages/osx-fsevents/osx-fsevents.0.2.0/opam";
    depends = with self; [ cmdliner ctypes ocaml osx-cf (self.lwt or null) ];
    buildDepends = with self; [ ocaml ocamlfind ];
  };
  stdlib-shims = {
    name = "stdlib-shims";
