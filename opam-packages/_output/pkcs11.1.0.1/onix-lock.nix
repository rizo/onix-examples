...
} }:
{
  ...
  pkcs11 = {
    ...
    version = "1.0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/cryptosense/pkcs11/releases/download/v1.0.1/pkcs11-v1.0.1.tbz";
      sha256 = "db6bed28e4a75cb3787d0b6feca954a91c9e52e678b8cc73c1058975b1846946";
    };
    opam = "${repo}/packages/pkcs11/pkcs11.1.0.1/opam";
    depends = with self; [ dune hex integers ocaml ppx_deriving
                           ppx_deriving_yojson ppx_variants_conv zarith ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppx_derivers = {
    name = "ppx_derivers";
