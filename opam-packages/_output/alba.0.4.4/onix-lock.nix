...
} }:
{
  alba = {
    ...
    version = "0.4.4";
    src = pkgs.fetchurl {
      url = "https://github.com/hbr/albatross/archive/0.4.4.tar.gz";
      sha256 = "0fyz2z69pxiyldzas0kfwxw6s2mzr0pnyznzksn5pr6k061h65s8";
    };
    opam = "${repo}/packages/alba/alba.0.4.4/opam";
    depends = with self; [ dune js_of_ocaml js_of_ocaml-ppx linenoise ocaml ];
    buildDepends = with self; [ dune menhir ocaml ppx_inline_test ];
  };
  base = {
    name = "base";
    version = "v0.15.0";
