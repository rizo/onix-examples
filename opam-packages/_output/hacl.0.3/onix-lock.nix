...
} }:
{
  ...
  hacl = {
    ...
    version = "0.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/nomadic-labs/ocaml-hacl/-/archive/v0.3/ocaml-hacl-v0.3.tar.gz";
      sha256 = "84b6a8dbff8a3701d5e07cf79b411feb227d91df4b0503e8f736520288bbeec7";
    };
    opam = "${repo}/packages/hacl/hacl.0.3/opam";
    depends = with self; [ base bigstring dune ocplib-endian stdio zarith ];
