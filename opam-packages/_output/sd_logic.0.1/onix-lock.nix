...
} }:
{
  ...
  sd_logic = {
    ...
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/zevbo/StateDimensionLogic/archive/refs/tags/v0.1.tar.gz";
      sha256 = "0x97agws9ib71cd4hqhjzahgv3ys58si56g79pfa9iabx5g9n46z";
    };
    opam = "${repo}/packages/sd_logic/sd_logic.0.1/opam";
    depends = with self; [ core dune ppx_jane ];
