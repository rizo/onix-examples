...
} }:
{
  ...
  tqdm = {
    ...
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/LaurentMazare/ocaml-tqdm/archive/0.1b.tar.gz";
    ...
    opam = "${repo}/packages/tqdm/tqdm.0.1/opam";
    depends = with self; [ base dune ocaml ocaml-compiler-libs stdio ];
    buildDepends = with self; [ dune ocaml ];
  };
}
