...
} }:
{
  febusy = {
    ...
    version = "0.0.0";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/smondet/febusy/-/archive/0.0.0/febusy-0.0.0.tar.gz";
      sha256 = "1abs2h7m7g21bmk850p0060r3xz6yykw0ybsdf8m631s1x6c68wa";
    };
    opam = "${repo}/packages/febusy/febusy.0.0.0/opam";
    depends = with self; [ jbuilder nonstd ocaml rresult sosa ];
