...
} }:
{
  ...
  wtr = {
    ...
    version = "3.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/lemaetech/wtr/archive/v3.0.0.tar.gz";
    ...
    opam = "${repo}/packages/wtr/wtr.3.0.0/opam";
  ...
  wtr-ppx = {
    ...
    opam = "${repo}/packages/wtr-ppx/wtr-ppx.3.0.0/opam";
    depends = with self; [ dune ocaml ppxlib uri wtr ];
    buildDepends = with self; [ dune ocaml ];
  };
}
