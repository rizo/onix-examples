...
} }:
{
  ...
  conf-portaudio = {
    name = "conf-portaudio";
    version = "1";
    opam = "${repo}/packages/conf-portaudio/conf-portaudio.1/opam";
    buildDepends = with self; [ conf-pkg-config ];
    depexts = with pkgs; [ portaudio ];
  };
  ctypes = {
    name = "ctypes";
    version = "0.20.1";
  ...
  portaudio_c_bindings = {
    ...
    version = "19.6.0";
    src = pkgs.fetchurl {
      url = "https://github.com/wlitwin/portaudio_c_bindings/releases/download/19.6.0/portaudio_c_bindings-19.6.0.tbz";
      sha256 = "2cf27412d3dc5c4b748637b1655b393e8cc072386d4de66923bc39284b642dd2";
    };
    opam = "${repo}/packages/portaudio_c_bindings/portaudio_c_bindings.19.6.0/opam";
    depends = with self; [ conf-portaudio ctypes ctypes-foreign dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  stdlib-shims = {
    name = "stdlib-shims";
