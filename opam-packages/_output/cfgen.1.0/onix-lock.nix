...
} }:
{
  ...
  bnfgen = {
    ...
    version = "3.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/dmbaturin/bnfgen/archive/3.0.0.tar.gz";
    ...
    opam = "${repo}/packages/bnfgen/bnfgen.3.0.0/opam";
  ...
  cfgen = {
    name = "cfgen";
    version = "1.0";
    opam = "${repo}/packages/cfgen/cfgen.1.0/opam";
    depends = with self; [ bnfgen ocaml ];
