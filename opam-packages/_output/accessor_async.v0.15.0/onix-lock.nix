...
} }:
{
  accessor = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/accessor-v0.15.0.tar.gz";
      sha256 = "435b0bd1466d826b26f9beff4b629dbbf85abe676bb117effab81ca897c5f0b3";
    };
    opam = "${repo}/packages/accessor/accessor.v0.15.0/opam";
    depends = with self; [ base dune higher_kinded ocaml ppx_jane ];
  ...
  accessor_async = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/accessor_async-v0.15.0.tar.gz";
      sha256 = "16be666b8b0b39426eb5b4004a9ef7d2c92c0d54356f72d96b90e8164a1ff562";
    };
    opam = "${repo}/packages/accessor_async/accessor_async.v0.15.0/opam";
    depends = with self; [ accessor_core async_kernel core dune ocaml
                           ppx_accessor ppx_jane ];
    buildDepends = with self; [ dune ocaml ];
  };
  accessor_base = {
    name = "accessor_base";
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/accessor_base-v0.15.0.tar.gz";
      sha256 = "e137911097ee71ad66380e2bfa5e2483c674fe7f81d5ebba5d8cce455ba6f936";
    };
    opam = "${repo}/packages/accessor_base/accessor_base.v0.15.0/opam";
    depends = with self; [ accessor base dune higher_kinded ocaml
                           ppx_accessor ppx_jane ];
    buildDepends = with self; [ dune ocaml ];
  };
  accessor_core = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/accessor_core-v0.15.0.tar.gz";
      sha256 = "9c0f7e8a8ba7688a065227fce8522ba16abbf828cf76db646e8929bc82795f8e";
    };
    opam = "${repo}/packages/accessor_core/accessor_core.v0.15.0/opam";
    depends = with self; [ accessor_base core dune ocaml ppx_accessor
                           ppx_jane ];
    buildDepends = with self; [ dune ocaml ];
  };
  async_kernel = {
  ...
  higher_kinded = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/higher_kinded-v0.15.0.tar.gz";
      sha256 = "24ec1a183fe13b44f13de5853692529ad318a2b9339e1fe7ddb9d788c54ace81";
    };
    opam = "${repo}/packages/higher_kinded/higher_kinded.v0.15.0/opam";
  ...
  ppx_accessor = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/ppx_accessor-v0.15.0.tar.gz";
      sha256 = "1c296a857b58361c745f346337e738d6c7eb4376a5950208d796c61189ba2ea6";
    };
    opam = "${repo}/packages/ppx_accessor/ppx_accessor.v0.15.0/opam";
    depends = with self; [ accessor base dune ocaml ppxlib ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppx_assert = {
    name = "ppx_assert";
