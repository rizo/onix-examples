...
} }:
{
  ...
  ppx_deriving_hash = {
    ...
    version = "0.1.1";
    src = pkgs.fetchurl {
      url = "https://github.com/sim642/ppx_deriving_hash/releases/download/0.1.1/ppx_deriving_hash-0.1.1.tbz";
      sha256 = "bdaaac5ab278eee6ded154e405eb7fa8a2dd2b7483032628ce56ef21ae062f24";
    };
    opam = "${repo}/packages/ppx_deriving_hash/ppx_deriving_hash.0.1.1/opam";
    depends = with self; [ dune ppx_deriving ppxlib ];
