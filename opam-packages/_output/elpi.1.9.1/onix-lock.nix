...
} }:
{
  ...
  elpi = {
    ...
    version = "1.9.1";
    src = pkgs.fetchurl {
      url = "https://github.com/LPCIC/elpi/releases/download/v1.9.1/elpi-v1.9.1.tbz";
      sha256 = "2432b140d355c56263381fcbc0bef64100bec02f4551cd723614b43de6cae6d8";
    };
    opam = "${repo}/packages/elpi/elpi.1.9.1/opam";
    depends = with self; [ camlp5 dune ocaml ocaml-migrate-parsetree
                           ppx_deriving ppx_tools_versioned re ];
    buildDepends = with self; [ dune ocaml ];
  };
  ocaml = {
    name = "ocaml";
