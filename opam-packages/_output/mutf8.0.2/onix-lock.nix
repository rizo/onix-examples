...
} }:
{
  ...
  mutf8 = {
    ...
    version = "0.2";
    src = pkgs.fetchurl {
      url = "http://github.com/wiml/ocaml-mutf8/archive/v0.2.tar.gz";
      sha512 = "595c25f2ffc8e5bc544d3c80c9491ee6d5a490a8995cba44e72c03e750e7d20a5b3c21c016cf1ffce44c273752b40f6f07482b6ceabe9e9851ad3759ac4dde8b";
    };
    opam = "${repo}/packages/mutf8/mutf8.0.2/opam";
