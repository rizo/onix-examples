...
} }:
{
  ...
  osx-secure-transport = {
    ...
    version = "0.1.1";
    src = pkgs.fetchurl {
      url = "https://github.com/toots/ocaml-osx-secure-transport/releases/download/0.1.1/osx-secure-transport-0.1.1.tar.gz";
      sha256 = "1drbar2n88n6qf2dfphlv7vajn5fxhmbmknqbh7cz3zzzpkjwf7z";
    };
    opam = "${repo}/packages/osx-secure-transport/osx-secure-transport.0.1.1/opam";
    depends = with self; [ ctypes ctypes-foreign dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  stdlib-shims = {
    name = "stdlib-shims";
