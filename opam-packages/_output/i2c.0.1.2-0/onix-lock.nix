...
} }:
{
  ...
  i2c = {
    ...
    opam = "${repo}/packages/i2c/i2c.0.1.2-0/opam";
    depends = with self; [ base-unix conf-linux-libc-dev ocaml ocamlfind
                           result stdint ];
  ...
  stdint = {
    ...
    opam = "${repo}/packages/stdint/stdint.0.5.0/opam";
    depends = with self; [ base-bytes ocaml ocamlfind ];
    buildDepends = with self; [ ocaml ocamlbuild ocamlfind ];
  };
}
