...
} }:
{
  ...
  lastfm = {
    ...
    version = "0.3.3";
    src = pkgs.fetchurl {
      url = "https://github.com/savonet/ocaml-lastfm/archive/v0.3.3.tar.gz";
    ...
    opam = "${repo}/packages/lastfm/lastfm.0.3.3/opam";
    depends = with self; [ dune pcre xmlplaylist (self.ocamlnet or null) ];
  ...
  xmlplaylist = {
    ...
    version = "0.1.5";
    src = pkgs.fetchurl {
      url = "https://github.com/savonet/ocaml-xmlplaylist/archive/v0.1.5.tar.gz";
    ...
    opam = "${repo}/packages/xmlplaylist/xmlplaylist.0.1.5/opam";
