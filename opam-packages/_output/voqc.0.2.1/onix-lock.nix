...
} }:
{
  ...
  openQASM = {
    ...
    version = "0.3.0";
    src = pkgs.fetchurl {
      url = "https://github.com/inQWIRE/openqasm-parser/releases/download/v0.3.0/openQASM-v0.3.0.tbz";
      sha256 = "09b91acef7beedf97fbced11139e4b10fffb5075fe551f6475e53e5cef578ef6";
    };
    opam = "${repo}/packages/openQASM/openQASM.0.3.0/opam";
    depends = with self; [ dune menhir ];
  ...
  voqc = {
    ...
    version = "0.2.1";
    src = pkgs.fetchurl {
      url = "https://github.com/inQWIRE/mlvoqc/releases/download/0.2.1/voqc-0.2.1.tbz";
      sha256 = "775c805a06491ba3f46d3d752902acaffdf0d505d842874d68bed87df45c079c";
    };
    opam = "${repo}/packages/voqc/voqc.0.2.1/opam";
    depends = with self; [ dune ocaml openQASM zarith ];
    buildDepends = with self; [ dune ocaml ];
  };
  zarith = {
    name = "zarith";
