...
} }:
{
  ...
  line-up-words = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/line-up-words-v0.15.0.tar.gz";
      sha256 = "060f154b237eda801a19811513d56ac818c6f90f52c82721d6f203b022ed2a19";
    };
    opam = "${repo}/packages/line-up-words/line-up-words.v0.15.0/opam";
    depends = with self; [ core core_unix dune ocaml patience_diff pcre
                           ppx_jane re2 ];
    buildDepends = with self; [ dune ocaml ];
  };
  num = {
