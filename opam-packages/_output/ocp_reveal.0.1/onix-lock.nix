...
} }:
{
  ...
  ocp_reveal = {
    ...
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/OCamlPro/ocp-reveal/archive/0.1.tar.gz";
      sha256 = "b665c9640a5c6b71354663547ed82921c5425320988cccc184e063be41ac4dbd";
    };
    opam = "${repo}/packages/ocp_reveal/ocp_reveal.0.1/opam";
    depends = with self; [ dune js_of_ocaml js_of_ocaml-ppx ocaml omd ];
    buildDepends = with self; [ dune ocaml ];
  };
  omd = {
    name = "omd";
