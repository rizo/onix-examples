...
} }:
{
  ...
  cppffigen = {
    ...
    version = "0.002";
    src = pkgs.fetchurl {
      url = "https://github.com/chetmurthy/ocaml-cppffigen/archive/refs/tags/0.002.tar.gz";
    ...
    opam = "${repo}/packages/cppffigen/cppffigen.0.002/opam";
    depends = with self; [ cmdliner pcre ppx_deriving ppx_sexp_conv sexplib ];
  };
  cppo = {
    name = "cppo";
    version = "1.6.9";
