...
} }:
{
  ...
  camelot = {
    ...
    version = "1.7.1";
    src = pkgs.fetchurl {
      url = "https://github.com/upenn-cis1xx/camelot/archive/1.7.1.tar.gz";
    ...
    opam = "${repo}/packages/camelot/camelot.1.7.1/opam";
    depends = with self; [ ANSITerminal dune ocaml yojson ];
    buildDepends = with self; [ dune ocaml ];
  };
  cppo = {
    name = "cppo";
