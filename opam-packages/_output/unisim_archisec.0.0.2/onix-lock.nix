...
} }:
{
  ...
  unisim_archisec = {
    ...
    version = "0.0.2";
    src = pkgs.fetchurl {
      url = "https://github.com/binsec/unisim_archisec/releases/download/0.0.2/unisim_archisec-0.0.2.tbz";
      sha256 = "1808b0113b272bb8b5609b8cc8f7f722bfe35cb81d02bc8283c435797389fffb";
    };
    opam = "${repo}/packages/unisim_archisec/unisim_archisec.0.0.2/opam";
    depends = with self; [ conf-gmp dune ];
    buildDepends = with self; [ conf-g++ conf-gcc dune ];
  };
}
