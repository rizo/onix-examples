...
} }:
{
  ...
  tezos-embedded-protocol-genesis = {
    ...
    opam = "${repo}/packages/tezos-embedded-protocol-genesis/tezos-embedded-protocol-genesis.9.7/opam";
    depends = with self; [ dune tezos-protocol-genesis tezos-protocol-updater ];
    buildDepends = with self; [ dune ];
  };
  tezos-error-monad = {
