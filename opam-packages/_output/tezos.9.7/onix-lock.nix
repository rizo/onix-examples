...
} }:
{
  ...
  conf-hidapi = {
    name = "conf-hidapi";
    version = "0";
    opam = "${repo}/packages/conf-hidapi/conf-hidapi.0/opam";
    buildDepends = with self; [ conf-pkg-config ];
    depexts = with pkgs; [ hidapi ];
  };
  conf-libev = {
    name = "conf-libev";
    version = "4+12";
  ...
  hidapi = {
    ...
    version = "1.1.1";
    src = pkgs.fetchurl {
      url = "https://github.com/vbmithr/ocaml-hidapi/releases/download/1.1.1/hidapi-1.1.1.tbz";
      sha256 = "1j7rd7ajrzla76r3sxljx6fb18f4f4s3jd7vhv59l2ilxyxycai2";
    };
    opam = "${repo}/packages/hidapi/hidapi.1.1.1/opam";
    depends = with self; [ bigstring dune dune-configurator ocaml ];
    buildDepends = with self; [ conf-hidapi dune ocaml ];
  };
  hkdf = {
    name = "hkdf";
    version = "1.0.4";
  ...
  ledgerwallet = {
    ...
    version = "0.2.0";
    src = pkgs.fetchurl {
      url = "https://github.com/vbmithr/ocaml-ledger-wallet/archive/refs/tags/0.2.0.tar.gz";
      sha256 = "9c326ab92ca40b50b7fef28e9db596774e3dffe4959956103dccbfcad869f81c";
    };
    opam = "${repo}/packages/ledgerwallet/ledgerwallet.0.2.0/opam";
    depends = with self; [ cstruct dune hidapi ocaml rresult ];
    buildDepends = with self; [ dune ocaml ];
  };
  ledgerwallet-tezos = {
    ...
    opam = "${repo}/packages/ledgerwallet-tezos/ledgerwallet-tezos.0.2.0/opam";
    depends = with self; [ dune ledgerwallet ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  logs = {
    name = "logs";
  ...
  lwt-exit = {
    ...
    opam = "${repo}/packages/lwt-exit/lwt-exit.1.0/opam";
    depends = with self; [ base-unix dune lwt ocaml ptime ];
    buildDepends = with self; [ dune ocaml ];
  };
  lwt-watcher = {
    name = "lwt-watcher";
  ...
  tezos = {
    name = "tezos";
    version = "9.7";
    opam = "${repo}/packages/tezos/tezos.9.7/opam";
    depends = with self; [ ledgerwallet-tezos tezos-accuser-009-PsFLoren
                           tezos-accuser-010-PtGRANAD
                           tezos-baker-009-PsFLoren tezos-baker-010-PtGRANAD
                           tezos-client tezos-client-001-PtCJ7pwo-commands
                           ...
                           tezos-codec tezos-embedded-protocol-001-PtCJ7pwo
                           ...
                           tezos-endorser-010-PtGRANAD tezos-node
                           tezos-signer ];
  };
  tezos-accuser-009-PsFLoren = {
    name = "tezos-accuser-009-PsFLoren";
    version = "9.7";
    src = pkgs.fetchurl {
    ...
    opam = "${repo}/packages/tezos-accuser-009-PsFLoren/tezos-accuser-009-PsFLoren.9.7/opam";
    depends = with self; [ dune tezos-baking-009-PsFLoren-commands
                           tezos-client-base-unix ];
    buildDepends = with self; [ dune ];
  };
  tezos-accuser-010-PtGRANAD = {
    name = "tezos-accuser-010-PtGRANAD";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-accuser-010-PtGRANAD/tezos-accuser-010-PtGRANAD.9.7/opam";
    depends = with self; [ dune tezos-baking-010-PtGRANAD-commands
                           tezos-client-base-unix ];
    buildDepends = with self; [ dune ];
  };
  tezos-baker-009-PsFLoren = {
    name = "tezos-baker-009-PsFLoren";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-baker-009-PsFLoren/tezos-baker-009-PsFLoren.9.7/opam";
    depends = with self; [ dune tezos-baking-009-PsFLoren-commands
                           tezos-client-base-unix ];
    buildDepends = with self; [ dune ];
  };
  tezos-baker-010-PtGRANAD = {
    name = "tezos-baker-010-PtGRANAD";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-baker-010-PtGRANAD/tezos-baker-010-PtGRANAD.9.7/opam";
    depends = with self; [ dune tezos-baking-010-PtGRANAD-commands
                           tezos-client-base-unix ];
    buildDepends = with self; [ dune ];
  };
  tezos-baking-009-PsFLoren = {
    ...
    opam = "${repo}/packages/tezos-baking-009-PsFLoren/tezos-baking-009-PsFLoren.9.7/opam";
    depends = with self; [ dune lwt-exit tezos-client-009-PsFLoren
                           tezos-client-commands tezos-shell-context ];
    buildDepends = with self; [ dune ];
  };
  tezos-baking-009-PsFLoren-commands = {
    ...
    opam = "${repo}/packages/tezos-baking-009-PsFLoren-commands/tezos-baking-009-PsFLoren-commands.9.7/opam";
    depends = with self; [ dune tezos-baking-009-PsFLoren ];
    buildDepends = with self; [ dune ];
  };
  tezos-baking-010-PtGRANAD = {
    name = "tezos-baking-010-PtGRANAD";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-baking-010-PtGRANAD/tezos-baking-010-PtGRANAD.9.7/opam";
    depends = with self; [ dune lwt-exit tezos-client-010-PtGRANAD
                           tezos-client-commands tezos-shell-context ];
    buildDepends = with self; [ dune ];
  };
  tezos-baking-010-PtGRANAD-commands = {
    name = "tezos-baking-010-PtGRANAD-commands";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-baking-010-PtGRANAD-commands/tezos-baking-010-PtGRANAD-commands.9.7/opam";
    depends = with self; [ dune tezos-baking-010-PtGRANAD ];
    buildDepends = with self; [ dune ];
  };
  tezos-base = {
    name = "tezos-base";
  ...
  tezos-client = {
    ...
    opam = "${repo}/packages/tezos-client/tezos-client.9.7/opam";
    depends = with self; [ dune tezos-baking-009-PsFLoren-commands
                           tezos-baking-010-PtGRANAD-commands
                           ...
                           (self.tezos-baking-008-PtEdo2Zk-commands or null)
                           (self.tezos-baking-alpha-commands or null)
                           (self.tezos-client-001-PtCJ7pwo-commands or null)
                           (self.tezos-client-002-PsYLVpVv-commands or null)
                           (self.tezos-client-003-PsddFKi3-commands or null)
                           (self.tezos-client-004-Pt24m4xi-commands or null)
                           (self.tezos-client-005-PsBabyM1-commands or null)
                           (self.tezos-client-006-PsCARTHA-commands or null)
                           (self.tezos-client-007-PsDELPH1-commands-registration or null)
                           (self.tezos-client-008-PtEdo2Zk-commands-registration or null)
                           (self.tezos-client-alpha-commands-registration or null)
                           (self.tezos-client-demo-counter or null)
                           (self.tezos-client-genesis or null) ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-000-Ps9mPmXa = {
    ...
    opam = "${repo}/packages/tezos-client-000-Ps9mPmXa/tezos-client-000-Ps9mPmXa.9.7/opam";
    depends = with self; [ dune tezos-client-commands
                           tezos-protocol-000-Ps9mPmXa ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-001-PtCJ7pwo = {
    name = "tezos-client-001-PtCJ7pwo";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-client-001-PtCJ7pwo/tezos-client-001-PtCJ7pwo.9.7/opam";
    depends = with self; [ dune tezos-protocol-001-PtCJ7pwo
  ...
  tezos-client-001-PtCJ7pwo-commands = {
    ...
    opam = "${repo}/packages/tezos-client-001-PtCJ7pwo-commands/tezos-client-001-PtCJ7pwo-commands.9.7/opam";
    depends = with self; [ dune tezos-client-001-PtCJ7pwo
                           tezos-client-commands ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-002-PsYLVpVv = {
    name = "tezos-client-002-PsYLVpVv";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-client-002-PsYLVpVv/tezos-client-002-PsYLVpVv.9.7/opam";
    depends = with self; [ dune tezos-protocol-002-PsYLVpVv
                           tezos-signer-backends ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-002-PsYLVpVv-commands = {
    name = "tezos-client-002-PsYLVpVv-commands";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-client-002-PsYLVpVv-commands/tezos-client-002-PsYLVpVv-commands.9.7/opam";
    depends = with self; [ dune tezos-client-002-PsYLVpVv
                           tezos-client-commands ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-003-PsddFKi3 = {
    name = "tezos-client-003-PsddFKi3";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-client-003-PsddFKi3/tezos-client-003-PsddFKi3.9.7/opam";
    depends = with self; [ dune tezos-protocol-003-PsddFKi3
                           tezos-signer-backends ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-003-PsddFKi3-commands = {
    name = "tezos-client-003-PsddFKi3-commands";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-client-003-PsddFKi3-commands/tezos-client-003-PsddFKi3-commands.9.7/opam";
    depends = with self; [ dune tezos-client-003-PsddFKi3
                           tezos-client-base-unix ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-004-Pt24m4xi = {
    ...
    opam = "${repo}/packages/tezos-client-004-Pt24m4xi/tezos-client-004-Pt24m4xi.9.7/opam";
    depends = with self; [ dune tezos-protocol-004-Pt24m4xi
                           tezos-signer-backends ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-004-Pt24m4xi-commands = {
    ...
    opam = "${repo}/packages/tezos-client-004-Pt24m4xi-commands/tezos-client-004-Pt24m4xi-commands.9.7/opam";
    depends = with self; [ dune tezos-client-004-Pt24m4xi
                           tezos-client-base-unix ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-005-PsBabyM1 = {
    ...
    opam = "${repo}/packages/tezos-client-005-PsBabyM1/tezos-client-005-PsBabyM1.9.7/opam";
    depends = with self; [ dune tezos-protocol-005-PsBabyM1
                           tezos-signer-backends ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-005-PsBabyM1-commands = {
    name = "tezos-client-005-PsBabyM1-commands";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-client-005-PsBabyM1-commands/tezos-client-005-PsBabyM1-commands.9.7/opam";
    depends = with self; [ dune tezos-client-005-PsBabyM1
                           tezos-client-base-unix ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-006-PsCARTHA = {
    ...
    opam = "${repo}/packages/tezos-client-006-PsCARTHA/tezos-client-006-PsCARTHA.9.7/opam";
    depends = with self; [ dune tezos-protocol-006-PsCARTHA
  ...
  tezos-client-006-PsCARTHA-commands = {
    ...
    opam = "${repo}/packages/tezos-client-006-PsCARTHA-commands/tezos-client-006-PsCARTHA-commands.9.7/opam";
    depends = with self; [ dune tezos-client-006-PsCARTHA
                           tezos-client-base-unix ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-007-PsDELPH1 = {
    ...
    opam = "${repo}/packages/tezos-client-007-PsDELPH1/tezos-client-007-PsDELPH1.9.7/opam";
    depends = with self; [ dune tezos-mockup-registration
                           tezos-protocol-plugin-007-PsDELPH1 tezos-proxy
                           tezos-signer-backends ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-007-PsDELPH1-commands = {
    ...
    opam = "${repo}/packages/tezos-client-007-PsDELPH1-commands/tezos-client-007-PsDELPH1-commands.9.7/opam";
    depends = with self; [ dune tezos-client-007-PsDELPH1
                           tezos-client-base-unix ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-007-PsDELPH1-commands-registration = {
    ...
    opam = "${repo}/packages/tezos-client-007-PsDELPH1-commands-registration/tezos-client-007-PsDELPH1-commands-registration.9.7/opam";
    depends = with self; [ dune tezos-client-007-PsDELPH1-commands ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-008-PtEdo2Zk = {
    ...
    opam = "${repo}/packages/tezos-client-008-PtEdo2Zk/tezos-client-008-PtEdo2Zk.9.7/opam";
    depends = with self; [ dune tezos-mockup-registration
  ...
  tezos-client-008-PtEdo2Zk-commands = {
    ...
    opam = "${repo}/packages/tezos-client-008-PtEdo2Zk-commands/tezos-client-008-PtEdo2Zk-commands.9.7/opam";
    depends = with self; [ dune tezos-client-008-PtEdo2Zk
                           tezos-client-base-unix ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-008-PtEdo2Zk-commands-registration = {
    ...
    opam = "${repo}/packages/tezos-client-008-PtEdo2Zk-commands-registration/tezos-client-008-PtEdo2Zk-commands-registration.9.7/opam";
    depends = with self; [ dune tezos-client-sapling-008-PtEdo2Zk ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-009-PsFLoren = {
    name = "tezos-client-009-PsFLoren";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-client-009-PsFLoren/tezos-client-009-PsFLoren.9.7/opam";
    depends = with self; [ dune tezos-mockup-registration
                           tezos-protocol-009-PsFLoren-parameters
                           tezos-protocol-plugin-009-PsFLoren tezos-proxy
                           tezos-signer-backends ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-009-PsFLoren-commands = {
    ...
    opam = "${repo}/packages/tezos-client-009-PsFLoren-commands/tezos-client-009-PsFLoren-commands.9.7/opam";
    depends = with self; [ dune tezos-client-009-PsFLoren
                           tezos-client-base-unix ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-009-PsFLoren-commands-registration = {
    ...
    opam = "${repo}/packages/tezos-client-009-PsFLoren-commands-registration/tezos-client-009-PsFLoren-commands-registration.9.7/opam";
    depends = with self; [ dune tezos-client-sapling-009-PsFLoren ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-010-PtGRANAD = {
    ...
    opam = "${repo}/packages/tezos-client-010-PtGRANAD/tezos-client-010-PtGRANAD.9.7/opam";
    depends = with self; [ dune ppx_inline_test tezos-mockup-registration
                           tezos-protocol-010-PtGRANAD-parameters
                           tezos-protocol-plugin-010-PtGRANAD tezos-proxy
                           tezos-signer-backends ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-010-PtGRANAD-commands = {
    ...
    opam = "${repo}/packages/tezos-client-010-PtGRANAD-commands/tezos-client-010-PtGRANAD-commands.9.7/opam";
    depends = with self; [ dune tezos-client-010-PtGRANAD
                           tezos-client-base-unix ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-010-PtGRANAD-commands-registration = {
    ...
    opam = "${repo}/packages/tezos-client-010-PtGRANAD-commands-registration/tezos-client-010-PtGRANAD-commands-registration.9.7/opam";
    depends = with self; [ dune tezos-client-sapling-010-PtGRANAD ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-base = {
    ...
    opam = "${repo}/packages/tezos-client-base/tezos-client-base.9.7/opam";
    depends = with self; [ dune tezos-rpc-http tezos-sapling tezos-storage ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-base-unix = {
    ...
    opam = "${repo}/packages/tezos-client-base-unix/tezos-client-base-unix.9.7/opam";
    depends = with self; [ dune lwt-exit tezos-mockup-commands tezos-proxy
                           tezos-signer-backends ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-commands = {
    ...
    opam = "${repo}/packages/tezos-client-commands/tezos-client-commands.9.7/opam";
    depends = with self; [ dune tezos-client-base tezos-shell-services
                           tezos-signer-backends ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-genesis-carthagenet = {
    ...
    opam = "${repo}/packages/tezos-client-genesis-carthagenet/tezos-client-genesis-carthagenet.9.7/opam";
    depends = with self; [ dune tezos-client-commands
  ...
  tezos-client-sapling-008-PtEdo2Zk = {
    ...
    opam = "${repo}/packages/tezos-client-sapling-008-PtEdo2Zk/tezos-client-sapling-008-PtEdo2Zk.9.7/opam";
    depends = with self; [ dune tezos-client-008-PtEdo2Zk-commands ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-sapling-009-PsFLoren = {
    ...
    opam = "${repo}/packages/tezos-client-sapling-009-PsFLoren/tezos-client-sapling-009-PsFLoren.9.7/opam";
    depends = with self; [ dune tezos-client-009-PsFLoren-commands ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-sapling-010-PtGRANAD = {
    ...
    opam = "${repo}/packages/tezos-client-sapling-010-PtGRANAD/tezos-client-sapling-010-PtGRANAD.9.7/opam";
    depends = with self; [ dune tezos-client-010-PtGRANAD-commands ];
    buildDepends = with self; [ dune ];
  };
  tezos-codec = {
    name = "tezos-codec";
    ...
    opam = "${repo}/packages/tezos-codec/tezos-codec.9.7/opam";
    depends = with self; [ dune tezos-client-base-unix tezos-signer-services
                           (self.tezos-client-005-PsBabyM1 or null)
                           (self.tezos-client-006-PsCARTHA or null)
                           (self.tezos-client-007-PsDELPH1 or null)
                           (self.tezos-client-008-PtEdo2Zk or null)
                           (self.tezos-client-009-PsFLoren or null)
                           (self.tezos-client-010-PtGRANAD or null)
                           (self.tezos-client-alpha or null) ];
    buildDepends = with self; [ dune ];
  };
  tezos-crypto = {
    name = "tezos-crypto";
  ...
  tezos-embedded-protocol-000-Ps9mPmXa = {
    ...
    opam = "${repo}/packages/tezos-embedded-protocol-000-Ps9mPmXa/tezos-embedded-protocol-000-Ps9mPmXa.9.7/opam";
    depends = with self; [ dune tezos-protocol-000-Ps9mPmXa
  ...
  tezos-embedded-protocol-001-PtCJ7pwo = {
    ...
    opam = "${repo}/packages/tezos-embedded-protocol-001-PtCJ7pwo/tezos-embedded-protocol-001-PtCJ7pwo.9.7/opam";
    depends = with self; [ dune tezos-protocol-001-PtCJ7pwo
                           tezos-protocol-updater ];
    buildDepends = with self; [ dune ];
  };
  tezos-embedded-protocol-002-PsYLVpVv = {
    name = "tezos-embedded-protocol-002-PsYLVpVv";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-embedded-protocol-002-PsYLVpVv/tezos-embedded-protocol-002-PsYLVpVv.9.7/opam";
    depends = with self; [ dune tezos-protocol-002-PsYLVpVv
                           tezos-protocol-updater ];
    buildDepends = with self; [ dune ];
  };
  tezos-embedded-protocol-003-PsddFKi3 = {
    name = "tezos-embedded-protocol-003-PsddFKi3";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-embedded-protocol-003-PsddFKi3/tezos-embedded-protocol-003-PsddFKi3.9.7/opam";
    depends = with self; [ dune tezos-protocol-003-PsddFKi3
                           tezos-protocol-updater ];
    buildDepends = with self; [ dune ];
  };
  tezos-embedded-protocol-004-Pt24m4xi = {
    name = "tezos-embedded-protocol-004-Pt24m4xi";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-embedded-protocol-004-Pt24m4xi/tezos-embedded-protocol-004-Pt24m4xi.9.7/opam";
    depends = with self; [ dune tezos-protocol-004-Pt24m4xi
                           tezos-protocol-updater ];
    buildDepends = with self; [ dune ];
  };
  tezos-embedded-protocol-005-PsBABY5H = {
    name = "tezos-embedded-protocol-005-PsBABY5H";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-embedded-protocol-005-PsBABY5H/tezos-embedded-protocol-005-PsBABY5H.9.7/opam";
    depends = with self; [ dune tezos-protocol-005-PsBABY5H
                           tezos-protocol-updater ];
    buildDepends = with self; [ dune ];
  };
  tezos-embedded-protocol-005-PsBabyM1 = {
    ...
    opam = "${repo}/packages/tezos-embedded-protocol-005-PsBabyM1/tezos-embedded-protocol-005-PsBabyM1.9.7/opam";
    depends = with self; [ dune tezos-protocol-005-PsBabyM1
                           tezos-protocol-updater ];
    buildDepends = with self; [ dune ];
  };
  tezos-embedded-protocol-006-PsCARTHA = {
    ...
    opam = "${repo}/packages/tezos-embedded-protocol-006-PsCARTHA/tezos-embedded-protocol-006-PsCARTHA.9.7/opam";
    depends = with self; [ dune tezos-protocol-006-PsCARTHA
                           tezos-protocol-updater ];
    buildDepends = with self; [ dune ];
  };
  tezos-embedded-protocol-007-PsDELPH1 = {
    ...
    opam = "${repo}/packages/tezos-embedded-protocol-007-PsDELPH1/tezos-embedded-protocol-007-PsDELPH1.9.7/opam";
    depends = with self; [ dune tezos-protocol-007-PsDELPH1
                           tezos-protocol-updater ];
    buildDepends = with self; [ dune ];
  };
  tezos-embedded-protocol-008-PtEdo2Zk = {
    name = "tezos-embedded-protocol-008-PtEdo2Zk";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-embedded-protocol-008-PtEdo2Zk/tezos-embedded-protocol-008-PtEdo2Zk.9.7/opam";
    depends = with self; [ dune tezos-protocol-008-PtEdo2Zk
                           tezos-protocol-updater ];
    buildDepends = with self; [ dune ];
  };
  tezos-embedded-protocol-008-PtEdoTez = {
    name = "tezos-embedded-protocol-008-PtEdoTez";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-embedded-protocol-008-PtEdoTez/tezos-embedded-protocol-008-PtEdoTez.9.7/opam";
    depends = with self; [ dune tezos-protocol-008-PtEdoTez
                           tezos-protocol-updater ];
    buildDepends = with self; [ dune ];
  };
  tezos-embedded-protocol-009-PsFLoren = {
    name = "tezos-embedded-protocol-009-PsFLoren";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-embedded-protocol-009-PsFLoren/tezos-embedded-protocol-009-PsFLoren.9.7/opam";
    depends = with self; [ dune tezos-protocol-009-PsFLoren
                           tezos-protocol-updater ];
    buildDepends = with self; [ dune ];
  };
  tezos-embedded-protocol-010-PtGRANAD = {
    name = "tezos-embedded-protocol-010-PtGRANAD";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-embedded-protocol-010-PtGRANAD/tezos-embedded-protocol-010-PtGRANAD.9.7/opam";
    depends = with self; [ dune tezos-protocol-010-PtGRANAD
                           tezos-protocol-updater ];
    buildDepends = with self; [ dune ];
  };
  tezos-embedded-protocol-genesis-carthagenet = {
    ...
    opam = "${repo}/packages/tezos-embedded-protocol-genesis-carthagenet/tezos-embedded-protocol-genesis-carthagenet.9.7/opam";
    depends = with self; [ dune tezos-protocol-genesis-carthagenet
                           tezos-protocol-updater ];
    buildDepends = with self; [ dune ];
  };
  tezos-endorser-009-PsFLoren = {
    name = "tezos-endorser-009-PsFLoren";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-endorser-009-PsFLoren/tezos-endorser-009-PsFLoren.9.7/opam";
    depends = with self; [ dune tezos-baking-009-PsFLoren-commands
                           tezos-client-base-unix ];
    buildDepends = with self; [ dune ];
  };
  tezos-endorser-010-PtGRANAD = {
    name = "tezos-endorser-010-PtGRANAD";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-endorser-010-PtGRANAD/tezos-endorser-010-PtGRANAD.9.7/opam";
    depends = with self; [ dune tezos-baking-010-PtGRANAD-commands
                           tezos-client-base-unix ];
    buildDepends = with self; [ dune ];
  };
  ...
  tezos-mockup = {
    ...
    opam = "${repo}/packages/tezos-mockup/tezos-mockup.9.7/opam";
    depends = with self; [ dune tezos-mockup-proxy tezos-mockup-registration
                           tezos-p2p ];
    buildDepends = with self; [ dune ];
  };
  tezos-mockup-commands = {
    ...
    opam = "${repo}/packages/tezos-mockup-commands/tezos-mockup-commands.9.7/opam";
    depends = with self; [ dune tezos-client-commands tezos-mockup ];
    buildDepends = with self; [ dune ];
  };
  tezos-mockup-proxy = {
    ...
    opam = "${repo}/packages/tezos-mockup-proxy/tezos-mockup-proxy.9.7/opam";
    depends = with self; [ dune resto-cohttp-self-serving-client
                           tezos-client-base tezos-protocol-environment
                           tezos-rpc-http-client tezos-shell-services ];
    buildDepends = with self; [ dune ];
  };
  tezos-mockup-registration = {
    ...
    opam = "${repo}/packages/tezos-mockup-registration/tezos-mockup-registration.9.7/opam";
  ...
  tezos-node = {
    ...
    opam = "${repo}/packages/tezos-node/tezos-node.9.7/opam";
    depends = with self; [ cmdliner dune tezos-embedded-protocol-000-Ps9mPmXa
                           tezos-embedded-protocol-genesis-carthagenet
                           tezos-protocol-plugin-009-PsFLoren-registerer
                           tezos-protocol-plugin-010-PtGRANAD-registerer
                           tezos-rpc-http-server tezos-validator tls
                           (self.tezos-embedded-protocol-001-PtCJ7pwo or null)
                           (self.tezos-embedded-protocol-002-PsYLVpVv or null)
                           (self.tezos-embedded-protocol-003-PsddFKi3 or null)
                           (self.tezos-embedded-protocol-004-Pt24m4xi or null)
                           (self.tezos-embedded-protocol-005-PsBABY5H or null)
                           (self.tezos-embedded-protocol-005-PsBabyM1 or null)
                           (self.tezos-embedded-protocol-006-PsCARTHA or null)
                           (self.tezos-embedded-protocol-007-PsDELPH1 or null)
                           (self.tezos-embedded-protocol-008-PtEdo2Zk or null)
                           (self.tezos-embedded-protocol-008-PtEdoTez or null)
                           (self.tezos-embedded-protocol-alpha or null)
                           (self.tezos-embedded-protocol-demo-counter or null)
                           (self.tezos-embedded-protocol-demo-noops or null)
                           (self.tezos-embedded-protocol-genesis or null)
                           (self.tezos-protocol-plugin-007-PsDELPH1-registerer or null)
                           (self.tezos-protocol-plugin-008-PtEdo2Zk-registerer or null)
                           (self.tezos-protocol-plugin-alpha-registerer or null)
                           ];
    buildDepends = with self; [ dune ];
  };
  tezos-p2p = {
    ...
    opam = "${repo}/packages/tezos-p2p/tezos-p2p.9.7/opam";
  ...
  tezos-protocol-000-Ps9mPmXa = {
    ...
    opam = "${repo}/packages/tezos-protocol-000-Ps9mPmXa/tezos-protocol-000-Ps9mPmXa.9.7/opam";
  ...
  tezos-protocol-001-PtCJ7pwo = {
    ...
    opam = "${repo}/packages/tezos-protocol-001-PtCJ7pwo/tezos-protocol-001-PtCJ7pwo.9.7/opam";
    depends = with self; [ dune tezos-protocol-compiler ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-002-PsYLVpVv = {
    name = "tezos-protocol-002-PsYLVpVv";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-protocol-002-PsYLVpVv/tezos-protocol-002-PsYLVpVv.9.7/opam";
    depends = with self; [ dune tezos-protocol-compiler ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-003-PsddFKi3 = {
    name = "tezos-protocol-003-PsddFKi3";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-protocol-003-PsddFKi3/tezos-protocol-003-PsddFKi3.9.7/opam";
    depends = with self; [ dune tezos-protocol-compiler ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-004-Pt24m4xi = {
    name = "tezos-protocol-004-Pt24m4xi";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-protocol-004-Pt24m4xi/tezos-protocol-004-Pt24m4xi.9.7/opam";
    depends = with self; [ dune tezos-protocol-compiler ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-005-PsBABY5H = {
    name = "tezos-protocol-005-PsBABY5H";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-protocol-005-PsBABY5H/tezos-protocol-005-PsBABY5H.9.7/opam";
    depends = with self; [ dune tezos-protocol-compiler ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-005-PsBabyM1 = {
    name = "tezos-protocol-005-PsBabyM1";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-protocol-005-PsBabyM1/tezos-protocol-005-PsBabyM1.9.7/opam";
    depends = with self; [ dune tezos-protocol-compiler ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-006-PsCARTHA = {
    name = "tezos-protocol-006-PsCARTHA";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-protocol-006-PsCARTHA/tezos-protocol-006-PsCARTHA.9.7/opam";
    depends = with self; [ dune tezos-protocol-compiler ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-006-PsCARTHA-parameters = {
    ...
    opam = "${repo}/packages/tezos-protocol-006-PsCARTHA-parameters/tezos-protocol-006-PsCARTHA-parameters.9.7/opam";
    depends = with self; [ dune tezos-protocol-006-PsCARTHA ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-007-PsDELPH1 = {
    ...
    opam = "${repo}/packages/tezos-protocol-007-PsDELPH1/tezos-protocol-007-PsDELPH1.9.7/opam";
    depends = with self; [ dune tezos-protocol-compiler ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-008-PtEdo2Zk = {
    ...
    opam = "${repo}/packages/tezos-protocol-008-PtEdo2Zk/tezos-protocol-008-PtEdo2Zk.9.7/opam";
    depends = with self; [ dune tezos-protocol-compiler ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-008-PtEdo2Zk-parameters = {
    ...
    opam = "${repo}/packages/tezos-protocol-008-PtEdo2Zk-parameters/tezos-protocol-008-PtEdo2Zk-parameters.9.7/opam";
    depends = with self; [ dune tezos-protocol-008-PtEdo2Zk ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-008-PtEdoTez = {
    name = "tezos-protocol-008-PtEdoTez";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-protocol-008-PtEdoTez/tezos-protocol-008-PtEdoTez.9.7/opam";
    depends = with self; [ dune tezos-protocol-compiler ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-009-PsFLoren = {
    name = "tezos-protocol-009-PsFLoren";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-protocol-009-PsFLoren/tezos-protocol-009-PsFLoren.9.7/opam";
    depends = with self; [ dune tezos-protocol-compiler ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-009-PsFLoren-parameters = {
    name = "tezos-protocol-009-PsFLoren-parameters";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-protocol-009-PsFLoren-parameters/tezos-protocol-009-PsFLoren-parameters.9.7/opam";
    depends = with self; [ dune tezos-protocol-009-PsFLoren ];
    buildDepends = with self; [ dune ];
  };
  ...
  tezos-protocol-010-PtGRANAD-parameters = {
    ...
    opam = "${repo}/packages/tezos-protocol-010-PtGRANAD-parameters/tezos-protocol-010-PtGRANAD-parameters.9.7/opam";
    depends = with self; [ dune tezos-protocol-010-PtGRANAD ];
    buildDepends = with self; [ dune ];
  };
  ...
  tezos-protocol-genesis-carthagenet = {
    ...
    opam = "${repo}/packages/tezos-protocol-genesis-carthagenet/tezos-protocol-genesis-carthagenet.9.7/opam";
    depends = with self; [ dune tezos-protocol-compiler ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-plugin-007-PsDELPH1 = {
    ...
    opam = "${repo}/packages/tezos-protocol-plugin-007-PsDELPH1/tezos-protocol-plugin-007-PsDELPH1.9.7/opam";
    depends = with self; [ dune tezos-protocol-007-PsDELPH1 ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-plugin-008-PtEdo2Zk = {
    ...
    opam = "${repo}/packages/tezos-protocol-plugin-008-PtEdo2Zk/tezos-protocol-plugin-008-PtEdo2Zk.9.7/opam";
    depends = with self; [ dune tezos-protocol-008-PtEdo2Zk ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-plugin-009-PsFLoren = {
    ...
    opam = "${repo}/packages/tezos-protocol-plugin-009-PsFLoren/tezos-protocol-plugin-009-PsFLoren.9.7/opam";
    depends = with self; [ dune tezos-protocol-009-PsFLoren ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-plugin-009-PsFLoren-registerer = {
    ...
    opam = "${repo}/packages/tezos-protocol-plugin-009-PsFLoren-registerer/tezos-protocol-plugin-009-PsFLoren-registerer.9.7/opam";
    depends = with self; [ dune tezos-embedded-protocol-009-PsFLoren
                           tezos-protocol-plugin-009-PsFLoren tezos-shell ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-plugin-010-PtGRANAD = {
    ...
    opam = "${repo}/packages/tezos-protocol-plugin-010-PtGRANAD/tezos-protocol-plugin-010-PtGRANAD.9.7/opam";
    depends = with self; [ dune tezos-protocol-010-PtGRANAD ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-plugin-010-PtGRANAD-registerer = {
    ...
    opam = "${repo}/packages/tezos-protocol-plugin-010-PtGRANAD-registerer/tezos-protocol-plugin-010-PtGRANAD-registerer.9.7/opam";
    depends = with self; [ dune tezos-embedded-protocol-010-PtGRANAD
                           tezos-protocol-plugin-010-PtGRANAD tezos-shell ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-updater = {
    ...
    opam = "${repo}/packages/tezos-protocol-updater/tezos-protocol-updater.9.7/opam";
    depends = with self; [ dune lwt-exit tezos-protocol-compiler
                           tezos-shell-context ];
    buildDepends = with self; [ dune ];
  };
  tezos-proxy = {
    ...
    opam = "${repo}/packages/tezos-proxy/tezos-proxy.9.7/opam";
    depends = with self; [ dune tezos-mockup-proxy ];
    buildDepends = with self; [ dune ];
  };
  tezos-requester = {
    ...
    opam = "${repo}/packages/tezos-requester/tezos-requester.9.7/opam";
  ...
  tezos-rpc-http = {
    ...
    opam = "${repo}/packages/tezos-rpc-http/tezos-rpc-http.9.7/opam";
  ...
  tezos-rpc-http-client = {
    ...
    opam = "${repo}/packages/tezos-rpc-http-client/tezos-rpc-http-client.9.7/opam";
  ...
  tezos-rpc-http-client-unix = {
    ...
    opam = "${repo}/packages/tezos-rpc-http-client-unix/tezos-rpc-http-client-unix.9.7/opam";
  ...
  tezos-rpc-http-server = {
    ...
    opam = "${repo}/packages/tezos-rpc-http-server/tezos-rpc-http-server.9.7/opam";
    depends = with self; [ dune resto-acl resto-cohttp-server tezos-rpc-http ];
    buildDepends = with self; [ dune ];
  };
  tezos-rust-libs = {
  ...
  tezos-shell = {
    ...
    opam = "${repo}/packages/tezos-shell/tezos-shell.9.7/opam";
  ...
  tezos-shell-context = {
    ...
    opam = "${repo}/packages/tezos-shell-context/tezos-shell-context.9.7/opam";
    depends = with self; [ dune tezos-protocol-environment ];
    buildDepends = with self; [ dune ];
  };
  tezos-shell-services = {
  ...
  tezos-signer = {
    ...
    opam = "${repo}/packages/tezos-signer/tezos-signer.9.7/opam";
    depends = with self; [ dune tezos-client-base-unix tezos-rpc-http-server ];
    buildDepends = with self; [ dune ];
  };
  tezos-signer-backends = {
    ...
    opam = "${repo}/packages/tezos-signer-backends/tezos-signer-backends.9.7/opam";
  ...
  tezos-signer-services = {
    ...
    opam = "${repo}/packages/tezos-signer-services/tezos-signer-services.9.7/opam";
  ...
  tezos-validation = {
    ...
    opam = "${repo}/packages/tezos-validation/tezos-validation.9.7/opam";
  ...
  tezos-validator = {
    ...
    opam = "${repo}/packages/tezos-validator/tezos-validator.9.7/opam";
    depends = with self; [ dune tezos-shell ];
    buildDepends = with self; [ dune ];
  };
  tezos-version = {
    name = "tezos-version";
