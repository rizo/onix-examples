...
} }:
{
  ...
  tezos-baking-011-PtHangz2 = {
    name = "tezos-baking-011-PtHangz2";
    version = "12.3";
    src = pkgs.fetchurl {
    ...
    opam = "${repo}/packages/tezos-baking-011-PtHangz2/tezos-baking-011-PtHangz2.12.3/opam";
    depends = with self; [ dune lwt-exit tezos-client-011-PtHangz2
                           tezos-client-commands tezos-shell-context ];
    buildDepends = with self; [ dune ];
  };
  tezos-baking-011-PtHangz2-commands = {
    name = "tezos-baking-011-PtHangz2-commands";
    version = "12.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v12.3/tezos-v12.3.tar.bz2";
      sha256 = "296bb5674bc6050afe6330326fbdd0dfc2255d414bfd6b79cc7666ac6b39316d";
    };
    opam = "${repo}/packages/tezos-baking-011-PtHangz2-commands/tezos-baking-011-PtHangz2-commands.12.3/opam";
    depends = with self; [ dune tezos-baking-011-PtHangz2 ];
    buildDepends = with self; [ dune ];
  };
  tezos-base = {
    name = "tezos-base";
  ...
  tezos-client-011-PtHangz2 = {
    name = "tezos-client-011-PtHangz2";
    version = "12.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v12.3/tezos-v12.3.tar.bz2";
      sha256 = "296bb5674bc6050afe6330326fbdd0dfc2255d414bfd6b79cc7666ac6b39316d";
    };
    opam = "${repo}/packages/tezos-client-011-PtHangz2/tezos-client-011-PtHangz2.12.3/opam";
    depends = with self; [ dune ppx_inline_test tezos-mockup-registration
                           tezos-protocol-011-PtHangz2-parameters
                           tezos-protocol-plugin-011-PtHangz2 tezos-proxy
  ...
  tezos-endorser-011-PtHangz2 = {
    name = "tezos-endorser-011-PtHangz2";
    version = "12.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v12.3/tezos-v12.3.tar.bz2";
      sha256 = "296bb5674bc6050afe6330326fbdd0dfc2255d414bfd6b79cc7666ac6b39316d";
    };
    opam = "${repo}/packages/tezos-endorser-011-PtHangz2/tezos-endorser-011-PtHangz2.12.3/opam";
    depends = with self; [ dune tezos-baking-011-PtHangz2-commands
                           tezos-client-base-unix ];
    buildDepends = with self; [ dune ];
  };
  tezos-error-monad = {
  ...
  tezos-protocol-011-PtHangz2 = {
    name = "tezos-protocol-011-PtHangz2";
    version = "12.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v12.3/tezos-v12.3.tar.bz2";
      sha256 = "296bb5674bc6050afe6330326fbdd0dfc2255d414bfd6b79cc7666ac6b39316d";
    };
    opam = "${repo}/packages/tezos-protocol-011-PtHangz2/tezos-protocol-011-PtHangz2.12.3/opam";
    depends = with self; [ dune tezos-protocol-compiler ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-011-PtHangz2-parameters = {
    name = "tezos-protocol-011-PtHangz2-parameters";
    version = "12.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v12.3/tezos-v12.3.tar.bz2";
      sha256 = "296bb5674bc6050afe6330326fbdd0dfc2255d414bfd6b79cc7666ac6b39316d";
    };
    opam = "${repo}/packages/tezos-protocol-011-PtHangz2-parameters/tezos-protocol-011-PtHangz2-parameters.12.3/opam";
    depends = with self; [ dune tezos-protocol-011-PtHangz2 ];
    buildDepends = with self; [ dune ];
  };
  ...
  tezos-protocol-plugin-011-PtHangz2 = {
    name = "tezos-protocol-plugin-011-PtHangz2";
    version = "12.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v12.3/tezos-v12.3.tar.bz2";
      sha256 = "296bb5674bc6050afe6330326fbdd0dfc2255d414bfd6b79cc7666ac6b39316d";
    };
    opam = "${repo}/packages/tezos-protocol-plugin-011-PtHangz2/tezos-protocol-plugin-011-PtHangz2.12.3/opam";
    depends = with self; [ dune tezos-protocol-011-PtHangz2 ];
    buildDepends = with self; [ dune ];
  };
  tezos-proxy = {
