...
} }:
{
  ...
  range = {
    ...
    version = "0.8.3";
    src = pkgs.fetchurl {
      url = "https://github.com/aldrikfr/range/archive/0.8.3.tar.gz";
      sha256 = "12gcvnh5dnk632ip2ripr42k8j70h6kn4nrsw5mh9cz9y9vnm63n";
    };
    opam = "${repo}/packages/range/range.0.8.3/opam";
