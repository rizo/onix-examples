...
} }:
{
  ...
  ocamlcodoc = {
    ...
    version = "1.0.1";
    src = pkgs.fetchurl {
      url = "https://gitlab.inria.fr/tmartine/ocamlcodoc/-/archive/v1.0.1/ocamlcodoc-v1.0.1.tar.gz";
    ...
    opam = "${repo}/packages/ocamlcodoc/ocamlcodoc.1.0.1/opam";
    depends = with self; [ cmdliner dune redirect stdcompat ];
