...
} }:
{
  ...
  mirage-crypto = {
    ...
    opam = "${repo}/packages/mirage-crypto/mirage-crypto.0.10.2/opam";
  ...
  mirage-crypto-pk = {
    ...
    opam = "${repo}/packages/mirage-crypto-pk/mirage-crypto-pk.0.10.2/opam";
  ...
  mirage-crypto-rng = {
    ...
    opam = "${repo}/packages/mirage-crypto-rng/mirage-crypto-rng.0.10.2/opam";
  ...
  otr = {
    ...
    version = "0.3.9";
    src = pkgs.fetchurl {
      url = "https://github.com/hannesm/ocaml-otr/releases/download/v0.3.9/otr-v0.3.9.tbz";
      sha256 = "e05d0fd26622f4c3c0fbd40a7168bba31c4c1da53a95ee32f66a385ab99ed918";
    };
    opam = "${repo}/packages/otr/otr.0.3.9/opam";
    depends = with self; [ astring base64 cstruct dune mirage-crypto
                           mirage-crypto-pk ocaml rresult sexplib0 ];
    buildDepends = with self; [ dune ocaml ];
  };
  parsexp = {
    name = "parsexp";
