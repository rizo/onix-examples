...
} }:
{
  ...
  mustache = {
    ...
    version = "3.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/rgrinberg/ocaml-mustache/archive/v3.1.0.zip";
      sha256 = "0pf4yigmhxq9xq9lwq6vl0n9icydnshnz57x86xgv5xq1jph82lb";
    };
    opam = "${repo}/packages/mustache/mustache.3.1.0/opam";
    depends = with self; [ dune ezjsonm menhir ocaml ];
    buildDepends = with self; [ dune ocaml ];
