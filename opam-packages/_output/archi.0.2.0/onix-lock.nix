...
} }:
{
  archi = {
    ...
    version = "0.2.0";
    src = pkgs.fetchurl {
      url = "https://github.com/anmonteiro/archi/releases/download/0.2.0/archi-0.2.0.tbz";
      sha256 = "5b33fc94a73d211f6d7ccebe750ac52b03962029fc90e35bb47329de611799c0";
    };
    opam = "${repo}/packages/archi/archi.0.2.0/opam";
    depends = with self; [ dune hmap ocaml ];
