...
} }:
{
  ...
  docker_hub = {
    ...
    version = "0.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/kit-ty-kate/ocaml-docker-hub/releases/download/v0.1.0/docker_hub-0.1.0.tar.gz";
    ...
    opam = "${repo}/packages/docker_hub/docker_hub.0.1.0/opam";
    depends = with self; [ dune http-lwt-client lwt lwt_ppx ocaml yojson ];
    buildDepends = with self; [ dune ocaml ];
  };
  domain-name = {
    name = "domain-name";
