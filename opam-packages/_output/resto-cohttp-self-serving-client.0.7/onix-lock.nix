...
} }:
{
  ...
  resto = {
    ...
    version = "0.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/nomadic-labs/resto/-/archive/v0.7/resto-v0.7.tar.gz";
    ...
    opam = "${repo}/packages/resto/resto.0.7/opam";
  ...
  resto-acl = {
    ...
    opam = "${repo}/packages/resto-acl/resto-acl.0.7/opam";
  ...
  resto-cohttp = {
    ...
    opam = "${repo}/packages/resto-cohttp/resto-cohttp.0.7/opam";
  ...
  resto-cohttp-client = {
    ...
    opam = "${repo}/packages/resto-cohttp-client/resto-cohttp-client.0.7/opam";
  ...
  resto-cohttp-self-serving-client = {
    ...
    opam = "${repo}/packages/resto-cohttp-self-serving-client/resto-cohttp-self-serving-client.0.7/opam";
  ...
  resto-cohttp-server = {
    ...
    opam = "${repo}/packages/resto-cohttp-server/resto-cohttp-server.0.7/opam";
  ...
  resto-directory = {
    ...
    opam = "${repo}/packages/resto-directory/resto-directory.0.7/opam";
