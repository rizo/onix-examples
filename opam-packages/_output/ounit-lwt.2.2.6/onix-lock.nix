...
} }:
{
  ...
  ounit-lwt = {
    ...
    opam = "${repo}/packages/ounit-lwt/ounit-lwt.2.2.6/opam";
    depends = with self; [ ounit2-lwt ];
  ...
  ounit2-lwt = {
    ...
    opam = "${repo}/packages/ounit2-lwt/ounit2-lwt.2.2.6/opam";
    depends = with self; [ dune lwt ocaml ounit2 seq ];
    buildDepends = with self; [ dune ocaml ];
  };
  result = {
    name = "result";
