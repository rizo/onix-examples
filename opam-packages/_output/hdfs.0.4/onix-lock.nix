...
} }:
{
  ...
  hdfs = {
    ...
    version = "0.4";
    src = pkgs.fetchurl {
      url = "https://ygrek.org/p/release/ocaml-hdfs/ocaml-hdfs-0.4.tar.gz";
      sha256 = "b1357764ab01ff935bba878d23c68bc0546a339340120e473e5f846450953ce7";
    };
    opam = "${repo}/packages/hdfs/hdfs.0.4/opam";
    depends = with self; [ base-bytes base-unix camlidl ocaml ];
