...
} }:
{
  ...
  bisect_ppx-ocamlbuild = {
    ...
    version = "1.0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/aantron/bisect_ppx/archive/1.3.3.tar.gz";
      sha256 = "1g4ihycqx57zd2d01pvfr89lbhap0lagnaj8q081mbiw0rpzp56r";
    };
    opam = "${repo}/packages/bisect_ppx-ocamlbuild/bisect_ppx-ocamlbuild.1.0.1/opam";
    depends = with self; [ bisect_ppx jbuilder ocaml ocamlbuild ];
