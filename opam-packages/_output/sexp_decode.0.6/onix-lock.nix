...
} }:
{
  ...
  sexp_decode = {
    ...
    version = "0.6";
    src = pkgs.fetchurl {
      url = "https://gitlab.inria.fr/bmontagu/sexp_decode/-/archive/0.6/sexp_decode-0.6.tar.gz";
    ...
    opam = "${repo}/packages/sexp_decode/sexp_decode.0.6/opam";
    depends = with self; [ csexp dune ocaml ppx_inline_test ];
    buildDepends = with self; [ dune ocaml ];
  };
  sexplib0 = {
    name = "sexplib0";
