...
} }:
{
  ...
  rfc7748 = {
    ...
    version = "1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/burgerdev/ocaml-rfc7748/archive/v1.0-rc2.tar.gz";
      sha256 = "13176vwax5c80c77qk22bq2afv4jv8fp5r0slf837a0w5l0cnqrz";
    };
    opam = "${repo}/packages/rfc7748/rfc7748.1.0/opam";
