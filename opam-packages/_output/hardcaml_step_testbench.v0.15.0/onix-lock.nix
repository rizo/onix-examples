...
} }:
{
  ...
  hardcaml_step_testbench = {
    name = "hardcaml_step_testbench";
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/hardcaml_step_testbench-v0.15.0.tar.gz";
      sha256 = "cfa21330796a78a457e529f6a1134147dc7b414d6aa6d30fad823f04423e87f5";
    };
    opam = "${repo}/packages/hardcaml_step_testbench/hardcaml_step_testbench.v0.15.0/opam";
    depends = with self; [ base dune expect_test_helpers_core hardcaml ocaml
                           ppx_jane ];
    buildDepends = with self; [ dune ocaml ];
  };
  int_repr = {
