...
} }:
{
  ...
  bytearray = {
    ...
    version = "1.0.2";
    src = pkgs.fetchurl {
      url = "https://github.com/UnixJunkie/bytearray/archive/v1.0.2.tar.gz";
      sha256 = "0aasdnrpvirj81qapghhxaa01isnq74z5x8m9pzhkhczcmzvqq24";
    };
    opam = "${repo}/packages/bytearray/bytearray.1.0.2/opam";
    depends = with self; [ base-bigarray cppo dune ocaml ];
