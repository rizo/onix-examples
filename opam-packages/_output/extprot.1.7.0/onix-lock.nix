...
} }:
{
  ...
  extprot = {
    ...
    version = "1.7.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mfp/extprot/releases/download/v1.7.0/extprot-1.7.0.tar.gz";
      sha256 = "1sc4wyphfxbv8zpjy0y5066nq1mr0zkvqaza0g0ih24ny2qn5n8y";
    };
    opam = "${repo}/packages/extprot/extprot.1.7.0/opam";
    depends = with self; [ base-bytes extlib ocaml ];
    buildDepends = with self; [ camlp4 ocaml ocamlfind omake ];
  };
  ocaml = {
    name = "ocaml";
    version = "4.14.0";
