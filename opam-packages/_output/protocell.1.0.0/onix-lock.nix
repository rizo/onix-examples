...
} }:
{
  ...
  protocell = {
    ...
    version = "1.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/martinslota/protocell/releases/download/1.0.0/protocell-1.0.0.tbz";
      sha256 = "8296a7b386ad3ceb5e815374e8e4aa608d618869988b6f89b354c46225582fa8";
    };
    opam = "${repo}/packages/protocell/protocell.1.0.0/opam";
    depends = with self; [ base dune ocaml ocplib-endian ppx_deriving stdio ];
    buildDepends = with self; [ dune ocaml ];
    depexts = with pkgs; [ (pkgs.libprotoc-dev or null)
                           (pkgs.libprotoc-devel or null)
