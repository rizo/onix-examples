...
} }:
{
  ...
  knights_tour = {
    ...
    version = "0.0.2";
    src = pkgs.fetchurl {
      url = "https://github.com/kdvolder/knights_tour/releases/download/v0.0.2/knights_tour-0.0.2.tbz";
      sha256 = "8362f846492183e83e1901f73933d772c193c08b8a375480c28d0f23f0d29e11";
    };
    opam = "${repo}/packages/knights_tour/knights_tour.0.0.2/opam";
    depends = with self; [ dune graphics ocaml ppx_expect ppx_inline_test
                           stdio ];
    buildDepends = with self; [ dune ocaml ];
  };
  ocaml = {
