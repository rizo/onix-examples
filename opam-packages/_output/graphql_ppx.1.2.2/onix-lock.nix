...
} }:
{
  ...
  graphql_ppx = {
    ...
    version = "1.2.2";
    src = pkgs.fetchurl {
      url = "https://github.com/reasonml-community/graphql-ppx/archive/refs/tags/v1.2.2.tar.gz";
    ...
    opam = "${repo}/packages/graphql_ppx/graphql_ppx.1.2.2/opam";
    depends = with self; [ dune ocaml ppxlib reason yojson ];
    buildDepends = with self; [ dune ocaml ];
  };
  menhir = {
    name = "menhir";
