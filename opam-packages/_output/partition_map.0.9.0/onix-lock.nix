...
} }:
{
  ...
  partition_map = {
    ...
    version = "0.9.0";
    src = pkgs.fetchurl {
      url = "https://github.com/rleonid/partition_map/archive/0.9.0.tar.gz";
      sha256 = "1748xh40ib410ngppbci9pzncwjmfx5j6nsq6mqnwgb2am2pkh90";
    };
    opam = "${repo}/packages/partition_map/partition_map.0.9.0/opam";
    depends = with self; [ bisect_ppx jbuilder ocaml ocaml-migrate-parsetree ];
    buildDepends = with self; [ ocaml ];
  };
  ppx_derivers = {
    name = "ppx_derivers";
