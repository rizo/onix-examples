...
} }:
{
  ...
  gopcaml-mode = {
    ...
    version = "0.0.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/gopiandcode/gopcaml-mode/-/archive/0.0.3/gopcaml-mode-0.0.3.tar.gz";
      sha256 = "05gar7db0wis6rkqgs7x2wxk05hlwx1ig0lg10w687bnbr9g8vyf";
    };
    opam = "${repo}/packages/gopcaml-mode/gopcaml-mode.0.0.3/opam";
    depends = with self; [ core dune ecaml merlin ocaml
                           ocaml-migrate-parsetree ocp-indent ppx_deriving ];
    buildDepends = with self; [ dune ocaml ];
  };
  int_repr = {
    name = "int_repr";
