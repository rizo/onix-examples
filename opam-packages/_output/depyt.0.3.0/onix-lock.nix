...
} }:
{
  ...
  depyt = {
    ...
    version = "0.3.0";
    src = pkgs.fetchurl {
      url = "https://github.com/samoht/depyt/releases/download/0.3.0/depyt-0.3.0.tbz";
      sha256 = "61dab6ed22949133f3f7763e66d357cf8bdc97fa4b4efc2642fd3bd8d7c0d478";
    };
    opam = "${repo}/packages/depyt/depyt.0.3.0/opam";
    depends = with self; [ cstruct dune fmt jsonm ocaml ocplib-endian ];
    buildDepends = with self; [ dune ocaml ];
  };
  dune = {
    name = "dune";
