...
} }:
{
  ...
  mirage-os-shim = {
    ...
    version = "3.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/mirage-os-shim/releases/download/v3.1.0/mirage-os-shim-3.1.0.tbz";
      sha256 = "0hi4xa5wmz8igbiaicjv6li4jcrz06myi2h53z41kl73sgyqq68k";
    };
    opam = "${repo}/packages/mirage-os-shim/mirage-os-shim.3.1.0/opam";
    depends = with self; [ lwt ocaml (self.mirage-solo5 or null)
                           (self.mirage-unix or null)
