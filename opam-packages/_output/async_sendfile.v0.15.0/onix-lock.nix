...
} }:
{
  ...
  async_sendfile = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/async_sendfile-v0.15.0.tar.gz";
      sha256 = "902b1f699107e900891ded2f338b2df939a2343938bcb72cc8813e39c3004792";
    };
    opam = "${repo}/packages/async_sendfile/async_sendfile.v0.15.0/opam";
    depends = with self; [ async_kernel async_unix core dune ocaml ppx_jane ];
    buildDepends = with self; [ dune ocaml ];
  };
  async_unix = {
    name = "async_unix";
