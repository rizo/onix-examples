...
} }:
{
  ...
  ocamlrss = {
    ...
    version = "2.2.2";
    src = pkgs.fetchurl {
      url = "https://framagit.org/zoggy/ocamlrss/-/archive/2.2.2/ocamlrss-2.2.2.tar.gz";
      sha256 = "07pksyhsq1h5c6q0xzfvzhlk4qlsq4634b0wfsxkgngijcwfp9rl";
    };
    opam = "${repo}/packages/ocamlrss/ocamlrss.2.2.2/opam";
    depends = with self; [ ocaml ocamlfind ocamlnet xmlm ];
    buildDepends = with self; [ ocaml ocamlfind ];
  };
  topkg = {
    name = "topkg";
