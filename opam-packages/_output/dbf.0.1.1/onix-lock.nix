...
} }:
{
  ...
  dbf = {
    ...
    version = "0.1.1";
    src = pkgs.fetchurl {
      url = "https://github.com/pveber/dbf/archive/0.1.1.tar.gz";
    ...
    opam = "${repo}/packages/dbf/dbf.0.1.1/opam";
    depends = with self; [ core_kernel cstruct-unix ppx_cstruct rresult ];
  };
  dune = {
    name = "dune";
    version = "3.2.0";
