...
} }:
{
  ...
  dune-private-libs = {
    ...
    opam = "${repo}/packages/dune-private-libs/dune-private-libs.2.9.3/opam";
    depends = with self; [ dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  fmt = {
  ...
  opam-dune-lint = {
    ...
    version = "0.2";
    src = pkgs.fetchurl {
      url = "https://github.com/ocurrent/opam-dune-lint/releases/download/v0.2/opam-dune-lint-v0.2.tbz";
      sha256 = "14820dabe460fda8272596d02c3de938ae584720285b7538fc7ee6f7d7a93432";
    };
    opam = "${repo}/packages/opam-dune-lint/opam-dune-lint.0.2/opam";
    depends = with self; [ astring bos cmdliner dune dune-private-libs fmt
                           ocaml opam-format opam-state sexplib ];
    buildDepends = with self; [ dune ocaml ];
  };
  opam-file-format = {
