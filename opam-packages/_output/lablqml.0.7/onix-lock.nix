...
} }:
{
  ...
  lablqml = {
    ...
    version = "0.7";
    src = pkgs.fetchurl {
      url = "https://github.com/Kakadu/lablqml/archive/0.7.tar.gz";
      sha256 = "20d8186990d189613f328d974b5216186783de24cd763d8f3e77939b048a57b5";
    };
    opam = "${repo}/packages/lablqml/lablqml.0.7/opam";
    depends = with self; [ conf-qt dune dune-configurator ocaml
                           ppx_inline_test ppx_show ppx_string_interpolation
                           ppxlib stdio ];
    buildDepends = with self; [ conf-pkg-config dune ocaml ocamlfind ];
  };
  ocaml = {
    name = "ocaml";
    version = "4.14.0";
  ...
  ppx_show = {
    ...
    version = "0.2.1";
    src = pkgs.fetchurl {
      url = "https://github.com/thierry-martinez/ppx_show/archive/v0.2.1.tar.gz";
    ...
    opam = "${repo}/packages/ppx_show/ppx_show.0.2.1/opam";
    depends = with self; [ dune ppxlib stdcompat ];
  ...
  ppx_string_interpolation = {
    ...
    opam = "${repo}/packages/ppx_string_interpolation/ppx_string_interpolation.1.0.1/opam";
    depends = with self; [ dune ocaml ppxlib sedlex ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppxlib = {
    name = "ppxlib";
