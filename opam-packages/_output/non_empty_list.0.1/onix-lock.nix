...
} }:
{
  ...
  non_empty_list = {
    ...
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/johnyob/ocaml-non-empty-list/releases/download/0.1/non_empty_list-0.1.tbz";
      sha256 = "af4bf61dc1beb8b5428955bff3a209a3c231fe93eaa02a70cbb13907bb65a85b";
    };
    opam = "${repo}/packages/non_empty_list/non_empty_list.0.1/opam";
    depends = with self; [ base dune ocaml ppx_deriving ];
    buildDepends = with self; [ dune ocaml ];
  };
  ocaml = {
    name = "ocaml";
