...
} }:
{
  ...
  redis-async = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/redis-async-v0.15.0.tar.gz";
      sha256 = "9ae8152ff50181c04fafa8864c9ed02fe38b57d5dfe2db5da0c060d256d6f7a9";
    };
    opam = "${repo}/packages/redis-async/redis-async.v0.15.0/opam";
    depends = with self; [ async bignum core core_kernel dune ocaml ppx_jane ];
    buildDepends = with self; [ dune ocaml ];
  };
  seq = {
    name = "seq";
