...
} }:
{
  ...
  mirage-random-test = {
    name = "mirage-random-test";
    version = "0.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/mirage-random-test/releases/download/v0.1.0/mirage-random-test-v0.1.0.tbz";
      sha256 = "86ec89265f5685729bf046e5e5e1981de50ff54ff9f2f67a07f46ca2d2f2b2ca";
    };
    opam = "${repo}/packages/mirage-random-test/mirage-random-test.0.1.0/opam";
    depends = with self; [ cstruct dune mirage-random ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  ocaml = {
    name = "ocaml";
