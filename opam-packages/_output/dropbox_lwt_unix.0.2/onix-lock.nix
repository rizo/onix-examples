...
} }:
{
  ...
  dropbox = {
    ...
    version = "0.2";
    src = pkgs.fetchurl {
      url = "https://github.com/Chris00/ocaml-dropbox/releases/download/0.2/dropbox-0.2.tbz";
      sha256 = "3a317ff6963c453fe74d955e24b23721d5ab44f22969db106a1ab64328f1d8c7";
    };
    opam = "${repo}/packages/dropbox/dropbox.0.2/opam";
    depends = with self; [ atdgen base-bytes cohttp cohttp-lwt dune lwt
                           yojson (self.ssl or null) (self.tls or null) ];
  ...
  dropbox_lwt_unix = {
    ...
    opam = "${repo}/packages/dropbox_lwt_unix/dropbox_lwt_unix.0.2/opam";
    depends = with self; [ cohttp-lwt-unix dropbox dune ];
    buildDepends = with self; [ dune ];
  };
  dune = {
    name = "dune";
