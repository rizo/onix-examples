...
} }:
{
  ...
  nanoid = {
    ...
    version = "1.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/routineco/ocaml-nanoid/archive/1.0.0.tar.gz";
    ...
    opam = "${repo}/packages/nanoid/nanoid.1.0.0/opam";
    depends = with self; [ cryptokit dune ocaml (self.js_of_ocaml or null) ];
    buildDepends = with self; [ dune ocaml ];
  };
  ocaml = {
    name = "ocaml";
