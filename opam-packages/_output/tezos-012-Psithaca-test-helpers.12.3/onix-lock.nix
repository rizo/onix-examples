...
} }:
{
  ...
  tezos-012-Psithaca-test-helpers = {
    name = "tezos-012-Psithaca-test-helpers";
    version = "12.3";
    src = pkgs.fetchurl {
    ...
    opam = "${repo}/packages/tezos-012-Psithaca-test-helpers/tezos-012-Psithaca-test-helpers.12.3/opam";
    depends = with self; [ alcotest-lwt dune tezos-client-012-Psithaca
