...
} }:
{
  ...
  mechaml = {
    ...
    version = "1.2.1";
    src = pkgs.fetchurl {
      url = "https://github.com/yannham/mechaml/archive/1.2.1.tar.gz";
    ...
    opam = "${repo}/packages/mechaml/mechaml.1.2.1/opam";
    depends = with self; [ cohttp cohttp-lwt cohttp-lwt-unix dune lambdasoup
                           lwt ocaml uri ];
    buildDepends = with self; [ dune ocaml ocaml-syntax-shims ];
  };
  mirage-crypto = {
