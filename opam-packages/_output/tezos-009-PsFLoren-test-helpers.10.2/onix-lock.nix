...
} }:
{
  ...
  tezos-009-PsFLoren-test-helpers = {
    ...
    opam = "${repo}/packages/tezos-009-PsFLoren-test-helpers/tezos-009-PsFLoren-test-helpers.10.2/opam";
  ...
  tezos-client-009-PsFLoren = {
    ...
    opam = "${repo}/packages/tezos-client-009-PsFLoren/tezos-client-009-PsFLoren.10.2/opam";
  ...
  tezos-protocol-009-PsFLoren = {
    ...
    opam = "${repo}/packages/tezos-protocol-009-PsFLoren/tezos-protocol-009-PsFLoren.10.2/opam";
  ...
  tezos-protocol-009-PsFLoren-parameters = {
    ...
    opam = "${repo}/packages/tezos-protocol-009-PsFLoren-parameters/tezos-protocol-009-PsFLoren-parameters.10.2/opam";
  ...
  tezos-protocol-plugin-009-PsFLoren = {
    ...
    opam = "${repo}/packages/tezos-protocol-plugin-009-PsFLoren/tezos-protocol-plugin-009-PsFLoren.10.2/opam";
    depends = with self; [ dune tezos-protocol-009-PsFLoren ];
    buildDepends = with self; [ dune ];
  };
  tezos-proxy = {
