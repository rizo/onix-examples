...
} }:
{
  ...
  mirage-block-ramdisk = {
    ...
    version = "0.5";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/mirage-block-ramdisk/releases/download/0.5/mirage-block-ramdisk-0.5.tbz";
      sha256 = "cc0e814fd54efe7a5b7a8c5eb1c04e2dece751b7d8dee2d95908a0768896e8af";
    };
    opam = "${repo}/packages/mirage-block-ramdisk/mirage-block-ramdisk.0.5/opam";
    depends = with self; [ cstruct dune io-page lwt mirage-block ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  mmap = {
    name = "mmap";
