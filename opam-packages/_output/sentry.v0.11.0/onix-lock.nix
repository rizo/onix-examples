...
} }:
{
  ...
  re2 = {
    ...
    version = "v0.14.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.14/files/re2-v0.14.0.tar.gz";
      sha256 = "1l0rprfwr4ssbkc8f34mb4ks5lwv34981i8pqbmabss3lchr2csf";
    };
    opam = "${repo}/packages/re2/re2.v0.14.0/opam";
    depends = with self; [ core_kernel dune ocaml ppx_jane ];
  ...
  sentry = {
    ...
    version = "v0.11.0";
    src = pkgs.fetchurl {
      url = "https://github.com/brendanlong/sentry-ocaml/releases/download/v0.11.0/sentry-v0.11.0.tbz";
      sha256 = "f475f3b68fb7386da82ba2fa7d45bf19ab5d08c535b27d38d0b3699251ec05c2";
    };
    opam = "${repo}/packages/sentry/sentry.v0.11.0/opam";
    depends = with self; [ atdgen cohttp cohttp-async core dune hex
                           json-derivers ocaml ppx_jane re2 sexplib uri uuidm
                           yojson ];
    buildDepends = with self; [ dune ocaml ];
  };
  seq = {
