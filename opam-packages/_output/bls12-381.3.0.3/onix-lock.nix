...
} }:
{
  ...
  bls12-381 = {
    ...
    version = "3.0.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/dannywillems/ocaml-bls12-381/-/archive/3.0.3/ocaml-bls12-381-3.0.3.tar.bz2";
    ...
    opam = "${repo}/packages/bls12-381/bls12-381.3.0.3/opam";
    depends = with self; [ dune ff-sig hex integers ocaml zarith ];
