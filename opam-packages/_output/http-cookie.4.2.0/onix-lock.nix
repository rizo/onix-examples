...
} }:
{
  ...
  http-cookie = {
    ...
    version = "4.2.0";
    src = pkgs.fetchurl {
      url = "https://github.com/lemaetech/http-cookie/releases/download/v4.2.0/http-cookie-v4.2.0.tbz";
      sha256 = "cdb91d7ee5420c38503fd3b333d0349a2c6689166b8c17f95fda8cd1c2454ed6";
    };
    opam = "${repo}/packages/http-cookie/http-cookie.4.2.0/opam";
    depends = with self; [ angstrom dune fmt ocaml ];
