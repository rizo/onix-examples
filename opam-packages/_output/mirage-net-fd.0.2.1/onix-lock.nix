...
} }:
{
  ...
  mirage-net-fd = {
    ...
    opam = "${repo}/packages/mirage-net-fd/mirage-net-fd.0.2.1/opam";
    depends = with self; [ cstruct cstruct-lwt io-page-unix ipaddr jbuilder
                           lwt mirage-net-lwt ocaml result ];
    buildDepends = with self; [ ocaml ];
  };
  mirage-net-lwt = {
    name = "mirage-net-lwt";
    ...
    opam = "${repo}/packages/mirage-net-lwt/mirage-net-lwt.1.2.0/opam";
    depends = with self; [ cstruct io-page jbuilder lwt macaddr mirage-net
                           ocaml ];
