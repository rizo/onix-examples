...
} }:
{
  ...
  bap-piqi = {
    ...
    opam = "${repo}/packages/bap-piqi/bap-piqi.2.4.0/opam";
    depends = with self; [ bap-std cmdliner ocaml piqi ];
    buildDepends = with self; [ oasis ocaml ];
  };
  bap-plugins = {
    name = "bap-plugins";
  ...
  piqi = {
    ...
    version = "0.7.7";
    src = pkgs.fetchurl {
      url = "https://github.com/alavrik/piqi-ocaml/archive/v0.7.7.tar.gz";
      sha256 = "1l0b4saxmwqgw9mb10mwrz31lvpj3l0abh3cwarqp0x4vdrzshbh";
    };
    opam = "${repo}/packages/piqi/piqi.0.7.7/opam";
    depends = with self; [ ocaml piqilib stdlib-shims ];
    buildDepends = with self; [ ocaml ocamlfind ];
  };
  piqilib = {
    name = "piqilib";
    version = "0.6.14";
    src = pkgs.fetchurl {
      url = "https://github.com/alavrik/piqi/archive/v0.6.14.tar.gz";
      sha256 = "1ssccnwqzfyf7syfq2fv4zyhwayxwd75rhq9y28mvq1w6qbww4l7";
    };
    opam = "${repo}/packages/piqilib/piqilib.0.6.14/opam";
    depends = with self; [ base64 easy-format ocaml ulex xmlm ];
    buildDepends = with self; [ ocaml ocamlfind ];
  };
  ppx_assert = {
    name = "ppx_assert";
