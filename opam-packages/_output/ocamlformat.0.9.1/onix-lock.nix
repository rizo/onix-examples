...
} }:
{
  ...
  ocamlformat = {
    ...
    version = "0.9.1";
    src = pkgs.fetchurl {
      url = "https://github.com/ocaml-ppx/ocamlformat/archive/0.9.1.tar.gz";
    ...
    opam = "${repo}/packages/ocamlformat/ocamlformat.0.9.1/opam";
    depends = with self; [ base base-unix cmdliner dune fpath ocaml
                           ocaml-migrate-parsetree octavius stdio uutf ];
    buildDepends = with self; [ dune ocaml ];
  };
  octavius = {
    name = "octavius";
