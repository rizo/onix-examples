...
} }:
{
  ...
  murmur3 = {
    ...
    version = "0.2";
    src = pkgs.fetchurl {
      url = "https://github.com/ahrefs/ocaml-murmur3/releases/download/v0.2/ocaml-murmur3-0.2.tar.gz";
      sha256 = "1p56r99vwlx1xf354dlcs675ip1vh1nfg61z8vv3ba81ds8yfy6p";
    };
    opam = "${repo}/packages/murmur3/murmur3.0.2/opam";
