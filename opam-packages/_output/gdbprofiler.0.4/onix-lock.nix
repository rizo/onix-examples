...
} }:
{
  ...
  gdbprofiler = {
    ...
    version = "0.4";
    src = pkgs.fetchurl {
      url = "https://github.com/copy/gdbprofiler/archive/0.4.tar.gz";
    ...
    opam = "${repo}/packages/gdbprofiler/gdbprofiler.0.4/opam";
    depends = with self; [ containers containers-data dune lwt lwt_log
                           lwt_ppx menhir ocaml yojson ];
    buildDepends = with self; [ dune ocaml ];
  };
  lwt = {
    name = "lwt";
