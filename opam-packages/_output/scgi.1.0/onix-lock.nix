...
} }:
{
  ...
  scgi = {
    ...
    version = "1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/bikallem/ocaml-scgi/archive/1.0.tar.gz";
    ...
    opam = "${repo}/packages/scgi/scgi.1.0/opam";
    depends = with self; [ dune lwt lwt_ppx ocaml stdcompat uri ];
    buildDepends = with self; [ dune ocaml ];
  };
  seq = {
    name = "seq";
