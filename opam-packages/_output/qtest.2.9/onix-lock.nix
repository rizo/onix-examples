...
} }:
{
  ...
  qtest = {
    ...
    version = "2.9";
    src = pkgs.fetchurl {
      url = "https://github.com/vincent-hugot/qtest/archive/v2.9.tar.gz";
      sha256 = "1g0q8va3lj12m6qsadg5bzfqfpqaycavnla1frlfcpx5p9l069xj";
    };
    opam = "${repo}/packages/qtest/qtest.2.9/opam";
    depends = with self; [ base-bytes jbuilder ocaml ounit qcheck ];
    buildDepends = with self; [ ocaml ];
  };
  seq = {
    name = "seq";
