...
} }:
{
  ...
  hardcaml_verilator = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/hardcaml_verilator-v0.15.0.tar.gz";
      sha256 = "df11a0aaed172de8c2166468066971c53128035eed8c5a743ba4b87fa3e62027";
    };
    opam = "${repo}/packages/hardcaml_verilator/hardcaml_verilator.v0.15.0/opam";
    depends = with self; [ core core_unix ctypes ctypes-foreign dune hardcaml
                           ocaml ppx_deriving_hardcaml ppx_jane ];
    buildDepends = with self; [ dune ocaml ];
  };
  int_repr = {
    name = "int_repr";
