...
} }:
{
  ...
  dump_ocamlformat = {
    name = "dump_ocamlformat";
    version = "0.2.2";
    src = pkgs.fetchurl {
      url = "https://github.com/diohabara/dump_ocamlformat/releases/download/0.2.2/dump_ocamlformat-0.2.2.tbz";
      sha256 = "3605a661b5fa437ef43f6c343395c0104c97c91d1c38e915ddf99324079e88d0";
    };
    opam = "${repo}/packages/dump_ocamlformat/dump_ocamlformat.0.2.2/opam";
    depends = with self; [ core dune ocaml ocamlformat odoc ];
    buildDepends = with self; [ dune ocaml ];
  };
  dune = {
    name = "dune";
