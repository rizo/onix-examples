...
} }:
{
  ...
  async-uri = {
    ...
    version = "0.3.0";
    src = pkgs.fetchurl {
      url = "https://github.com/vbmithr/async-uri/releases/download/0.3.0/async-uri-0.3.0.tbz";
      sha256 = "06b35d97bf87ff967877e7060ee98b85824327dfa1852f8f0578460d112063b9";
    };
    opam = "${repo}/packages/async-uri/async-uri.0.3.0/opam";
    depends = with self; [ async async_ssl core dune ocaml uri uri-sexp ];
    buildDepends = with self; [ dune ocaml ];
  };
  async_kernel = {
    name = "async_kernel";
