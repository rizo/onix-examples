...
} }:
{
  ...
  ldap = {
    ...
    version = "2.4.2";
    src = pkgs.fetchurl {
      url = "https://github.com/kit-ty-kate/ocamldap/releases/download/2.4.2/ldap-2.4.2.tbz";
      sha256 = "2f7fa9d27e12e3604c6f84384aa31ab98fffd06fe7c9e5354a387a15131a708e";
    };
    opam = "${repo}/packages/ldap/ldap.2.4.2/opam";
    depends = with self; [ dune ocaml ocamlnet pcre ssl ];
    buildDepends = with self; [ dune ocaml ];
  };
  ocaml = {
    name = "ocaml";
  ...
  ocamldap = {
    name = "ocamldap";
    version = "transition";
    opam = "${repo}/packages/ocamldap/ocamldap.transition/opam";
    depends = with self; [ ldap ocaml ];
    buildDepends = with self; [ ocaml ];
  };
  ocamlfind = {
    name = "ocamlfind";
