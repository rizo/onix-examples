...
} }:
{
  ...
  tube = {
    ...
    version = "4.4.0";
    src = pkgs.fetchurl {
      url = "https://github.com/alinpopa/tube/archive/4.4.0.tar.gz";
      sha256 = "1zgy3vrq4dxl0p65aiwwfvx4wv7qx0mv3b7xsi92gkbcbmvsimaq";
    };
    opam = "${repo}/packages/tube/tube.4.4.0/opam";
