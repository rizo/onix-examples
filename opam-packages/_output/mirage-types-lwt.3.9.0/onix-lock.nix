...
} }:
{
  ...
  mirage-console = {
    ...
    opam = "${repo}/packages/mirage-console/mirage-console.5.1.0/opam";
    depends = with self; [ dune lwt mirage-flow ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  mirage-device = {
    name = "mirage-device";
  ...
  mirage-fs = {
    ...
    opam = "${repo}/packages/mirage-fs/mirage-fs.4.0.0/opam";
    depends = with self; [ cstruct dune fmt lwt mirage-kv ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  mirage-kv = {
    name = "mirage-kv";
  ...
  mirage-protocols = {
    ...
    version = "8.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/mirage-protocols/releases/download/v8.0.0/mirage-protocols-v8.0.0.tbz";
      sha256 = "503091e09ab7b70f4ffc8970ed3e3edfeca2f50ed516a9c78577920af83d772c";
    };
    opam = "${repo}/packages/mirage-protocols/mirage-protocols.8.0.0/opam";
    depends = with self; [ arp dune ethernet ipaddr ocaml tcpip ];
    buildDepends = with self; [ dune ocaml ];
  };
  mirage-random = {
    name = "mirage-random";
  ...
  mirage-types = {
    ...
    version = "3.9.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/mirage/releases/download/v3.9.0/mirage-v3.9.0.tbz";
      sha256 = "8a5207c01b5073dbdafe2de7b61d4e907ee989132ec56e38e793cab01381f6c3";
    };
    opam = "${repo}/packages/mirage-types/mirage-types.3.9.0/opam";
  ...
  mirage-types-lwt = {
    ...
    opam = "${repo}/packages/mirage-types-lwt/mirage-types-lwt.3.9.0/opam";
    depends = with self; [ dune mirage-types ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  mmap = {
    name = "mmap";
