...
} }:
{
  ...
  ppx_inline_alcotest = {
    ...
    version = "1.0.0";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/gopiandcode/ppx-inline-alcotest/-/archive/1.0.0/ppx-inline-alcotest-1.0.0.tar.gz";
      sha256 = "1p7bgppqvg1zgbgzcfwc3xnrpr2q398hh44a1c3yfhyiqpy8hgip";
    };
    opam = "${repo}/packages/ppx_inline_alcotest/ppx_inline_alcotest.1.0.0/opam";
    depends = with self; [ alcotest dune ocaml ppxlib ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppxlib = {
    name = "ppxlib";
