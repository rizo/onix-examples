...
} }:
{
  ...
  prom = {
    ...
    version = "0.3";
    src = pkgs.fetchurl {
      url = "https://github.com/vbmithr/ocaml-prometheus/releases/download/0.3/prom-0.3.tbz";
      sha256 = "ab2790fed9bf4cd5e8410a498cf92538975c7cb86959db560138296791579b2b";
    };
    opam = "${repo}/packages/prom/prom.0.3/opam";
    depends = with self; [ containers dune fmt ocaml ptime ];
    buildDepends = with self; [ dune ocaml ];
  };
  ptime = {
    name = "ptime";
