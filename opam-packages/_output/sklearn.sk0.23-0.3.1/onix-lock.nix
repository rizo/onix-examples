...
} }:
{
  ...
  np = {
    ...
    src = pkgs.fetchurl {
      url = "https://github.com/lehy/ocaml-sklearn/releases/download/v0.3.1/sklearn-v0.3.1.tbz";
      sha256 = "48809d88893a3f17d79f8e5acbd28126de919b8ced6d1f6856a61fd6bfae571d";
    };
    opam = "${repo}/packages/np/np.np1.19-0.3.1/opam";
  ...
  scipy = {
    ...
    opam = "${repo}/packages/scipy/scipy.sp1.5-0.3.1/opam";
    depends = with self; [ dune np ocaml pyml ];
    buildDepends = with self; [ dune ocaml ];
  };
  sklearn = {
    name = "sklearn";
    ...
    opam = "${repo}/packages/sklearn/sklearn.sk0.23-0.3.1/opam";
    depends = with self; [ dune np ocaml pyml scipy ];
    buildDepends = with self; [ dune ocaml ];
  };
  stdcompat = {
    name = "stdcompat";
