...
} }:
{
  ...
  http-multipart-formdata = {
    ...
    version = "3.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/lemaetech/http-mutlipart-formdata/archive/v3.1.0.tar.gz";
    ...
    opam = "${repo}/packages/http-multipart-formdata/http-multipart-formdata.3.1.0/opam";
    depends = with self; [ angstrom cstruct dune fmt ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  ocaml = {
    name = "ocaml";
