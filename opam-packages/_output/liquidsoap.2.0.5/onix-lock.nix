...
} }:
{
  ...
  liquidsoap = {
    ...
    version = "2.0.5";
    src = pkgs.fetchurl {
      url = "https://github.com/savonet/liquidsoap-release-assets/releases/download/v2.0.5/liquidsoap-2.0.5.tar.bz2";
      sha512 = "357406708f30d5c1ea33c0b5dd778dc376bdca444a93acc4e14b1f1fc22eceafa5f73659f55a81413df6ac207aa3de4b277ac2137e3ed8c297aebab37346461a";
    };
    opam = "${repo}/packages/liquidsoap/liquidsoap.2.0.5/opam";
