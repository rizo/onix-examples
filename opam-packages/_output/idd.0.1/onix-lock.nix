...
} }:
{
  ...
  idd = {
    ...
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/netkat-lang/idd/archive/0.1.tar.gz";
      sha256 = "0zsxcy7pk0nkmfsffbyd2ra66d4b0qymaccvrjpbrgy1axz54hi2";
    };
    opam = "${repo}/packages/idd/idd.0.1/opam";
    depends = with self; [ base dune ocaml ppx_deriving ppx_jane ];
    buildDepends = with self; [ dune ocaml ];
  };
  jane-street-headers = {
