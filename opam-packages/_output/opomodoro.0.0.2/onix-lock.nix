...
} }:
{
  ...
  opomodoro = {
    ...
    version = "0.0.2";
    src = pkgs.fetchurl {
      url = "https://github.com/m-laniakea/opomodoro/archive/v0.0.2.tar.gz";
    ...
    opam = "${repo}/packages/opomodoro/opomodoro.0.0.2/opam";
    depends = with self; [ ANSITerminal dune lwt ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  result = {
    name = "result";
