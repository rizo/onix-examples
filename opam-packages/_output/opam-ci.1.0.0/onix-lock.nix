...
} }:
{
  ...
  dockerfile-cmd = {
    ...
    version = "6.4.0";
    src = pkgs.fetchurl {
      url = "https://github.com/avsm/ocaml-dockerfile/releases/download/v6.4.0/dockerfile-v6.4.0.tbz";
      sha256 = "554c9df81a79bbf0e6099cdd437b0c2e89969c48d9697c6f115267d3f183c61a";
    };
    opam = "${repo}/packages/dockerfile-cmd/dockerfile-cmd.6.4.0/opam";
    depends = with self; [ bos cmdliner dockerfile-opam dune fmt logs ocaml
                           ppx_sexp_conv rresult ];
    buildDepends = with self; [ dune ocaml ];
  };
  dockerfile-opam = {
    ...
    version = "5.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/avsm/ocaml-dockerfile/releases/download/v5.0.0/dockerfile-5.0.0.tbz";
      sha256 = "01rdiiq30hkb6l6s5zr4rrmdz48mlhhnffzn3sirg4zxiaj5xllw";
    };
    opam = "${repo}/packages/dockerfile-opam/dockerfile-opam.5.0.0/opam";
    depends = with self; [ astring cmdliner dockerfile jbuilder ocaml
                           ocaml-migrate-parsetree ocaml-version ];
    buildDepends = with self; [ ocaml ];
  };
  dune = {
    name = "dune";
  ...
  obi = {
    ...
    version = "1.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/ocaml/obi/releases/download/v1.0.0/obi-1.0.0.tbz";
      sha256 = "021xwqjq4w2x6m2hccapzszrfs5gavpyakrl8byqni53nbi5va8a";
    };
    opam = "${repo}/packages/obi/obi.1.0.0/opam";
    depends = with self; [ dockerfile-cmd dockerfile-opam ezjsonm jbuilder
                           ocaml ocaml-version uri yaml ];
    buildDepends = with self; [ ocaml ];
  };
  ocaml = {
    name = "ocaml";
  ...
  ocaml-version = {
    ...
    version = "0.3.0";
    src = pkgs.fetchurl {
      url = "https://github.com/avsm/ocaml-version/releases/download/v0.3.0/ocaml-version-0.3.0.tbz";
      sha256 = "0c3906z33r1fjxspdzk3hhpxf0qxdycf93nmpri7m9wmr3wzymf7";
    };
    opam = "${repo}/packages/ocaml-version/ocaml-version.0.3.0/opam";
  ...
  opam-ci = {
    ...
    opam = "${repo}/packages/opam-ci/opam-ci.1.0.0/opam";
    depends = with self; [ bos cmdliner fmt jbuilder logs obi ocaml rresult
                           textwrap ];
    buildDepends = with self; [ ocaml ];
  };
  parsexp = {
  ...
  textwrap = {
    ...
    opam = "${repo}/packages/textwrap/textwrap.0.2/opam";
    depends = with self; [ ocaml ocamlfind ];
  ...
  yaml = {
    ...
    version = "3.0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/avsm/ocaml-yaml/releases/download/v3.0.1/yaml-3.0.1.tbz";
      sha256 = "92ed1ba429559a14b6b45e170f3482191791f99ac5189a5f20612e15bfbdf695";
    };
    opam = "${repo}/packages/yaml/yaml.3.0.1/opam";
