...
} }:
{
  ...
  lmdb = {
    ...
    opam = "${repo}/packages/lmdb/lmdb.1.0/opam";
    depends = with self; [ bigstringaf dune ocaml ];
    buildDepends = with self; [ dune dune-configurator ocaml ];
    depexts = with pkgs; [ (pkgs.liblmdb-dev or null)
                           (pkgs.liblmdb-devel or null) (pkgs.lmdb or null)
                           (pkgs.lmdb-dev or null) (pkgs.lmdb-devel or null) ];
  };
  ocaml = {
    name = "ocaml";
    version = "4.14.0";
