...
} }:
{
  ...
  css-parser = {
    ...
    version = "0.2.5";
    src = pkgs.fetchurl {
      url = "https://github.com/astrada/ocaml-css-parser/archive/v0.2.5.tar.gz";
      sha256 = "1i1gjfn60zfp5jamjzw755hx3imggy3j4f15s4lckg8s9kxyrgz0";
    };
    opam = "${repo}/packages/css-parser/css-parser.0.2.5/opam";
    depends = with self; [ dune menhir sedlex ];
