...
} }:
{
  ...
  mirage-nat = {
    ...
    version = "2.2.5";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/mirage-nat/releases/download/v2.2.5/mirage-nat-v2.2.5.tbz";
      sha256 = "048456aa671f438af47e1816e53cc7b80a32e04df1c79ecfe70a725fc907b707";
    };
    opam = "${repo}/packages/mirage-nat/mirage-nat.2.2.5/opam";
    depends = with self; [ cstruct dune ethernet ipaddr lru ocaml
                           ppx_deriving tcpip ];
    buildDepends = with self; [ dune ocaml ];
  };
  mirage-net = {
