...
} }:
{
  ...
  bignum = {
    ...
    version = "v0.14.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.14/files/bignum-v0.14.0.tar.gz";
      sha256 = "10fypz05n287dbx3cf0aqxpm0s50m75pzwdwrmv4vbx0r0b6i93p";
    };
    opam = "${repo}/packages/bignum/bignum.v0.14.0/opam";
    depends = with self; [ core_kernel dune num ocaml ppx_jane
                           splittable_random typerep zarith zarith_stubs_js ];
    buildDepends = with self; [ dune ocaml ];
  };
  bin_prot = {
    name = "bin_prot";
  ...
  freetds = {
    ...
    version = "0.7";
    src = pkgs.fetchurl {
      url = "https://github.com/kennknowles/ocaml-freetds/releases/download/0.7/freetds-0.7.tbz";
      sha256 = "19kphm4f50im5lhsicpqiwdiixanyfi5r365jlsmhdl12vwmg2h9";
    };
    opam = "${repo}/packages/freetds/freetds.0.7/opam";
    depends = with self; [ dune dune-configurator ocaml ];
    buildDepends = with self; [ cppo dune ocaml ];
    depexts = with pkgs; [ (pkgs.epel-release or null) (pkgs.freetds or null)
                           (pkgs.freetds-dev or null)
                           (pkgs.freetds-devel or null)
                           (pkgs.libfreetds-devel or null) ];
  };
  iter = {
    name = "iter";
    version = "1.4";
  ...
  mssql = {
    ...
    version = "2.2.0";
    src = pkgs.fetchurl {
      url = "https://github.com/arenadotio/ocaml-mssql/releases/download/2.2.0/mssql-2.2.0.tbz";
      sha256 = "4c1bba6dd0fc6be8a5a370050400192dbe54706e7c070b4d2ddce5845d5239e2";
    };
    opam = "${repo}/packages/mssql/mssql.2.2.0/opam";
    depends = with self; [ async_unix bignum dune freetds iter logs ocaml
                           ppx_jane text ];
    buildDepends = with self; [ dune ocaml ];
  };
  num = {
  ...
  text = {
    ...
    version = "0.8.1";
    src = pkgs.fetchurl {
      url = "https://github.com/vbmithr/ocaml-text/releases/download/0.8.1/text-0.8.1.tbz";
      sha256 = "163b2cbc9f07915ea9093333b689f85fb6bcad3c4876222001f19c2016ee1d54";
    };
    opam = "${repo}/packages/text/text.0.8.1/opam";
    depends = with self; [ base-bytes ocaml (self.camlp4 or null)
                           (self.pcre or null) ];
