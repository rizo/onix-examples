...
} }:
{
  ...
  pci = {
    ...
    opam = "${repo}/packages/pci/pci.1.0.1/opam";
    depends = with self; [ ctypes ocaml ];
    buildDepends = with self; [ ocaml ocamlbuild ocamlfind ];
    depexts = with pkgs; [ (pkgs.hwdata or null) (pkgs.libpci-dev or null)
                           (pkgs.pciutil-devel or null)
                           (pkgs.pciutils-dev or null)
                           (pkgs.pciutils-devel or null) ];
  };
  stdlib-shims = {
    name = "stdlib-shims";
    version = "0.3.0";
