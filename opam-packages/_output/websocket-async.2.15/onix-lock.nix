...
} }:
{
  ...
  logs-async = {
    ...
    version = "1.1";
    src = pkgs.fetchurl {
      url = "https://github.com/vbmithr/logs-async/releases/download/1.1/logs-async-1.1.tbz";
      sha256 = "0b064d139db08f6b928358ee34729d80558de2739362ace84ceb754a7a062b05";
    };
    opam = "${repo}/packages/logs-async/logs-async.1.1/opam";
    depends = with self; [ async_kernel dune logs ];
  ...
  logs-async-reporter = {
    ...
    version = "1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/vbmithr/logs-async/releases/download/1.0/logs-async-1.0.tbz";
      sha256 = "1vplgn94m7108f3fdvhzkiiy0wr48gkbqpa9vhr1q5wf3khdlq51";
    };
    opam = "${repo}/packages/logs-async-reporter/logs-async-reporter.1.0/opam";
    depends = with self; [ async dune fmt logs ];
    buildDepends = with self; [ dune ];
  };
  macaddr = {
    name = "macaddr";
  ...
  websocket-async = {
    ...
    opam = "${repo}/packages/websocket-async/websocket-async.2.15/opam";
    depends = with self; [ async cohttp-async core dune logs-async
                           logs-async-reporter ocaml websocket ];
    buildDepends = with self; [ dune ocaml ];
  };
}
