...
} }:
{
  ...
  conf-liblz4 = {
    name = "conf-liblz4";
    version = "1";
    opam = "${repo}/packages/conf-liblz4/conf-liblz4.1/opam";
    buildDepends = with self; [ conf-pkg-config ];
    depexts = with pkgs; [ (pkgs.liblz4-dev or null)
                           (pkgs.liblz4-devel or null) (pkgs.lz4 or null)
                           (pkgs.lz4-dev or null) (pkgs.lz4-devel or null) ];
  };
  conf-pkg-config = {
  ...
  dokeysto_lz4 = {
    ...
    opam = "${repo}/packages/dokeysto_lz4/dokeysto_lz4.4.0.0/opam";
    depends = with self; [ dokeysto dune lz4 minicli ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  dune = {
    name = "dune";
  ...
  lz4 = {
    ...
    opam = "${repo}/packages/lz4/lz4.1.1.1/opam";
    depends = with self; [ base-bigarray base-bytes conf-liblz4 ctypes ocaml ];
