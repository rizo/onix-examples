...
} }:
{
  ...
  callipyge = {
    ...
    version = "0.2";
    src = pkgs.fetchurl {
      url = "https://github.com/oklm-wsh/callipyge/releases/download/v0.2/callipyge-0.2.tbz";
      sha256 = "07b45ip4yycbg2p8qs1x674n9kr93pkms8q89rssxg1irxmpizsg";
    };
    opam = "${repo}/packages/callipyge/callipyge.0.2/opam";
    depends = with self; [ dune eqaf fmt ocaml ];
