...
} }:
{
  ...
  json_decoder = {
    ...
    version = "0.1.1";
    src = pkgs.fetchurl {
      url = "https://github.com/dagoof/ocaml-json-decoder/releases/download/v0.1.1/json_decoder-0.1.1.tbz";
      sha256 = "05208h7x7m0728qlpncn2yknzlgcamvxdydf604zcr8nrrzhg98l";
    };
    opam = "${repo}/packages/json_decoder/json_decoder.0.1.1/opam";
    depends = with self; [ dune ocaml result yojson ];
    buildDepends = with self; [ dune ocaml ];
  };
  ocaml = {
    name = "ocaml";
