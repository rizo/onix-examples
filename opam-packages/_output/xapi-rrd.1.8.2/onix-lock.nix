...
} }:
{
  ...
  xapi-rrd = {
    ...
    version = "1.8.2";
    src = pkgs.fetchurl {
      url = "https://github.com/xapi-project/xcp-rrd/archive/v1.8.2.tar.gz";
      sha256 = "9b61409e062aa4cade3ac51fbcfd22b1313876ce3f75972d6f23d4fdf60280be";
    };
    opam = "${repo}/packages/xapi-rrd/xapi-rrd.1.8.2/opam";
    depends = with self; [ base-bigarray base-unix dune ezjsonm ocaml
                           ppx_deriving_rpc rpclib uuidm xmlm ];
    buildDepends = with self; [ dune ocaml ];
  };
  xmlm = {
    name = "xmlm";
