...
} }:
{
  ...
  beluga = {
    ...
    version = "1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/Beluga-lang/Beluga/archive/v1.0.tar.gz";
    ...
    opam = "${repo}/packages/beluga/beluga.1.0/opam";
    depends = with self; [ dune dune-build-info extlib gen linenoise ocaml
                           sedlex ];
