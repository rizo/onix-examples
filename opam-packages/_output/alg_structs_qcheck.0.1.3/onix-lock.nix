...
} }:
{
  alg_structs = {
    ...
    version = "0.1.3";
    src = pkgs.fetchurl {
      url = "https://github.com/shonfeder/alg_structs/releases/download/0.1.3/alg_structs_qcheck-0.1.3.tbz";
      sha256 = "6b0113f2500e70fd00862879ba36d64e9e0f1815ad6ffe2325b1e5e8ed561c08";
    };
    opam = "${repo}/packages/alg_structs/alg_structs.0.1.3/opam";
    depends = with self; [ dune ocaml ppx_deriving ];
  ...
  alg_structs_qcheck = {
    ...
    opam = "${repo}/packages/alg_structs_qcheck/alg_structs_qcheck.0.1.3/opam";
    depends = with self; [ alg_structs dune ocaml qcheck ];
    buildDepends = with self; [ dune ocaml ];
  };
  base-bytes = {
    name = "base-bytes";
  ...
  qcheck = {
    ...
    version = "0.17";
    src = pkgs.fetchurl {
      url = "https://github.com/c-cube/qcheck/archive/0.17.tar.gz";
    ...
    opam = "${repo}/packages/qcheck/qcheck.0.17/opam";
  ...
  qcheck-core = {
    ...
    opam = "${repo}/packages/qcheck-core/qcheck-core.0.17/opam";
  ...
  qcheck-ounit = {
    ...
    opam = "${repo}/packages/qcheck-ounit/qcheck-ounit.0.17/opam";
