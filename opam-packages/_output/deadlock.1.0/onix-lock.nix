...
} }:
{
  ...
  deadlock = {
    ...
    version = "1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/TDacik/Deadlock/archive/refs/tags/1.0.1.tar.gz";
      sha256 = "15w32caxx31l42yarmsvybn2gryhxlc75nb578wpp3jg45vfzaqf";
    };
    opam = "${repo}/packages/deadlock/deadlock.1.0/opam";
    depends = with self; [ containers frama-c ocaml ounit2 ];
