...
} }:
{
  ...
  wu-manber-fuzzy-search = {
    name = "wu-manber-fuzzy-search";
    version = "0.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/ifazk/wu-manber-fuzzy-search/releases/download/0.1.0/wu-manber-fuzzy-search-0.1.0.tbz";
      sha256 = "6383ed484151c85bd4de90592391d9117c9ea03eddc04bef0af5cfe57b25f56f";
    };
    opam = "${repo}/packages/wu-manber-fuzzy-search/wu-manber-fuzzy-search.0.1.0/opam";
    depends = with self; [ dune ocaml optint ];
    buildDepends = with self; [ dune ocaml ];
  };
}
