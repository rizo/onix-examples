...
} }:
{
  ...
  env_config = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/env_config-v0.15.0.tar.gz";
      sha256 = "905b9eef3d5bf6d87b03a34a21df4b03fd0dd024d8f1efc3e8ab56d4e067e6c5";
    };
    opam = "${repo}/packages/env_config/env_config.v0.15.0/opam";
  ...
  hex_encode = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/hex_encode-v0.15.0.tar.gz";
      sha256 = "96f04d63daa024d5731c13de1e31c5bcee50209c213462c5f2115ccb5cdf830f";
    };
    opam = "${repo}/packages/hex_encode/hex_encode.v0.15.0/opam";
  ...
  krb = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/krb-v0.15.0.tar.gz";
      sha256 = "d0b4b946f4e53dff9091d2d02a235e861ab5ad9d64638b17ba1834dedfb4f53d";
    };
    opam = "${repo}/packages/krb/krb.v0.15.0/opam";
    depends = with self; [ async base core dune dune-configurator env_config
                           hex_encode ocaml ppx_jane protocol_version_header
                           stdio username_kernel ];
    buildDepends = with self; [ dune ocaml ];
    depexts = with pkgs; [ (pkgs.krb5-devel or null)
                           (pkgs.libkrb5-dev or null) ];
  };
  num = {
    name = "num";
    version = "1.4";
  ...
  username_kernel = {
    name = "username_kernel";
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/username_kernel-v0.15.0.tar.gz";
      sha256 = "ce4e7bab1d21a39461d47299475633840557c0b692cae228f0962bf05540d840";
    };
    opam = "${repo}/packages/username_kernel/username_kernel.v0.15.0/opam";
    depends = with self; [ core dune ocaml ppx_jane ];
    buildDepends = with self; [ dune ocaml ];
  };
  uutf = {
