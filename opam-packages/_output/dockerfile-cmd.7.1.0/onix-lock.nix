...
} }:
{
  ...
  dockerfile-cmd = {
    ...
    opam = "${repo}/packages/dockerfile-cmd/dockerfile-cmd.7.1.0/opam";
  ...
  dockerfile-opam = {
    ...
    opam = "${repo}/packages/dockerfile-opam/dockerfile-opam.7.1.0/opam";
    depends = with self; [ astring cmdliner dockerfile dune fmt ocaml
                           ocaml-version ppx_sexp_conv sexplib ];
    buildDepends = with self; [ dune ocaml ];
  };
  dune = {
    name = "dune";
