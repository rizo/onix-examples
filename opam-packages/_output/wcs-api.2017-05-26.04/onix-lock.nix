...
} }:
{
  ...
  sedlex = {
    ...
    opam = "${repo}/packages/sedlex/sedlex.2.1/opam";
  ...
  wcs-api = {
    ...
    opam = "${repo}/packages/wcs-api/wcs-api.2017-05-26.04/opam";
    depends = with self; [ cohttp-lwt-unix jbuilder ocaml wcs-lib ];
    buildDepends = with self; [ ocaml ];
  };
  wcs-lib = {
    name = "wcs-lib";
    ...
    opam = "${repo}/packages/wcs-lib/wcs-lib.2017-05-26.04/opam";
    depends = with self; [ atd jbuilder menhir ocaml rml sedlex ];
