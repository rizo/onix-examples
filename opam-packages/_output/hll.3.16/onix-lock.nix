...
} }:
{
  ...
  hll = {
    ...
    version = "3.16";
    src = pkgs.fetchurl {
      url = "http://acsl-pkgs.s3.amazonaws.com/hll-3.16.tar.gz";
      sha256 = "0449smxd0m7s2yq62cmk14895ga2gi6lqjqfr0v4dqavmpgscrwg";
    };
    opam = "${repo}/packages/hll/hll.3.16/opam";
    depends = with self; [ cmdliner containers ocaml ocamlfind process toml ];
    buildDepends = with self; [ ocaml ocamlfind pds ];
  };
  ISO8601 = {
    name = "ISO8601";
    version = "0.2.6";
  ...
  pds = {
    ...
    version = "5.38";
    src = pkgs.fetchurl {
      url = "http://acsl-pkgs.s3.amazonaws.com/pds-5.38.tar.gz";
      sha256 = "1gr3318svj86asara2hk31jxkgamnb706prxf5q26g6p99v2rx6q";
    };
    opam = "${repo}/packages/pds/pds.5.38/opam";
    depends = with self; [ cmdliner containers crunch ocaml ocamlfind
                           ppx_deriving process sedlex toml ];
    buildDepends = with self; [ ocaml ocamlfind ];
  };
  ppx_derivers = {
    name = "ppx_derivers";
  ...
  toml = {
    ...
    version = "5.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/ocaml-toml/to.ml/archive/v5.0.0.tar.gz";
      sha256 = "0fnp6qdqjrsxbhrp195k7zc7mxxfhna5hyx89pxsf1c9027d2vpk";
    };
    opam = "${repo}/packages/toml/toml.5.0.0/opam";
