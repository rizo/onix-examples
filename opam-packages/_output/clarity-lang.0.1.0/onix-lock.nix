...
} }:
{
  ...
  clarity-lang = {
    ...
    version = "0.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/weavery/clarity.ml/releases/download/0.1.0/clarity-lang-0.1.0.tbz";
      sha256 = "448ad2078579ccdb99ffdc274ad59d4d2202dca96d802646d3a76b828cac1981";
    };
    opam = "${repo}/packages/clarity-lang/clarity-lang.0.1.0/opam";
    depends = with self; [ dune menhir num ];
    buildDepends = with self; [ cppo dune ];
  };
  cppo = {
    name = "cppo";
    version = "1.6.9";
