...
} }:
{
  ...
  reed-solomon-erasure = {
    ...
    version = "1.0.2";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/darrenldl/ocaml-reed-solomon-erasure/-/archive/v1.0.2/ocaml-reed-solomon-erasure-v1.0.2.tar.gz";
      sha256 = "1f1d4815fl5y1vsw6d5wb8v807pb5bzgfbh29n6qgggpfpqpw5i5";
    };
    opam = "${repo}/packages/reed-solomon-erasure/reed-solomon-erasure.1.0.2/opam";
    depends = with self; [ core_kernel ctypes ctypes-foreign dune ocaml ];
    buildDepends = with self; [ bisect_ppx cppo dune ocaml ];
  };
  result = {
    name = "result";
    version = "1.5";
