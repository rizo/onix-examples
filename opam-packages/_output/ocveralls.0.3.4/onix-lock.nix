...
} }:
{
  ...
  ocveralls = {
    ...
    opam = "${repo}/packages/ocveralls/ocveralls.0.3.4/opam";
    depends = with self; [ bisect ocaml ];
    buildDepends = with self; [ ezjsonm ocaml ocamlfind (self.bisect or null)
                                (self.bisect_ppx or null) ];
  };
  sexplib0 = {
    name = "sexplib0";
    version = "v0.15.0";
