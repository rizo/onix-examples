...
} }:
{
  ...
  dns-forward-lwt-unix = {
    ...
    opam = "${repo}/packages/dns-forward-lwt-unix/dns-forward-lwt-unix.0.9.0/opam";
    depends = with self; [ cstruct-lwt dns-forward io-page-unix jbuilder lwt
                           mirage-clock-unix ocaml ];
    buildDepends = with self; [ ocaml ];
  };
  domain-name = {
    name = "domain-name";
  ...
  io-page = {
    ...
    opam = "${repo}/packages/io-page/io-page.2.4.0/opam";
    depends = with self; [ bigarray-compat cstruct dune ocaml
  ...
  io-page-unix = {
    ...
    version = "2.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/io-page/releases/download/v2.1.0/io-page-v2.1.0.tbz";
      sha256 = "1x0rhbf699m8bjw80fn53g69gxvm0d5da7982mibsjz688kkfwg4";
    };
    opam = "${repo}/packages/io-page-unix/io-page-unix.2.1.0/opam";
  ...
  mirage-clock-unix = {
    ...
    opam = "${repo}/packages/mirage-clock-unix/mirage-clock-unix.2.0.0/opam";
    depends = with self; [ dune lwt mirage-clock mirage-clock-lwt ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  mirage-device = {
    name = "mirage-device";
