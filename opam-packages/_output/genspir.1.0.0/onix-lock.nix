...
} }:
{
  ...
  genspir = {
    ...
    version = "1.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/UnixJunkie/genspir/archive/v1.0.0.tar.gz";
      sha256 = "00nsf0h1xcmn3acddjzcigmjvzc6n92a308p381ib2p9i3arzflc";
    };
    opam = "${repo}/packages/genspir/genspir.1.0.0/opam";
