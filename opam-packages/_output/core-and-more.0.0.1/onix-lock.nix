...
} }:
{
  ...
  core-and-more = {
    ...
    version = "0.0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/amiltner/core-and-more/releases/download/0.0.1/core-and-more-0.0.1.tbz";
      sha256 = "ba36e935c518ec5b8f4bcfea565ff5e929f9341ba09b06d59806ea988db5182d";
    };
    opam = "${repo}/packages/core-and-more/core-and-more.0.0.1/opam";
    depends = with self; [ core dune ocaml posix-math ppx_deriving ppx_hash ];
    buildDepends = with self; [ dune ocaml ];
  };
  core_kernel = {
    name = "core_kernel";
  ...
  posix-math = {
    ...
    opam = "${repo}/packages/posix-math/posix-math.0.3.1-0/opam";
    depends = with self; [ ocaml ocamlfind result ];
