...
} }:
{
  ...
  mirage-flow-rawlink = {
    ...
    version = "1.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/mirage-flow-rawlink/releases/download/v1.1.0/mirage-flow-rawlink-v1.1.0.tbz";
      sha256 = "0djz5s85srd6zai7i3flzlmlscwrpx2hx847wbzngbh3vcgvz4v3";
    };
    opam = "${repo}/packages/mirage-flow-rawlink/mirage-flow-rawlink.1.1.0/opam";
    depends = with self; [ cstruct dune lwt mirage-flow-lwt ocaml rawlink ];
    buildDepends = with self; [ dune ocaml ];
  };
  mmap = {
    name = "mmap";
  ...
  rawlink = {
    ...
    version = "1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/haesbaert/rawlink/releases/download/v1.0/rawlink-v1.0.tbz";
      sha256 = "0a7cspysr4sdiwv798mf8s6iisli573n1ljrvq2kjdn3ifvzza7k";
    };
    opam = "${repo}/packages/rawlink/rawlink.1.0/opam";
