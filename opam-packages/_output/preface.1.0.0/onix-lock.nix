...
} }:
{
  ...
  preface = {
    ...
    version = "1.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/xvw/preface/releases/download/v1.0.0/preface-1.0.0.tbz";
      sha256 = "4bf4f89ecee0cc0064394d2f27ab2378b696c85dfa1d940fbf5c5594e3c669b9";
    };
    opam = "${repo}/packages/preface/preface.1.0.0/opam";
    depends = with self; [ dune either ocaml ];
