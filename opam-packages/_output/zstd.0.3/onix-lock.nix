...
} }:
{
  ...
  zstd = {
    ...
    version = "0.3";
    src = pkgs.fetchurl {
      url = "https://ygrek.org/p/release/ocaml-zstd/ocaml-zstd-0.3.tar.gz";
      sha256 = "d3f12f6ecbcedc5920ec24cc2c1679e79a7a5db77bb8f69bda3ff8915585bcb3";
    };
    opam = "${repo}/packages/zstd/zstd.0.3/opam";
    depends = with self; [ conf-zstd ctypes dune integers ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
}
