...
} }:
{
  ...
  ocaml_db_model = {
    ...
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/pat227/ocaml-db-model/archive/0.1.tar.gz";
    ...
    opam = "${repo}/packages/ocaml_db_model/ocaml_db_model.0.1/opam";
    depends = with self; [ bignum core dune fieldslib mysql ocaml pcre
                           ppx_deriving ppx_deriving_yojson ppx_fields_conv
                           uint yojson ];
    buildDepends = with self; [ dune ocaml ];
  };
  ocamlfind = {
