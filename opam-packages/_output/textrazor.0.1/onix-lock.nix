...
} }:
{
  ...
  textrazor = {
    ...
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/Richard-Degenne/ocaml-textrazor/archive/0.1.tar.gz";
    ...
    opam = "${repo}/packages/textrazor/textrazor.0.1/opam";
    depends = with self; [ cohttp-lwt-unix dune lwt_ppx lwt_ssl ocaml
                           ppx_deriving_yojson uri yojson ];
    buildDepends = with self; [ dune ocaml ];
  };
  topkg = {
    name = "topkg";
