...
} }:
{
  ...
  fasmifra = {
    ...
    version = "1.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/UnixJunkie/FASMIFRA/archive/refs/tags/v1.1.0.tar.gz";
      sha256 = "1jh6559pp341ckj0fdvszn6pdk9ncnwpwqs5d0mcv86c32gr4vk9";
    };
    opam = "${repo}/packages/fasmifra/fasmifra.1.1.0/opam";
    depends = with self; [ base-unix batteries conf-python-3 conf-rdkit dolog
                           dune line_oriented minicli ocaml parany ];
    buildDepends = with self; [ dune ocaml ];
  };
  line_oriented = {
    name = "line_oriented";
