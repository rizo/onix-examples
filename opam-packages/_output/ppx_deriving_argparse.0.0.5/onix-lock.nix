...
} }:
{
  ...
  ppx_deriving_argparse = {
    ...
    version = "0.0.5";
    src = pkgs.fetchurl {
      url = "https://github.com/masashi-y/ppx_deriving_argparse/archive/0.0.5.tar.gz";
      sha256 = "08k1p8ibyxknw2hihdvzvrv301pqrrfi6y58bqcgkvjrhl8sya44";
    };
    opam = "${repo}/packages/ppx_deriving_argparse/ppx_deriving_argparse.0.0.5/opam";
