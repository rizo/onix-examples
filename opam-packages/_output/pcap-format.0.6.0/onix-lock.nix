...
} }:
{
  ...
  pcap-format = {
    ...
    version = "0.6.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/ocaml-pcap/releases/download/v0.6.0/pcap-format-0.6.0.tbz";
      sha256 = "2d48f2f179ba56c9ccab51472b398983bba8ae44efedc393b282f09ad34791a6";
    };
    opam = "${repo}/packages/pcap-format/pcap-format.0.6.0/opam";
    depends = with self; [ cstruct dune ocaml ppx_cstruct ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppx_cstruct = {
    name = "ppx_cstruct";
