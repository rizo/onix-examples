...
} }:
{
  ...
  piqilib = {
    ...
    version = "0.6.15";
    src = pkgs.fetchurl {
      url = "https://github.com/alavrik/piqi/archive/v0.6.15.tar.gz";
      sha256 = "1gdgq90hmsgq1v1qgjwk7wk522kkyks39i3x3qbr9p0g6az8paly";
    };
    opam = "${repo}/packages/piqilib/piqilib.0.6.15/opam";
    depends = with self; [ base64 easy-format ocaml sedlex xmlm ];
