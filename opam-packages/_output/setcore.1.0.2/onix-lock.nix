...
} }:
{
  ...
  setcore = {
    ...
    version = "1.0.2";
    src = pkgs.fetchurl {
      url = "https://github.com/UnixJunkie/setcore/archive/v1.0.2.tar.gz";
      sha256 = "0azdjcfizx5ynl7ll3pkqkrxj8bphm5r1mp6nzm8sxfn2jibpng4";
    };
    opam = "${repo}/packages/setcore/setcore.1.0.2/opam";
