...
} }:
{
  ...
  u2f = {
    ...
    version = "0.1.2";
    src = pkgs.fetchurl {
      url = "https://github.com/roburio/u2f/releases/download/v0.1.2/u2f-0.1.2.tbz";
      sha256 = "37b31e6636745172a3d4bce6152dafe497da4ca4e90b582cbfa74bfcf94f621e";
    };
    opam = "${repo}/packages/u2f/u2f.0.1.2/opam";
    depends = with self; [ base64 cstruct dune mirage-crypto-ec
                           mirage-crypto-rng ocaml ppx_deriving_yojson x509
                           yojson ];
    buildDepends = with self; [ dune ocaml ];
  };
  x509 = {
