...
} }:
{
  ...
  core_extended = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/core_extended-v0.15.0.tar.gz";
      sha256 = "875fcea0352c10e3ae6e96ddd86136ffd8e24cb19e56193463aa22c292c737d5";
    };
    opam = "${repo}/packages/core_extended/core_extended.v0.15.0/opam";
    depends = with self; [ core core_unix dune ocaml ppx_jane re
                           record_builder ];
    buildDepends = with self; [ dune ocaml ];
  };
  core_kernel = {
  ...
  delimited_parsing = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/delimited_parsing-v0.15.0.tar.gz";
      sha256 = "77dcb18c1f3043dde221fd3ecee7be2ca436843e2f284633f86ea435cfd54925";
    };
    opam = "${repo}/packages/delimited_parsing/delimited_parsing.v0.15.0/opam";
    depends = with self; [ async core core_extended dune ocaml ppx_jane ];
    buildDepends = with self; [ dune ocaml ];
  };
  dune = {
    name = "dune";
