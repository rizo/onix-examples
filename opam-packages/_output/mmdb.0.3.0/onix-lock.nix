...
} }:
{
  ...
  mmdb = {
    ...
    version = "0.3.0";
    src = pkgs.fetchurl {
      url = "https://github.com/issuu/ocaml-mmdb/releases/download/0.3.0/mmdb-0.3.0.tbz";
      sha256 = "c35a78d505e17d8a35840e17a8047d9fba32dfa72663d39aecebf5d8196826e5";
    };
    opam = "${repo}/packages/mmdb/mmdb.0.3.0/opam";
    depends = with self; [ base conf-libmaxminddb ctypes ctypes-foreign dune
                           ocaml ppx_deriving ppx_let ];
    buildDepends = with self; [ dune ocaml ];
  };
  ocaml = {
    name = "ocaml";
