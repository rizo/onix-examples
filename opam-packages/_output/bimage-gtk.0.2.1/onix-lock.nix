...
} }:
{
  ...
  bimage = {
    ...
    version = "0.2.1";
    src = pkgs.fetchurl {
      url = "https://github.com/zshipko/ocaml-bimage/releases/download/v0.2.1/bimage-v0.2.1.tbz";
      sha256 = "edc83c7f2749277376a070df72e7b654b963e85f630ec56353b4ea53445d5e3a";
    };
    opam = "${repo}/packages/bimage/bimage.0.2.1/opam";
  ...
  bimage-gtk = {
    ...
    opam = "${repo}/packages/bimage-gtk/bimage-gtk.0.2.1/opam";
    depends = with self; [ bimage cairo2 dune lablgtk3 ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  cairo2 = {
    name = "cairo2";
