...
} }:
{
  ...
  benchpress-server = {
    name = "benchpress-server";
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/sneeuwballen/benchpress/archive/0.1.tar.gz";
      sha512 = "79173afcebe9dbdeabf8e8d6cf31b757bff1021c20d3f29b618081b3601289a939f032773dd3fc939dd005596f3cebc4407c542624ec1fcb2ff6f595b9914834";
    };
    opam = "${repo}/packages/benchpress-server/benchpress-server.0.1/opam";
    depends = with self; [ base-unix base64 benchpress cmdliner containers
                           csv dune gnuplot logs ocaml printbox sqlite3
                           sqlite3_utils tiny_httpd tiny_httpd_camlzip tyxml
                           uuidm ];
    buildDepends = with self; [ dune ocaml ];
  };
  camlzip = {
  ...
  tiny_httpd = {
    ...
    version = "0.6";
    src = pkgs.fetchurl {
      url = "https://github.com/c-cube/tiny_httpd/archive/0.6.tar.gz";
    ...
    opam = "${repo}/packages/tiny_httpd/tiny_httpd.0.6/opam";
  ...
  tiny_httpd_camlzip = {
    ...
    opam = "${repo}/packages/tiny_httpd_camlzip/tiny_httpd_camlzip.0.6/opam";
    depends = with self; [ camlzip dune ocaml tiny_httpd ];
    buildDepends = with self; [ dune ocaml ];
  };
  topkg = {
    name = "topkg";
