...
} }:
{
  ...
  bogue = {
    ...
    version = "20220314";
    src = pkgs.fetchurl {
      url = "https://github.com/sanette/bogue/archive/20220314.tar.gz";
    ...
    opam = "${repo}/packages/bogue/bogue.20220314/opam";
    depends = with self; [ dune ocaml tsdl tsdl-image tsdl-ttf ];
    buildDepends = with self; [ dune ocaml ];
  };
  conf-libffi = {
    name = "conf-libffi";
  ...
  tsdl-image = {
    ...
    version = "0.3.2";
    src = pkgs.fetchurl {
      url = "https://github.com/sanette/tsdl-image/archive/0.3.2.tar.gz";
    ...
    opam = "${repo}/packages/tsdl-image/tsdl-image.0.3.2/opam";
    depends = with self; [ conf-sdl2-image ctypes ctypes-foreign dune
