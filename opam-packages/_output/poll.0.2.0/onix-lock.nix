...
} }:
{
  ...
  kqueue = {
    ...
    version = "0.2.0";
    src = pkgs.fetchurl {
      url = "https://github.com/anuragsoni/kqueue-ml/releases/download/0.2.0/kqueue-0.2.0.tbz";
      sha256 = "6f2fff9c0996c49377a552ae7b4bc573e5a80ec6a16855d18987b738e15eecd1";
    };
    opam = "${repo}/packages/kqueue/kqueue.0.2.0/opam";
    depends = with self; [ dune ocaml ppx_optcomp ];
    buildDepends = with self; [ dune ocaml ];
  };
  ocaml = {
    name = "ocaml";
  ...
  poll = {
    ...
    version = "0.2.0";
    src = pkgs.fetchurl {
      url = "https://github.com/anuragsoni/poll/releases/download/0.2.0/poll-0.2.0.tbz";
      sha256 = "3d23be996b9992d8f8de44bf23da268a89ab02fbc7595df02b572d2deafe9145";
    };
    opam = "${repo}/packages/poll/poll.0.2.0/opam";
    depends = with self; [ base-unix dune dune-configurator kqueue ocaml
                           ppx_optcomp ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppx_derivers = {
