...
} }:
{
  ...
  oraft = {
    ...
    version = "0.2.0";
    src = pkgs.fetchurl {
      url = "https://github.com/komamitsu/oraft/archive/0.2.0.tar.gz";
    ...
    opam = "${repo}/packages/oraft/oraft.0.2.0/opam";
    depends = with self; [ cohttp-lwt-unix core dune ocaml ppx_deriving
                           ppx_deriving_yojson yojson ];
    buildDepends = with self; [ dune ocaml ];
  };
  parsexp = {
    name = "parsexp";
