...
} }:
{
  ...
  unix-unistd = {
    ...
    opam = "${repo}/packages/unix-unistd/unix-unistd.0.4.0/opam";
    depends = with self; [ ocaml (self.base-unix or null)
                           (self.ctypes or null) (self.lwt or null)
                           (self.posix-types or null)
                           (self.unix-errno or null)
                           (self.unix-type-representations or null) ];
