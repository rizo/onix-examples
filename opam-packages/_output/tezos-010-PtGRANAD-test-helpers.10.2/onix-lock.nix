...
} }:
{
  ...
  tezos-010-PtGRANAD-test-helpers = {
    ...
    opam = "${repo}/packages/tezos-010-PtGRANAD-test-helpers/tezos-010-PtGRANAD-test-helpers.10.2/opam";
  ...
  tezos-client-010-PtGRANAD = {
    ...
    opam = "${repo}/packages/tezos-client-010-PtGRANAD/tezos-client-010-PtGRANAD.10.2/opam";
  ...
  tezos-protocol-010-PtGRANAD = {
    ...
    opam = "${repo}/packages/tezos-protocol-010-PtGRANAD/tezos-protocol-010-PtGRANAD.10.2/opam";
  ...
  tezos-protocol-010-PtGRANAD-parameters = {
    ...
    opam = "${repo}/packages/tezos-protocol-010-PtGRANAD-parameters/tezos-protocol-010-PtGRANAD-parameters.10.2/opam";
  ...
  tezos-protocol-plugin-010-PtGRANAD = {
    ...
    opam = "${repo}/packages/tezos-protocol-plugin-010-PtGRANAD/tezos-protocol-plugin-010-PtGRANAD.10.2/opam";
    depends = with self; [ dune tezos-protocol-010-PtGRANAD ];
    buildDepends = with self; [ dune ];
  };
  tezos-proxy = {
