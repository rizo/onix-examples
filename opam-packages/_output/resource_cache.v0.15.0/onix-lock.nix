...
} }:
{
  ...
  resource_cache = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/resource_cache-v0.15.0.tar.gz";
      sha256 = "2f9a45a93a7f722e9b1c5bcc84d63df9b4644b496388e5c57d8e22db325b2b37";
    };
    opam = "${repo}/packages/resource_cache/resource_cache.v0.15.0/opam";
    depends = with self; [ async_kernel async_rpc_kernel core dune ocaml
                           ppx_jane ];
    buildDepends = with self; [ dune ocaml ];
  };
  seq = {
