...
} }:
{
  ...
  re2_stable = {
    ...
    version = "v0.14.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.14/files/re2_stable-v0.14.0.tar.gz";
      sha256 = "0wd83s5sxbv1rnypv26x9b7yr6vnchwsq61qy1nhiyhyk4801119";
    };
    opam = "${repo}/packages/re2_stable/re2_stable.v0.14.0/opam";
    depends = with self; [ core dune ocaml ppx_jane re2 ];
    buildDepends = with self; [ dune ocaml ];
  };
  seq = {
    name = "seq";
