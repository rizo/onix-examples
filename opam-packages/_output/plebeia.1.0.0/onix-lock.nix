...
} }:
{
  ...
  plebeia = {
    ...
    version = "1.0.0";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/dailambda/plebeia/-/archive/1.0.0/plebeia-1.0.0.tar.bz2";
      sha256 = "17df8a9wmhx6srj5pbmk68j3vixbachwxjm3w84j2zc48yylda42";
    };
    opam = "${repo}/packages/plebeia/plebeia.1.0.0/opam";
    depends = with self; [ bigstring blake2 cstruct data-encoding dune hex
                           ptime stdint ];
    buildDepends = with self; [ dune ];
  };
  ptime = {
