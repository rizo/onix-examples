...
} }:
{
  ...
  sexp_diff_kernel = {
    name = "sexp_diff_kernel";
    version = "v0.14.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.14/files/sexp_diff_kernel-v0.14.0.tar.gz";
      sha256 = "1j3rgy10sy208lg1wdqw6vnnxbr40ksvjwlg8lklliqskyp2zszl";
    };
    opam = "${repo}/packages/sexp_diff_kernel/sexp_diff_kernel.v0.14.0/opam";
