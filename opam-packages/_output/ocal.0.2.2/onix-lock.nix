...
} }:
{
  ...
  ocal = {
    ...
    version = "0.2.2";
    src = pkgs.fetchurl {
      url = "https://github.com/mor1/ocal/releases/download/0.2.2/ocal-0.2.2.tbz";
      sha256 = "0dskiq0h2zpzdjlj2rqj1a8hp6qyhdprhf4430bbv025cqgwarxl";
    };
    opam = "${repo}/packages/ocal/ocal.0.2.2/opam";
    depends = with self; [ dune ocaml ];
    buildDepends = with self; [ astring calendar cmdliner dune notty ocaml ];
  };
  ocaml = {
    name = "ocaml";
    version = "4.13.1";
