...
} }:
{
  ...
  hg_lib = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/hg_lib-v0.15.0.tar.gz";
      sha256 = "c0486d07af6bdeead224460bba29ea26507c05bdca1877f713ca83f72f8eef7d";
    };
    opam = "${repo}/packages/hg_lib/hg_lib.v0.15.0/opam";
    depends = with self; [ async core core_kernel dune
                           expect_test_helpers_core ocaml ppx_jane ];
    buildDepends = with self; [ dune ocaml ];
  };
  int_repr = {
    name = "int_repr";
