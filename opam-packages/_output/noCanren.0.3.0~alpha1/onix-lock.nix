...
} }:
{
  ...
  GT = {
    ...
    version = "0.5.1";
    src = pkgs.fetchurl {
      url = "https://github.com/JetBrains-Research/GT/archive/refs/tags/0.5.1.tar.gz";
      sha256 = "fe0aa1e40afd36f7c1fcd992c408261d0b5645cea080ea98bc5dbf0b8682187f";
    };
    opam = "${repo}/packages/GT/GT.0.5.1/opam";
    depends = with self; [ base camlp5 dune logger-p5 ocaml
                           ocaml-migrate-parsetree ocamlfind ocamlgraph
                           ppx_inline_test ppxlib ];
    buildDepends = with self; [ conf-m4 dune ocaml ocamlfind ];
  };
  jane-street-headers = {
  ...
  noCanren = {
    ...
    src = pkgs.fetchurl {
      url = "https://github.com/Kakadu/noCanren/archive/0.3.0-alpha1.tar.gz";
      sha256 = "ca41ad2cef7b45c29f30c6cf3402b133d8dba82f69818a783bfee95173d62797";
    };
    opam = "${repo}/packages/noCanren/noCanren.0.3.0~alpha1/opam";
    depends = with self; [ dune GT OCanren OCanren-ppx ocaml ppxlib ];
    buildDepends = with self; [ dune ocaml ];
  };
  OCanren = {
    name = "OCanren";
    version = "0.3.0";
    src = pkgs.fetchurl {
      url = "https://github.com/JetBrains-Research/OCanren/archive/refs/tags/0.3.0.tar.gz";
      sha256 = "eaf9624bbdbae8050eb43a48c0e79e97160b83b6f65a543ee1beca4c9f4ff4b2";
    };
    opam = "${repo}/packages/OCanren/OCanren.0.3.0/opam";
    depends = with self; [ camlp5 dune dune-configurator GT logger-p5 mtime
                           OCanren-ppx ocaml ocamlfind ppx_inline_test ];
  ...
  OCanren-ppx = {
    ...
    opam = "${repo}/packages/OCanren-ppx/OCanren-ppx.0.3.0/opam";
    depends = with self; [ base dune dune-configurator ocaml ppx_expect
                           ppx_inline_test ppxlib ];
    buildDepends = with self; [ dune ocaml ];
  };
  ocaml = {
