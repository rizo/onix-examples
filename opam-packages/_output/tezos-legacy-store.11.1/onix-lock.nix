...
} }:
{
  ...
  lwt-watcher = {
    ...
    version = "0.2";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/nomadic-labs/lwt-watcher/-/archive/v0.2/lwt-watcher-v0.2.tar.gz";
    ...
    opam = "${repo}/packages/lwt-watcher/lwt-watcher.0.2/opam";
    depends = with self; [ dune lwt ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  lwt_log = {
  ...
  tezos-legacy-store = {
    ...
    opam = "${repo}/packages/tezos-legacy-store/tezos-legacy-store.11.1/opam";
    depends = with self; [ dune lwt-watcher tezos-lmdb tezos-validation ];
    buildDepends = with self; [ dune ];
  };
  tezos-lmdb = {
    name = "tezos-lmdb";
  ...
  tezos-protocol-updater = {
    ...
    opam = "${repo}/packages/tezos-protocol-updater/tezos-protocol-updater.11.1/opam";
  ...
  tezos-validation = {
    ...
    opam = "${repo}/packages/tezos-validation/tezos-validation.11.1/opam";
