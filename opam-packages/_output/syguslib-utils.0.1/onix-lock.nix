...
} }:
{
  ...
  getopt = {
    ...
    opam = "${repo}/packages/getopt/getopt.20120615/opam";
    depends = with self; [ ocaml ocamlfind ];
  ...
  syguslib-utils = {
    ...
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/victornicolet/syguslib-utils/archive/0.1.tar.gz";
    ...
    opam = "${repo}/packages/syguslib-utils/syguslib-utils.0.1/opam";
    depends = with self; [ base core dune fileutils fmt getopt lwt lwt_ppx
                           odoc parsexp sexplib stdio ];
