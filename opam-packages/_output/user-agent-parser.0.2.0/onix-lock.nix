...
} }:
{
  ...
  user-agent-parser = {
    ...
    version = "0.2.0";
    src = pkgs.fetchurl {
      url = "https://github.com/issuu/uap-ocaml/releases/download/0.2.0/user-agent-parser-0.2.0.tbz";
      sha256 = "00ca1fbb107a1628733dcd95277b9630e466d235a354c8f8055d491c3307e026";
    };
    opam = "${repo}/packages/user-agent-parser/user-agent-parser.0.2.0/opam";
    depends = with self; [ base dune ocaml ppx_deriving ppx_let re stdio
                           yojson ];
    buildDepends = with self; [ dune ocaml yaml ];
  };
  yaml = {
    name = "yaml";
    version = "3.1.0";
