...
} }:
{
  ...
  mirage-block-unix = {
    ...
    opam = "${repo}/packages/mirage-block-unix/mirage-block-unix.2.9.0/opam";
    depends = with self; [ cstruct cstruct-lwt io-page-unix jbuilder logs
                           mirage-block-lwt ocaml rresult uri ];
    buildDepends = with self; [ ocaml ];
