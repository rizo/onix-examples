...
} }:
{
  ...
  omlr = {
    ...
    version = "1.0.2";
    src = pkgs.fetchurl {
      url = "https://github.com/UnixJunkie/omlr/archive/v1.0.2.tar.gz";
      sha256 = "0q7j8dvzjy72ajmvbcz3wx6hhv7hzad4sc1q9bq8csck3xnhh956";
    };
    opam = "${repo}/packages/omlr/omlr.1.0.2/opam";
