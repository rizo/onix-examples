...
} }:
{
  ...
  ostap = {
    ...
    version = "0.5";
    src = pkgs.fetchurl {
      url = "https://github.com/Kakadu/ostap/archive/0.5-memoCPS.tar.gz";
      sha256 = "b7c8499f46c6d376b2127ba4c926560d0bf6ac3a81aeb8c3fed95956e86f51be";
    };
    opam = "${repo}/packages/ostap/ostap.0.5/opam";
    depends = with self; [ camlp5 GT re ];
    buildDepends = with self; [ ocamlbuild ocamlfind ];
  };
  ppx_assert = {
    name = "ppx_assert";
    version = "v0.15.0";
