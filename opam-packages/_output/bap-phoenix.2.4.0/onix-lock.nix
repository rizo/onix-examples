...
} }:
{
  ...
  bap-phoenix = {
    ...
    opam = "${repo}/packages/bap-phoenix/bap-phoenix.2.4.0/opam";
    depends = with self; [ bap-std cmdliner core_kernel ezjsonm graphlib
                           ocaml ocamlgraph ppx_bap regular text-tags ];
    buildDepends = with self; [ oasis ocaml ];
  };
  bap-plugins = {
    name = "bap-plugins";
