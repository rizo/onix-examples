...
} }:
{
  ...
  idds = {
    ...
    version = "0.2";
    src = pkgs.fetchurl {
      url = "https://github.com/netkat-lang/idds/releases/download/0.2/idds-0.2.tbz";
      sha256 = "0cb7c160cb45957dfd2603ca6d10dab80fef51d60e47b9d7a5a8b7970d30ac39";
    };
    opam = "${repo}/packages/idds/idds.0.2/opam";
    depends = with self; [ base dune ocaml open ppx_deriving ppx_jane ];
    buildDepends = with self; [ dune ocaml ];
  };
  jane-street-headers = {
