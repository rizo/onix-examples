...
} }:
{
  ...
  lemonade = {
    ...
    opam = "${repo}/packages/lemonade/lemonade.0.6.0/opam";
    depends = with self; [ broken bsdowl conf-bmake mixture ocaml ocamlfind ];
    buildDepends = with self; [ ocaml ocamlfind ];
  };
  lemonade-sqlite = {
    ...
    opam = "${repo}/packages/lemonade-sqlite/lemonade-sqlite.0.1.0/opam";
    depends = with self; [ broken bsdowl conf-bmake lemonade ocaml ocamlfind
                           sqlite3 ];
    buildDepends = with self; [ ocaml ocamlfind ];
    depexts = with pkgs; [ sqlite3 ];
  };
  mixture = {
    name = "mixture";
    version = "1.0.0";
    ...
    opam = "${repo}/packages/mixture/mixture.1.0.0/opam";
