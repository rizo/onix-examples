...
} }:
{
  ...
  hardcaml_verify = {
    name = "hardcaml_verify";
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/hardcaml_verify-v0.15.0.tar.gz";
      sha256 = "a469d63c76bd86fbd04aa38d391dc736d4bc291ad5ffe0090b31cc4ae3ba6622";
    };
    opam = "${repo}/packages/hardcaml_verify/hardcaml_verify.v0.15.0/opam";
    depends = with self; [ base dune hardcaml hardcaml_waveterm ocaml
                           ppx_deriving_hardcaml ppx_jane re stdio ];
    buildDepends = with self; [ dune ocaml ];
  };
  hardcaml_waveterm = {
    name = "hardcaml_waveterm";
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/hardcaml_waveterm-v0.15.0.tar.gz";
      sha256 = "05c9aaa7e8bf3d834a10efb59d757d022adfff20eb371ac9558bb3927afc4bb4";
    };
    opam = "${repo}/packages/hardcaml_waveterm/hardcaml_waveterm.v0.15.0/opam";
    depends = with self; [ base core_unix dune expect_test_helpers_core
                           hardcaml notty notty_async num ocaml
                           ppx_deriving_hardcaml ppx_jane re stdio ];
    buildDepends = with self; [ dune ocaml ];
  };
  int_repr = {
  ...
  notty_async = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/notty_async-v0.15.0.tar.gz";
      sha256 = "16a1e28f145bd3c18203d26707fac984f6af903b3ca55d63a9d28f1c0d1ef7b0";
    };
    opam = "${repo}/packages/notty_async/notty_async.v0.15.0/opam";
    depends = with self; [ async dune notty ocaml ppx_jane ];
    buildDepends = with self; [ dune ocaml ];
  };
  num = {
    name = "num";
