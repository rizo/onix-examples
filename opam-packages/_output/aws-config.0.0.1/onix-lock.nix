...
} }:
{
  aws-config = {
    ...
    version = "0.0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/Nymphium/aws-config/archive/0.0.1.tar.gz";
    ...
    opam = "${repo}/packages/aws-config/aws-config.0.0.1/opam";
    depends = with self; [ dune logs ocaml re yojson ];
