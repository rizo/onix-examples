...
} }:
{
  ...
  key-parsers = {
    ...
    version = "1.4.0";
    src = pkgs.fetchurl {
      url = "https://github.com/cryptosense/key-parsers/releases/download/1.4.0/key-parsers-1.4.0.tbz";
      sha256 = "01466350871121b73ae2c23eace1ac6aa883898d7dd0f9ad34c523413d2e67c0";
    };
    opam = "${repo}/packages/key-parsers/key-parsers.1.4.0/opam";
    depends = with self; [ asn1-combinators cstruct dune hex ocaml
                           ppx_deriving result zarith ];
    buildDepends = with self; [ dune ocaml ];
  };
  ocaml = {
    name = "ocaml";
