...
} }:
{
  ...
  dune-release = {
    ...
    version = "1.6.2";
    src = pkgs.fetchurl {
      url = "https://github.com/ocamllabs/dune-release/releases/download/1.6.2/dune-release-1.6.2.tbz";
      sha256 = "a09e522fba8d3398b3a04a6bfa74e36d3f989a6348a32ed081236c7b7c0d200e";
    };
    opam = "${repo}/packages/dune-release/dune-release.1.6.2/opam";
    depends = with self; [ astring bos cmdliner curly dune fmt fpath logs
                           ocaml odoc opam-core opam-file-format opam-format
                           opam-state re rresult yojson ];
    buildDepends = with self; [ dune ocaml ];
  };
  easy-format = {
    name = "easy-format";
