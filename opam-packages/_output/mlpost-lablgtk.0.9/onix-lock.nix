...
} }:
{
  ...
  bitstring = {
    ...
    opam = "${repo}/packages/bitstring/bitstring.4.1.0/opam";
  ...
  cairo2-gtk = {
    ...
    opam = "${repo}/packages/cairo2-gtk/cairo2-gtk.0.6.2/opam";
    depends = with self; [ base-bigarray cairo2 conf-cairo dune lablgtk ocaml ];
  ...
  mlpost = {
    ...
    version = "0.9";
    src = pkgs.fetchurl {
      url = "https://github.com/backtracking/mlpost/releases/download/0.9/mlpost-0.9.tbz";
      sha256 = "9fad08fbc364a5989f65da507b03d63a3e2fb67aea160c59f43022a14b2897de";
    };
    opam = "${repo}/packages/mlpost/mlpost.0.9/opam";
    depends = with self; [ bitstring cairo2 dune ocaml
                           ocaml-migrate-parsetree ocamlfind ppx_bitstring
                           (self.graphics or null) ];
  ...
  mlpost-lablgtk = {
    ...
    opam = "${repo}/packages/mlpost-lablgtk/mlpost-lablgtk.0.9/opam";
    depends = with self; [ bitstring cairo2-gtk conf-gnomecanvas dune lablgtk
                           mlpost ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  ocaml = {
  ...
  ppx_bitstring = {
    ...
    version = "4.0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/xguerin/bitstring/archive/v4.0.1.tar.gz";
      sha256 = "1gzn5g78b4ry2m4z1wsigayrqag3xj7pfpbd05gjrjkadzpnyra3";
    };
    opam = "${repo}/packages/ppx_bitstring/ppx_bitstring.4.0.1/opam";
    depends = with self; [ bitstring dune ocaml ];
    buildDepends = with self; [ dune ocaml ppxlib ];
  };
  ppx_derivers = {
    name = "ppx_derivers";
    version = "1.2.1";
