...
} }:
{
  ...
  river = {
    ...
    version = "0.2";
    src = pkgs.fetchurl {
      url = "https://github.com/kayceesrk/river/releases/download/0.2/river-0.2.tbz";
      sha256 = "8bf4a8cfc46ed255a4c97c081308755b8a35108778c3b80e5ec3f6a2cb3e8c72";
    };
    opam = "${repo}/packages/river/river.0.2/opam";
    depends = with self; [ cohttp cohttp-lwt cohttp-lwt-unix dune lambdasoup
                           lwt ocaml ocamlnet ptime syndic ];
    buildDepends = with self; [ dune ocaml ];
  };
  rresult = {
    name = "rresult";
  ...
  syndic = {
    ...
    version = "1.6.1";
    src = pkgs.fetchurl {
      url = "https://github.com/Cumulus/Syndic/releases/download/v1.6.1/syndic-v1.6.1.tbz";
      sha256 = "a830f3e471a4058a93ac03b979b5a96d5e75e59ec6e9e1e3dd048c081ef683c4";
    };
    opam = "${repo}/packages/syndic/syndic.1.6.1/opam";
