...
} }:
{
  ...
  sexp_string_quickcheck = {
    name = "sexp_string_quickcheck";
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/sexp_string_quickcheck-v0.15.0.tar.gz";
      sha256 = "abd619a1a3ccf5730dd0ee9396681f4e5b7513d34ce36af4b28ec09b4661ac14";
    };
    opam = "${repo}/packages/sexp_string_quickcheck/sexp_string_quickcheck.v0.15.0/opam";
    depends = with self; [ core dune ocaml parsexp ppx_jane ];
    buildDepends = with self; [ dune ocaml ];
  };
  sexplib = {
    name = "sexplib";
