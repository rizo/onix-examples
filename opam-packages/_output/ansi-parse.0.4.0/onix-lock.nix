...
} }:
{
  ...
  ansi-parse = {
    ...
    version = "0.4.0";
    src = pkgs.fetchurl {
      url = "https://github.com/diskuv/ansi-parse/archive/0.4.0.tar.gz";
    ...
    opam = "${repo}/packages/ansi-parse/ansi-parse.0.4.0/opam";
    depends = with self; [ angstrom dune ocaml ppx_deriving tyxml ];
