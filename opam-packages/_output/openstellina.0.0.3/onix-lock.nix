...
} }:
{
  ...
  ezgzip = {
    ...
    opam = "${repo}/packages/ezgzip/ezgzip.0.2.3/opam";
    depends = with self; [ astring camlzip dune ocaml ocplib-endian rresult ];
    buildDepends = with self; [ dune ocaml ];
  };
  fmt = {
    name = "fmt";
  ...
  openstellina = {
    ...
    version = "0.0.3";
    src = pkgs.fetchurl {
      url = "https://github.com/jrrk2/openstellina/releases/download/opam-publish-openstellina.0.0.3/openstellina-opam-publish-openstellina.0.0.3.tbz";
      sha256 = "5e6ae3c1aeb57105ea79f0a0b938c0b8ef7e19b413ef69799fc07292d42245b2";
    };
    opam = "${repo}/packages/openstellina/openstellina.0.0.3/opam";
    depends = with self; [ cohttp-lwt-unix digestif dune lablgtk lwt_glib
                           lwt_ssl ocaml ppx_let ppx_yojson quests yojson
                           zeit ];
    buildDepends = with self; [ dune ocaml ];
  };
  parsexp = {
  ...
  ppx_yojson = {
    ...
    version = "1.2.0";
    src = pkgs.fetchurl {
      url = "https://github.com/NathanReb/ppx_yojson/releases/download/1.2.0/ppx_yojson-1.2.0.tbz";
      sha256 = "d12b59c88b8866d38a40d0e3eb3465727db35a19b27fdea739e9875628a10651";
    };
    opam = "${repo}/packages/ppx_yojson/ppx_yojson.1.2.0/opam";
  ...
  quests = {
    ...
    version = "0.1.3";
    src = pkgs.fetchurl {
      url = "https://github.com/roddyyaga/quests/archive/0.1.3.tar.gz";
    ...
    opam = "${repo}/packages/quests/quests.0.1.3/opam";
    depends = with self; [ cohttp cohttp-lwt-unix dune ezgzip lwt lwt_ppx
                           lwt_ssl ocaml ppx_deriving ppx_yojson ssl tls
                           yojson ];
    buildDepends = with self; [ dune ocaml ];
  };
  re = {
  ...
  zeit = {
    ...
    version = "0.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/emillon/ocaml-zeit/releases/download/v0.1.0/zeit-0.1.0.tbz";
      sha256 = "0sz8gdj1fzh1nyl0r7ac8y8rkicgkcmi90yvzz8x8h851hm5ql2j";
    };
    opam = "${repo}/packages/zeit/zeit.0.1.0/opam";
    depends = with self; [ cohttp-lwt-unix digestif dune ocaml ppx_deriving
                           ppx_deriving_yojson ppx_let ];
    buildDepends = with self; [ dune ocaml ];
  };
}
