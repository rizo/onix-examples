...
} }:
{
  ...
  morbig = {
    ...
    version = "0.9.1";
    src = pkgs.fetchurl {
      url = "https://github.com/colis-anr/morbig/archive/v0.9.1.tar.gz";
    ...
    opam = "${repo}/packages/morbig/morbig.0.9.1/opam";
    depends = with self; [ menhir ppx_deriving_yojson visitors yojson ];
