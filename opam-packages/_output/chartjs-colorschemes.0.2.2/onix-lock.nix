...
} }:
{
  ...
  chartjs = {
    ...
    version = "0.2.2";
    src = pkgs.fetchurl {
      url = "https://github.com/monstasat/chartjs-ocaml/archive/v0.2.2.tar.gz";
      sha256 = "370fbff01351b354a7947dfc44fd6bda49306f1b9b8712395bcd3651269af27b";
    };
    opam = "${repo}/packages/chartjs/chartjs.0.2.2/opam";
    depends = with self; [ dune js_of_ocaml js_of_ocaml-ppx ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  chartjs-colorschemes = {
    ...
    opam = "${repo}/packages/chartjs-colorschemes/chartjs-colorschemes.0.2.2/opam";
    depends = with self; [ chartjs dune js_of_ocaml js_of_ocaml-ppx ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  cmdliner = {
    name = "cmdliner";
