...
} }:
{
  ...
  irmin = {
    ...
    version = "2.9.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/irmin/releases/download/2.9.0/irmin-2.9.0.tbz";
      sha256 = "7af11e14d312b9ae340997f8c27907b9fc9a0d19539fb643e1820d5183a76750";
    };
    opam = "${repo}/packages/irmin/irmin.2.9.0/opam";
  ...
  irmin-layers = {
    ...
    opam = "${repo}/packages/irmin-layers/irmin-layers.2.9.0/opam";
  ...
  irmin-pack = {
    ...
    opam = "${repo}/packages/irmin-pack/irmin-pack.2.9.0/opam";
  ...
  ppx_irmin = {
    ...
    opam = "${repo}/packages/ppx_irmin/ppx_irmin.2.9.0/opam";
  ...
  tezos-client-012-Psithaca-commands = {
    name = "tezos-client-012-Psithaca-commands";
    version = "12.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v12.3/tezos-v12.3.tar.bz2";
      sha256 = "296bb5674bc6050afe6330326fbdd0dfc2255d414bfd6b79cc7666ac6b39316d";
    };
    opam = "${repo}/packages/tezos-client-012-Psithaca-commands/tezos-client-012-Psithaca-commands.12.3/opam";
    depends = with self; [ dune tezos-client-012-Psithaca
                           tezos-client-base-unix ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-012-Psithaca-commands-registration = {
    name = "tezos-client-012-Psithaca-commands-registration";
    version = "12.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v12.3/tezos-v12.3.tar.bz2";
      sha256 = "296bb5674bc6050afe6330326fbdd0dfc2255d414bfd6b79cc7666ac6b39316d";
    };
    opam = "${repo}/packages/tezos-client-012-Psithaca-commands-registration/tezos-client-012-Psithaca-commands-registration.12.3/opam";
    depends = with self; [ dune tezos-client-sapling-012-Psithaca ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-base = {
  ...
  tezos-client-sapling-012-Psithaca = {
    name = "tezos-client-sapling-012-Psithaca";
    version = "12.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v12.3/tezos-v12.3.tar.bz2";
      sha256 = "296bb5674bc6050afe6330326fbdd0dfc2255d414bfd6b79cc7666ac6b39316d";
    };
    opam = "${repo}/packages/tezos-client-sapling-012-Psithaca/tezos-client-sapling-012-Psithaca.12.3/opam";
    depends = with self; [ dune tezos-client-012-Psithaca-commands ];
    buildDepends = with self; [ dune ];
  };
  tezos-context = {
    name = "tezos-context";
