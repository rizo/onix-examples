...
} }:
{
  ...
  mirage-entropy = {
    ...
    version = "0.5.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/mirage-entropy/releases/download/v0.5.0/mirage-entropy-0.5.0.tbz";
      sha256 = "1dff63xglb0m5vf4lmn7bsa92b9m10fnysfj6a3rlhpxsahx6mrq";
    };
    opam = "${repo}/packages/mirage-entropy/mirage-entropy.0.5.0/opam";
    depends = with self; [ cstruct lwt mirage-runtime ocaml
  ...
  mirage-random-stdlib = {
    name = "mirage-random-stdlib";
    version = "0.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/mirage-random-stdlib/releases/download/v0.1.0/mirage-random-stdlib-v0.1.0.tbz";
      sha256 = "51783442c9b97711715ce62a15bcbefd3b01ae32c737f998eede395bc2dbfda3";
    };
    opam = "${repo}/packages/mirage-random-stdlib/mirage-random-stdlib.0.1.0/opam";
    depends = with self; [ cstruct dune lwt mirage-entropy mirage-random
                           ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  mirage-runtime = {
