...
} }:
{
  ...
  spotify-web-api = {
    ...
    version = "0.2.1";
    src = pkgs.fetchurl {
      url = "https://github.com/johnelse/ocaml-spotify-web-api/archive/spotify-web-api.0.2.1.tar.gz";
      sha256 = "0nnl615idsbvp2qwbg5aqjlpfr5msdr89187n072xcx58i3d3jkb";
    };
    opam = "${repo}/packages/spotify-web-api/spotify-web-api.0.2.1/opam";
    depends = with self; [ atdgen biniou cohttp-lwt-unix dune ssl uri yojson ];
