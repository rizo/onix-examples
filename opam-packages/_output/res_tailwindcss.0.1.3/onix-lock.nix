...
} }:
{
  ...
  res_tailwindcss = {
    ...
    version = "0.1.3";
    src = pkgs.fetchurl {
      url = "https://github.com/mattdamon108/res_tailwindcss/archive/opam-0.1.3.tar.gz";
    ...
    opam = "${repo}/packages/res_tailwindcss/res_tailwindcss.0.1.3/opam";
    depends = with self; [ core dune menhir ocaml ppx_deriving ppx_expect
