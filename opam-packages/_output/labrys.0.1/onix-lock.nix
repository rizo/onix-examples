...
} }:
{
  ...
  labrys = {
    ...
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/kit-ty-kate/labrys/archive/0.1.tar.gz";
      sha256 = "02jldnhbpdlg7k7h8hv0ap30n5qxmxdaqsg91hbf8xn810j6n50v";
    };
    opam = "${repo}/packages/labrys/labrys.0.1/opam";
    depends = with self; [ base-unix cmdliner containers dune llvm menhir
                           msgpack ocaml pprint re uutf ];
    buildDepends = with self; [ dune ocaml ];
    depexts = with pkgs; [ (pkgs.bdw-gc or null) (pkgs.boehm-gc or null)
                           (pkgs.boehmgc or null)
                           (pkgs.devel/boehm-gc or null) (pkgs.gc or null)
                           (pkgs.gc-dev or null) (pkgs.gc-devel or null)
                           (pkgs.libgc-dev or null) ];
  };
  llvm = {
    name = "llvm";
    version = "13.0.0";
