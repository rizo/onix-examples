...
} }:
{
  ...
  ppx_wideopen = {
    ...
    version = "0.0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/ghilesZ/ppx_wideopen/archive/0.0.1.tar.gz";
    ...
    opam = "${repo}/packages/ppx_wideopen/ppx_wideopen.0.0.1/opam";
    depends = with self; [ dune ocaml ppx_tools_versioned ];
    buildDepends = with self; [ dune ocaml ];
  };
  result = {
    name = "result";
