...
} }:
{
  ...
  dedukti = {
    ...
    version = "2.6.0";
    src = pkgs.fetchurl {
      url = "https://github.com/Deducteam/Dedukti/archive/v2.6.0.tar.gz";
      sha256 = "1y6ng02f4848fnjhrrv575dyridbdxks1x5xnmy366dwx81b0pa0";
    };
    opam = "${repo}/packages/dedukti/dedukti.2.6.0/opam";
