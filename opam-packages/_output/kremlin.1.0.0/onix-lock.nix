...
} }:
{
  ...
  conf-python-2-7 = {
    ...
    version = "1.2";
    opam = "${repo}/packages/conf-python-2-7/conf-python-2-7.1.2/opam";
    depexts = with pkgs; [ python27 ];
  };
  cppo = {
    name = "cppo";
    version = "1.6.9";
  ...
  fstar = {
    ...
    version = "2022.01.15";
    src = pkgs.fetchurl {
      url = "https://github.com/FStarLang/FStar/archive/refs/tags/v2022.01.15.tar.gz";
    ...
    opam = "${repo}/packages/fstar/fstar.2022.01.15/opam";
    depends = with self; [ batteries fileutils ocaml ocamlfind ppx_deriving
                           ppx_deriving_yojson ppxlib process stdint yojson
                           z3 zarith ];
    buildDepends = with self; [ menhir ocaml ocamlbuild ocamlfind pprint
                                sedlex ];
  ...
  kremlin = {
    ...
    version = "1.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/FStarLang/kremlin/archive/refs/tags/v1.0.0.zip";
    ...
    opam = "${repo}/packages/kremlin/kremlin.1.0.0/opam";
    depends = with self; [ batteries fileutils fix fstar menhir ocaml pprint
                           ppx_deriving ppx_deriving_yojson process stdint
                           ulex visitors wasm yojson zarith ];
    buildDepends = with self; [ ocaml ocamlbuild ocamlfind ];
    depexts = with pkgs; [ unzip (pkgs.coreutils or null) ];
  };
  menhir = {
    name = "menhir";
    version = "20220210";
  ...
  process = {
    ...
    opam = "${repo}/packages/process/process.0.2.1/opam";
    depends = with self; [ base-bytes base-unix ocaml ];
    buildDepends = with self; [ ocaml ocamlbuild ocamlfind ];
  };
  result = {
    name = "result";
  ...
  wasm = {
    ...
    version = "1.1.1";
    src = pkgs.fetchurl {
      url = "https://github.com/WebAssembly/spec/archive/opam-1.1.1.zip";
      sha256 = "08k9fai0gmxakq5hl660ncvmhx16d6n4jq5yrcadak4ia9970vw3";
    };
    opam = "${repo}/packages/wasm/wasm.1.1.1/opam";
    depends = with self; [ ocaml ];
    buildDepends = with self; [ ocaml ocamlbuild ocamlfind ];
  ...
  z3 = {
    ...
    opam = "${repo}/packages/z3/z3.4.8.5/opam";
    depends = with self; [ conf-gmp num ocaml ];
    buildDepends = with self; [ conf-python-2-7 ocaml ocamlfind ];
  };
  zarith = {
    name = "zarith";
    version = "1.12";
