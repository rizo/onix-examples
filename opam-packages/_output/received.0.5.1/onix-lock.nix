...
} }:
{
  ...
  received = {
    ...
    version = "0.5.1";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/colombe/releases/download/received-v0.5.1/received-received-v0.5.1.tbz";
      sha256 = "d16dda6f13f4587827f220697d5652ad6dea186ed891c97867440c1584591f0b";
    };
    opam = "${repo}/packages/received/received.0.5.1/opam";
    depends = with self; [ angstrom colombe dune emile mrmime ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  result = {
    name = "result";
