...
} }:
{
  ...
  weberizer = {
    ...
    version = "0.8";
    src = pkgs.fetchurl {
      url = "https://github.com/Chris00/weberizer/releases/download/0.8/weberizer-0.8.tbz";
      sha256 = "1gpcnpsdjjg6bvzfjcg673swrxwma627hy0bppjqd9j8idzj0bv8";
    };
    opam = "${repo}/packages/weberizer/weberizer.0.8/opam";
    depends = with self; [ dune ocaml ocamlnet ];
