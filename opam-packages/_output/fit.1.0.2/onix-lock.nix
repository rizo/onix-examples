...
} }:
{
  ...
  fit = {
    ...
    version = "1.0.2";
    src = pkgs.fetchurl {
      url = "https://github.com/lindig/fit/releases/download/1.0.2/fit-1.0.2.tbz";
      sha256 = "692faf7156994c7ff9ea84c668f6d37d7e5a5ac0a4f7dacfb4c19ed66193208f";
    };
    opam = "${repo}/packages/fit/fit.1.0.2/opam";
    depends = with self; [ angstrom cmdliner dune ezjsonm ISO8601 ocaml
                           rresult ];
    buildDepends = with self; [ dune ocaml ];
  };
  fmt = {
