...
} }:
{
  ...
  ppx_open = {
    ...
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/johnyob/ppx-open/releases/download/0.1/ppx_open-0.1.tbz";
      sha256 = "9ab1fa1a7102184a23bbca5138f2294b4daa60ca8014d37256c76bc31788ce43";
    };
    opam = "${repo}/packages/ppx_open/ppx_open.0.1/opam";
    depends = with self; [ base dune menhir ocaml ppxlib ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppxlib = {
    name = "ppxlib";
