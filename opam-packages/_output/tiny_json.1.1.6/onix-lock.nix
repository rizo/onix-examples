...
} }:
{
  ...
  tiny_json = {
    ...
    version = "1.1.6";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/camlspotter/tiny_json/-/archive/1.1.6/tiny_json-1.1.6.tar.bz2";
      sha256 = "05vnsn56rdzgq9jgk8fk9pk4z9f81z0ms9xjf4qgykhsblp0q854";
    };
    opam = "${repo}/packages/tiny_json/tiny_json.1.1.6/opam";
