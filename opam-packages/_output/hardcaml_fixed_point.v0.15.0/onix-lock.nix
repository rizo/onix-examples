...
} }:
{
  ...
  hardcaml_fixed_point = {
    name = "hardcaml_fixed_point";
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/hardcaml_fixed_point-v0.15.0.tar.gz";
      sha256 = "aac72d5a89d3a93147781c248436d29db5ee86c93e0fc6c92bab5e0011dde910";
    };
    opam = "${repo}/packages/hardcaml_fixed_point/hardcaml_fixed_point.v0.15.0/opam";
    depends = with self; [ base dune hardcaml ocaml ppx_jane ];
    buildDepends = with self; [ dune ocaml ];
  };
  jane-street-headers = {
