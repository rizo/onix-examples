...
} }:
{
  ...
  erlang = {
    ...
    version = "0.0.14";
    src = pkgs.fetchurl {
      url = "https://github.com/AbstractMachinesLab/caramel/releases/download/v0.0.14/erlang-v0.0.14.tbz";
      sha256 = "5e018ee6cd932f534c19b31e83345290fbc48cb91af1cd5c57986ab485215031";
    };
    opam = "${repo}/packages/erlang/erlang.0.0.14/opam";
    depends = with self; [ cmdliner dune menhir ocaml ppx_sexp_conv sexplib ];
    buildDepends = with self; [ dune ocaml ];
  };
  menhir = {
    name = "menhir";
