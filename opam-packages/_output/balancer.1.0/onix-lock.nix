...
} }:
{
  balancer = {
    ...
    version = "1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/XnuKernPoll/ocaml-balancers/archive/v1.0.tar.gz";
      sha256 = "17fbi2p7aiqmgiani3ymh3ka799yq908dj9lchr1hzi6r2wq1vgs";
    };
    opam = "${repo}/packages/balancer/balancer.1.0/opam";
    depends = with self; [ cstruct fmt hex jbuilder lwt ocaml react ];
