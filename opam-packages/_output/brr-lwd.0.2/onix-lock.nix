...
} }:
{
  ...
  brr = {
    ...
    version = "0.0.3";
    src = pkgs.fetchurl {
      url = "https://erratique.ch/software/brr/releases/brr-0.0.3.tbz";
      sha512 = "5fa5498c57f86799a3bd9743c41991bb7bc347f424258b474ac92d6b7cf645300c9b618ebe78ac3973d6940b38d2d7c415be20c2b68cb89452288bd3f9122add";
    };
    opam = "${repo}/packages/brr/brr.0.0.3/opam";
    depends = with self; [ js_of_ocaml-compiler js_of_ocaml-toplevel note
                           ocaml ];
  ...
  brr-lwd = {
    ...
    opam = "${repo}/packages/brr-lwd/brr-lwd.0.2/opam";
    depends = with self; [ brr dune js_of_ocaml lwd ];
  ...
  note = {
    ...
    version = "0.0.2";
    src = pkgs.fetchurl {
      url = "https://erratique.ch/software/note/releases/note-0.0.2.tbz";
    ...
    opam = "${repo}/packages/note/note.0.0.2/opam";
    depends = with self; [ ocaml ];
