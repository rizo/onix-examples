...
} }:
{
  ...
  dirsp-proscript-mirage = {
    name = "dirsp-proscript-mirage";
    version = "0.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/diskuv/dirsp-exchange/archive/0.1.0.tar.gz";
      sha512 = "0500d75ff0d3ac187e876d0c3b888ce7d6396ea5bf55ec4aca4a0adfc4ac76d3838bbcb2d6efcc40e2cecb7fc2070ebe362ed2a6606dc42790588f7a0966d199";
    };
    opam = "${repo}/packages/dirsp-proscript-mirage/dirsp-proscript-mirage.0.1.0/opam";
    depends = with self; [ dirsp-proscript dune mirage-crypto-ec
                           mirage-crypto-rng ocaml ppx_deriving_protobuf ];
    buildDepends = with self; [ dune ocaml ];
  };
  dune = {
    name = "dune";
