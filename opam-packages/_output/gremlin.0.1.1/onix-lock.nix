...
} }:
{
  ...
  gremlin = {
    ...
    version = "0.1.1";
    src = pkgs.fetchurl {
      url = "https://github.com/bramford/ocaml-gremlin/archive/0.1.1.tar.gz";
    ...
    opam = "${repo}/packages/gremlin/gremlin.0.1.1/opam";
    depends = with self; [ conduit-lwt-unix containers core dune lwt lwt_ppx
                           ocaml ppx_let websocket websocket-lwt-unix yojson ];
    buildDepends = with self; [ dune ocaml ];
  };
  ipaddr = {
    name = "ipaddr";
  ...
  websocket = {
    ...
    version = "2.14";
    src = pkgs.fetchurl {
      url = "https://github.com/vbmithr/ocaml-websocket/releases/download/2.14/websocket-2.14.tbz";
      sha256 = "30e40d098da86fb5f6b2adbc53211503c6e0c20422c21a7b41c8ac83168ca439";
    };
    opam = "${repo}/packages/websocket/websocket.2.14/opam";
  ...
  websocket-lwt-unix = {
    ...
    opam = "${repo}/packages/websocket-lwt-unix/websocket-lwt-unix.2.14/opam";
