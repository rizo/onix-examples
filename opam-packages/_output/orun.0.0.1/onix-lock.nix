...
} }:
{
  ...
  orun = {
    ...
    version = "0.0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/ocaml-bench/orun/releases/download/v0.0.1/orun-v0.0.1.tbz";
      sha256 = "762fb57673f83b702bfc0ee6d3006a519ad71d8951d7f286af2ffd141e569d6d";
    };
    opam = "${repo}/packages/orun/orun.0.0.1/opam";
    depends = with self; [ cmdliner dune ocaml re yojson ];
    buildDepends = with self; [ conf-libdw dune ocaml ];
