...
} }:
{
  ...
  dream-encoding = {
    ...
    version = "0.2.0";
    src = pkgs.fetchurl {
      url = "https://github.com/tmattio/dream-encoding/releases/download/0.2.0/dream-encoding-0.2.0.tbz";
      sha256 = "ca6c5d4a2dd31e1cca75f4ce9c95134b7f339ff2f4ea56d88ea859d57b82aa06";
    };
    opam = "${repo}/packages/dream-encoding/dream-encoding.0.2.0/opam";
    depends = with self; [ decompress dream dune lwt_ppx ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  dream-httpaf = {
    name = "dream-httpaf";
