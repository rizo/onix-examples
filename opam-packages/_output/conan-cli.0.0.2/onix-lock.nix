...
} }:
{
  ...
  conan = {
    ...
    opam = "${repo}/packages/conan/conan.0.0.2/opam";
    depends = with self; [ dune ocaml ptime re uutf ];
  ...
  conan-cli = {
    ...
    opam = "${repo}/packages/conan-cli/conan-cli.0.0.2/opam";
    depends = with self; [ conan conan-database conan-unix dune dune-site
                           ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  conan-database = {
    ...
    opam = "${repo}/packages/conan-database/conan-database.0.0.2/opam";
    depends = with self; [ conan dune ];
  ...
  conan-unix = {
    ...
    opam = "${repo}/packages/conan-unix/conan-unix.0.0.2/opam";
    depends = with self; [ base-unix conan dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  csexp = {
    name = "csexp";
