...
} }:
{
  ...
  carton = {
    ...
    version = "0.4.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/ocaml-git/releases/download/carton-v0.4.0/carton-carton-v0.4.0.tbz";
      sha256 = "777f9692b83cd63570c17527a32c5045818ab9242d923cbbde72fc23d0da0140";
    };
    opam = "${repo}/packages/carton/carton.0.4.0/opam";
  ...
  carton-git = {
    ...
    opam = "${repo}/packages/carton-git/carton-git.0.4.0/opam";
    depends = with self; [ astring base-unix bigarray-compat bigstringaf
                           carton carton-lwt decompress dune fmt fpath lwt
                           mmap ocaml result ];
    buildDepends = with self; [ dune ocaml ];
  };
  carton-lwt = {
    ...
    opam = "${repo}/packages/carton-lwt/carton-lwt.0.4.0/opam";
  ...
  cohttp-mirage = {
    ...
    opam = "${repo}/packages/cohttp-mirage/cohttp-mirage.2.5.6/opam";
    depends = with self; [ astring cohttp cohttp-lwt conduit conduit-mirage
                           dune fmt lwt magic-mime mirage-channel mirage-flow
                           mirage-kv ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  conduit = {
  ...
  conduit-mirage = {
    ...
    version = "2.2.1";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/ocaml-conduit/releases/download/v2.2.1/conduit-v2.2.1.tbz";
      sha256 = "daac02c9955b5b1ec0e3ce29588bb20c4869ab956bd92e992bf3b0c0d98e26ff";
    };
    opam = "${repo}/packages/conduit-mirage/conduit-mirage.2.2.1/opam";
    depends = with self; [ conduit-lwt cstruct dns-client dune ipaddr
                           ipaddr-sexp mirage-clock mirage-flow
                           mirage-flow-combinators mirage-random mirage-stack
                           mirage-time ocaml ppx_sexp_conv sexplib tls
                           tls-mirage vchan xenstore ];
    buildDepends = with self; [ dune ocaml ];
  };
  conf-gmp = {
    name = "conf-gmp";
  ...
  dns = {
    ...
    version = "4.6.3";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/ocaml-dns/releases/download/v4.6.3/dns-v4.6.3.tbz";
      sha256 = "be69bc317369409fc4dfbab1120ced7510313888105a4d13071b962a07e1fd3c";
    };
    opam = "${repo}/packages/dns/dns.4.6.3/opam";
    depends = with self; [ astring cstruct domain-name dune duration fmt gmap
                           ipaddr logs lru metrics ocaml ptime rresult ];
    buildDepends = with self; [ dune ocaml ];
  };
  dns-client = {
    name = "dns-client";
    ...
    opam = "${repo}/packages/dns-client/dns-client.4.6.3/opam";
    depends = with self; [ cstruct dns domain-name dune fmt ipaddr logs lwt
                           mirage-clock mirage-crypto-rng mirage-random
                           mirage-stack mirage-time mtime ocaml randomconv
                           rresult ];
    buildDepends = with self; [ dune ocaml ];
  };
  domain-name = {
  ...
  git = {
    ...
    version = "3.3.3";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/ocaml-git/releases/download/3.3.3/git-3.3.3.tbz";
      sha256 = "a3ab287daa3f1163be610f9fb7d327e9ab00cf43f5a38cb5ccd02d7278e21749";
    };
    opam = "${repo}/packages/git/git.3.3.3/opam";
    depends = with self; [ angstrom astring base64 bigarray-compat
                           ...
                           encore fmt fpath ipaddr ke logs lwt mimic
                           mirage-flow ocaml ocamlgraph optint psq result
                           rresult uri ];
    buildDepends = with self; [ dune ocaml ];
  };
  git-cohttp-mirage = {
    name = "git-cohttp-mirage";
    version = "3.3.3";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/ocaml-git/releases/download/3.3.3/git-3.3.3.tbz";
      sha256 = "a3ab287daa3f1163be610f9fb7d327e9ab00cf43f5a38cb5ccd02d7278e21749";
    };
    opam = "${repo}/packages/git-cohttp-mirage/git-cohttp-mirage.3.3.3/opam";
    depends = with self; [ cohttp cohttp-lwt cohttp-mirage dune fmt git lwt
                           mimic ocaml result rresult uri ];
    buildDepends = with self; [ dune ocaml ];
  };
  gmap = {
    name = "gmap";
  ...
  mirage-channel = {
    ...
    opam = "${repo}/packages/mirage-channel/mirage-channel.4.1.0/opam";
    depends = with self; [ cstruct dune logs lwt mirage-flow ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  mirage-clock = {
    name = "mirage-clock";
  ...
  mirage-flow-combinators = {
    name = "mirage-flow-combinators";
    version = "3.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/mirage-flow/releases/download/v3.0.0/mirage-flow-v3.0.0.tbz";
      sha256 = "d70bda6c85ec2747bed88bc4d95f269d2810503b92913f0807be5291696138fc";
    };
    opam = "${repo}/packages/mirage-flow-combinators/mirage-flow-combinators.3.0.0/opam";
  ...
  mirage-stack = {
    ...
    opam = "${repo}/packages/mirage-stack/mirage-stack.4.0.0/opam";
    depends = with self; [ dune ocaml tcpip ];
    buildDepends = with self; [ dune ocaml ];
  };
  mirage-time = {
    name = "mirage-time";
  ...
  tls = {
    ...
    version = "0.14.1";
    src = pkgs.fetchurl {
      url = "https://github.com/mirleft/ocaml-tls/releases/download/v0.14.1/tls-v0.14.1.tbz";
      sha256 = "58cf2d517d6eac5b1ccc5eeb656da690aef2125a19c1eca3fbececd858046216";
    };
    opam = "${repo}/packages/tls/tls.0.14.1/opam";
    depends = with self; [ cstruct cstruct-sexp domain-name dune fmt hkdf
                           logs lwt mirage-crypto mirage-crypto-ec
                           mirage-crypto-pk mirage-crypto-rng ocaml
                           ppx_cstruct ppx_sexp_conv ptime rresult sexplib
                           x509 ];
    buildDepends = with self; [ dune ocaml ];
  };
  tls-mirage = {
    ...
    opam = "${repo}/packages/tls-mirage/tls-mirage.0.14.1/opam";
  ...
  vchan = {
    ...
    opam = "${repo}/packages/vchan/vchan.6.0.1/opam";
    depends = with self; [ cstruct dune io-page lwt mirage-flow ocaml
                           ppx_cstruct ppx_sexp_conv sexplib xenstore
                           xenstore_transport ];
    buildDepends = with self; [ dune ocaml ];
  };
  x509 = {
    ...
    opam = "${repo}/packages/x509/x509.0.14.1/opam";
    depends = with self; [ asn1-combinators base64 cstruct domain-name dune
                           fmt gmap logs mirage-crypto mirage-crypto-ec
                           mirage-crypto-pk mirage-crypto-rng ocaml pbkdf
                           ptime rresult ];
    buildDepends = with self; [ dune ocaml ];
  };
  xenstore = {
