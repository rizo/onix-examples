...
} }:
{
  ...
  prc = {
    ...
    version = "0.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/pveber/prc/releases/download/v0.1.0/prc-0.1.0.tbz";
      sha256 = "898322ef7f722e37f332362a24c1ad5f1bf8f8bb396cdb549fb44d59fc4f769a";
    };
    opam = "${repo}/packages/prc/prc.0.1.0/opam";
    depends = with self; [ core_kernel dune gsl ppx_jane
                           (self.ocaml-r or null) ];
