...
} }:
{
  ...
  opam-client = {
    ...
    opam = "${repo}/packages/opam-client/opam-client.2.0.10/opam";
  ...
  opam-package-upgrade = {
    ...
    version = "0.2";
    src = pkgs.fetchurl {
      url = "https://github.com/AltGr/opam-format-upgrade/archive/0.2.tar.gz";
    ...
    opam = "${repo}/packages/opam-package-upgrade/opam-package-upgrade.0.2/opam";
    depends = with self; [ cmdliner dune opam-client ];
  ...
  opam-solver = {
    ...
    opam = "${repo}/packages/opam-solver/opam-solver.2.0.10/opam";
    depends = with self; [ cudf dose3 dune mccs ocaml opam-format re ];
    buildDepends = with self; [ dune ocaml ];
  };
  opam-state = {
    name = "opam-state";
