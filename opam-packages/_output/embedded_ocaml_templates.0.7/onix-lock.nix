...
} }:
{
  ...
  embedded_ocaml_templates = {
    ...
    version = "0.7";
    src = pkgs.fetchurl {
      url = "https://github.com/EmileTrotignon/embedded_ocaml_templates/archive/0.7.tar.gz";
    ...
    opam = "${repo}/packages/embedded_ocaml_templates/embedded_ocaml_templates.0.7/opam";
    depends = with self; [ containers dune menhir ocaml pprint
                           ppx_inline_test ppxlib sedlex uutf ];
    buildDepends = with self; [ dune ocaml ];
  };
  gen = {
    name = "gen";
