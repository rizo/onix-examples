...
} }:
{
  ...
  ezjs_extension = {
    ...
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/ocamlpro/ezjs_extension/archive/0.1.tar.gz";
    ...
    opam = "${repo}/packages/ezjs_extension/ezjs_extension.0.1/opam";
    depends = with self; [ dune ezjs_min ocaml (self.lwt or null) ];
    buildDepends = with self; [ dune ocaml ];
  };
  ezjs_min = {
    name = "ezjs_min";
