...
} }:
{
  ...
  gapi-ocaml = {
    ...
    version = "0.4.2";
    src = pkgs.fetchurl {
      url = "https://github.com/astrada/gapi-ocaml/archive/v0.4.2.tar.gz";
      sha256 = "0ajvmzhgddbzcppwvd4bvisf41d1ympyq50amk97adj48gx6sk4w";
    };
    opam = "${repo}/packages/gapi-ocaml/gapi-ocaml.0.4.2/opam";
    depends = with self; [ cryptokit dune ocaml ocamlnet ocurl yojson ];
    buildDepends = with self; [ dune ocaml ];
  };
  ocaml = {
    name = "ocaml";
