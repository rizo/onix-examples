...
} }:
{
  agrid = {
    ...
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/OCamlPro/agrid/archive/0.1.tar.gz";
      sha256 = "ea82546711a6abdd4edf8bc3052041498cae9c2e5a9e147e29820da4eac4beb4";
    };
    opam = "${repo}/packages/agrid/agrid.0.1/opam";
    depends = with self; [ dune flex-array ocaml ];
  ...
  atable = {
    ...
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/ocamlpro/atable/archive/0.1.tar.gz";
      sha256 = "d485f97e5badfc5d69eeb95c4551fce0063da837fa4417677447ea72b3d1e378";
    };
    opam = "${repo}/packages/atable/atable.0.1/opam";
    depends = with self; [ agrid dune flex-array js_of_ocaml-compiler
                           js_of_ocaml-ppx ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  base-threads = {
    name = "base-threads";
  ...
  flex-array = {
    ...
    version = "1.2.0";
    src = pkgs.fetchurl {
      url = "https://github.com/backtracking/flex-array/releases/download/1.2.0/flex-array-1.2.0.tbz";
      sha256 = "a20a3c025eb7587c19c175ce66c6a3a6046b0e7d44ce1b3bd6d96beffe052c6a";
    };
    opam = "${repo}/packages/flex-array/flex-array.1.2.0/opam";
    depends = with self; [ dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  js_of_ocaml = {
