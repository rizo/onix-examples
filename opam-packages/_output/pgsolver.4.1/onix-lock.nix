...
} }:
{
  ...
  ocaml-sat-solvers = {
    ...
    version = "0.4";
    src = pkgs.fetchurl {
      url = "https://github.com/tcsprojects/ocaml-sat-solvers/archive/v0.4.tar.gz";
      sha256 = "0j9q5c0sqgzd811hfpjqms2zad0jdkkq0dwcv1sk6zkhfq10waq6";
    };
    opam = "${repo}/packages/ocaml-sat-solvers/ocaml-sat-solvers.0.4/opam";
    depends = with self; [ minisat ocaml ];
  ...
  pgsolver = {
    ...
    opam = "${repo}/packages/pgsolver/pgsolver.4.1/opam";
    depends = with self; [ minisat ocaml ocaml-sat-solvers TCSLib
