...
} }:
{
  ...
  ppx_viewpattern = {
    name = "ppx_viewpattern";
    version = "0.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/sim642/ppx_viewpattern/releases/download/0.1.0/ppx_viewpattern-0.1.0.tbz";
      sha256 = "826e53c910e1255698e2988e1055f5dc173a4f3fb6cd92346f62d0b3d0e05c7b";
    };
    opam = "${repo}/packages/ppx_viewpattern/ppx_viewpattern.0.1.0/opam";
