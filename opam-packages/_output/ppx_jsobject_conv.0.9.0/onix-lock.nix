...
} }:
{
  ...
  ppx_jsobject_conv = {
    ...
    version = "0.9.0";
    src = pkgs.fetchurl {
      url = "https://github.com/little-arhat/ppx_jsobject_conv/archive/v0.9.0.tar.gz";
      sha256 = "0xq7dw1vpdanb9wza330grci4d1swar27s6nwy17s58nax9ggln3";
    };
    opam = "${repo}/packages/ppx_jsobject_conv/ppx_jsobject_conv.0.9.0/opam";
