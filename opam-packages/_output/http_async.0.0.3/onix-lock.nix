...
} }:
{
  ...
  http_async = {
    ...
    version = "0.0.3";
    src = pkgs.fetchurl {
      url = "https://github.com/anuragsoni/http_async/releases/download/0.0.3/http_async-0.0.3.tbz";
      sha256 = "fd0da06524318709cbad869956c3071d5c2fba948de16806a3a44b1aa76f3a2c";
    };
    opam = "${repo}/packages/http_async/http_async.0.0.3/opam";
    depends = with self; [ dune ocaml ppxlib shuttle ];
    buildDepends = with self; [ dune ocaml ];
  };
  int_repr = {
    name = "int_repr";
  ...
  shuttle = {
    ...
    version = "0.4.0";
    src = pkgs.fetchurl {
      url = "https://github.com/anuragsoni/shuttle/releases/download/0.4.0/shuttle-0.4.0.tbz";
      sha256 = "e701a36d3383156f5b1d16f6676622377ab148e39c44b96821ea45fb7e22abb7";
    };
    opam = "${repo}/packages/shuttle/shuttle.0.4.0/opam";
