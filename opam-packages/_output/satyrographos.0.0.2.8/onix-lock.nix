...
} }:
{
  ...
  bos = {
    ...
    opam = "${repo}/packages/bos/bos.0.2.0/opam";
  ...
  json-derivers = {
    ...
    opam = "${repo}/packages/json-derivers/json-derivers.1.0.0/opam";
  ...
  opam-core = {
    ...
    version = "2.0.10";
    src = pkgs.fetchurl {
      url = "https://github.com/ocaml/opam/archive/2.0.10.tar.gz";
    ...
    opam = "${repo}/packages/opam-core/opam-core.2.0.10/opam";
  ...
  opam-format = {
    ...
    opam = "${repo}/packages/opam-format/opam-format.2.0.10/opam";
  ...
  opam-repository = {
    ...
    opam = "${repo}/packages/opam-repository/opam-repository.2.0.10/opam";
  ...
  opam-state = {
    ...
    opam = "${repo}/packages/opam-state/opam-state.2.0.10/opam";
  ...
  posixat = {
    ...
    version = "v0.14.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.14/files/posixat-v0.14.0.tar.gz";
      sha256 = "081hqxl37rxln7wzq18ip1y7h67rikb1xlaivlm5mkmgfv0ayibj";
    };
    opam = "${repo}/packages/posixat/posixat.v0.14.0/opam";
    depends = with self; [ base dune ocaml ppx_optcomp ppx_sexp_conv ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppx_assert = {
    name = "ppx_assert";
  ...
  rresult = {
    ...
    opam = "${repo}/packages/rresult/rresult.0.6.0/opam";
  ...
  satyrographos = {
    ...
    version = "0.0.2.8";
    src = pkgs.fetchurl {
      url = "https://github.com/na4zagin3/satyrographos/archive/v0.0.2.8.tar.gz";
    ...
    opam = "${repo}/packages/satyrographos/satyrographos.0.0.2.8/opam";
    depends = with self; [ core dune fileutils json-derivers menhir ocaml
                           ocamlgraph opam-format opam-state ppx_deriving
                           ppx_deriving_yojson ppx_jane shexp uri uri-sexp
                           yaml yojson ];
    buildDepends = with self; [ dune ocaml ];
    depexts = with pkgs; [ (pkgs.diffutils or null) ];
  };
  seq = {
    name = "seq";
    version = "base";
  ...
  shexp = {
    ...
    version = "v0.14.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.14/files/shexp-v0.14.0.tar.gz";
      sha256 = "0d9x9ak2l9p83pfi7m8yn38qmysryc9xlgr3vv4hrhw5jcal3yh1";
    };
    opam = "${repo}/packages/shexp/shexp.v0.14.0/opam";
    depends = with self; [ base base-threads dune ocaml posixat spawn ];
    buildDepends = with self; [ dune ocaml ];
  };
  spawn = {
    name = "spawn";
  ...
  yaml = {
    ...
    version = "2.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/avsm/ocaml-yaml/releases/download/v2.1.0/yaml-v2.1.0.tbz";
      sha256 = "05153817981ea97b62d8c49eeb42ba2e7efba82e61a3834b65213e59a0dee80d";
    };
    opam = "${repo}/packages/yaml/yaml.2.1.0/opam";
    depends = with self; [ bos ctypes dune dune-configurator fmt logs ocaml
                           ppx_sexp_conv rresult sexplib ];
    buildDepends = with self; [ dune ocaml ];
  };
  yojson = {
    name = "yojson";
