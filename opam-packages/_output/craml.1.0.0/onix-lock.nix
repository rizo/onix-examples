...
} }:
{
  ...
  craml = {
    ...
    version = "1.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/realworldocaml/craml/releases/download/1.0.0/craml-1.0.0.tbz";
      sha256 = "1vyh3yh0h936fw2q4n66qb4w0plvpc8x1dikizrkns4mdvqkmrzg";
    };
    opam = "${repo}/packages/craml/craml.1.0.0/opam";
    depends = with self; [ astring cmdliner fmt jbuilder logs ocaml ];
    buildDepends = with self; [ ocaml ];
  };
  fmt = {
    name = "fmt";
