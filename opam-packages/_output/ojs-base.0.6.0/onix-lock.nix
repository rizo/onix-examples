...
} }:
{
  ...
  ojs-base = {
    ...
    version = "0.6.0";
    src = pkgs.fetchurl {
      url = "https://framagit.org/zoggy/ojs-base/-/archive/0.6.0/ojs-base-0.6.0.tar.gz";
    ...
    opam = "${repo}/packages/ojs-base/ojs-base.0.6.0/opam";
    depends = with self; [ base64 cohttp js_of_ocaml lwt lwt_ppx magic-mime
                           ocaml ppx_deriving_yojson websocket
                           websocket-lwt-unix xtmpl yojson ];
    buildDepends = with self; [ ocaml ocamlfind ];
  };
  parsexp = {
    name = "parsexp";
  ...
  xtmpl = {
    ...
    version = "0.18.0";
    src = pkgs.fetchurl {
      url = "https://framagit.org/zoggy/xtmpl/-/archive/0.18.0/xtmpl-0.18.0.tar.gz";
    ...
    opam = "${repo}/packages/xtmpl/xtmpl.0.18.0/opam";
    depends = with self; [ iri js_of_ocaml js_of_ocaml-ppx ocaml ppx_tools re
                           sedlex uutf ];
    buildDepends = with self; [ ocaml ocamlfind ];
  };
  yojson = {
