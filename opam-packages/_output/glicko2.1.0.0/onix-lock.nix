...
} }:
{
  ...
  glicko2 = {
    ...
    version = "1.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/bruce-ricard/glicko2/archive/v1.0.0.tar.gz";
      sha256 = "0g7s1lnjgk8z6cq9fh73y5mdpldp6j2cdzzn44d23vja01hjvmka";
    };
    opam = "${repo}/packages/glicko2/glicko2.1.0.0/opam";
    depends = with self; [ fmt logs ocaml ];
