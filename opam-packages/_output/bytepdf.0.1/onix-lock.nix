...
} }:
{
  ...
  bytepdf = {
    ...
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/Drup/bytepdf/releases/download/0.1/bytepdf-0.1.tbz";
      sha256 = "10337y314brk4bmxf74inj1vhwsx8vlhm1pjgzawzxj3a4cqrr5b";
    };
    opam = "${repo}/packages/bytepdf/bytepdf.0.1/opam";
    depends = with self; [ bos cmdliner containers dune obytelib ocaml
                           (self.camlpdf or null) (self.ocaml or null) ];
    buildDepends = with self; [ dune ocaml (self.ocaml or null) ];
  };
  camlpdf = {
    name = "camlpdf";
    version = "2.5";
  ...
  obytelib = {
    ...
    version = "1.5";
    src = pkgs.fetchurl {
      url = "https://github.com/bvaugon/obytelib/archive/1.5.tar.gz";
      sha256 = "0ksmhgalbkxmrlh6rmq30fvvn7sfqidh5jbsvq3kcvx4gmam0pga";
    };
    opam = "${repo}/packages/obytelib/obytelib.1.5/opam";
    depends = with self; [ ocaml ];
