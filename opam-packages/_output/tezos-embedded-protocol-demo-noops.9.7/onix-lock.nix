...
} }:
{
  ...
  tezos-embedded-protocol-demo-noops = {
    ...
    opam = "${repo}/packages/tezos-embedded-protocol-demo-noops/tezos-embedded-protocol-demo-noops.9.7/opam";
    depends = with self; [ dune tezos-protocol-demo-noops
  ...
  tezos-protocol-demo-noops = {
    ...
    opam = "${repo}/packages/tezos-protocol-demo-noops/tezos-protocol-demo-noops.9.7/opam";
