...
} }:
{
  ...
  sanddb = {
    ...
    version = "0.3.0";
    src = pkgs.fetchurl {
      url = "https://github.com/StrykerKKD/SandDB/releases/download/0.3.0/sanddb-0.3.0.tbz";
      sha256 = "3452ba21c6b448b58a12f4da42ca66d8dedd3a4105807786d1ba60a7464e1bf1";
    };
    opam = "${repo}/packages/sanddb/sanddb.0.3.0/opam";
    depends = with self; [ alcotest atdgen base dune lwt ocaml uuidm ];
    buildDepends = with self; [ dune ocaml ];
  };
  seq = {
    name = "seq";
