...
} }:
{
  ...
  tiny_httpd = {
    ...
    version = "0.9";
    src = pkgs.fetchurl {
      url = "https://github.com/c-cube/tiny_httpd/archive/v0.9.tar.gz";
    ...
    opam = "${repo}/packages/tiny_httpd/tiny_httpd.0.9/opam";
  ...
  tiny_httpd_camlzip = {
    ...
    opam = "${repo}/packages/tiny_httpd_camlzip/tiny_httpd_camlzip.0.9/opam";
