...
} }:
{
  ...
  swhid = {
    ...
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/OCamlPro/swhid/archive/refs/tags/0.1.tar.gz";
      sha256 = "1ca94411004d45b42194ed70754993592dffc1b5836c15276ed81d2e92f662fb";
    };
    opam = "${repo}/packages/swhid/swhid.0.1/opam";
    depends = with self; [ digestif dune ezcurl jsonm menhir ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  topkg = {
    name = "topkg";
