...
} }:
{
  ...
  ppx_make = {
    ...
    version = "0.3.0";
    src = pkgs.fetchurl {
      url = "https://github.com/bn-d/ppx_make/archive/v0.3.0.tar.gz";
    ...
    opam = "${repo}/packages/ppx_make/ppx_make.0.3.0/opam";
  ...
  pyre-ast = {
    ...
    version = "0.1.8";
    src = pkgs.fetchurl {
      url = "https://github.com/grievejia/pyre-ast/releases/download/0.1.8/pyre-ast-0.1.8.tbz";
      sha256 = "b5a77edb62222661f3b1209ffc194ddfe7c6c5b7dc082a2495f6f4dbf8f62db4";
    };
    opam = "${repo}/packages/pyre-ast/pyre-ast.0.1.8/opam";
    depends = with self; [ base dune ppx_compare ppx_deriving ppx_hash
                           ppx_make ppx_sexp_conv ];
    buildDepends = with self; [ dune ];
  };
  result = {
    name = "result";
