...
} }:
{
  ...
  lambdapi = {
    ...
    version = "2.2.0";
    src = pkgs.fetchurl {
      url = "https://github.com/Deducteam/lambdapi/releases/download/2.2.0/lambdapi-2.2.0.tbz";
      sha256 = "920de48ec6c2c3223b6b93879bb65d07ea24aa27f7f7176b3de16e5e467b9939";
    };
    opam = "${repo}/packages/lambdapi/lambdapi.2.2.0/opam";
    depends = with self; [ bindlib cmdliner dune menhir ocaml pratter sedlex
                           stdlib-shims timed why3 yojson ];
    buildDepends = with self; [ dune ocaml ];
  };
  menhir = {
    name = "menhir";
  ...
  pratter = {
    ...
    opam = "${repo}/packages/pratter/pratter.1.2/opam";
    depends = with self; [ dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  sedlex = {
