...
} }:
{
  ...
  varint = {
    ...
    version = "1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/XnuKernPoll/ocaml-varint/archive/v1.0.tar.gz";
      sha256 = "020bdiwffgjmcpgs4s4yvdln9kkl2hrckyxvyb1yhwndd5n4f02s";
    };
    opam = "${repo}/packages/varint/varint.1.0/opam";
    depends = with self; [ jbuilder mstruct ocaml ];
    buildDepends = with self; [ ocaml ];
  };
}
