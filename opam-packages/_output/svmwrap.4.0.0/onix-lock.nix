...
} }:
{
  ...
  conf-libsvm-tools = {
    name = "conf-libsvm-tools";
    version = "1.0.0";
    opam = "${repo}/packages/conf-libsvm-tools/conf-libsvm-tools.1.0.0/opam";
    depexts = with pkgs; [ (pkgs.libsvm or null) (pkgs.libsvm-tools or null)
                           (pkgs.sci-libs/libsvm or null)
                           (pkgs.svm-tools or null) ];
  };
  conf-nlopt = {
    name = "conf-nlopt";
    version = "1";
  ...
  svmwrap = {
    ...
    version = "4.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/UnixJunkie/svmwrap/archive/v4.0.0.tar.gz";
      sha256 = "1rn61ncfjr9v8kqpxzyscfj94nf4gdmhl38fcxpw3zs8rmiz6109";
    };
    opam = "${repo}/packages/svmwrap/svmwrap.4.0.0/opam";
    depends = with self; [ base-unix batteries conf-libsvm-tools cpm dolog
                           dune line_oriented minicli molenc nlopt-ocaml
                           parany (self.conf-gnuplot or null) ];
