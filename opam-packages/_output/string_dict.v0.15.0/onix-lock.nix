...
} }:
{
  ...
  string_dict = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/string_dict-v0.15.0.tar.gz";
      sha256 = "b20629dc1e710f20a5177ea910f0d9de9b8aff1756ad374ddea8fa08a555315d";
    };
    opam = "${repo}/packages/string_dict/string_dict.v0.15.0/opam";
    depends = with self; [ base dune ocaml ppx_compare ppx_hash ];
    buildDepends = with self; [ dune ocaml ];
  };
}
