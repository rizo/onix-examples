...
} }:
{
  ...
  ezjs_push = {
    ...
    version = "0.2";
    src = pkgs.fetchurl {
      url = "https://github.com/ocamlpro/ezjs_push/archive/0.2.tar.gz";
    ...
    opam = "${repo}/packages/ezjs_push/ezjs_push.0.2/opam";
    depends = with self; [ base64 bigstring dune ezjs_min ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  js_of_ocaml = {
    name = "js_of_ocaml";
