...
} }:
{
  ...
  cordova = {
    ...
    opam = "${repo}/packages/cordova/cordova.1.0/opam";
    depends = with self; [ gen_js_api js_of_ocaml ocaml ];
  ...
  cordova-plugin-sim-card = {
    ...
    opam = "${repo}/packages/cordova-plugin-sim-card/cordova-plugin-sim-card.1.0/opam";
    depends = with self; [ cordova gen_js_api js_of_ocaml ocaml ];
    buildDepends = with self; [ ocaml ocamlfind ];
  };
  cppo = {
    name = "cppo";
  ...
  gen_js_api = {
    ...
    opam = "${repo}/packages/gen_js_api/gen_js_api.1.1.0/opam";
  ...
  ojs = {
    ...
    opam = "${repo}/packages/ojs/ojs.1.1.0/opam";
