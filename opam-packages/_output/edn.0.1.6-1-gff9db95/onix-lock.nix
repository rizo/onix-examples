...
} }:
{
  ...
  edn = {
    ...
    src = pkgs.fetchurl {
      url = "https://github.com/prepor/ocaml-edn/releases/download/v0.1.6-1-gff9db95/edn-0.1.6-1-gff9db95.tbz";
      sha256 = "1x1iizll5xplkb0i76cvmpg6s976gi8qa61wc96m7vxma28pw1ah";
    };
    opam = "${repo}/packages/edn/edn.0.1.6-1-gff9db95/opam";
