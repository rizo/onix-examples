...
} }:
{
  ...
  bap-radare2 = {
    ...
    opam = "${repo}/packages/bap-radare2/bap-radare2.2.4.0/opam";
    depends = with self; [ bap-abi bap-arm bap-core-theory bap-future
                           bap-knowledge bap-main bap-relation bap-std bitvec
                           conf-radare2 core_kernel ocaml ogre ppx_bap re
                           yojson zarith ];
    buildDepends = with self; [ ocaml ];
  };
  bap-recipe = {
  ...
  conf-radare2 = {
    name = "conf-radare2";
    version = "0.1";
    opam = "${repo}/packages/conf-radare2/conf-radare2.0.1/opam";
    depends = with self; [ base-unix ocaml ];
    buildDepends = with self; [ conf-which ocaml ];
    depexts = with pkgs; [ (pkgs.radare2 or null) ];
  };
  conf-which = {
    name = "conf-which";
    version = "1";
