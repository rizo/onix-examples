...
} }:
{
  ...
  tezos-embedded-protocol-demo-counter = {
    ...
    opam = "${repo}/packages/tezos-embedded-protocol-demo-counter/tezos-embedded-protocol-demo-counter.9.7/opam";
    depends = with self; [ dune tezos-protocol-demo-counter
