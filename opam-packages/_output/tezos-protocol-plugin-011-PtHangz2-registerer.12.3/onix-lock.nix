...
} }:
{
  ...
  tezos-embedded-protocol-011-PtHangz2 = {
    name = "tezos-embedded-protocol-011-PtHangz2";
    version = "12.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v12.3/tezos-v12.3.tar.bz2";
      sha256 = "296bb5674bc6050afe6330326fbdd0dfc2255d414bfd6b79cc7666ac6b39316d";
    };
    opam = "${repo}/packages/tezos-embedded-protocol-011-PtHangz2/tezos-embedded-protocol-011-PtHangz2.12.3/opam";
  ...
  tezos-protocol-plugin-011-PtHangz2-registerer = {
    name = "tezos-protocol-plugin-011-PtHangz2-registerer";
    version = "12.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v12.3/tezos-v12.3.tar.bz2";
      sha256 = "296bb5674bc6050afe6330326fbdd0dfc2255d414bfd6b79cc7666ac6b39316d";
    };
    opam = "${repo}/packages/tezos-protocol-plugin-011-PtHangz2-registerer/tezos-protocol-plugin-011-PtHangz2-registerer.12.3/opam";
    depends = with self; [ dune tezos-embedded-protocol-011-PtHangz2
                           tezos-protocol-plugin-011-PtHangz2 tezos-shell ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-updater = {
