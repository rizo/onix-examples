...
} }:
{
  ...
  qcstm = {
    ...
    version = "0.1.1";
    src = pkgs.fetchurl {
      url = "https://github.com/jmid/qcstm/archive/0.1.1.tar.gz";
      sha256 = "1a6a29hvpygszbgfkcq0vc4b7lxbqj3fpzz8qd3gy4km355r8d5n";
    };
    opam = "${repo}/packages/qcstm/qcstm.0.1.1/opam";
    depends = with self; [ ocaml qcheck ];
