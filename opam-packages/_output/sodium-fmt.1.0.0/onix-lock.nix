...
} }:
{
  ...
  sodium-fmt = {
    ...
    version = "1.0.0";
    src = pkgs.fetchurl {
      url = "https://git.sr.ht/~schube/sodium-fmt/archive/1.0.0.tar.gz";
    ...
    opam = "${repo}/packages/sodium-fmt/sodium-fmt.1.0.0/opam";
    depends = with self; [ base64 dune fmt ocaml sodium ];
    buildDepends = with self; [ dune ocaml ];
  };
  stdlib-shims = {
    name = "stdlib-shims";
