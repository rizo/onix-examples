...
} }:
{
  ...
  conduit = {
    ...
    opam = "${repo}/packages/conduit/conduit.2.3.0/opam";
  ...
  conduit-lwt = {
    ...
    opam = "${repo}/packages/conduit-lwt/conduit-lwt.2.3.0/opam";
  ...
  conduit-lwt-unix = {
    ...
    opam = "${repo}/packages/conduit-lwt-unix/conduit-lwt-unix.2.3.0/opam";
  ...
  resto-cohttp = {
    ...
    opam = "${repo}/packages/resto-cohttp/resto-cohttp.0.5/opam";
  ...
  resto-cohttp-client = {
    ...
    opam = "${repo}/packages/resto-cohttp-client/resto-cohttp-client.0.5/opam";
  ...
  tezos-baking-007-PsDELPH1 = {
    name = "tezos-baking-007-PsDELPH1";
    version = "8.3";
    src = pkgs.fetchurl {
    ...
    opam = "${repo}/packages/tezos-baking-007-PsDELPH1/tezos-baking-007-PsDELPH1.8.3/opam";
  ...
  tezos-baking-007-PsDELPH1-commands = {
    name = "tezos-baking-007-PsDELPH1-commands";
    version = "8.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v8.3/tezos-v8.3.tar.bz2";
      sha256 = "e3876bf4b877522a31dd8f27a7ec23dc2abba4ed6cd05800126d16a1497189f3";
    };
    opam = "${repo}/packages/tezos-baking-007-PsDELPH1-commands/tezos-baking-007-PsDELPH1-commands.8.3/opam";
    depends = with self; [ dune tezos-baking-007-PsDELPH1 ];
    buildDepends = with self; [ dune ];
  };
  tezos-base = {
    name = "tezos-base";
    ...
    opam = "${repo}/packages/tezos-base/tezos-base.8.3/opam";
  ...
  tezos-clic = {
    ...
    opam = "${repo}/packages/tezos-clic/tezos-clic.8.3/opam";
  ...
  tezos-client-007-PsDELPH1 = {
    ...
    opam = "${repo}/packages/tezos-client-007-PsDELPH1/tezos-client-007-PsDELPH1.8.3/opam";
  ...
  tezos-client-base = {
    ...
    opam = "${repo}/packages/tezos-client-base/tezos-client-base.8.3/opam";
  ...
  tezos-client-base-unix = {
    ...
    opam = "${repo}/packages/tezos-client-base-unix/tezos-client-base-unix.8.3/opam";
    depends = with self; [ dune tezos-mockup-commands tezos-signer-backends ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-commands = {
    ...
    opam = "${repo}/packages/tezos-client-commands/tezos-client-commands.8.3/opam";
  ...
  tezos-crypto = {
    ...
    opam = "${repo}/packages/tezos-crypto/tezos-crypto.8.3/opam";
  ...
  tezos-embedded-protocol-007-PsDELPH1 = {
    ...
    opam = "${repo}/packages/tezos-embedded-protocol-007-PsDELPH1/tezos-embedded-protocol-007-PsDELPH1.8.3/opam";
    depends = with self; [ dune tezos-protocol-007-PsDELPH1
                           tezos-protocol-updater ];
    buildDepends = with self; [ dune ];
  };
  tezos-endorser-007-PsDELPH1 = {
    name = "tezos-endorser-007-PsDELPH1";
    version = "8.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v8.3/tezos-v8.3.tar.bz2";
      sha256 = "e3876bf4b877522a31dd8f27a7ec23dc2abba4ed6cd05800126d16a1497189f3";
    };
    opam = "${repo}/packages/tezos-endorser-007-PsDELPH1/tezos-endorser-007-PsDELPH1.8.3/opam";
    depends = with self; [ dune tezos-baking-007-PsDELPH1-commands
                           tezos-client-base-unix ];
    buildDepends = with self; [ dune ];
  };
  tezos-error-monad = {
    ...
    opam = "${repo}/packages/tezos-error-monad/tezos-error-monad.8.3/opam";
  ...
  tezos-event-logging = {
    ...
    opam = "${repo}/packages/tezos-event-logging/tezos-event-logging.8.3/opam";
  ...
  tezos-lwt-result-stdlib = {
    ...
    opam = "${repo}/packages/tezos-lwt-result-stdlib/tezos-lwt-result-stdlib.8.3/opam";
  ...
  tezos-micheline = {
    ...
    opam = "${repo}/packages/tezos-micheline/tezos-micheline.8.3/opam";
  ...
  tezos-mockup = {
    ...
    opam = "${repo}/packages/tezos-mockup/tezos-mockup.8.3/opam";
    depends = with self; [ dune tezos-mockup-registration tezos-p2p ];
    buildDepends = with self; [ dune ];
  };
  tezos-mockup-commands = {
    ...
    opam = "${repo}/packages/tezos-mockup-commands/tezos-mockup-commands.8.3/opam";
  ...
  tezos-mockup-registration = {
    ...
    opam = "${repo}/packages/tezos-mockup-registration/tezos-mockup-registration.8.3/opam";
  ...
  tezos-p2p = {
    ...
    opam = "${repo}/packages/tezos-p2p/tezos-p2p.8.3/opam";
  ...
  tezos-p2p-services = {
    ...
    opam = "${repo}/packages/tezos-p2p-services/tezos-p2p-services.8.3/opam";
  ...
  tezos-protocol-007-PsDELPH1 = {
    ...
    opam = "${repo}/packages/tezos-protocol-007-PsDELPH1/tezos-protocol-007-PsDELPH1.8.3/opam";
    depends = with self; [ dune tezos-protocol-compiler ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-007-PsDELPH1-parameters = {
    name = "tezos-protocol-007-PsDELPH1-parameters";
    version = "8.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v8.3/tezos-v8.3.tar.bz2";
      sha256 = "e3876bf4b877522a31dd8f27a7ec23dc2abba4ed6cd05800126d16a1497189f3";
    };
    opam = "${repo}/packages/tezos-protocol-007-PsDELPH1-parameters/tezos-protocol-007-PsDELPH1-parameters.8.3/opam";
    depends = with self; [ dune tezos-protocol-007-PsDELPH1 ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-compiler = {
    ...
    opam = "${repo}/packages/tezos-protocol-compiler/tezos-protocol-compiler.8.3/opam";
  ...
  tezos-protocol-environment = {
    ...
    opam = "${repo}/packages/tezos-protocol-environment/tezos-protocol-environment.8.3/opam";
  ...
  tezos-protocol-environment-packer = {
    ...
    opam = "${repo}/packages/tezos-protocol-environment-packer/tezos-protocol-environment-packer.8.3/opam";
    depends = with self; [ dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  tezos-protocol-environment-sigs = {
    ...
    opam = "${repo}/packages/tezos-protocol-environment-sigs/tezos-protocol-environment-sigs.8.3/opam";
  ...
  tezos-protocol-environment-structs = {
    ...
    opam = "${repo}/packages/tezos-protocol-environment-structs/tezos-protocol-environment-structs.8.3/opam";
  ...
  tezos-protocol-plugin-007-PsDELPH1 = {
    ...
    opam = "${repo}/packages/tezos-protocol-plugin-007-PsDELPH1/tezos-protocol-plugin-007-PsDELPH1.8.3/opam";
  ...
  tezos-protocol-updater = {
    ...
    opam = "${repo}/packages/tezos-protocol-updater/tezos-protocol-updater.8.3/opam";
  ...
  tezos-requester = {
    ...
    opam = "${repo}/packages/tezos-requester/tezos-requester.8.3/opam";
  ...
  tezos-rpc = {
    ...
    opam = "${repo}/packages/tezos-rpc/tezos-rpc.8.3/opam";
  ...
  tezos-rpc-http = {
    ...
    opam = "${repo}/packages/tezos-rpc-http/tezos-rpc-http.8.3/opam";
  ...
  tezos-rpc-http-client = {
    ...
    opam = "${repo}/packages/tezos-rpc-http-client/tezos-rpc-http-client.8.3/opam";
  ...
  tezos-rpc-http-client-unix = {
    ...
    opam = "${repo}/packages/tezos-rpc-http-client-unix/tezos-rpc-http-client-unix.8.3/opam";
  ...
  tezos-sapling = {
    ...
    opam = "${repo}/packages/tezos-sapling/tezos-sapling.8.3/opam";
    depends = with self; [ dune tezos-crypto ];
    buildDepends = with self; [ dune ];
  };
  tezos-shell = {
    ...
    opam = "${repo}/packages/tezos-shell/tezos-shell.8.3/opam";
  ...
  tezos-shell-context = {
    ...
    opam = "${repo}/packages/tezos-shell-context/tezos-shell-context.8.3/opam";
  ...
  tezos-shell-services = {
    ...
    opam = "${repo}/packages/tezos-shell-services/tezos-shell-services.8.3/opam";
  ...
  tezos-signer-backends = {
    ...
    opam = "${repo}/packages/tezos-signer-backends/tezos-signer-backends.8.3/opam";
  ...
  tezos-signer-services = {
    ...
    opam = "${repo}/packages/tezos-signer-services/tezos-signer-services.8.3/opam";
  ...
  tezos-stdlib = {
    ...
    opam = "${repo}/packages/tezos-stdlib/tezos-stdlib.8.3/opam";
  ...
  tezos-stdlib-unix = {
    ...
    opam = "${repo}/packages/tezos-stdlib-unix/tezos-stdlib-unix.8.3/opam";
  ...
  tezos-storage = {
    ...
    opam = "${repo}/packages/tezos-storage/tezos-storage.8.3/opam";
  ...
  tezos-validation = {
    ...
    opam = "${repo}/packages/tezos-validation/tezos-validation.8.3/opam";
  ...
  tezos-version = {
    ...
    opam = "${repo}/packages/tezos-version/tezos-version.8.3/opam";
    depends = with self; [ dune tezos-base ];
    buildDepends = with self; [ dune ];
  };
  tezos-workers = {
    ...
    opam = "${repo}/packages/tezos-workers/tezos-workers.8.3/opam";
    depends = with self; [ dune tezos-base ];
    buildDepends = with self; [ dune ];
  };
  topkg = {
