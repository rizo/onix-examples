...
} }:
{
  ...
  tezos-client-alpha = {
    ...
    opam = "${repo}/packages/tezos-client-alpha/tezos-client-alpha.9.7/opam";
  ...
  tezos-client-alpha-commands = {
    ...
    opam = "${repo}/packages/tezos-client-alpha-commands/tezos-client-alpha-commands.9.7/opam";
    depends = with self; [ dune tezos-client-alpha tezos-client-base-unix ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-alpha-commands-registration = {
    ...
    opam = "${repo}/packages/tezos-client-alpha-commands-registration/tezos-client-alpha-commands-registration.9.7/opam";
    depends = with self; [ dune tezos-client-sapling-alpha ];
    buildDepends = with self; [ dune ];
  };
  tezos-client-base = {
  ...
  tezos-client-sapling-alpha = {
    ...
    opam = "${repo}/packages/tezos-client-sapling-alpha/tezos-client-sapling-alpha.9.7/opam";
    depends = with self; [ dune tezos-client-alpha-commands ];
    buildDepends = with self; [ dune ];
  };
  tezos-crypto = {
    name = "tezos-crypto";
  ...
  tezos-protocol-alpha = {
    ...
    opam = "${repo}/packages/tezos-protocol-alpha/tezos-protocol-alpha.9.7/opam";
  ...
  tezos-protocol-alpha-parameters = {
    ...
    opam = "${repo}/packages/tezos-protocol-alpha-parameters/tezos-protocol-alpha-parameters.9.7/opam";
  ...
  tezos-protocol-plugin-alpha = {
    ...
    opam = "${repo}/packages/tezos-protocol-plugin-alpha/tezos-protocol-plugin-alpha.9.7/opam";
    depends = with self; [ dune tezos-protocol-alpha ];
    buildDepends = with self; [ dune ];
  };
  tezos-proxy = {
