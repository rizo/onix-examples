...
} }:
{
  angstrom = {
    ...
    opam = "${repo}/packages/angstrom/angstrom.0.6.0/opam";
    depends = with self; [ cstruct jbuilder ocaml ocplib-endian result ];
  ...
  nosetup = {
    ...
    opam = "${repo}/packages/nosetup/nosetup.0.8.1/opam";
    depends = with self; [ angstrom containers ocaml ocamlfind ];
