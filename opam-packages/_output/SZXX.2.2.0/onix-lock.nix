...
} }:
{
  ...
  SZXX = {
    ...
    version = "2.2.0";
    src = pkgs.fetchurl {
      url = "https://github.com/asemio/SZXX/archive/v2.2.0.tar.gz";
    ...
    opam = "${repo}/packages/SZXX/SZXX.2.2.0/opam";
    depends = with self; [ angstrom core_kernel decompress dune lwt ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  seq = {
    name = "seq";
