...
} }:
{
  ...
  tezos-accuser-alpha = {
    ...
    opam = "${repo}/packages/tezos-accuser-alpha/tezos-accuser-alpha.12.3/opam";
  ...
  tezos-baking-alpha = {
    ...
    opam = "${repo}/packages/tezos-baking-alpha/tezos-baking-alpha.12.3/opam";
  ...
  tezos-baking-alpha-commands = {
    ...
    opam = "${repo}/packages/tezos-baking-alpha-commands/tezos-baking-alpha-commands.12.3/opam";
  ...
  tezos-client-alpha = {
    ...
    opam = "${repo}/packages/tezos-client-alpha/tezos-client-alpha.12.3/opam";
  ...
  tezos-protocol-alpha = {
    ...
    opam = "${repo}/packages/tezos-protocol-alpha/tezos-protocol-alpha.12.3/opam";
  ...
  tezos-protocol-alpha-parameters = {
    ...
    opam = "${repo}/packages/tezos-protocol-alpha-parameters/tezos-protocol-alpha-parameters.12.3/opam";
  ...
  tezos-protocol-plugin-alpha = {
    ...
    opam = "${repo}/packages/tezos-protocol-plugin-alpha/tezos-protocol-plugin-alpha.12.3/opam";
    depends = with self; [ dune tezos-protocol-alpha ];
    buildDepends = with self; [ dune ];
  };
  tezos-proxy = {
