...
} }:
{
  angstrom = {
    ...
    version = "0.10.0";
    src = pkgs.fetchurl {
      url = "https://github.com/inhabitedtype/angstrom/archive/0.10.0.tar.gz";
      sha256 = "0l6gr7hqjmfbhc0y34h6v9sm1qq9zbba9w5ccmk9qbca7r488cyp";
    };
    opam = "${repo}/packages/angstrom/angstrom.0.10.0/opam";
    depends = with self; [ bigstringaf jbuilder ocaml result ];
  ...
  angstrom-unix = {
    ...
    opam = "${repo}/packages/angstrom-unix/angstrom-unix.0.9.0/opam";
    depends = with self; [ angstrom base-unix jbuilder ocaml ];
    buildDepends = with self; [ ocaml ];
  };
  base-threads = {
    name = "base-threads";
