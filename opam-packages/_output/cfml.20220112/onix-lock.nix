...
} }:
{
  ...
  cfml = {
    ...
    version = "20220112";
    src = pkgs.fetchurl {
      url = "https://gitlab.inria.fr/charguer/cfml2/-/archive/20220112/archive.tar.gz";
    ...
    opam = "${repo}/packages/cfml/cfml.20220112/opam";
    depends = with self; [ dune menhir ocaml pprint ];
