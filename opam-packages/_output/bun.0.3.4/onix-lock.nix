...
} }:
{
  afl = {
    ...
    opam = "${repo}/packages/afl/afl.2.52b/opam";
  ...
  bun = {
    ...
    version = "0.3.4";
    src = pkgs.fetchurl {
      url = "https://github.com/ocurrent/bun/releases/download/v0.3.4/bun-v0.3.4.tbz";
      sha256 = "95345fb1f8e0458579968fe5223dfa1e0c34582c2d48283fb7fbfd4c339ea5b6";
    };
    opam = "${repo}/packages/bun/bun.0.3.4/opam";
    depends = with self; [ afl astring bos cmdliner dune fmt fpath logs lwt
                           ocaml rresult ];
    buildDepends = with self; [ dune ocaml ];
  };
  cmdliner = {
