...
} }:
{
  alonzo = {
    ...
    version = "0.4.0";
    src = pkgs.fetchurl {
      url = "https://github.com/groupoid/alonzo/archive/refs/tags/0.4.0.tar.gz";
      sha512 = "2e105bb1c177f7395cf12c509b9d80351851c4bc7487c7aa51cbd435f9a8522f8c057666970939ba22e7b905cadfa9f2c0a96cc531bd7e719465c4b0fee02be5";
    };
    opam = "${repo}/packages/alonzo/alonzo.0.4.0/opam";
