...
} }:
{
  ...
  cohttp_static_handler = {
    name = "cohttp_static_handler";
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/cohttp_static_handler-v0.15.0.tar.gz";
      sha256 = "176f172b470c48d9ea813aad4fa2fad52ceb077163dc1ca19771b39e3f175e7d";
    };
    opam = "${repo}/packages/cohttp_static_handler/cohttp_static_handler.v0.15.0/opam";
    depends = with self; [ cohttp-async dune ocaml ppx_jane uri-sexp ];
    buildDepends = with self; [ dune ocaml ];
  };
  conduit = {
    name = "conduit";
  ...
  expect_test_helpers_async = {
    name = "expect_test_helpers_async";
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/expect_test_helpers_async-v0.15.0.tar.gz";
      sha256 = "76bc302c23a0436133f8591484a3e759aa1304acfeab3b5375f0855bd5903ae8";
    };
    opam = "${repo}/packages/expect_test_helpers_async/expect_test_helpers_async.v0.15.0/opam";
    depends = with self; [ async core core_unix dune expect_test_helpers_core
                           ocaml ppx_jane sexp_pretty ];
    buildDepends = with self; [ dune ocaml ];
  };
  ...
  magic-trace = {
    ...
    version = "1.0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/janestreet/magic-trace/archive/refs/tags/v1.0.1.tar.gz";
      sha256 = "77b2e4b3bc769910656d0fdee4839250548aa49486fd3554f6c057f1d64abe99";
    };
    opam = "${repo}/packages/magic-trace/magic-trace.1.0.1/opam";
    depends = with self; [ async cohttp cohttp_static_handler core core_unix
                           dune expect_test_helpers_async ocaml owee ppx_jane
                           re shell ];
    buildDepends = with self; [ dune ocaml ];
  };
  num = {
  ...
  shell = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/shell-v0.15.0.tar.gz";
      sha256 = "7b992e214e6ecdbffb1d3726ac649558f2799957da12db145e1bbd08688db2d0";
    };
    opam = "${repo}/packages/shell/shell.v0.15.0/opam";
    depends = with self; [ core core_unix dune jst-config ocaml ppx_jane
                           spawn textutils ];
    buildDepends = with self; [ dune ocaml ];
    depexts = with pkgs; [ (pkgs.linux-headers or null) ];
  };
