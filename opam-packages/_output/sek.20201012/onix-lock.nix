...
} }:
{
  ...
  sek = {
    ...
    version = "20201012";
    src = pkgs.fetchurl {
      url = "https://gitlab.inria.fr/fpottier/sek/-/archive/20201012/archive.tar.gz";
    ...
    opam = "${repo}/packages/sek/sek.20201012/opam";
    depends = with self; [ cppo dune ocaml pprint seq ];
