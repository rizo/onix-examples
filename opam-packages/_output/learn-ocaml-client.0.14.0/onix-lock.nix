...
} }:
{
  ...
  learn-ocaml-client = {
    ...
    opam = "${repo}/packages/learn-ocaml-client/learn-ocaml-client.0.14.0/opam";
    depends = with self; [ asak base base64 cmdliner cohttp cohttp-lwt-unix
                           cstruct digestif dune ezjsonm gg ipaddr lwt
                           lwt_ssl ocaml ocaml-migrate-parsetree
                           ocp-indent-nlfork ocp-ocamlres ocplib-json-typed
                           omd ppx_fields_conv ppx_sexp_conv ppx_tools ppxlib
                           ssl vg ];
