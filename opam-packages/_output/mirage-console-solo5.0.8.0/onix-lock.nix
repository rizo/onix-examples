...
} }:
{
  ...
  mirage-console-solo5 = {
    ...
    version = "0.8.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/mirage-console-solo5/releases/download/v0.8.0/mirage-console-solo5-0.8.0.tbz";
      sha256 = "dab4cafc90e4476c8a569f5ebdc48ba8c93fe0d6e505589d7e80aac4fae86415";
    };
    opam = "${repo}/packages/mirage-console-solo5/mirage-console-solo5.0.8.0/opam";
    depends = with self; [ cstruct dune lwt mirage-console mirage-solo5 ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  mirage-flow = {
    name = "mirage-flow";
