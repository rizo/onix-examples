...
} }:
{
  ...
  cohttp-lwt-jsoo = {
    ...
    opam = "${repo}/packages/cohttp-lwt-jsoo/cohttp-lwt-jsoo.5.0.0/opam";
    depends = with self; [ cohttp cohttp-lwt dune js_of_ocaml js_of_ocaml-lwt
                           js_of_ocaml-ppx logs lwt ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  conf-pkg-config = {
  ...
  gitlab = {
    ...
    version = "0.1.3";
    src = pkgs.fetchurl {
      url = "https://github.com/tmcgilchrist/ocaml-gitlab/releases/download/0.1.3/lab-0.1.3.tbz";
      sha256 = "4b6107f10cbe34638378946f4a475ac5d7d66f88fc26046203a22c532f426002";
    };
    opam = "${repo}/packages/gitlab/gitlab.0.1.3/opam";
    depends = with self; [ atdgen cohttp-lwt dune ezjsonm ISO8601 ocaml
  ...
  gitlab-jsoo = {
    ...
    opam = "${repo}/packages/gitlab-jsoo/gitlab-jsoo.0.1.3/opam";
    depends = with self; [ cohttp cohttp-lwt-jsoo dune gitlab js_of_ocaml-lwt
                           ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  hex = {
