...
} }:
{
  ...
  cmdliner = {
    ...
    opam = "${repo}/packages/cmdliner/cmdliner.0.9.4/opam";
    depends = with self; [ ocaml ocamlfind ];
  ...
  mirage = {
    ...
    opam = "${repo}/packages/mirage/mirage.2.6.1/opam";
    depends = with self; [ cmdliner ipaddr lwt mirage-types mirage-types-lwt
                           ocaml ];
  ...
  mirage-seal = {
    ...
    opam = "${repo}/packages/mirage-seal/mirage-seal.0.4.2/opam";
    depends = with self; [ cmdliner crunch dolog ocaml ];
    buildDepends = with self; [ mirage ocaml ocamlbuild ];
  };
  mirage-types = {
    name = "mirage-types";
    version = "2.8.0";
    ...
    opam = "${repo}/packages/mirage-types/mirage-types.2.8.0/opam";
    depends = with self; [ ocaml (self.cstruct or null)
                           (self.io-page or null) (self.ipaddr or null)
                           (self.lwt or null) ];
    buildDepends = with self; [ ocaml ocamlbuild ocamlfind ];
  };
  mirage-types-lwt = {
    ...
    version = "2.8.0";
    opam = "${repo}/packages/mirage-types-lwt/mirage-types-lwt.2.8.0/opam";
    depends = with self; [ cstruct io-page ipaddr lwt mirage-types ocaml
                           ocamlfind ];
    buildDepends = with self; [ ocaml ocamlfind ];
  };
  mmap = {
