...
} }:
{
  ...
  ojs_base = {
    ...
    version = "0.7.0";
    src = pkgs.fetchurl {
      url = "https://framagit.org/zoggy/ojs-base/-/archive/0.7.0/ojs-base-0.7.0.tar.bz2";
    ...
    opam = "${repo}/packages/ojs_base/ojs_base.0.7.0/opam";
    depends = with self; [ dune js_of_ocaml js_of_ocaml-ppx lwt lwt_ppx ocaml
                           ppx_deriving_yojson websocket websocket-lwt-unix
                           xtmpl xtmpl_ppx yojson ];
    buildDepends = with self; [ dune ocaml ];
  };
  ojs_base_all = {
    name = "ojs_base_all";
    ...
    opam = "${repo}/packages/ojs_base_all/ojs_base_all.0.7.0/opam";
    depends = with self; [ dune ojs_base ojs_ed ojs_filetree ojs_list ];
    buildDepends = with self; [ dune ];
  };
  ojs_base_ppx = {
    name = "ojs_base_ppx";
    ...
    opam = "${repo}/packages/ojs_base_ppx/ojs_base_ppx.0.7.0/opam";
    depends = with self; [ dune ocaml ojs_base ppxlib ];
    buildDepends = with self; [ dune ocaml ];
  };
  ojs_ed = {
    name = "ojs_ed";
    ...
    opam = "${repo}/packages/ojs_ed/ojs_ed.0.7.0/opam";
    depends = with self; [ dune ojs_base ];
    buildDepends = with self; [ dune ];
  };
  ojs_filetree = {
    name = "ojs_filetree";
    ...
    opam = "${repo}/packages/ojs_filetree/ojs_filetree.0.7.0/opam";
    depends = with self; [ base64 dune magic-mime ojs_base ];
    buildDepends = with self; [ dune ];
  };
  ojs_list = {
    name = "ojs_list";
    ...
    opam = "${repo}/packages/ojs_list/ojs_list.0.7.0/opam";
    depends = with self; [ dune ojs_base ];
    buildDepends = with self; [ dune ];
  };
  omd = {
  ...
  stog_all = {
    ...
    opam = "${repo}/packages/stog_all/stog_all.0.20.0/opam";
    depends = with self; [ dune stog stog_plugins stog_server
                           stog_server_multi ];
    buildDepends = with self; [ dune ];
  };
  stog_asy = {
    ...
    opam = "${repo}/packages/stog_asy/stog_asy.0.20.0/opam";
  ...
  stog_dot = {
    ...
    opam = "${repo}/packages/stog_dot/stog_dot.0.20.0/opam";
    depends = with self; [ dune stog ];
    buildDepends = with self; [ dune ];
  };
  stog_extern = {
    ...
    opam = "${repo}/packages/stog_extern/stog_extern.0.20.0/opam";
    depends = with self; [ dune stog ];
    buildDepends = with self; [ dune ];
  };
  stog_markdown = {
    ...
    opam = "${repo}/packages/stog_markdown/stog_markdown.0.20.0/opam";
    depends = with self; [ dune omd stog ];
    buildDepends = with self; [ dune ];
  };
  stog_multi_doc = {
    name = "stog_multi_doc";
    ...
    opam = "${repo}/packages/stog_multi_doc/stog_multi_doc.0.20.0/opam";
    depends = with self; [ dune stog ];
    buildDepends = with self; [ dune ];
  };
  stog_nocaml = {
  ...
  stog_noexec = {
    ...
    opam = "${repo}/packages/stog_noexec/stog_noexec.0.20.0/opam";
    depends = with self; [ dune stog ];
    buildDepends = with self; [ dune ];
  };
  stog_plugins = {
    ...
    opam = "${repo}/packages/stog_plugins/stog_plugins.0.20.0/opam";
    depends = with self; [ dune stog_asy stog_dot stog_extern stog_markdown
                           stog_multi_doc stog_nocaml stog_noexec
                           stog_rel_href stog_sitemap stog_writing
                           (self.stog_rdf or null) ];
    buildDepends = with self; [ dune ];
  };
  stog_rel_href = {
    name = "stog_rel_href";
    ...
    opam = "${repo}/packages/stog_rel_href/stog_rel_href.0.20.0/opam";
    depends = with self; [ dune stog ];
    buildDepends = with self; [ dune ];
  };
  stog_server = {
    ...
    opam = "${repo}/packages/stog_server/stog_server.0.20.0/opam";
    depends = with self; [ cryptokit dune ojs_base_all ppx_deriving_yojson
                           stog websocket xmldiff xmldiff_js xtmpl_js ];
    buildDepends = with self; [ dune ];
  };
  stog_server_multi = {
    ...
    opam = "${repo}/packages/stog_server_multi/stog_server_multi.0.20.0/opam";
    depends = with self; [ dune ojs_base_ppx stog stog_server ];
    buildDepends = with self; [ dune ];
  };
  stog_sitemap = {
    name = "stog_sitemap";
    ...
    opam = "${repo}/packages/stog_sitemap/stog_sitemap.0.20.0/opam";
    depends = with self; [ dune stog ];
    buildDepends = with self; [ dune ];
  };
  stog_writing = {
    ...
    opam = "${repo}/packages/stog_writing/stog_writing.0.20.0/opam";
    depends = with self; [ dune stog ];
    buildDepends = with self; [ dune ];
  };
  stringext = {
  ...
  websocket = {
    ...
    version = "2.15";
    src = pkgs.fetchurl {
      url = "https://github.com/vbmithr/ocaml-websocket/releases/download/2.15/websocket-lwt-unix-2.15.tbz";
      sha256 = "7ba435572227093515e60fa58c395735750d16d0ca866a7dbc0986d2f67f55bc";
    };
    opam = "${repo}/packages/websocket/websocket.2.15/opam";
    depends = with self; [ astring base64 cohttp conduit dune ocaml
                           ocplib-endian ];
    buildDepends = with self; [ dune ocaml ];
  };
  websocket-lwt-unix = {
    ...
    opam = "${repo}/packages/websocket-lwt-unix/websocket-lwt-unix.2.15/opam";
    depends = with self; [ cohttp-lwt-unix dune lwt_log ocaml websocket ];
    buildDepends = with self; [ dune ocaml ];
  };
  x509 = {
    name = "x509";
  ...
  xtmpl_js = {
    ...
    opam = "${repo}/packages/xtmpl_js/xtmpl_js.0.19.0/opam";
    depends = with self; [ dune js_of_ocaml js_of_ocaml-ppx xtmpl ];
    buildDepends = with self; [ dune ];
  };
  xtmpl_ppx = {
    name = "xtmpl_ppx";
