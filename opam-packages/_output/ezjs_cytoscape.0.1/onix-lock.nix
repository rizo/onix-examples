...
} }:
{
  ...
  ezjs_cytoscape = {
    ...
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/ocamlpro/ezjs_cytoscape/archive/0.1.tar.gz";
    ...
    opam = "${repo}/packages/ezjs_cytoscape/ezjs_cytoscape.0.1/opam";
    depends = with self; [ dune js_of_ocaml-ppx ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  js_of_ocaml = {
    name = "js_of_ocaml";
