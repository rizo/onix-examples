...
} }:
{
  ...
  curve-sampling = {
    ...
    version = "0.2.1";
    src = pkgs.fetchurl {
      url = "https://github.com/Chris00/ocaml-curve-sampling/releases/download/0.2.1/curve-sampling-0.2.1.tbz";
      sha256 = "3e145c7d7a087decd613ae932cb677e1725e4d28cdd84f55ebb519171ba58231";
    };
    opam = "${repo}/packages/curve-sampling/curve-sampling.0.2.1/opam";
