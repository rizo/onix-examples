...
} }:
{
  ...
  otoggl = {
    ...
    version = "0.3.2";
    src = pkgs.fetchurl {
      url = "https://github.com/unitrack-time-tracking/OToggl/releases/download/0.3.2/dev-0.3.2.tbz";
      sha256 = "22ee2dc184836891b833d6791bea35f583e24bb2ce87ae4f6e5dcbdb272dc4c9";
    };
    opam = "${repo}/packages/otoggl/otoggl.0.3.2/opam";
    depends = with self; [ atdgen-runtime base64 containers dune ocaml piaf
                           ptime ];
    buildDepends = with self; [ atdgen dune ocaml ppx_deriving ];
  };
  pecu = {
    name = "pecu";
    version = "0.6";
