...
} }:
{
  ...
  file_path = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/file_path-v0.15.0.tar.gz";
      sha256 = "4c44185450fffa919bf900db1b54f2788f6831048997df390ef3bcf58395c41c";
    };
    opam = "${repo}/packages/file_path/file_path.v0.15.0/opam";
    depends = with self; [ async core core_kernel core_unix dune
