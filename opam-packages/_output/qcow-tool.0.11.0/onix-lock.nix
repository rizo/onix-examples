...
} }:
{
  ...
  mirage-block = {
    ...
    opam = "${repo}/packages/mirage-block/mirage-block.2.0.1/opam";
    depends = with self; [ cstruct dune lwt mirage-device ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  mirage-block-combinators = {
    ...
    opam = "${repo}/packages/mirage-block-combinators/mirage-block-combinators.2.0.1/opam";
  ...
  mirage-block-unix = {
    ...
    version = "2.12.1";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/mirage-block-unix/releases/download/v2.12.1/mirage-block-unix-v2.12.1.tbz";
      sha256 = "4fc0ccea3c06c654e149c0f0e1c2a6f19be4e3fe1afd293c6a0dba1b56b3b8c4";
    };
    opam = "${repo}/packages/mirage-block-unix/mirage-block-unix.2.12.1/opam";
    depends = with self; [ cstruct cstruct-lwt dune io-page logs mirage-block
                           ocaml rresult uri ];
    buildDepends = with self; [ dune ocaml ];
  };
  mirage-device = {
  ...
  qcow = {
    ...
    version = "0.11.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/ocaml-qcow/releases/download/0.11.0/qcow-0.11.0.tbz";
      sha256 = "563a2cc10c79055b6d57111592bc6f1445397cf5ef57e74f70f5e1ca6ec23807";
    };
    opam = "${repo}/packages/qcow/qcow.0.11.0/opam";
    depends = with self; [ astring base-bytes cmdliner cstruct fmt
                           io-page-unix logs lwt mirage-block
                           mirage-block-combinators mirage-block-unix
                           mirage-time mirage-types-lwt ocaml ppx_deriving
                           ppx_sexp_conv ppx_tools prometheus result sexplib
                           sha stdlib-shims unix-type-representations ];
    buildDepends = with self; [ ocaml ppxlib ];
  };
  qcow-tool = {
    name = "qcow-tool";
    version = "0.11.0";
    ...
    opam = "${repo}/packages/qcow-tool/qcow-tool.0.11.0/opam";
    depends = with self; [ astring cmdliner cstruct fmt io-page logs lwt
                           mirage-block mirage-block-unix mirage-time
                           mirage-types-lwt ocaml qcow result sexplib sha
