...
} }:
{
  ...
  bastet_lwt = {
    ...
    version = "0.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/Risto-Stevcev/bastet-lwt/archive/0.1.0.tar.gz";
    ...
    opam = "${repo}/packages/bastet_lwt/bastet_lwt.0.1.0/opam";
    depends = with self; [ bastet dune lwt ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  bigarray-compat = {
