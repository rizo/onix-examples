...
} }:
{
  ...
  ff-sig = {
    ...
    version = "0.5.0";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/dannywillems/ocaml-ff/-/archive/0.5.0/ocaml-ff-0.5.0.tar.gz";
    ...
    opam = "${repo}/packages/ff-sig/ff-sig.0.5.0/opam";
  ...
  polynomial = {
    ...
    version = "0.3.0";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/dannywillems/ocaml-polynomial/-/archive/0.3.0/ocaml-polynomial-0.3.0.tar.gz";
    ...
    opam = "${repo}/packages/polynomial/polynomial.0.3.0/opam";
    depends = with self; [ dune ff-sig zarith ];
