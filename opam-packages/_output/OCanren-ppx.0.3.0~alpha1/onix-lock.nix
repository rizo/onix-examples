...
} }:
{
  ...
  OCanren = {
    ...
    src = pkgs.fetchurl {
      url = "https://github.com/JetBrains-Research/OCanren/archive/refs/tags/0.3.0-alpha1.tar.gz";
      sha256 = "d530d7e64c2858796c9c3b366702d2afa96097ea0815c0c7b9b185c41c0c7db9";
    };
    opam = "${repo}/packages/OCanren/OCanren.0.3.0~alpha1/opam";
    depends = with self; [ camlp5 dune dune-configurator GT logger-p5 mtime
                           ocaml ocamlfind ppx_inline_test ];
  ...
  OCanren-ppx = {
    ...
    opam = "${repo}/packages/OCanren-ppx/OCanren-ppx.0.3.0~alpha1/opam";
    depends = with self; [ base dune dune-configurator GT OCanren ocaml
                           ppx_expect ppx_inline_test ppxlib ];
    buildDepends = with self; [ dune ocaml ];
  };
  ocaml = {
    name = "ocaml";
  ...
  ppxlib = {
    ...
    opam = "${repo}/packages/ppxlib/ppxlib.0.23.0/opam";
