...
} }:
{
  ...
  mysql8 = {
    ...
    version = "1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/chrisnevers/mysql8/archive/0.11.tar.gz";
    ...
    opam = "${repo}/packages/mysql8/mysql8.1.0/opam";
    depends = with self; [ dune dune-configurator ppx_inline_test ];
    buildDepends = with self; [ conf-mysql dune ];
  };
  ocaml = {
    name = "ocaml";
    version = "4.14.0";
