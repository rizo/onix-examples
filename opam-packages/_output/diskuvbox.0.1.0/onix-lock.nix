...
} }:
{
  ...
  diskuvbox = {
    ...
    version = "0.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/diskuv/diskuvbox/archive/0.1.0.tar.gz";
    ...
    opam = "${repo}/packages/diskuvbox/diskuvbox.0.1.0/opam";
    depends = with self; [ bos cmdliner dune fmt logs mdx ocaml ppx_deriving ];
    buildDepends = with self; [ dune headache ocaml ocamlformat ];
  };
  dune = {
    name = "dune";
    version = "3.2.0";
  ...
  mdx = {
    ...
    opam = "${repo}/packages/mdx/mdx.2.1.0/opam";
    depends = with self; [ astring cmdliner csexp dune fmt logs ocaml
                           ocaml-version ocamlfind odoc-parser re result ];
