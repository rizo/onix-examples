...
} }:
{
  ...
  dream-serve = {
    ...
    opam = "${repo}/packages/dream-serve/dream-serve.1.0.0/opam";
    depends = with self; [ dream dune lambdasoup luv lwt lwt_ppx ];
  ...
  luv = {
    ...
    opam = "${repo}/packages/luv/luv.0.5.11/opam";
    depends = with self; [ ctypes dune ocaml result ];
