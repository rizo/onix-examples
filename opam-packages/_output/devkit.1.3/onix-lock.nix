...
} }:
{
  ...
  extunix = {
    ...
    version = "0.3.2";
    src = pkgs.fetchurl {
      url = "https://ygrek.org/p/release/ocaml-extunix/ocaml-extunix-0.3.2.tar.gz";
      sha256 = "3ad5c6bfef5d87273f7ba91bf14c4cebee9171439cfacdb06b294427cf034bed";
    };
    opam = "${repo}/packages/extunix/extunix.0.3.2/opam";
