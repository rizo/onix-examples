...
} }:
{
  ...
  grib = {
    ...
    opam = "${repo}/packages/grib/grib.0.9.7/opam";
    depends = with self; [ batteries ocaml ocamlfind pcre ];
    buildDepends = with self; [ ocaml ocamlbuild ocamlfind ];
    depexts = with pkgs; [ (pkgs.libgrib-api-dev or null)
                           (pkgs.libjasper-dev or null)
                           (pkgs.libjpeg-dev or null)
                           (pkgs.libopenjpeg-dev or null)
                           (pkgs.libpng-dev or null) ];
  };
  num = {
    name = "num";
    version = "1.4";
