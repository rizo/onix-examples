...
} }:
{
  ...
  clp_operations = {
    ...
    version = "0.0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/2over12/clp_operations/releases/download/0.0.1/clp_operations-0.0.1.tbz";
      sha256 = "ab3507410f32b2775a6c9392551c7bd0f5b7631a76cf37dd42067d7752d3a711";
    };
    opam = "${repo}/packages/clp_operations/clp_operations.0.0.1/opam";
    depends = with self; [ bap core_kernel dune oseq zarith ];
