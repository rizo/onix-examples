...
} }:
{
  absolute = {
    ...
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/mpelleau/AbSolute/archive/v0.1.tar.gz";
    ...
    opam = "${repo}/packages/absolute/absolute.0.1/opam";
    depends = with self; [ apron apronext dune ocaml picasso
                           (self.vpl-core or null) ];
  ...
  picasso = {
    ...
    version = "0.3.0";
    src = pkgs.fetchurl {
      url = "https://github.com/ghilesZ/picasso/archive/0.3.0.tar.gz";
    ...
    opam = "${repo}/packages/picasso/picasso.0.3.0/opam";
    depends = with self; [ apron apronext dune ocaml (self.graphics or null)
