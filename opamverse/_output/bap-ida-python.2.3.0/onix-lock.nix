...
} }:
{
  ...
  bap = {
    ...
    version = "2.3.0";
    src = pkgs.fetchurl {
      url = "https://github.com/BinaryAnalysisPlatform/bap/archive/v2.3.0.tar.gz";
      sha256 = "1smq6v81mfhvghw429c5hcffqiki3n4pi62dav5bf9mam99his56";
    };
    opam = "${repo}/packages/bap/bap.2.3.0/opam";
    depends = with self; [ bap-abi bap-analyze bap-api bap-arm bap-beagle
                           bap-beagle-strings bap-bil bap-build bap-bundle
                           bap-byteweight bap-c bap-cache
                           bap-callgraph-collator bap-callsites
                           bap-constant-tracker bap-cxxfilt bap-demangle
                           bap-dependencies bap-disassemble bap-dump-symbols
                           bap-elementary bap-elf bap-emacs-goodies
                           bap-frontc bap-frontend bap-glibc-runtime bap-llvm
                           bap-main bap-mc bap-microx bap-mips bap-objdump
                           bap-optimization bap-plugins bap-powerpc
                           bap-primus bap-primus-dictionary bap-primus-lisp
                           bap-primus-powerpc bap-primus-propagate-taint
                           bap-primus-random bap-primus-region
                           bap-primus-support bap-primus-symbolic-executor
                           bap-primus-systems bap-primus-taint
                           bap-primus-test bap-primus-x86 bap-print bap-raw
                           bap-recipe bap-recipe-command bap-relation
                           bap-relocatable bap-report bap-riscv bap-run
                           bap-specification bap-ssa bap-std bap-strings
                           bap-stub-resolver bap-symbol-reader bap-systemz
                           bap-taint bap-taint-propagator bap-term-mapper
                           bap-thumb bap-trace bap-traces
                           bap-trivial-condition-form bap-warn-unused bap-x86
                           ocaml ];
  ...
  bap-abi = {
    ...
    opam = "${repo}/packages/bap-abi/bap-abi.2.3.0/opam";
  ...
  bap-analyze = {
    ...
    opam = "${repo}/packages/bap-analyze/bap-analyze.2.3.0/opam";
  ...
  bap-api = {
    ...
    opam = "${repo}/packages/bap-api/bap-api.2.3.0/opam";
  ...
  bap-arm = {
    ...
    opam = "${repo}/packages/bap-arm/bap-arm.2.3.0/opam";
    depends = with self; [ bap-abi bap-api bap-c bap-core-theory
                           bap-knowledge bap-main bap-std bitvec bitvec-order
  ...
  bap-beagle = {
    ...
    opam = "${repo}/packages/bap-beagle/bap-beagle.2.3.0/opam";
  ...
  bap-beagle-strings = {
    ...
    opam = "${repo}/packages/bap-beagle-strings/bap-beagle-strings.2.3.0/opam";
  ...
  bap-bil = {
    ...
    opam = "${repo}/packages/bap-bil/bap-bil.2.3.0/opam";
  ...
  bap-build = {
    ...
    opam = "${repo}/packages/bap-build/bap-build.2.3.0/opam";
  ...
  bap-bundle = {
    ...
    opam = "${repo}/packages/bap-bundle/bap-bundle.2.3.0/opam";
  ...
  bap-byteweight = {
    ...
    opam = "${repo}/packages/bap-byteweight/bap-byteweight.2.3.0/opam";
  ...
  bap-c = {
    ...
    opam = "${repo}/packages/bap-c/bap-c.2.3.0/opam";
  ...
  bap-cache = {
    ...
    opam = "${repo}/packages/bap-cache/bap-cache.2.3.0/opam";
  ...
  bap-callgraph-collator = {
    ...
    opam = "${repo}/packages/bap-callgraph-collator/bap-callgraph-collator.2.3.0/opam";
  ...
  bap-callsites = {
    ...
    opam = "${repo}/packages/bap-callsites/bap-callsites.2.3.0/opam";
  ...
  bap-constant-tracker = {
    ...
    opam = "${repo}/packages/bap-constant-tracker/bap-constant-tracker.2.3.0/opam";
  ...
  bap-core-theory = {
    ...
    opam = "${repo}/packages/bap-core-theory/bap-core-theory.2.3.0/opam";
  ...
  bap-cxxfilt = {
    ...
    opam = "${repo}/packages/bap-cxxfilt/bap-cxxfilt.2.3.0/opam";
  ...
  bap-demangle = {
    ...
    opam = "${repo}/packages/bap-demangle/bap-demangle.2.3.0/opam";
  ...
  bap-dependencies = {
    ...
    opam = "${repo}/packages/bap-dependencies/bap-dependencies.2.3.0/opam";
  ...
  bap-disassemble = {
    ...
    opam = "${repo}/packages/bap-disassemble/bap-disassemble.2.3.0/opam";
  ...
  bap-dump-symbols = {
    ...
    opam = "${repo}/packages/bap-dump-symbols/bap-dump-symbols.2.3.0/opam";
  ...
  bap-dwarf = {
    ...
    opam = "${repo}/packages/bap-dwarf/bap-dwarf.2.3.0/opam";
  ...
  bap-elementary = {
    ...
    opam = "${repo}/packages/bap-elementary/bap-elementary.2.3.0/opam";
  ...
  bap-elf = {
    ...
    opam = "${repo}/packages/bap-elf/bap-elf.2.3.0/opam";
  ...
  bap-frontc = {
    ...
    opam = "${repo}/packages/bap-frontc/bap-frontc.2.3.0/opam";
  ...
  bap-frontend = {
    ...
    opam = "${repo}/packages/bap-frontend/bap-frontend.2.3.0/opam";
    depends = with self; [ bap-core-theory bap-knowledge bap-main bap-std
  ...
  bap-future = {
    ...
    opam = "${repo}/packages/bap-future/bap-future.2.3.0/opam";
  ...
  bap-glibc-runtime = {
    ...
    opam = "${repo}/packages/bap-glibc-runtime/bap-glibc-runtime.2.3.0/opam";
  ...
  bap-ida-python = {
    ...
    version = "2.3.0";
    src = pkgs.fetchurl {
      url = "https://github.com/BinaryAnalysisPlatform/bap-ida-python/archive/v2.3.0.tar.gz";
      sha256 = "0qjz6m2b70w0k757lic6iw9m69vx06l4yfd4b698xig1h9vq7sn5";
    };
    opam = "${repo}/packages/bap-ida-python/bap-ida-python.2.3.0/opam";
    depends = with self; [ bap conf-ida ocaml ];
    buildDepends = with self; [ ocaml ];
  };
  bap-knowledge = {
    name = "bap-knowledge";
    ...
    opam = "${repo}/packages/bap-knowledge/bap-knowledge.2.3.0/opam";
  ...
  bap-llvm = {
    ...
    opam = "${repo}/packages/bap-llvm/bap-llvm.2.3.0/opam";
  ...
  bap-main = {
    ...
    opam = "${repo}/packages/bap-main/bap-main.2.3.0/opam";
  ...
  bap-mc = {
    ...
    opam = "${repo}/packages/bap-mc/bap-mc.2.3.0/opam";
  ...
  bap-microx = {
    ...
    opam = "${repo}/packages/bap-microx/bap-microx.2.3.0/opam";
  ...
  bap-mips = {
    ...
    opam = "${repo}/packages/bap-mips/bap-mips.2.3.0/opam";
    depends = with self; [ bap-abi bap-api bap-c bap-core-theory
  ...
  bap-objdump = {
    ...
    opam = "${repo}/packages/bap-objdump/bap-objdump.2.3.0/opam";
  ...
  bap-optimization = {
    ...
    opam = "${repo}/packages/bap-optimization/bap-optimization.2.3.0/opam";
    depends = with self; [ bap-std core_kernel graphlib ocaml ppx_bap regular ];
    buildDepends = with self; [ ocaml ];
  };
  bap-plugins = {
    ...
    opam = "${repo}/packages/bap-plugins/bap-plugins.2.3.0/opam";
  ...
  bap-powerpc = {
    ...
    opam = "${repo}/packages/bap-powerpc/bap-powerpc.2.3.0/opam";
    depends = with self; [ bap-abi bap-api bap-c bap-core-theory
  ...
  bap-primus = {
    ...
    opam = "${repo}/packages/bap-primus/bap-primus.2.3.0/opam";
  ...
  bap-primus-dictionary = {
    ...
    opam = "${repo}/packages/bap-primus-dictionary/bap-primus-dictionary.2.3.0/opam";
  ...
  bap-primus-exploring-scheduler = {
    ...
    opam = "${repo}/packages/bap-primus-exploring-scheduler/bap-primus-exploring-scheduler.2.3.0/opam";
  ...
  bap-primus-greedy-scheduler = {
    ...
    opam = "${repo}/packages/bap-primus-greedy-scheduler/bap-primus-greedy-scheduler.2.3.0/opam";
  ...
  bap-primus-limit = {
    ...
    opam = "${repo}/packages/bap-primus-limit/bap-primus-limit.2.3.0/opam";
    depends = with self; [ bap-primus bap-std ocaml ];
    buildDepends = with self; [ ocaml ];
  };
  bap-primus-lisp = {
    ...
    opam = "${repo}/packages/bap-primus-lisp/bap-primus-lisp.2.3.0/opam";
  ...
  bap-primus-loader = {
    ...
    opam = "${repo}/packages/bap-primus-loader/bap-primus-loader.2.3.0/opam";
  ...
  bap-primus-mark-visited = {
    ...
    opam = "${repo}/packages/bap-primus-mark-visited/bap-primus-mark-visited.2.3.0/opam";
  ...
  bap-primus-powerpc = {
    ...
    opam = "${repo}/packages/bap-primus-powerpc/bap-primus-powerpc.2.3.0/opam";
  ...
  bap-primus-print = {
    ...
    opam = "${repo}/packages/bap-primus-print/bap-primus-print.2.3.0/opam";
  ...
  bap-primus-promiscuous = {
    ...
    opam = "${repo}/packages/bap-primus-promiscuous/bap-primus-promiscuous.2.3.0/opam";
    depends = with self; [ bap-primus bap-std monads ocaml ];
    buildDepends = with self; [ ocaml ];
  };
  bap-primus-propagate-taint = {
    ...
    opam = "${repo}/packages/bap-primus-propagate-taint/bap-primus-propagate-taint.2.3.0/opam";
  ...
  bap-primus-random = {
    ...
    opam = "${repo}/packages/bap-primus-random/bap-primus-random.2.3.0/opam";
  ...
  bap-primus-region = {
    ...
    opam = "${repo}/packages/bap-primus-region/bap-primus-region.2.3.0/opam";
    depends = with self; [ bap-primus bap-std ocaml ];
    buildDepends = with self; [ ocaml ];
  };
  bap-primus-round-robin-scheduler = {
    ...
    opam = "${repo}/packages/bap-primus-round-robin-scheduler/bap-primus-round-robin-scheduler.2.3.0/opam";
    depends = with self; [ bap-future bap-primus bap-std monads ocaml ];
    buildDepends = with self; [ ocaml ];
  };
  bap-primus-support = {
    ...
    opam = "${repo}/packages/bap-primus-support/bap-primus-support.2.3.0/opam";
  ...
  bap-primus-symbolic-executor = {
    ...
    opam = "${repo}/packages/bap-primus-symbolic-executor/bap-primus-symbolic-executor.2.3.0/opam";
  ...
  bap-primus-systems = {
    ...
    opam = "${repo}/packages/bap-primus-systems/bap-primus-systems.2.3.0/opam";
  ...
  bap-primus-taint = {
    ...
    opam = "${repo}/packages/bap-primus-taint/bap-primus-taint.2.3.0/opam";
  ...
  bap-primus-test = {
    ...
    opam = "${repo}/packages/bap-primus-test/bap-primus-test.2.3.0/opam";
    depends = with self; [ bap-primus bap-std ocaml ];
    buildDepends = with self; [ ocaml ];
  };
  bap-primus-track-visited = {
    ...
    opam = "${repo}/packages/bap-primus-track-visited/bap-primus-track-visited.2.3.0/opam";
    depends = with self; [ bap-primus bap-std ocaml ];
    buildDepends = with self; [ ocaml ];
  };
  bap-primus-wandering-scheduler = {
    ...
    opam = "${repo}/packages/bap-primus-wandering-scheduler/bap-primus-wandering-scheduler.2.3.0/opam";
    depends = with self; [ bap-future bap-primus bap-std monads ocaml ];
    buildDepends = with self; [ ocaml ];
  };
  bap-primus-x86 = {
    ...
    opam = "${repo}/packages/bap-primus-x86/bap-primus-x86.2.3.0/opam";
  ...
  bap-print = {
    ...
    opam = "${repo}/packages/bap-print/bap-print.2.3.0/opam";
  ...
  bap-raw = {
    ...
    opam = "${repo}/packages/bap-raw/bap-raw.2.3.0/opam";
  ...
  bap-recipe = {
    ...
    opam = "${repo}/packages/bap-recipe/bap-recipe.2.3.0/opam";
  ...
  bap-recipe-command = {
    ...
    opam = "${repo}/packages/bap-recipe-command/bap-recipe-command.2.3.0/opam";
  ...
  bap-relation = {
    ...
    opam = "${repo}/packages/bap-relation/bap-relation.2.3.0/opam";
  ...
  bap-relocatable = {
    ...
    opam = "${repo}/packages/bap-relocatable/bap-relocatable.2.3.0/opam";
  ...
  bap-report = {
    ...
    opam = "${repo}/packages/bap-report/bap-report.2.3.0/opam";
  ...
  bap-riscv = {
    ...
    opam = "${repo}/packages/bap-riscv/bap-riscv.2.3.0/opam";
    depends = with self; [ bap-abi bap-api bap-c bap-core-theory
  ...
  bap-run = {
    ...
    opam = "${repo}/packages/bap-run/bap-run.2.3.0/opam";
    depends = with self; [ bap-primus bap-std ocaml ];
    buildDepends = with self; [ ocaml ];
  };
  bap-signatures = {
    ...
    version = "2.3.0";
    src = pkgs.fetchurl {
      url = "https://github.com/BinaryAnalysisPlatform/bap/releases/download/v2.3.0/sigs.tar.gz";
      sha256 = "0vaikbkmrhlkrvav5xvly5dmpyjvy3xfs6dh20daanvmimzlphs5";
    };
    opam = "${repo}/packages/bap-signatures/bap-signatures.2.3.0/opam";
    depends = with self; [ ocaml ];
    buildDepends = with self; [ ocaml ];
  };
  bap-specification = {
    ...
    opam = "${repo}/packages/bap-specification/bap-specification.2.3.0/opam";
  ...
  bap-ssa = {
    ...
    opam = "${repo}/packages/bap-ssa/bap-ssa.2.3.0/opam";
    depends = with self; [ bap-std ocaml ];
    buildDepends = with self; [ ocaml ];
  };
  bap-std = {
    ...
    opam = "${repo}/packages/bap-std/bap-std.2.3.0/opam";
    depends = with self; [ bap-bundle bap-core-theory bap-future
                           ...
                           cmdliner core_kernel fileutils graphlib monads
                           ocaml ocamlfind ogre ppx_bap regular result uri
                           uuidm zarith ];
    buildDepends = with self; [ conf-clang conf-gmp conf-which conf-zlib
                                oasis ocaml ocamlfind utop ];
  ...
  bap-strings = {
    ...
    opam = "${repo}/packages/bap-strings/bap-strings.2.3.0/opam";
  ...
  bap-stub-resolver = {
    ...
    opam = "${repo}/packages/bap-stub-resolver/bap-stub-resolver.2.3.0/opam";
  ...
  bap-symbol-reader = {
    ...
    opam = "${repo}/packages/bap-symbol-reader/bap-symbol-reader.2.3.0/opam";
  ...
  bap-systemz = {
    ...
    opam = "${repo}/packages/bap-systemz/bap-systemz.2.3.0/opam";
    depends = with self; [ bap-core-theory bap-knowledge bap-main bap-std
  ...
  bap-taint = {
    ...
    opam = "${repo}/packages/bap-taint/bap-taint.2.3.0/opam";
  ...
  bap-taint-propagator = {
    ...
    opam = "${repo}/packages/bap-taint-propagator/bap-taint-propagator.2.3.0/opam";
  ...
  bap-term-mapper = {
    ...
    opam = "${repo}/packages/bap-term-mapper/bap-term-mapper.2.3.0/opam";
  ...
  bap-thumb = {
    ...
    opam = "${repo}/packages/bap-thumb/bap-thumb.2.3.0/opam";
  ...
  bap-trace = {
    ...
    opam = "${repo}/packages/bap-trace/bap-trace.2.3.0/opam";
  ...
  bap-traces = {
    ...
    opam = "${repo}/packages/bap-traces/bap-traces.2.3.0/opam";
  ...
  bap-trivial-condition-form = {
    ...
    opam = "${repo}/packages/bap-trivial-condition-form/bap-trivial-condition-form.2.3.0/opam";
    depends = with self; [ bap-std ocaml ];
    buildDepends = with self; [ ocaml ];
  };
  bap-warn-unused = {
    ...
    opam = "${repo}/packages/bap-warn-unused/bap-warn-unused.2.3.0/opam";
    depends = with self; [ bap-std cmdliner ocaml ];
    buildDepends = with self; [ oasis ocaml ];
  };
  bap-x86 = {
    ...
    opam = "${repo}/packages/bap-x86/bap-x86.2.3.0/opam";
  ...
  bare = {
    ...
    opam = "${repo}/packages/bare/bare.2.3.0/opam";
  ...
  bitvec = {
    ...
    opam = "${repo}/packages/bitvec/bitvec.2.3.0/opam";
  ...
  bitvec-binprot = {
    ...
    opam = "${repo}/packages/bitvec-binprot/bitvec-binprot.2.3.0/opam";
  ...
  bitvec-order = {
    ...
    opam = "${repo}/packages/bitvec-order/bitvec-order.2.3.0/opam";
  ...
  bitvec-sexp = {
    ...
    opam = "${repo}/packages/bitvec-sexp/bitvec-sexp.2.3.0/opam";
  ...
  conf-ida = {
    name = "conf-ida";
    version = "0.3";
    opam = "${repo}/packages/conf-ida/conf-ida.0.3/opam";
    depends = with self; [ base-unix ocaml ];
    buildDepends = with self; [ conf-which ocaml ];
  };
  conf-pkg-config = {
  ...
  graphlib = {
    ...
    opam = "${repo}/packages/graphlib/graphlib.2.3.0/opam";
  ...
  monads = {
    ...
    opam = "${repo}/packages/monads/monads.2.3.0/opam";
    depends = with self; [ core_kernel ocaml ppx_bap ];
    buildDepends = with self; [ oasis ocaml ];
  };
  num = {
  ...
  ogre = {
    ...
    opam = "${repo}/packages/ogre/ogre.2.3.0/opam";
    depends = with self; [ core_kernel monads ocaml ppx_bap ];
    buildDepends = with self; [ oasis ocaml ];
  };
  ounit = {
  ...
  regular = {
    ...
    opam = "${repo}/packages/regular/regular.2.3.0/opam";
    depends = with self; [ core_kernel ocaml ppx_bap ];
    buildDepends = with self; [ oasis ocaml ];
  };
  result = {
  ...
  text-tags = {
    ...
    opam = "${repo}/packages/text-tags/text-tags.2.3.0/opam";
