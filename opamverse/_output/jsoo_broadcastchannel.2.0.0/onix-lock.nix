...
} }:
{
  ...
  jsoo_broadcastchannel = {
    ...
    version = "2.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/xvw/jsoo_broadcastchannel/archive/2.0.0.tar.gz";
      sha256 = "00f5lhimjcvp3qxlra2sf98s3mnpj5fg0skl5ix7gifn4cn102wf";
    };
    opam = "${repo}/packages/jsoo_broadcastchannel/jsoo_broadcastchannel.2.0.0/opam";
