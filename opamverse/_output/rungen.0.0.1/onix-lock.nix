...
} }:
{
  ...
  rungen = {
    ...
    version = "0.0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/shakthimaan/rungen/releases/download/v0.0.1/rungen-v0.0.1.tbz";
      sha256 = "25917db3b93824f35addba416c302cc1b5dc07088dc30e9aa466e7591fa19914";
    };
    opam = "${repo}/packages/rungen/rungen.0.0.1/opam";
    depends = with self; [ dune ocaml sexplib0 yojson ];
    buildDepends = with self; [ dune ocaml ];
  };
  sexplib0 = {
    name = "sexplib0";
