...
} }:
{
  ...
  dune-action-plugin = {
    ...
    opam = "${repo}/packages/dune-action-plugin/dune-action-plugin.3.2.0/opam";
    depends = with self; [ csexp dune dune-glob dune-private-libs stdune ];
  ...
  dune-glob = {
    ...
    opam = "${repo}/packages/dune-glob/dune-glob.3.2.0/opam";
    depends = with self; [ dune dune-private-libs stdune ];
    buildDepends = with self; [ dune ];
  };
  dune-private-libs = {
