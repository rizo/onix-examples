...
} }:
{
  ...
  mirage-net-macosx = {
    ...
    version = "1.9.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/mirage-net-macosx/releases/download/v1.9.0/mirage-net-macosx-v1.9.0.tbz";
      sha256 = "931d4ed0f7fbb9481e6f4907cbb9475b0deee2fa4f2e118ef4e2513749f335e3";
    };
    opam = "${repo}/packages/mirage-net-macosx/mirage-net-macosx.1.9.0/opam";
    depends = with self; [ cstruct dune logs lwt macaddr mirage-net ocaml
                           sexplib vmnet ];
    buildDepends = with self; [ dune ocaml ];
  };
  mmap = {
  ...
  vmnet = {
    ...
    version = "1.5.1";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/ocaml-vmnet/releases/download/v1.5.1/vmnet-v1.5.1.tbz";
      sha256 = "87568fc1714fced553843a3a534e9a92f7d328068051a815e22dded0350ea04e";
    };
    opam = "${repo}/packages/vmnet/vmnet.1.5.1/opam";
    depends = with self; [ cstruct cstruct-unix dune lwt lwt-dllist macaddr
