...
} }:
{
  ...
  tezos-baking-008-PtEdoTez = {
    name = "tezos-baking-008-PtEdoTez";
    version = "8.1";
    src = pkgs.fetchurl {
    ...
    opam = "${repo}/packages/tezos-baking-008-PtEdoTez/tezos-baking-008-PtEdoTez.8.1/opam";
  ...
  tezos-baking-008-PtEdoTez-commands = {
    name = "tezos-baking-008-PtEdoTez-commands";
    version = "8.1";
    src = pkgs.fetchurl {
      url = "https://github.com/ocaml/opam-source-archives/raw/main/tezos-v8.1.tar.bz2";
      sha256 = "a86de0cc02108a4d2defb67b3774c4ba9c645280908e3695d465e194bbd9dad9";
    };
    opam = "${repo}/packages/tezos-baking-008-PtEdoTez-commands/tezos-baking-008-PtEdoTez-commands.8.1/opam";
    depends = with self; [ dune tezos-baking-008-PtEdoTez ];
    buildDepends = with self; [ dune ];
  };
  tezos-base = {
    name = "tezos-base";
  ...
  tezos-endorser-008-PtEdoTez = {
    name = "tezos-endorser-008-PtEdoTez";
    version = "8.1";
    src = pkgs.fetchurl {
      url = "https://github.com/ocaml/opam-source-archives/raw/main/tezos-v8.1.tar.bz2";
      sha256 = "a86de0cc02108a4d2defb67b3774c4ba9c645280908e3695d465e194bbd9dad9";
    };
    opam = "${repo}/packages/tezos-endorser-008-PtEdoTez/tezos-endorser-008-PtEdoTez.8.1/opam";
    depends = with self; [ dune tezos-baking-008-PtEdoTez-commands
                           tezos-client-base-unix ];
    buildDepends = with self; [ dune ];
  };
  tezos-error-monad = {
