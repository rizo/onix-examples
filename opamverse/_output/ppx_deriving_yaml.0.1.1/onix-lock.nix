...
} }:
{
  ...
  ppx_deriving_yaml = {
    ...
    version = "0.1.1";
    src = pkgs.fetchurl {
      url = "https://github.com/patricoferris/ppx_deriving_yaml/releases/download/v0.1.1/ppx_deriving_yaml-0.1.1.tbz";
      sha256 = "9d1df9ebc50b33a8da186e07e3e94b053109aa1fc02c73e2271bdee348cf531c";
    };
    opam = "${repo}/packages/ppx_deriving_yaml/ppx_deriving_yaml.0.1.1/opam";
    depends = with self; [ dune ocaml ppxlib yaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppxlib = {
    name = "ppxlib";
