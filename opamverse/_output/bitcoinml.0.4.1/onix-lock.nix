...
} }:
{
  ...
  bitcoinml = {
    ...
    version = "0.4.1";
    src = pkgs.fetchurl {
      url = "https://github.com/dakk/bitcoinml/archive/0.4.1.zip";
    ...
    opam = "${repo}/packages/bitcoinml/bitcoinml.0.4.1/opam";
    depends = with self; [ bignum bitstring cryptokit dune ocaml stdint ];
    buildDepends = with self; [ dune ocaml ];
