...
} }:
{
  ...
  crc = {
    ...
    version = "2.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/xapi-project/ocaml-crc/archive/2.1.0.tar.gz";
      sha256 = "0c55d1sbmib18wh9vwi9f8pvylpfwq3q1b1d4j9wq956zw3dhd58";
    };
    opam = "${repo}/packages/crc/crc.2.1.0/opam";
    depends = with self; [ cstruct dune ocaml ppx_deriving_rpc ppx_sexp_conv ];
    buildDepends = with self; [ dune ocaml ];
  };
  csexp = {
    name = "csexp";
