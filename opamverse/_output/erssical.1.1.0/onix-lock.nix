...
} }:
{
  ...
  erssical = {
    ...
    version = "1.1.0";
    src = pkgs.fetchurl {
      url = "https://framagit.org/zoggy/erssical/-/archive/1.1.0/erssical-1.1.0.tar.bz2";
    ...
    opam = "${repo}/packages/erssical/erssical.1.1.0/opam";
    depends = with self; [ cohttp-lwt-unix dune icalendar lru-cache lwt_ppx
                           ocaml rss xtmpl ];
    buildDepends = with self; [ dune ocaml ];
  };
  fmt = {
  ...
  icalendar = {
    ...
    version = "0.1.5";
    src = pkgs.fetchurl {
      url = "https://github.com/roburio/icalendar/releases/download/v0.1.5/icalendar-v0.1.5.tbz";
      sha256 = "934327b0c361e04e0931b48e40bea7cd3bfdabb2663b0ed06a2e04f86ff873a6";
    };
    opam = "${repo}/packages/icalendar/icalendar.0.1.5/opam";
    depends = with self; [ angstrom dune fmt gmap ocaml ppx_deriving ptime re
                           uri ];
    buildDepends = with self; [ dune ocaml ];
  };
  ipaddr = {
  ...
  lru-cache = {
    ...
    version = "0.3.0";
    src = pkgs.fetchurl {
      url = "https://framagit.org/zoggy/ocaml-lru-cache/-/archive/0.3.0/ocaml-lru-cache-0.3.0.tar.gz";
      sha256 = "14yf3fxyx71362mk2w09ynz0zygm3h2xz98jm8v3zz4vryppvi09";
    };
    opam = "${repo}/packages/lru-cache/lru-cache.0.3.0/opam";
    depends = with self; [ ocaml ocamlfind ];
    buildDepends = with self; [ ocaml ocamlfind ];
  };
  lwt = {
  ...
  rss = {
    ...
    version = "3.0";
    src = pkgs.fetchurl {
      url = "https://framagit.org/zoggy/ocamlrss/-/archive/3.0/ocamlrss-3.0.tar.bz2";
    ...
    opam = "${repo}/packages/rss/rss.3.0/opam";
    depends = with self; [ dune ocaml ptime uri xmlm ];
    buildDepends = with self; [ dune ocaml ];
  };
  sedlex = {
    name = "sedlex";
