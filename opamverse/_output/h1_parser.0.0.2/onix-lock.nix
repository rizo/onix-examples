...
} }:
{
  ...
  h1_parser = {
    ...
    version = "0.0.2";
    src = pkgs.fetchurl {
      url = "https://github.com/anuragsoni/h1/releases/download/0.0.2/h1-0.0.2.tbz";
      sha256 = "6de8da90c7442c69d3ff2d82c393804dae4e90fe3abd963a896e825669c95dfd";
    };
    opam = "${repo}/packages/h1_parser/h1_parser.0.0.2/opam";
    depends = with self; [ base_bigstring cohttp dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  int_repr = {
    name = "int_repr";
