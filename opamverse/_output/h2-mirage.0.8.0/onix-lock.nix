...
} }:
{
  ...
  gluten-mirage = {
    ...
    opam = "${repo}/packages/gluten-mirage/gluten-mirage.0.2.1/opam";
    depends = with self; [ conduit-mirage cstruct dune faraday-lwt gluten-lwt
                           lwt mirage-flow ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  gmap = {
    name = "gmap";
  ...
  h2-mirage = {
    ...
    opam = "${repo}/packages/h2-mirage/h2-mirage.0.8.0/opam";
    depends = with self; [ conduit-mirage cstruct dune faraday-lwt gluten-lwt
                           gluten-mirage h2-lwt lwt mirage-flow ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  hkdf = {
    name = "hkdf";
