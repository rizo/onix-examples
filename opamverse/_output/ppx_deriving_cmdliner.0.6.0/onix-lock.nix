...
} }:
{
  ...
  ppx_deriving_cmdliner = {
    ...
    version = "0.6.0";
    src = pkgs.fetchurl {
      url = "https://github.com/hammerlab/ppx_deriving_cmdliner/archive/refs/tags/v0.6.0.tar.gz";
      sha256 = "1p3y29wd66x64jb9q7alancc3hbxv082gn9822znrk5s641092w5";
    };
    opam = "${repo}/packages/ppx_deriving_cmdliner/ppx_deriving_cmdliner.0.6.0/opam";
    depends = with self; [ cmdliner dune ocaml ppx_deriving ppxlib result ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppxlib = {
    name = "ppxlib";
