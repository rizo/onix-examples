...
} }:
{
  ...
  dune-deps = {
    ...
    version = "1.3.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mjambon/dune-deps/archive/v1.3.0.tar.gz";
      sha256 = "1cxwi9m0ppify3ams70kddp9nx0r0il1chn9lskq92fiiaa7kygs";
    };
    opam = "${repo}/packages/dune-deps/dune-deps.1.3.0/opam";
    depends = with self; [ cmdliner dune ocaml sexplib ];
    buildDepends = with self; [ dune ocaml ];
  };
  num = {
    name = "num";
