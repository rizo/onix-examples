...
} }:
{
  ...
  oplsr = {
    ...
    version = "8.0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/UnixJunkie/oplsr/archive/v8.0.1.tar.gz";
      sha256 = "1cfbp5rbff3zq20f1nx3w8mlpjwlf0wz6fghvrmlf0fqwn6kyzfk";
    };
    opam = "${repo}/packages/oplsr/oplsr.8.0.1/opam";
