...
} }:
{
  ...
  tezos-client-genesis = {
    ...
    opam = "${repo}/packages/tezos-client-genesis/tezos-client-genesis.9.7/opam";
    depends = with self; [ dune tezos-client-commands tezos-protocol-genesis
                           tezos-proxy ];
    buildDepends = with self; [ dune ];
  };
  tezos-crypto = {
  ...
  tezos-protocol-genesis = {
    ...
    opam = "${repo}/packages/tezos-protocol-genesis/tezos-protocol-genesis.9.7/opam";
