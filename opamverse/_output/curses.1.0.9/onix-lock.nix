...
} }:
{
  ...
  curses = {
    ...
    version = "1.0.9";
    src = pkgs.fetchurl {
      url = "https://github.com/mbacarella/curses/archive/1.0.9.tar.gz";
    ...
    opam = "${repo}/packages/curses/curses.1.0.9/opam";
    depends = with self; [ conf-ncurses dune dune-configurator ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  dune = {
    name = "dune";
