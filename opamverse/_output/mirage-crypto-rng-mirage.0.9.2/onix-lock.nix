...
} }:
{
  ...
  mirage-crypto = {
    ...
    version = "0.9.2";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/mirage-crypto/releases/download/v0.9.2/mirage-crypto-v0.9.2.tbz";
      sha256 = "da200c0afdbe63474ab19f2bc616e26c10b0e4fbb53fb97fefb2794212f5d442";
    };
    opam = "${repo}/packages/mirage-crypto/mirage-crypto.0.9.2/opam";
    depends = with self; [ bigarray-compat cstruct dune dune-configurator
                           eqaf ocaml (self.ocaml-freestanding or null) ];
  ...
  mirage-crypto-rng = {
    ...
    opam = "${repo}/packages/mirage-crypto-rng/mirage-crypto-rng.0.9.2/opam";
    depends = with self; [ cstruct dune dune-configurator duration logs lwt
                           mirage-crypto mtime ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  mirage-crypto-rng-mirage = {
    name = "mirage-crypto-rng-mirage";
    version = "0.9.2";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/mirage-crypto/releases/download/v0.9.2/mirage-crypto-v0.9.2.tbz";
      sha256 = "da200c0afdbe63474ab19f2bc616e26c10b0e4fbb53fb97fefb2794212f5d442";
    };
    opam = "${repo}/packages/mirage-crypto-rng-mirage/mirage-crypto-rng-mirage.0.9.2/opam";
    depends = with self; [ cstruct dune duration logs lwt mirage-clock
                           mirage-crypto-rng mirage-runtime mirage-time ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  mirage-runtime = {
    name = "mirage-runtime";
