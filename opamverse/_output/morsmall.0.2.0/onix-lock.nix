...
} }:
{
  ...
  morbig = {
    ...
    version = "0.10.3";
    src = pkgs.fetchurl {
      url = "https://github.com/colis-anr/morbig/archive/0.10.3.tar.gz";
    ...
    opam = "${repo}/packages/morbig/morbig.0.10.3/opam";
    depends = with self; [ dune menhir ocaml ppx_deriving_yojson visitors
                           yojson ];
    buildDepends = with self; [ dune ocaml ];
  };
  morsmall = {
    ...
    version = "0.2.0";
    src = pkgs.fetchurl {
      url = "https://github.com/colis-anr/morsmall/archive/0.2.0.tar.gz";
    ...
    opam = "${repo}/packages/morsmall/morsmall.0.2.0/opam";
    depends = with self; [ dune morbig ocaml ppx_deriving ];
    buildDepends = with self; [ dune ocaml ];
  };
  ocaml = {
    name = "ocaml";
