...
} }:
{
  ...
  opencc1_1 = {
    ...
    version = "0.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/kandu/ocaml-opencc1_1/archive/refs/tags/0.1.0.tar.gz";
      sha256 = "1ynd4x4fvf73zpg1z05afiaq2laqg9gsh6a7xikdsazi16kwch25";
    };
    opam = "${repo}/packages/opencc1_1/opencc1_1.0.1.0/opam";
    depends = with self; [ conf-opencc1_1 ctypes ctypes-foreign dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  stdlib-shims = {
    name = "stdlib-shims";
