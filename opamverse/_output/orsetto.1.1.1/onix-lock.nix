...
} }:
{
  ...
  conjury = {
    ...
    version = "2.1";
    src = pkgs.fetchurl {
      url = "https://bitbucket.org/jhw/conjury/get/r2.1.tar.gz";
      sha256 = "0njs1zx2chqz3sj3lamzwl6ypr80xv54y79v9kx77skszg6yxlx2";
    };
    opam = "${repo}/packages/conjury/conjury.2.1/opam";
    depends = with self; [ base-unix ocaml ocamlfind omake ounit2 ];
    buildDepends = with self; [ ocaml ocamlfind ];
  };
  dune = {
    name = "dune";
  ...
  orsetto = {
    ...
    version = "1.1.1";
    src = pkgs.fetchurl {
      url = "https://bitbucket.org/jhw/orsetto/get/r1.1.1.tar.gz";
      sha256 = "0bwnh1ysgaik1wb0234ri9j5pgwhggfk58smr4xjc11jrs3kca41";
    };
    opam = "${repo}/packages/orsetto/orsetto.1.1.1/opam";
    depends = with self; [ ocaml ];
    buildDepends = with self; [ conjury ocaml omake uucd ];
  };
  ounit2 = {
    name = "ounit2";
    version = "2.2.6";
  ...
  uucd = {
    ...
    version = "14.0.0";
    src = pkgs.fetchurl {
      url = "https://erratique.ch/software/uucd/releases/uucd-14.0.0.tbz";
    ...
    opam = "${repo}/packages/uucd/uucd.14.0.0/opam";
    depends = with self; [ ocaml xmlm ];
