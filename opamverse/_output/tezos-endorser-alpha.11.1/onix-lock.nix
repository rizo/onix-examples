...
} }:
{
  ...
  bls12-381 = {
    ...
    version = "1.0.2";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/dannywillems/ocaml-bls12-381/-/archive/f1727556f0fb6589b5e01a9eae8ba8fda8ccd476/ocaml-bls12-381-f1727556f0fb6589b5e01a9eae8ba8fda8ccd476.tar.bz2";
    ...
    opam = "${repo}/packages/bls12-381/bls12-381.1.0.2/opam";
  ...
  bls12-381-unix = {
    ...
    opam = "${repo}/packages/bls12-381-unix/bls12-381-unix.1.0.2/opam";
    depends = with self; [ bls12-381 ctypes dune hex ocaml zarith ];
  ...
  index = {
    ...
    version = "1.5.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/index/releases/download/1.5.0/index-1.5.0.tbz";
      sha256 = "2e311cd0bad5b831ac4cebacc83d319b0bca7d5b713ef42dca2bcc064cda34e0";
    };
    opam = "${repo}/packages/index/index.1.5.0/opam";
  ...
  irmin = {
    ...
    version = "2.9.1";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/irmin/releases/download/2.9.1/irmin-2.9.1.tbz";
      sha256 = "16003a8a873737b0a8ae2a940399b14754c5c2ba506e4511b96df4473e912783";
    };
    opam = "${repo}/packages/irmin/irmin.2.9.1/opam";
  ...
  irmin-layers = {
    ...
    opam = "${repo}/packages/irmin-layers/irmin-layers.2.9.1/opam";
  ...
  irmin-pack = {
    ...
    opam = "${repo}/packages/irmin-pack/irmin-pack.2.9.1/opam";
  ...
  ppx_irmin = {
    ...
    opam = "${repo}/packages/ppx_irmin/ppx_irmin.2.9.1/opam";
  ...
  ppx_repr = {
    ...
    version = "0.5.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/repr/releases/download/0.5.0/repr-fuzz-0.5.0.tbz";
      sha256 = "2ed0e1dab950eeb551cbecc3bbc5ddb584b3b3e4b4e039ff3abf7bd6d5b238f9";
    };
    opam = "${repo}/packages/ppx_repr/ppx_repr.0.5.0/opam";
  ...
  repr = {
    ...
    opam = "${repo}/packages/repr/repr.0.5.0/opam";
  ...
  tezos-baking-alpha = {
    ...
    version = "11.1";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v11.1/tezos-v11.1.tar.bz2";
      sha256 = "31548ca8962ee9e3e55feb160776b3698ac8d94d4837f09058d3a54685aba10b";
    };
    opam = "${repo}/packages/tezos-baking-alpha/tezos-baking-alpha.11.1/opam";
    depends = with self; [ dune lwt-exit tezos-client-alpha
  ...
  tezos-baking-alpha-commands = {
    ...
    opam = "${repo}/packages/tezos-baking-alpha-commands/tezos-baking-alpha-commands.11.1/opam";
    depends = with self; [ dune tezos-baking-alpha ];
    buildDepends = with self; [ dune ];
  };
  tezos-base = {
    name = "tezos-base";
    ...
    opam = "${repo}/packages/tezos-base/tezos-base.11.1/opam";
  ...
  tezos-clic = {
    ...
    opam = "${repo}/packages/tezos-clic/tezos-clic.11.1/opam";
  ...
  tezos-client-alpha = {
    ...
    opam = "${repo}/packages/tezos-client-alpha/tezos-client-alpha.11.1/opam";
    depends = with self; [ dune ppx_inline_test tezos-mockup-registration
                           tezos-protocol-alpha-parameters
                           tezos-protocol-plugin-alpha tezos-proxy
  ...
  tezos-client-base = {
    ...
    opam = "${repo}/packages/tezos-client-base/tezos-client-base.11.1/opam";
  ...
  tezos-client-base-unix = {
    ...
    opam = "${repo}/packages/tezos-client-base-unix/tezos-client-base-unix.11.1/opam";
  ...
  tezos-client-commands = {
    ...
    opam = "${repo}/packages/tezos-client-commands/tezos-client-commands.11.1/opam";
    depends = with self; [ dune tezos-signer-backends ];
    buildDepends = with self; [ dune ];
  };
  tezos-context = {
    name = "tezos-context";
    ...
    opam = "${repo}/packages/tezos-context/tezos-context.11.1/opam";
    depends = with self; [ bigstringaf dune irmin irmin-pack tezos-base
  ...
  tezos-crypto = {
    ...
    opam = "${repo}/packages/tezos-crypto/tezos-crypto.11.1/opam";
  ...
  tezos-endorser-alpha = {
    ...
    opam = "${repo}/packages/tezos-endorser-alpha/tezos-endorser-alpha.11.1/opam";
    depends = with self; [ dune tezos-baking-alpha-commands
                           tezos-client-base-unix ];
    buildDepends = with self; [ dune ];
  };
  tezos-error-monad = {
    ...
    opam = "${repo}/packages/tezos-error-monad/tezos-error-monad.11.1/opam";
  ...
  tezos-event-logging = {
    ...
    opam = "${repo}/packages/tezos-event-logging/tezos-event-logging.11.1/opam";
  ...
  tezos-hacl-glue = {
    ...
    opam = "${repo}/packages/tezos-hacl-glue/tezos-hacl-glue.11.1/opam";
    depends = with self; [ dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  tezos-hacl-glue-unix = {
    ...
    opam = "${repo}/packages/tezos-hacl-glue-unix/tezos-hacl-glue-unix.11.1/opam";
  ...
  tezos-lwt-result-stdlib = {
    ...
    opam = "${repo}/packages/tezos-lwt-result-stdlib/tezos-lwt-result-stdlib.11.1/opam";
    depends = with self; [ dune lwt ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  tezos-micheline = {
    ...
    opam = "${repo}/packages/tezos-micheline/tezos-micheline.11.1/opam";
  ...
  tezos-mockup = {
    ...
    opam = "${repo}/packages/tezos-mockup/tezos-mockup.11.1/opam";
  ...
  tezos-mockup-commands = {
    ...
    opam = "${repo}/packages/tezos-mockup-commands/tezos-mockup-commands.11.1/opam";
  ...
  tezos-mockup-proxy = {
    ...
    opam = "${repo}/packages/tezos-mockup-proxy/tezos-mockup-proxy.11.1/opam";
  ...
  tezos-mockup-registration = {
    ...
    opam = "${repo}/packages/tezos-mockup-registration/tezos-mockup-registration.11.1/opam";
  ...
  tezos-p2p = {
    ...
    opam = "${repo}/packages/tezos-p2p/tezos-p2p.11.1/opam";
    depends = with self; [ dune lwt lwt-canceler lwt-watcher ringo
                           tezos-p2p-services ];
    buildDepends = with self; [ dune ];
  };
  tezos-p2p-services = {
    ...
    opam = "${repo}/packages/tezos-p2p-services/tezos-p2p-services.11.1/opam";
  ...
  tezos-protocol-alpha = {
    ...
    opam = "${repo}/packages/tezos-protocol-alpha/tezos-protocol-alpha.11.1/opam";
  ...
  tezos-protocol-alpha-parameters = {
    ...
    opam = "${repo}/packages/tezos-protocol-alpha-parameters/tezos-protocol-alpha-parameters.11.1/opam";
    depends = with self; [ dune tezos-protocol-alpha ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-compiler = {
    ...
    opam = "${repo}/packages/tezos-protocol-compiler/tezos-protocol-compiler.11.1/opam";
  ...
  tezos-protocol-environment = {
    ...
    opam = "${repo}/packages/tezos-protocol-environment/tezos-protocol-environment.11.1/opam";
    depends = with self; [ bls12-381 bls12-381-legacy dune tezos-base
  ...
  tezos-protocol-environment-packer = {
    ...
    opam = "${repo}/packages/tezos-protocol-environment-packer/tezos-protocol-environment-packer.11.1/opam";
    depends = with self; [ dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  tezos-protocol-environment-sigs = {
    ...
    opam = "${repo}/packages/tezos-protocol-environment-sigs/tezos-protocol-environment-sigs.11.1/opam";
  ...
  tezos-protocol-environment-structs = {
    ...
    opam = "${repo}/packages/tezos-protocol-environment-structs/tezos-protocol-environment-structs.11.1/opam";
    depends = with self; [ bls12-381-legacy dune tezos-crypto
                           tezos-protocol-environment-packer ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-plugin-alpha = {
    ...
    opam = "${repo}/packages/tezos-protocol-plugin-alpha/tezos-protocol-plugin-alpha.11.1/opam";
    depends = with self; [ dune tezos-protocol-alpha ];
    buildDepends = with self; [ dune ];
  };
  tezos-proxy = {
    ...
    opam = "${repo}/packages/tezos-proxy/tezos-proxy.11.1/opam";
  ...
  tezos-rpc = {
    ...
    opam = "${repo}/packages/tezos-rpc/tezos-rpc.11.1/opam";
  ...
  tezos-rpc-http = {
    ...
    opam = "${repo}/packages/tezos-rpc-http/tezos-rpc-http.11.1/opam";
  ...
  tezos-rpc-http-client = {
    ...
    opam = "${repo}/packages/tezos-rpc-http-client/tezos-rpc-http-client.11.1/opam";
  ...
  tezos-rpc-http-client-unix = {
    ...
    opam = "${repo}/packages/tezos-rpc-http-client-unix/tezos-rpc-http-client-unix.11.1/opam";
  ...
  tezos-sapling = {
    ...
    opam = "${repo}/packages/tezos-sapling/tezos-sapling.11.1/opam";
    depends = with self; [ ctypes ctypes-foreign dune integers tezos-crypto
                           tezos-rust-libs ];
    buildDepends = with self; [ conf-rust dune ];
  };
  tezos-shell-context = {
    ...
    opam = "${repo}/packages/tezos-shell-context/tezos-shell-context.11.1/opam";
  ...
  tezos-shell-services = {
    ...
    opam = "${repo}/packages/tezos-shell-services/tezos-shell-services.11.1/opam";
  ...
  tezos-signer-backends = {
    ...
    opam = "${repo}/packages/tezos-signer-backends/tezos-signer-backends.11.1/opam";
  ...
  tezos-signer-services = {
    ...
    opam = "${repo}/packages/tezos-signer-services/tezos-signer-services.11.1/opam";
  ...
  tezos-stdlib = {
    ...
    opam = "${repo}/packages/tezos-stdlib/tezos-stdlib.11.1/opam";
  ...
  tezos-stdlib-unix = {
    ...
    opam = "${repo}/packages/tezos-stdlib-unix/tezos-stdlib-unix.11.1/opam";
  ...
  tezos-version = {
    ...
    opam = "${repo}/packages/tezos-version/tezos-version.11.1/opam";
    depends = with self; [ dune tezos-base ];
    buildDepends = with self; [ dune ];
  };
  tezos-workers = {
    ...
    opam = "${repo}/packages/tezos-workers/tezos-workers.11.1/opam";
    depends = with self; [ dune tezos-base ];
    buildDepends = with self; [ dune ];
  };
  time_now = {
