...
} }:
{
  ...
  nice_parser = {
    ...
    version = "1.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/smolkaj/ocaml-parsing/archive/1.0.0.tar.gz";
    ...
    opam = "${repo}/packages/nice_parser/nice_parser.1.0.0/opam";
    depends = with self; [ dune ocaml stdio ];
    buildDepends = with self; [ dune ocaml ];
  };
  ocaml = {
    name = "ocaml";
