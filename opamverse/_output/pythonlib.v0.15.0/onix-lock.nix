...
} }:
{
  ...
  pythonlib = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/pythonlib-v0.15.0.tar.gz";
      sha256 = "e7f789218f633e97468555dcb0453d8c8d871061c5c680a516416844859d2a4e";
    };
    opam = "${repo}/packages/pythonlib/pythonlib.v0.15.0/opam";
    depends = with self; [ base dune ocaml ppx_expect ppx_let ppx_python pyml
                           stdio typerep ];
    buildDepends = with self; [ dune ocaml ];
  };
  re = {
