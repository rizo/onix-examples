...
} }:
{
  ...
  ppx_type_directed_value = {
    name = "ppx_type_directed_value";
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/ppx_type_directed_value-v0.15.0.tar.gz";
      sha256 = "2d72561276b7b3cc39bd60ca84b202881f0afbc7b96e93705972b2cc7ad83fbc";
    };
    opam = "${repo}/packages/ppx_type_directed_value/ppx_type_directed_value.v0.15.0/opam";
    depends = with self; [ base dune ocaml ppx_jane ppxlib ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppx_typerep_conv = {
