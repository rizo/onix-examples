...
} }:
{
  ...
  distributed = {
    ...
    version = "0.6.0";
    src = pkgs.fetchurl {
      url = "https://github.com/essdotteedot/distributed/archive/v0.6.0.tar.gz";
    ...
    opam = "${repo}/packages/distributed/distributed.0.6.0/opam";
    depends = with self; [ base-unix dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  distributed-uwt = {
    name = "distributed-uwt";
    version = "0.2.0";
    src = pkgs.fetchurl {
      url = "https://github.com/essdotteedot/distributed/archive/v0.6.0.tar.gz";
      sha512 = "d1c2bd6a5f11dab70bc74178f9fafe2a36a697313f52bf2bce7b263ac2c9e0930f367c34bcd74ebfe8c56b269f03b6f6ac7c0738ee0e81d752658a831b559c05";
    };
    opam = "${repo}/packages/distributed-uwt/distributed-uwt.0.2.0/opam";
    depends = with self; [ distributed dune logs ocaml uwt ];
    buildDepends = with self; [ dune ocaml ];
  };
  dune = {
    name = "dune";
  ...
  uwt = {
    ...
    version = "0.3.3";
    src = pkgs.fetchurl {
      url = "https://github.com/fdopen/uwt/releases/download/0.3.3/uwt-0.3.3.tar.gz";
      sha256 = "01q80vii5lxi0r2gzxk35zwqyp7i5zqdv047llsm8g51qygklrcy";
    };
    opam = "${repo}/packages/uwt/uwt.0.3.3/opam";
    depends = with self; [ base-bigarray base-bytes base-threads base-unix
                           lwt ocaml result ];
    buildDepends = with self; [ conf-pkg-config cppo ocaml ocamlfind omake ];
  };
}
