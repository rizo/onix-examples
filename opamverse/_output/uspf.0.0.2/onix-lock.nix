...
} }:
{
  ...
  uspf = {
    ...
    version = "0.0.2";
    src = pkgs.fetchurl {
      url = "https://github.com/dinosaure/uspf/releases/download/0.0.2/uspf-0.0.2.tbz";
      sha256 = "3531d7343ba9298de7edbecc88164b1ee7945016a32eed812f25407b53cff673";
    };
    opam = "${repo}/packages/uspf/uspf.0.0.2/opam";
    depends = with self; [ angstrom astring colombe dns dns-client
                           domain-name dune fmt hmap ipaddr logs lwt mrmime
                           ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  uutf = {
