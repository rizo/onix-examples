...
} }:
{
  ...
  bloomf = {
    ...
    version = "0.2.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/bloomf/releases/download/v0.2.0/bloomf-v0.2.0.tbz";
      sha256 = "16409a1221e1d05a3d6b64ec0e5b302a60b6802cc573fdc243662e2fc85bd561";
    };
    opam = "${repo}/packages/bloomf/bloomf.0.2.0/opam";
    depends = with self; [ bitv dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  dune = {
    name = "dune";
