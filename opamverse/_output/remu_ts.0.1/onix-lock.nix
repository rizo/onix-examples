...
} }:
{
  ...
  remu_ts = {
    ...
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/RemuLang/remu-type-system/archive/0.1.zip";
    ...
    opam = "${repo}/packages/remu_ts/remu_ts.0.1/opam";
    depends = with self; [ batteries dune ocaml ppx_deriving ];
    buildDepends = with self; [ dune ocaml ];
