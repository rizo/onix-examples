...
} }:
{
  ...
  conf-glpk = {
    name = "conf-glpk";
    version = "1";
    opam = "${repo}/packages/conf-glpk/conf-glpk.1/opam";
    depexts = with pkgs; [ (pkgs.epel-release or null) (pkgs.glpk or null)
                           (pkgs.glpk-dev@testing or null)
                           (pkgs.glpk-devel or null)
                           (pkgs.libglpk-dev or null) ];
  };
  ctypes = {
    name = "ctypes";
    version = "0.20.1";
  ...
  lp = {
    ...
    version = "0.4.0";
    src = pkgs.fetchurl {
      url = "https://github.com/ktahar/ocaml-lp/archive/0.4.0.tar.gz";
    ...
    opam = "${repo}/packages/lp/lp.0.4.0/opam";
  ...
  lp-glpk = {
    ...
    opam = "${repo}/packages/lp-glpk/lp-glpk.0.4.0/opam";
    depends = with self; [ conf-glpk ctypes dune lp ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  menhir = {
    name = "menhir";
