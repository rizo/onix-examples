...
} }:
{
  ...
  libsvm = {
    ...
    src = pkgs.fetchurl {
      ...
      sha256 = "1qlz7b201wmnzqjyvgzj1iz2vhad3hvbizkyswcarvh2gw9gq957";
    };
    opam = "${repo}/packages/libsvm/libsvm.0.9.4/opam";
    depends = with self; [ base conf-g++ jbuilder lacaml ocaml stdio ];
    buildDepends = with self; [ ocaml ];
  };
  ocaml = {
    name = "ocaml";
