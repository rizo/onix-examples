...
} }:
{
  ...
  posix-bindings = {
    ...
    opam = "${repo}/packages/posix-bindings/posix-bindings.2.0.0/opam";
    depends = with self; [ ctypes dune posix-base posix-getopt posix-socket
                           posix-socket-unix posix-types posix-uname ];
    buildDepends = with self; [ dune ];
  };
  posix-getopt = {
    name = "posix-getopt";
    ...
    opam = "${repo}/packages/posix-getopt/posix-getopt.2.0.0/opam";
    depends = with self; [ ctypes dune dune-configurator posix-base
                           unix-errno ];
    buildDepends = with self; [ dune ];
  };
  posix-socket = {
  ...
  posix-socket-unix = {
    ...
    opam = "${repo}/packages/posix-socket-unix/posix-socket-unix.2.0.0/opam";
    depends = with self; [ ctypes dune posix-base posix-socket unix-errno ];
    buildDepends = with self; [ dune ];
  };
  posix-types = {
    name = "posix-types";
    ...
    opam = "${repo}/packages/posix-types/posix-types.2.0.0/opam";
    depends = with self; [ ctypes dune ocaml posix-base ];
    buildDepends = with self; [ dune ocaml ];
  };
  posix-uname = {
    name = "posix-uname";
    ...
    opam = "${repo}/packages/posix-uname/posix-uname.2.0.0/opam";
    depends = with self; [ ctypes dune posix-base unix-errno ];
    buildDepends = with self; [ dune ];
  };
  result = {
    name = "result";
