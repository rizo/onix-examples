...
} }:
{
  ...
  imagelib = {
    ...
    version = "20210511";
    src = pkgs.fetchurl {
      url = "https://github.com/rlepigre/ocaml-imagelib/releases/download/20210511/imagelib-20210511.tbz";
      sha256 = "1cb94ea3731dc994c205940c9434543ce3f2470cdcb2e93a3e02ed793e80d480";
    };
    opam = "${repo}/packages/imagelib/imagelib.20210511/opam";
    depends = with self; [ base-unix decompress dune ocaml stdlib-shims ];
    buildDepends = with self; [ dune ocaml ];
  };
  ocaml = {
    name = "ocaml";
