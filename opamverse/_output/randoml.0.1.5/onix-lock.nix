...
} }:
{
  ...
  bignum = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/bignum-v0.15.0.tar.gz";
      sha256 = "c3056514f93f1fa98fa54136fb119e8a7d623eafd349d21dd8dc979428a379b1";
    };
    opam = "${repo}/packages/bignum/bignum.v0.15.0/opam";
    depends = with self; [ core dune num ocaml ppx_jane splittable_random
                           typerep zarith zarith_stubs_js ];
    buildDepends = with self; [ dune ocaml ];
  };
  bin_prot = {
    name = "bin_prot";
  ...
  conf-rust-2018 = {
    name = "conf-rust-2018";
    version = "1";
    opam = "${repo}/packages/conf-rust-2018/conf-rust-2018.1/opam";
    depexts = with pkgs; [ cargo ];
  };
  core = {
    name = "core";
    version = "v0.15.0";
  ...
  randoml = {
    ...
    version = "0.1.5";
    src = pkgs.fetchurl {
      url = "https://github.com/mimoo/randoml/releases/download/0.1.5/randoml-0.1.5.tbz";
      sha256 = "a9de5733299b6a28872d07500c6ef459681a2322a6868b1ea3cadc99172e2e52";
    };
    opam = "${repo}/packages/randoml/randoml.0.1.5/opam";
    depends = with self; [ bignum conf-rust-2018 core_kernel dune
                           ppx_inline_test ];
