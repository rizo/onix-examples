...
} }:
{
  ...
  camelsnakekebab = {
    name = "camelsnakekebab";
    version = "0.4";
    src = pkgs.fetchurl {
      url = "https://github.com/swuecho/camelsnakekebab/archive/0.4.tar.gz";
    ...
    opam = "${repo}/packages/camelsnakekebab/camelsnakekebab.0.4/opam";
    depends = with self; [ base dune ocaml pcre ];
    buildDepends = with self; [ dune ocaml ];
  };
  conf-libpcre = {
    name = "conf-libpcre";
