...
} }:
{
  ...
  logs-syslog = {
    ...
    version = "0.3.1";
    src = pkgs.fetchurl {
      url = "https://github.com/hannesm/logs-syslog/releases/download/v0.3.1/logs-syslog-v0.3.1.tbz";
      sha256 = "348c54b71e4e89b30342644736e9b4cc79b749cc9f45186a2f7aebced9142ad4";
    };
    opam = "${repo}/packages/logs-syslog/logs-syslog.0.3.1/opam";
    depends = with self; [ dune logs ocaml ptime syslog-message
                           (self.cstruct or null) (self.ipaddr or null)
                           (self.lwt or null) (self.mirage-clock or null)
                           (self.mirage-console or null)
                           (self.mirage-kv or null) (self.tcpip or null)
                           (self.tls or null) (self.tls-mirage or null)
                           (self.x509 or null) ];
  ...
  syslog-message = {
    ...
    version = "1.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/verbosemode/syslog-message/releases/download/1.1.0/syslog-message-1.1.0.tbz";
      sha256 = "6f14705026aced72a7f86548d3b0ab3ead9013f3726be77f36ca092ce86cc46f";
    };
    opam = "${repo}/packages/syslog-message/syslog-message.1.1.0/opam";
    depends = with self; [ astring dune ocaml ptime rresult ];
    buildDepends = with self; [ dune ocaml ];
  };
  topkg = {
    name = "topkg";
