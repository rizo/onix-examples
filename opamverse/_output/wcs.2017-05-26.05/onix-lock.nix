...
} }:
{
  ...
  jbuilder = {
    name = "jbuilder";
    version = "1.0+beta20.1";
    src = pkgs.fetchurl {
      url = "https://github.com/ocaml/dune/releases/download/1.0%2Bbeta20.1/jbuilder-1.0+beta20.1.tbz";
      sha256 = "10xsz2wgxp2zay125mcbgyi307q4y710mqs8dfd1knakzsl0vxss";
    };
    opam = "${repo}/packages/jbuilder/jbuilder.1.0+beta20.1/opam";
    depends = with self; [ ocaml ];
    buildDepends = with self; [ ocaml ];
  };
  jsonm = {
  ...
  rml = {
    ...
    version = "1.09.07";
    src = pkgs.fetchurl {
      url = "http://rml.lri.fr/distrib/rml-1.09.07-2021-07-26.tar.gz";
      sha256 = "1c09v01c2hksb3fg9ij90y7kzkn14f00njw9ssa4cfzkklqwbb3l";
    };
    opam = "${repo}/packages/rml/rml.1.09.07/opam";
    depends = with self; [ num ocaml ];
    buildDepends = with self; [ ocaml ];
    depexts = with pkgs; [ (pkgs.patch or null) ];
  };
  rresult = {
    name = "rresult";
    version = "0.7.0";
  ...
  wcs = {
    ...
    src = pkgs.fetchurl {
      url = "https://github.com/IBM/wcs-ocaml/archive/2017-05-26.05.tar.gz";
      sha256 = "0axr9x2ng667cidrx0ny295xx7j0wp9v8317pn09b9353bb3q353";
    };
    opam = "${repo}/packages/wcs/wcs.2017-05-26.05/opam";
    depends = with self; [ cohttp-lwt-unix ocaml wcs-lib ];
    buildDepends = with self; [ ocaml ];
  };
  wcs-lib = {
    name = "wcs-lib";
    ...
    opam = "${repo}/packages/wcs-lib/wcs-lib.2017-05-26.05/opam";
    depends = with self; [ atd cohttp-lwt-unix jbuilder menhir ocaml rml
                           sedlex ];
    buildDepends = with self; [ atdgen ocaml ocaml-migrate-parsetree ];
  };
  x509 = {
    name = "x509";
    version = "0.16.0";
