...
} }:
{
  ...
  cordova-plugin-globalization = {
    ...
    opam = "${repo}/packages/cordova-plugin-globalization/cordova-plugin-globalization.1.0/opam";
    depends = with self; [ gen_js_api ocaml ocaml-js-stdlib ];
  ...
  gen_js_api = {
    ...
    version = "1.0.6";
    src = pkgs.fetchurl {
      url = "https://github.com/LexiFi/gen_js_api/archive/v1.0.6.tar.gz";
    ...
    opam = "${repo}/packages/gen_js_api/gen_js_api.1.0.6/opam";
  ...
  ocaml-js-stdlib = {
    ...
    opam = "${repo}/packages/ocaml-js-stdlib/ocaml-js-stdlib.1.0/opam";
    depends = with self; [ gen_js_api ocaml ];
    buildDepends = with self; [ ocaml ocamlfind ];
  };
