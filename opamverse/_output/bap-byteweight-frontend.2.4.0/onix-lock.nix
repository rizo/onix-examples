...
} }:
{
  ...
  bap-byteweight-frontend = {
    ...
    opam = "${repo}/packages/bap-byteweight-frontend/bap-byteweight-frontend.2.4.0/opam";
    depends = with self; [ bap-byteweight bap-std cmdliner core_kernel
                           fileutils ocaml ocamlfind ocurl ppx_bap re ];
