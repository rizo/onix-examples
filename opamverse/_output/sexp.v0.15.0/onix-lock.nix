...
} }:
{
  ...
  csvfields = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/csvfields-v0.15.0.tar.gz";
      sha256 = "43b117aff5abe66fe11bb6b464f36b3a4adcd356c4c87bf172336a4b741eb002";
    };
    opam = "${repo}/packages/csvfields/csvfields.v0.15.0/opam";
  ...
  jsonaf = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/jsonaf-v0.15.0.tar.gz";
      sha256 = "695e50569db70af61954a1a177ba119d2f2ddcdd34a54f39213d659b23dd6ff8";
    };
    opam = "${repo}/packages/jsonaf/jsonaf.v0.15.0/opam";
    depends = with self; [ angstrom base dune faraday ocaml ppx_jane ];
    buildDepends = with self; [ dune ocaml ];
  };
  jst-config = {
    name = "jst-config";
  ...
  sexp = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/sexp-v0.15.0.tar.gz";
      sha256 = "7c0bc2f04bf7abda23ccf02ce10cf90cd9e60124736ffa6501388693f2f30ac0";
    };
    opam = "${repo}/packages/sexp/sexp.v0.15.0/opam";
    depends = with self; [ async core core_kernel core_unix csvfields dune
                           jsonaf ocaml ppx_jane re2 sexp_diff sexp_macro
                           sexp_pretty sexp_select sexplib ];
    buildDepends = with self; [ dune ocaml ];
  };
  sexp_diff = {
    name = "sexp_diff";
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/sexp_diff-v0.15.0.tar.gz";
      sha256 = "be94dcc05db0831dbb27b7c8e0ebeb3436b0ae7651c4b5be65c5d6bdec0206e1";
    };
    opam = "${repo}/packages/sexp_diff/sexp_diff.v0.15.0/opam";
    depends = with self; [ core dune ocaml ppx_jane ];
    buildDepends = with self; [ dune ocaml ];
  };
  sexp_macro = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/sexp_macro-v0.15.0.tar.gz";
      sha256 = "01d24495c83c7bbee6e5e36894baeee43e5666e8c433f7154fcd0b46ea27325f";
    };
    opam = "${repo}/packages/sexp_macro/sexp_macro.v0.15.0/opam";
    depends = with self; [ async dune ocaml ppx_jane sexplib ];
    buildDepends = with self; [ dune ocaml ];
  };
  sexp_pretty = {
    name = "sexp_pretty";
  ...
  sexp_select = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/sexp_select-v0.15.0.tar.gz";
      sha256 = "16cf2220e3dbaf2ecc136097c5e694833a3b0f686b3cef081762108507a754de";
    };
    opam = "${repo}/packages/sexp_select/sexp_select.v0.15.0/opam";
    depends = with self; [ base dune ocaml ppx_jane ];
    buildDepends = with self; [ dune ocaml ];
  };
  sexplib = {
