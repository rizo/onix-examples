...
} }:
{
  ...
  ppx_pyformat = {
    ...
    version = "0.1.2";
    src = pkgs.fetchurl {
      url = "https://github.com/bn-d/ppx_pyformat/archive/v0.1.2.tar.gz";
    ...
    opam = "${repo}/packages/ppx_pyformat/ppx_pyformat.0.1.2/opam";
    depends = with self; [ dune menhir ocaml ppx_make ppxlib ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppxlib = {
    name = "ppxlib";
