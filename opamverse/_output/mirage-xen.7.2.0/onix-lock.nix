...
} }:
{
  ...
  mirage-xen = {
    ...
    version = "7.2.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/mirage-xen/releases/download/v7.2.0/mirage-xen-7.2.0.tbz";
      sha256 = "e59773a2ead0b211c6b583cf749b492e91fc3fa64b35b8d05b2ed30f1718dce0";
    };
    opam = "${repo}/packages/mirage-xen/mirage-xen.7.2.0/opam";
    depends = with self; [ bheap cstruct dune duration fmt io-page logs lwt
                           lwt-dllist mirage-profile mirage-runtime ocaml
                           shared-memory-ring-lwt xenstore ];
    buildDepends = with self; [ dune ocaml ];
  };
  mmap = {
    name = "mmap";
  ...
  shared-memory-ring = {
    ...
    version = "3.1.1";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/shared-memory-ring/releases/download/v3.1.1/shared-memory-ring-3.1.1.tbz";
      sha256 = "296f20ae28ff3809c591d51d451645db55f7f43bea6b2ce44d67912b017cba85";
    };
    opam = "${repo}/packages/shared-memory-ring/shared-memory-ring.3.1.1/opam";
    depends = with self; [ cstruct dune mirage-profile ocaml ppx_cstruct ];
    buildDepends = with self; [ dune ocaml ];
  };
  shared-memory-ring-lwt = {
    ...
    opam = "${repo}/packages/shared-memory-ring-lwt/shared-memory-ring-lwt.3.1.1/opam";
    depends = with self; [ cstruct dune lwt lwt-dllist mirage-profile ocaml
                           ppx_cstruct shared-memory-ring ];
    buildDepends = with self; [ dune ocaml ];
  };
  stdlib-shims = {
    name = "stdlib-shims";
