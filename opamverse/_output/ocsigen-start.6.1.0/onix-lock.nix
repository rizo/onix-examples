...
} }:
{
  ...
  conduit = {
    ...
    version = "4.0.2";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/ocaml-conduit/releases/download/v4.0.2/conduit-v4.0.2.tbz";
      sha256 = "2a37ffaa352a1e145ef3d80ac28661213c69a741b238623e59f29e3d5a12c537";
    };
    opam = "${repo}/packages/conduit/conduit.4.0.2/opam";
  ...
  conduit-lwt = {
    ...
    opam = "${repo}/packages/conduit-lwt/conduit-lwt.4.0.2/opam";
  ...
  conduit-lwt-unix = {
    ...
    opam = "${repo}/packages/conduit-lwt-unix/conduit-lwt-unix.4.0.2/opam";
  ...
  conf-npm = {
    name = "conf-npm";
    version = "1";
    opam = "${repo}/packages/conf-npm/conf-npm.1/opam";
    depexts = with pkgs; [ (pkgs.epel-release or null) (pkgs.node or null)
                           (pkgs.nodejs or null) (pkgs.npm or null)
                           (pkgs.npm5 or null) ];
  };
  conf-pkg-config = {
  ...
  eliom = {
    ...
    version = "10.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/ocsigen/eliom/archive/10.0.0.tar.gz";
    ...
    opam = "${repo}/packages/eliom/eliom.10.0.0/opam";
    depends = with self; [ base-bytes ipaddr js_of_ocaml js_of_ocaml-compiler
                           js_of_ocaml-lwt js_of_ocaml-ppx
                           js_of_ocaml-ppx_deriving_json js_of_ocaml-tyxml
                           lwt_log lwt_ppx ocaml ocamlfind ocsigenserver
                           ocsipersist ppx_deriving ppxlib reactiveData tyxml ];
    buildDepends = with self; [ js_of_ocaml-ocamlbuild ocaml ocamlfind ];
  };
  eqaf = {
    name = "eqaf";
    version = "0.8";
  ...
  js_of_ocaml-ocamlbuild = {
    ...
    opam = "${repo}/packages/js_of_ocaml-ocamlbuild/js_of_ocaml-ocamlbuild.3.11.0/opam";
    depends = with self; [ dune ocaml ocamlbuild ];
    buildDepends = with self; [ dune ocaml ocamlbuild ];
  };
  js_of_ocaml-ppx = {
  ...
  js_of_ocaml-ppx_deriving_json = {
    ...
    opam = "${repo}/packages/js_of_ocaml-ppx_deriving_json/js_of_ocaml-ppx_deriving_json.4.0.0/opam";
    depends = with self; [ dune js_of_ocaml ocaml ppxlib ];
    buildDepends = with self; [ dune ocaml ];
  };
  js_of_ocaml-tyxml = {
  ...
  ocsigen-i18n = {
    ...
    version = "4.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/besport/ocsigen-i18n/archive/4.0.0.tar.gz";
    ...
    opam = "${repo}/packages/ocsigen-i18n/ocsigen-i18n.4.0.0/opam";
    depends = with self; [ dune ocaml ppxlib ];
    buildDepends = with self; [ dune ocaml ];
  };
  ocsigen-ppx-rpc = {
    name = "ocsigen-ppx-rpc";
    version = "1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/ocsigen/ocsigen-ppx-rpc/archive/1.0.tar.gz";
    ...
    opam = "${repo}/packages/ocsigen-ppx-rpc/ocsigen-ppx-rpc.1.0/opam";
  ...
  ocsigen-start = {
    ...
    version = "6.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/ocsigen/ocsigen-start/archive/6.1.0.tar.gz";
    ...
    opam = "${repo}/packages/ocsigen-start/ocsigen-start.6.1.0/opam";
    depends = with self; [ cohttp-lwt-unix conf-npm eliom ocaml ocamlnet
                           ocsigen-i18n ocsigen-ppx-rpc ocsigen-toolkit
                           pgocaml pgocaml_ppx re resource-pooling safepass
                           yojson ];
    buildDepends = with self; [ ocaml ];
    depexts = with pkgs; [ (pkgs.imagemagick or null)
                           (pkgs.md5sha1sum or null)
                           (pkgs.postgresql or null)
                           (pkgs.postgresql-common or null)
                           (pkgs.ruby-sass or null) (pkgs.sassc or null) ];
  };
  ocsigen-toolkit = {
    name = "ocsigen-toolkit";
    version = "3.2.0";
    src = pkgs.fetchurl {
      url = "https://github.com/ocsigen/ocsigen-toolkit/archive/3.2.0.tar.gz";
    ...
    opam = "${repo}/packages/ocsigen-toolkit/ocsigen-toolkit.3.2.0/opam";
    depends = with self; [ calendar eliom js_of_ocaml ocaml ];
    buildDepends = with self; [ ocaml ];
  };
  ocsigenserver = {
    name = "ocsigenserver";
    version = "5.0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/ocsigen/ocsigenserver/archive/5.0.1.tar.gz";
    ...
    opam = "${repo}/packages/ocsigenserver/ocsigenserver.5.0.1/opam";
    depends = with self; [ base-threads base-unix camlzip cohttp-lwt-unix
                           conduit-lwt-unix cryptokit dune hmap ipaddr lwt
                           lwt_log lwt_react lwt_ssl ocaml ocamlfind pcre
                           react ssl xml-light ];
  ...
  ocsipersist = {
    ...
    version = "1.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/ocsigen/ocsipersist/archive/1.1.0.tar.gz";
    ...
    opam = "${repo}/packages/ocsipersist/ocsipersist.1.1.0/opam";
    depends = with self; [ dune lwt ocsigenserver ocsipersist-lib
                           (self.ocsipersist-dbm or null)
                           (self.ocsipersist-pgsql or null)
                           (self.ocsipersist-sqlite or null) ];
    buildDepends = with self; [ dune ];
  };
  ocsipersist-lib = {
    ...
    opam = "${repo}/packages/ocsipersist-lib/ocsipersist-lib.1.1.0/opam";
    depends = with self; [ dune lwt lwt_ppx ];
    buildDepends = with self; [ dune ];
  };
  parsexp = {
    name = "parsexp";
  ...
  pgocaml = {
    ...
    version = "4.3.0";
    src = pkgs.fetchurl {
      url = "https://github.com/darioteixeira/pgocaml/archive/4.3.0.tar.gz";
    ...
    opam = "${repo}/packages/pgocaml/pgocaml.4.3.0/opam";
    depends = with self; [ calendar csv dune hex ocaml ppx_deriving
  ...
  pgocaml_ppx = {
    ...
    opam = "${repo}/packages/pgocaml_ppx/pgocaml_ppx.4.3.0/opam";
    depends = with self; [ dune ocaml pgocaml ppx_optcomp ppxlib ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppx_derivers = {
    name = "ppx_derivers";
  ...
  resource-pooling = {
    ...
    version = "1.2";
    src = pkgs.fetchurl {
      url = "https://github.com/ocsigen/resource-pooling/archive/1.2.tar.gz";
    ...
    opam = "${repo}/packages/resource-pooling/resource-pooling.1.2/opam";
    depends = with self; [ dune lwt lwt_log ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  result = {
    name = "result";
  ...
  safepass = {
    ...
    opam = "${repo}/packages/safepass/safepass.3.1/opam";
    depends = with self; [ dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  seq = {
