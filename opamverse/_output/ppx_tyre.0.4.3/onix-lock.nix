...
} }:
{
  ...
  ppx_tyre = {
    ...
    version = "0.4.3";
    src = pkgs.fetchurl {
      url = "https://github.com/paurkedal/ppx_regexp/releases/download/v0.4.3/ppx_regexp-v0.4.3.tbz";
      sha256 = "70cbf4495de5e8ca4aada49c4fe25c586858dade8448efef29fd2d2ea620d413";
    };
    opam = "${repo}/packages/ppx_tyre/ppx_tyre.0.4.3/opam";
    depends = with self; [ dune ocaml ocaml-migrate-parsetree
                           ppx_tools_versioned re tyre ];
    buildDepends = with self; [ dune ocaml ];
  };
  re = {
    name = "re";
  ...
  tyre = {
    ...
    version = "0.5";
    src = pkgs.fetchurl {
      url = "https://github.com/Drup/tyre/releases/download/0.5/tyre-0.5.tbz";
      sha256 = "7aa07fada72aa71bb9855942e0eb3ee007c339e623e145c5dd2ff80a491e9b69";
    };
    opam = "${repo}/packages/tyre/tyre.0.5/opam";
    depends = with self; [ dune ocaml re result seq ];
    buildDepends = with self; [ dune ocaml ];
  };
}
