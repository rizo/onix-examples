...
} }:
{
  ...
  hardcaml_xilinx = {
    name = "hardcaml_xilinx";
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/hardcaml_xilinx-v0.15.0.tar.gz";
      sha256 = "57b9f815b21a01c040dcbb82d46da402648cc60e4f3fd695507025701727e4a7";
    };
    opam = "${repo}/packages/hardcaml_xilinx/hardcaml_xilinx.v0.15.0/opam";
