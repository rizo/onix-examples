...
} }:
{
  ...
  ezjs_min = {
    ...
    version = "0.3.0";
    src = pkgs.fetchurl {
      url = "https://github.com/ocamlpro/ezjs_min/archive/0.3.0.tar.gz";
    ...
    opam = "${repo}/packages/ezjs_min/ezjs_min.0.3.0/opam";
    depends = with self; [ dune js_of_ocaml-ppx ocaml stdlib-shims
                           (self.lwt or null) ];
    buildDepends = with self; [ dune ocaml ];
  };
  js_of_ocaml = {
  ...
  ppx_deriving_jsoo = {
    name = "ppx_deriving_jsoo";
    version = "0.2";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/api/v4/projects/22645789/repository/archive?sha=1544d22e6e68f309608f46b48f5349a692003ab8";
    ...
    opam = "${repo}/packages/ppx_deriving_jsoo/ppx_deriving_jsoo.0.2/opam";
    depends = with self; [ dune ezjs_min ocaml ppxlib ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppxlib = {
    name = "ppxlib";
