...
} }:
{
  ...
  httpaf = {
    ...
    version = "0.5.0";
    src = pkgs.fetchurl {
      url = "https://github.com/inhabitedtype/httpaf/archive/0.5.0.tar.gz";
      sha256 = "06qiprnjzyd2i24lmvynp6780gbw1lk64m7wml35hbl68wqdk5fq";
    };
    opam = "${repo}/packages/httpaf/httpaf.0.5.0/opam";
    depends = with self; [ angstrom faraday jbuilder ocaml result ];
  ...
  subscriptions-transport-ws = {
    ...
    version = "0.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/anmonteiro/ocaml-subscriptions-transport-ws/releases/download/0.1.0/subscriptions-transport-ws-0.1.0.tbz";
      sha256 = "03c04ff7ca01ccc8ca7a50d7ca9b5d84d9ad33204ede4f867cc03519d80cd89d";
    };
    opam = "${repo}/packages/subscriptions-transport-ws/subscriptions-transport-ws.0.1.0/opam";
    depends = with self; [ dune graphql graphql_parser ocaml websocketaf ];
    buildDepends = with self; [ dune ocaml ];
  };
  topkg = {
    name = "topkg";
  ...
  websocketaf = {
    ...
    version = "0.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/inhabitedtype/websocketaf/archive/0.1.0.tar.gz";
      sha256 = "0z3abjmk7w5jwsg3i5vy0fvr9ww84hhm0xixm8a2baj450p43v5b";
    };
    opam = "${repo}/packages/websocketaf/websocketaf.0.1.0/opam";
    depends = with self; [ angstrom base64 bigstringaf dune faraday httpaf
                           ocaml result ];
    buildDepends = with self; [ dune ocaml ];
  };
  yojson = {
