...
} }:
{
  ...
  camlzip = {
    ...
    opam = "${repo}/packages/camlzip/camlzip.1.10/opam";
  ...
  tar = {
    ...
    opam = "${repo}/packages/tar/tar.1.1.0/opam";
    depends = with self; [ cstruct dune ocaml ppx_cstruct re ];
    buildDepends = with self; [ dune ocaml ppx_tools ];
  };
  tar-unix = {
    name = "tar-unix";
    version = "1.1.0";
    ...
    opam = "${repo}/packages/tar-unix/tar-unix.1.1.0/opam";
    depends = with self; [ cstruct cstruct-lwt dune lwt ocaml re tar ];
    buildDepends = with self; [ dune ocaml ];
  };
  terminal = {
    name = "terminal";
  ...
  tezos-embedded-protocol-012-Psithaca = {
    name = "tezos-embedded-protocol-012-Psithaca";
    version = "12.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v12.3/tezos-v12.3.tar.bz2";
      sha256 = "296bb5674bc6050afe6330326fbdd0dfc2255d414bfd6b79cc7666ac6b39316d";
    };
    opam = "${repo}/packages/tezos-embedded-protocol-012-Psithaca/tezos-embedded-protocol-012-Psithaca.12.3/opam";
    depends = with self; [ dune tezos-protocol-012-Psithaca
                           tezos-protocol-compiler tezos-protocol-updater ];
    buildDepends = with self; [ dune ];
  };
  tezos-error-monad = {
  ...
  tezos-protocol-plugin-012-Psithaca-registerer = {
    name = "tezos-protocol-plugin-012-Psithaca-registerer";
    version = "12.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v12.3/tezos-v12.3.tar.bz2";
      sha256 = "296bb5674bc6050afe6330326fbdd0dfc2255d414bfd6b79cc7666ac6b39316d";
    };
    opam = "${repo}/packages/tezos-protocol-plugin-012-Psithaca-registerer/tezos-protocol-plugin-012-Psithaca-registerer.12.3/opam";
    depends = with self; [ dune tezos-embedded-protocol-012-Psithaca
                           tezos-protocol-plugin-012-Psithaca tezos-shell ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-updater = {
    ...
    opam = "${repo}/packages/tezos-protocol-updater/tezos-protocol-updater.12.3/opam";
  ...
  tezos-requester = {
    ...
    opam = "${repo}/packages/tezos-requester/tezos-requester.12.3/opam";
  ...
  tezos-shell = {
    ...
    opam = "${repo}/packages/tezos-shell/tezos-shell.12.3/opam";
    depends = with self; [ dune lwt-canceler tezos-p2p tezos-requester
                           tezos-store tezos-validation ];
    buildDepends = with self; [ dune ];
  };
  tezos-shell-context = {
  ...
  tezos-store = {
    ...
    opam = "${repo}/packages/tezos-store/tezos-store.12.3/opam";
    depends = with self; [ camlzip dune index lwt-watcher ringo-lwt tar-unix
                           tezos-validation ];
    buildDepends = with self; [ dune ];
  };
  tezos-validation = {
    ...
    opam = "${repo}/packages/tezos-validation/tezos-validation.12.3/opam";
