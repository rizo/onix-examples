...
} }:
{
  ...
  cosovo = {
    ...
    version = "3";
    src = pkgs.fetchurl {
      url = "https://github.com/barko/cosovo/releases/download/3/cosovo-3.tbz";
      sha256 = "fca9a6d3ad87bbffa483417424b858db69ab4bf7407459ddbb52accf4f368ef1";
    };
    opam = "${repo}/packages/cosovo/cosovo.3/opam";
    depends = with self; [ cmdliner dune menhir ocaml re ];
