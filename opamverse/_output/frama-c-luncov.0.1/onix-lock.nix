...
} }:
{
  ...
  frama-c-luncov = {
    ...
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://git.frama-c.com/pub/ltest/luncov/-/archive/0.1/luncov-0.1.tar.bz2";
      sha512 = "e98b7984c429933a7608629b336df1e18dbeb2907382d9786bae0e2e4cb88ce9c51045b709369b8a08dc5ed8aa670efbf25714685922f162e80878a00f2aaa84";
    };
    opam = "${repo}/packages/frama-c-luncov/frama-c-luncov.0.1/opam";
    depends = with self; [ conf-autoconf frama-c ocaml ];
