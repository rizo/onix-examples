...
} }:
{
  ...
  orewa = {
    ...
    version = "0.2.1";
    src = pkgs.fetchurl {
      url = "https://github.com/Leonidas-from-XIV/orewa/releases/download/0.2.1/orewa-0.2.1.tbz";
      sha256 = "50c2bc62230a94f0856b9f2e414c6bff501fbf2071438d17cabdc0093bee718a";
    };
    opam = "${repo}/packages/orewa/orewa.0.2.1/opam";
    depends = with self; [ async core dune ppx_deriving ppx_let ];
