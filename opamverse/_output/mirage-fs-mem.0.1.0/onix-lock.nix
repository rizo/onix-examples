...
} }:
{
  ...
  mirage-fs-mem = {
    ...
    version = "0.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/roburio/mirage-fs-mem/releases/download/0.1.0/mirage-fs-mem-0.1.0.tbz";
      sha256 = "00ffbhygq4ji46wqyrb2dgm27lw27x1k6nczkxjmnw6n2vm00paz";
    };
    opam = "${repo}/packages/mirage-fs-mem/mirage-fs-mem.0.1.0/opam";
    depends = with self; [ cstruct dune fmt fpath mirage-fs-lwt ocaml rresult ];
    buildDepends = with self; [ dune ocaml ];
  };
  mirage-kv = {
    name = "mirage-kv";
