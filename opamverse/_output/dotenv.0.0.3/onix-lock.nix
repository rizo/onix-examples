...
} }:
{
  ...
  dotenv = {
    ...
    version = "0.0.3";
    src = pkgs.fetchurl {
      url = "https://github.com/thatportugueseguy/ocaml-dotenv/releases/download/v0.0.3/dotenv-v0.0.3.tbz";
      sha256 = "b8b0745746db0b8c6dd6bff9de8b89512c657cc5e0d09f9ba29aa5561a07c517";
    };
    opam = "${repo}/packages/dotenv/dotenv.0.0.3/opam";
    depends = with self; [ base dune ocaml pcre stdio uutf ];
    buildDepends = with self; [ dune ocaml ];
  };
  dune = {
    name = "dune";
