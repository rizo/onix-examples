...
} }:
{
  ...
  camlrack = {
    ...
    version = "0.10.1";
    src = pkgs.fetchurl {
      url = "https://github.com/pdarragh/camlrack/archive/0.10.1.tar.gz";
    ...
    opam = "${repo}/packages/camlrack/camlrack.0.10.1/opam";
  ...
  ppx_camlrack = {
    ...
    opam = "${repo}/packages/ppx_camlrack/ppx_camlrack.0.10.1/opam";
    depends = with self; [ camlrack dune ocaml ppxlib ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppx_derivers = {
    name = "ppx_derivers";
