...
} }:
{
  ...
  reparse = {
    ...
    version = "3.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/lemaetech/reparse/releases/download/v3.1.0/reparse-v3.1.0.tbz";
      sha256 = "60e57fdac0ae0b68b41a0cb5bd50327c84b306d40f74e9c21925c08049703e1d";
    };
    opam = "${repo}/packages/reparse/reparse.3.1.0/opam";
    depends = with self; [ cstruct dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  reparse-lwt-unix = {
    name = "reparse-lwt-unix";
    version = "3.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/lemaetech/reparse/releases/download/v3.1.0/reparse-v3.1.0.tbz";
      sha256 = "60e57fdac0ae0b68b41a0cb5bd50327c84b306d40f74e9c21925c08049703e1d";
    };
    opam = "${repo}/packages/reparse-lwt-unix/reparse-lwt-unix.3.1.0/opam";
    depends = with self; [ cstruct dune lwt ocaml reparse ];
    buildDepends = with self; [ dune ocaml ];
  };
  result = {
    name = "result";
