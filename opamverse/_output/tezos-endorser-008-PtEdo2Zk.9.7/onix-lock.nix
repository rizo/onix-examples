...
} }:
{
  ...
  tezos-baking-008-PtEdo2Zk = {
    name = "tezos-baking-008-PtEdo2Zk";
    version = "9.7";
    src = pkgs.fetchurl {
    ...
    opam = "${repo}/packages/tezos-baking-008-PtEdo2Zk/tezos-baking-008-PtEdo2Zk.9.7/opam";
    depends = with self; [ dune lwt-exit tezos-client-008-PtEdo2Zk
                           tezos-client-commands tezos-shell-context ];
    buildDepends = with self; [ dune ];
  };
  tezos-baking-008-PtEdo2Zk-commands = {
    name = "tezos-baking-008-PtEdo2Zk-commands";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-baking-008-PtEdo2Zk-commands/tezos-baking-008-PtEdo2Zk-commands.9.7/opam";
    depends = with self; [ dune tezos-baking-008-PtEdo2Zk ];
    buildDepends = with self; [ dune ];
  };
  tezos-base = {
    name = "tezos-base";
  ...
  tezos-endorser-008-PtEdo2Zk = {
    name = "tezos-endorser-008-PtEdo2Zk";
    version = "9.7";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v9.7/tezos-v9.7.tar.bz2";
      sha256 = "f7b20fc8052f36c362310bf8947803d1e4b3e62a820a6dff056af576f9e21fe2";
    };
    opam = "${repo}/packages/tezos-endorser-008-PtEdo2Zk/tezos-endorser-008-PtEdo2Zk.9.7/opam";
    depends = with self; [ dune tezos-baking-008-PtEdo2Zk-commands
                           tezos-client-base-unix ];
    buildDepends = with self; [ dune ];
  };
  tezos-error-monad = {
