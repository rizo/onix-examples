...
} }:
{
  ...
  camlp4 = {
    ...
    opam = "${repo}/packages/camlp4/camlp4.4.10+1/opam";
  ...
  lwt_named_threads = {
    ...
    opam = "${repo}/packages/lwt_named_threads/lwt_named_threads.0.1/opam";
    depends = with self; [ extlib lwt objsize ocaml ];
    buildDepends = with self; [ ocaml ocamlfind ];
  };
  mmap = {
    name = "mmap";
  ...
  objsize = {
    ...
    version = "0.18";
    src = pkgs.fetchurl {
      url = "https://ygrek.org/p/release/objsize/objsize-0.18.tar.bz2";
      sha256 = "1vya8g6w1byd25nzjzpf0wiq7km7qh3qvchb3lk6wgds43w9iabf";
    };
    opam = "${repo}/packages/objsize/objsize.0.18/opam";
