...
} }:
{
  ...
  KaSim = {
    ...
    version = "4.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/Kappa-Dev/KappaTools/archive/v4.0.tar.gz";
      sha256 = "05b04hpksn9q7shnqi8fzfkla2xih45d33j5sbqj9wqx9yfmz4jx";
    };
    opam = "${repo}/packages/KaSim/KaSim.4.0.0/opam";
    depends = with self; [ lwt num ocaml ocamlfind yojson
