...
} }:
{
  ...
  cookie = {
    ...
    version = "0.1.8";
    src = pkgs.fetchurl {
      url = "https://github.com/ulrikstrid/ocaml-cookie/releases/download/0.1.8/cookie-0.1.8.tbz";
      sha256 = "bc405a88a6f94453fbaee19b98469818c09b567646a46e1f4ac1a9d5d9fee2db";
    };
    opam = "${repo}/packages/cookie/cookie.0.1.8/opam";
    depends = with self; [ astring dune ocaml ptime uri ];
    buildDepends = with self; [ dune ocaml ];
  };
  cppo = {
    name = "cppo";
  ...
  session-cookie = {
    ...
    opam = "${repo}/packages/session-cookie/session-cookie.0.1.8/opam";
    depends = with self; [ cookie dune ocaml session ];
    buildDepends = with self; [ dune ocaml ];
  };
  session-cookie-lwt = {
    ...
    version = "0.1.8";
    src = pkgs.fetchurl {
      url = "https://github.com/ulrikstrid/ocaml-cookie/releases/download/0.1.8/session-cookie-lwt-0.1.8.tbz";
      sha256 = "bc405a88a6f94453fbaee19b98469818c09b567646a46e1f4ac1a9d5d9fee2db";
    };
    opam = "${repo}/packages/session-cookie-lwt/session-cookie-lwt.0.1.8/opam";
    depends = with self; [ dune lwt ocaml session-cookie ];
    buildDepends = with self; [ dune ocaml ];
  };
  stringext = {
    name = "stringext";
