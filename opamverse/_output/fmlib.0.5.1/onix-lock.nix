...
} }:
{
  ...
  fmlib = {
    ...
    version = "0.5.1";
    src = pkgs.fetchurl {
      url = "https://github.com/hbr/fmlib/archive/0.5.1.tar.gz";
      sha256 = "167bah8lrh8sy36v6dq72x3z1y4clr0nmz8fjwjk3wjsk4gm42km";
    };
    opam = "${repo}/packages/fmlib/fmlib.0.5.1/opam";
    depends = with self; [ dune fmlib_js fmlib_parse fmlib_pretty fmlib_std
                           ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  fmlib_js = {
    ...
    opam = "${repo}/packages/fmlib_js/fmlib_js.0.5.1/opam";
    depends = with self; [ dune fmlib_std js_of_ocaml js_of_ocaml-ppx ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  fmlib_parse = {
    name = "fmlib_parse";
    ...
    opam = "${repo}/packages/fmlib_parse/fmlib_parse.0.5.1/opam";
    depends = with self; [ dune fmlib_pretty fmlib_std ocaml ppx_inline_test ];
    buildDepends = with self; [ dune ocaml ];
  };
  fmlib_pretty = {
    name = "fmlib_pretty";
    ...
    opam = "${repo}/packages/fmlib_pretty/fmlib_pretty.0.5.1/opam";
    depends = with self; [ dune fmlib_std ocaml ppx_inline_test ];
    buildDepends = with self; [ dune ocaml ];
  };
  fmlib_std = {
    name = "fmlib_std";
    ...
    opam = "${repo}/packages/fmlib_std/fmlib_std.0.5.1/opam";
    depends = with self; [ dune ocaml ppx_inline_test ];
    buildDepends = with self; [ dune ocaml ];
  };
  jane-street-headers = {
