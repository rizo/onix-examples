...
} }:
{
  ...
  opam-custom-install = {
    name = "opam-custom-install";
    version = "0.2";
    src = pkgs.fetchurl {
      url = "https://gitlab.ocamlpro.com/louis/opam-custom-install/-/archive/0.2/opam-custom-install-0.2.tar.gz";
    ...
    opam = "${repo}/packages/opam-custom-install/opam-custom-install.0.2/opam";
    depends = with self; [ dune opam-client ];
