...
} }:
{
  ...
  conf-plplot = {
    name = "conf-plplot";
    version = "1";
    opam = "${repo}/packages/conf-plplot/conf-plplot.1/opam";
    buildDepends = with self; [ conf-pkg-config ];
    depexts = with pkgs; [ plplot ];
  };
  conf-zlib = {
    name = "conf-zlib";
    version = "1";
  ...
  jupyter = {
    ...
    version = "2.8.0";
    src = pkgs.fetchurl {
      url = "https://github.com/akabe/ocaml-jupyter/releases/download/v2.8.0/jupyter-2.8.0.tbz";
      sha256 = "10b86a6788a9be21bd348ffced001f7ed765e3cccca7a6dd9319ace92c306bd3";
    };
    opam = "${repo}/packages/jupyter/jupyter.2.8.0/opam";
    depends = with self; [ base-threads base-unix base64 cryptokit dune logs
                           lwt lwt_ppx ocaml ppx_deriving ppx_yojson_conv
                           stdint uuidm yojson zmq zmq-lwt
                           (self.merlin or null) ];
    buildDepends = with self; [ dune ocaml ];
  };
  logs = {
  ...
  owl-jupyter = {
    ...
    version = "1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/owlbarn/owl_jupyter/releases/download/v1.0/owl-jupyter-v1.0.tbz";
      sha256 = "296e4c29d6c9d14921c756230cf9e5a499cdb3840a209f3bfd1a5dd9e451bd09";
    };
    opam = "${repo}/packages/owl-jupyter/owl-jupyter.1.0/opam";
    depends = with self; [ dune jupyter ocaml owl-plplot owl-top ];
    buildDepends = with self; [ dune ocaml ];
  };
  owl-plplot = {
    name = "owl-plplot";
    ...
    opam = "${repo}/packages/owl-plplot/owl-plplot.1.0.2/opam";
    depends = with self; [ dune ocaml owl plplot ];
    buildDepends = with self; [ dune ocaml ];
  };
  owl-top = {
    name = "owl-top";
    ...
    opam = "${repo}/packages/owl-top/owl-top.1.0.2/opam";
    depends = with self; [ dune ocaml ocaml-compiler-libs owl owl-zoo ];
    buildDepends = with self; [ dune ocaml ];
  };
  owl-zoo = {
    name = "owl-zoo";
    ...
    opam = "${repo}/packages/owl-zoo/owl-zoo.1.0.2/opam";
    depends = with self; [ dune ocaml ocaml-compiler-libs owl ];
    buildDepends = with self; [ dune ocaml ];
  };
  plplot = {
    name = "plplot";
    version = "5.11.0+1";
    src = pkgs.fetchurl {
      url = "https://github.com/hcarty/ocaml-plplot/releases/download/v5.11.0-1/plplot-v5.11.0-1.tbz";
      sha256 = "0e621226ea66e72399936a6790caf1a3c12a1091e2c7e24b612ad75b42533f52";
    };
    opam = "${repo}/packages/plplot/plplot.5.11.0-1/opam";
    depends = with self; [ conf-plplot dune dune-configurator ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppx_derivers = {
    name = "ppx_derivers";
  ...
  ppx_js_style = {
    ...
    opam = "${repo}/packages/ppx_js_style/ppx_js_style.v0.15.0/opam";
  ...
  ppx_yojson_conv = {
    ...
    opam = "${repo}/packages/ppx_yojson_conv/ppx_yojson_conv.v0.15.0/opam";
    depends = with self; [ base dune ocaml ppx_js_style ppx_yojson_conv_lib
                           ppxlib ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppx_yojson_conv_lib = {
  ...
  zmq-lwt = {
    ...
    opam = "${repo}/packages/zmq-lwt/zmq-lwt.5.1.5/opam";
    depends = with self; [ dune lwt ocaml zmq ];
    buildDepends = with self; [ dune ocaml ];
  };
}
