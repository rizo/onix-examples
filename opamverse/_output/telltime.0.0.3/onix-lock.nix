...
} }:
{
  ...
  telltime = {
    ...
    version = "0.0.3";
    src = pkgs.fetchurl {
      url = "https://github.com/daypack-dev/telltime/releases/download/v0.0.3/manually-archived-v0.0.3.tar.gz";
      sha256 = "a8bc4e08299e2ec9f70df2250e13bfbfeb5f06271a0d34e8f7cef2fa33df6e28";
    };
    opam = "${repo}/packages/telltime/telltime.0.0.3/opam";
    depends = with self; [ cmdliner daypack-lib dune ocaml oseq ptime ];
    buildDepends = with self; [ dune ocaml ];
  };
  topkg = {
    name = "topkg";
