...
} }:
{
  ...
  lens = {
    ...
    version = "1.2.5";
    src = pkgs.fetchurl {
      url = "https://github.com/pdonadeo/ocaml-lens/archive/v1.2.5.tar.gz";
      sha256 = "0sc7gjcrrvhyjbnbm98y4i7ajz0pgj181i0hwgxcggr0h669b0jx";
    };
    opam = "${repo}/packages/lens/lens.1.2.5/opam";
