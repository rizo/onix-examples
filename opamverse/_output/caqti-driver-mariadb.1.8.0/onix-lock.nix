...
} }:
{
  ...
  caqti-driver-mariadb = {
    ...
    opam = "${repo}/packages/caqti-driver-mariadb/caqti-driver-mariadb.1.8.0/opam";
    depends = with self; [ caqti dune mariadb ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  conf-gcc = {
    name = "conf-gcc";
  ...
  mariadb = {
    ...
    version = "1.1.6";
    src = pkgs.fetchurl {
      url = "https://github.com/andrenth/ocaml-mariadb/releases/download/1.1.6/ocaml-mariadb-1.1.6.tar.gz";
      sha256 = "dff0b51b3ea5b94cd2ee86ae74b9431cc4fa241dafe4e75b2d5cc986d6b21c63";
    };
    opam = "${repo}/packages/mariadb/mariadb.1.1.6/opam";
    depends = with self; [ conf-gcc conf-mariadb ctypes ocaml ];
