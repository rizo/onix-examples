...
} }:
{
  ...
  b0 = {
    ...
    version = "0.0.4";
    src = pkgs.fetchurl {
      url = "https://erratique.ch/software/b0/releases/b0-0.0.4.tbz";
    ...
    opam = "${repo}/packages/b0/b0.0.0.4/opam";
    depends = with self; [ cmdliner ocaml ];
    buildDepends = with self; [ ocaml ocamlbuild ocamlfind topkg ];
  };
  base-threads = {
    name = "base-threads";
  ...
  odig = {
    ...
    version = "0.0.8";
    src = pkgs.fetchurl {
      url = "https://erratique.ch/software/odig/releases/odig-0.0.8.tbz";
    ...
    opam = "${repo}/packages/odig/odig.0.0.8/opam";
    depends = with self; [ b0 cmdliner ocaml odoc ];
    buildDepends = with self; [ ocaml ocamlbuild ocamlfind topkg ];
  };
  odoc = {
    name = "odoc";
