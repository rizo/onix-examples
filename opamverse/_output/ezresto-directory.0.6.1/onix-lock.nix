...
} }:
{
  ...
  ezresto = {
    ...
    opam = "${repo}/packages/ezresto/ezresto.0.6.1/opam";
    depends = with self; [ dune ocaml resto resto-json uri ];
    buildDepends = with self; [ dune ocaml ];
  };
  ezresto-directory = {
    name = "ezresto-directory";
    version = "0.6.1";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/nomadic-labs/resto/-/archive/v0.6.1/resto-v0.6.1.tar.gz";
      sha512 = "f362893693e75df8021365a7b3291874ad38f928054e16fc48f9040545d7dcfc60f9c19bd7f00f8e89b3c2c72bea916a425d769b41331da08a222a81968954e9";
    };
    opam = "${repo}/packages/ezresto-directory/ezresto-directory.0.6.1/opam";
    depends = with self; [ dune ezresto lwt ocaml resto resto-directory ];
    buildDepends = with self; [ dune ocaml ];
  };
  json-data-encoding = {
  ...
  resto-json = {
    ...
    opam = "${repo}/packages/resto-json/resto-json.0.6.1/opam";
    depends = with self; [ dune json-data-encoding json-data-encoding-bson
                           ocaml resto ];
    buildDepends = with self; [ dune ocaml ];
  };
  result = {
