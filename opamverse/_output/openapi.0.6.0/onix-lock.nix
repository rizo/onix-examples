...
} }:
{
  ...
  openapi = {
    ...
    version = "0.6.0";
    src = pkgs.fetchurl {
      url = "https://github.com/jhuapl-saralab/openapi-ocaml/releases/download/v0.6.0/openapi-v0.6.0.tbz";
      sha256 = "69fe5f6a245b5c977ff09ba52174bd67684283fadf4cb5d6608d6ad08b0ada3b";
    };
    opam = "${repo}/packages/openapi/openapi.0.6.0/opam";
    depends = with self; [ core dune opium ppx_deriving ppx_yojson_conv
                           yojson ];
    buildDepends = with self; [ dune ];
  };
  opium = {
