...
} }:
{
  ...
  easy_logging = {
    ...
    version = "0.8.2";
    src = pkgs.fetchurl {
      url = "https://github.com/sapristi/easy_logging/archive/v0.8.2.tar.gz";
    ...
    opam = "${repo}/packages/easy_logging/easy_logging.0.8.2/opam";
    depends = with self; [ calendar dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  easy_logging_yojson = {
    ...
    opam = "${repo}/packages/easy_logging_yojson/easy_logging_yojson.0.8.2/opam";
    depends = with self; [ dune easy_logging ocaml ppx_deriving
                           ppx_deriving_yojson ];
    buildDepends = with self; [ dune ocaml ];
  };
  ocaml = {
