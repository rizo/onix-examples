...
} }:
{
  ...
  tezos-protocol-plugin-007-PsDELPH1-registerer = {
    ...
    opam = "${repo}/packages/tezos-protocol-plugin-007-PsDELPH1-registerer/tezos-protocol-plugin-007-PsDELPH1-registerer.9.7/opam";
    depends = with self; [ dune tezos-embedded-protocol-007-PsDELPH1
                           tezos-protocol-plugin-007-PsDELPH1 tezos-shell ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-updater = {
