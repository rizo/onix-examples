...
} }:
{
  ...
  class_group_vdf = {
    ...
    version = "0.0.1";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/rrtoledo/ocaml-chia-vdf/-/archive/v0.0.1/ocaml-chia-vdf-v0.0.1.tar.gz";
    ...
    opam = "${repo}/packages/class_group_vdf/class_group_vdf.0.0.1/opam";
    depends = with self; [ conf-g++ conf-gmp dune integers ocaml zarith ];
