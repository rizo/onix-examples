...
} }:
{
  ...
  tezos-shell-services-test-helpers = {
    name = "tezos-shell-services-test-helpers";
    version = "12.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/tezos/tezos/-/archive/v12.3/tezos-v12.3.tar.bz2";
      sha256 = "296bb5674bc6050afe6330326fbdd0dfc2255d414bfd6b79cc7666ac6b39316d";
    };
    opam = "${repo}/packages/tezos-shell-services-test-helpers/tezos-shell-services-test-helpers.12.3/opam";
    depends = with self; [ dune tezos-base tezos-shell-services
                           tezos-test-helpers ];
    buildDepends = with self; [ dune ];
  };
  tezos-stdlib = {
