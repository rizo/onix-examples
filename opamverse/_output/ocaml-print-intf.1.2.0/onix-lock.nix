...
} }:
{
  ...
  ocaml-print-intf = {
    ...
    version = "1.2.0";
    src = pkgs.fetchurl {
      url = "https://github.com/avsm/ocaml-print-intf/releases/download/v1.2.0/ocaml-print-intf-v1.2.0.tbz";
      sha256 = "02aad204b646f67b3d2aa7dae5d74083ce4bd169e5b43b691c1f04c9436d9980";
    };
    opam = "${repo}/packages/ocaml-print-intf/ocaml-print-intf.1.2.0/opam";
    depends = with self; [ bos dune dune-build-info ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  ocamlbuild = {
    name = "ocamlbuild";
