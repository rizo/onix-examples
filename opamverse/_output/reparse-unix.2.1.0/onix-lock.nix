...
} }:
{
  ...
  reparse = {
    ...
    version = "2.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/lemaetech/reparse/releases/download/v2.1.0/reparse-unix-v2.1.0.tbz";
      sha256 = "51f7bb7087679e7e8dabf237a2e080094391bc626476c4c614515a14a3da6919";
    };
    opam = "${repo}/packages/reparse/reparse.2.1.0/opam";
  ...
  reparse-unix = {
    ...
    opam = "${repo}/packages/reparse-unix/reparse-unix.2.1.0/opam";
    depends = with self; [ base-unix dune ocaml reparse ];
    buildDepends = with self; [ dune ocaml ];
  };
  sexplib0 = {
    name = "sexplib0";
