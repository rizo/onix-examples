...
} }:
{
  ...
  lablgtk3-gtkspell3 = {
    name = "lablgtk3-gtkspell3";
    version = "3.1.2";
    src = pkgs.fetchurl {
      url = "https://github.com/garrigue/lablgtk/archive/3.1.2.tar.gz";
      sha256 = "0s8nbwc5qmc3kw6h3c9x4qkb7k7gw75dik06rjbnawbrby3ifx5d";
    };
    opam = "${repo}/packages/lablgtk3-gtkspell3/lablgtk3-gtkspell3.3.1.2/opam";
    depends = with self; [ dune lablgtk3 ocaml ];
    buildDepends = with self; [ dune ocaml ];
    depexts = with pkgs; [ (pkgs.epel-release or null)
                           (pkgs.gtkspell3 or null)
                           (pkgs.gtkspell3-dev or null)
                           (pkgs.gtkspell3-devel or null)
                           (pkgs.libgtkspell3-3-dev or null)
