...
} }:
{
  ...
  orocksdb = {
    ...
    version = "0.4.0";
    src = pkgs.fetchurl {
      url = "https://github.com/domsj/orocksdb/archive/0.4.0.tar.gz";
      sha256 = "1wyd3pqnnhilxcwfvv2yvc4wfqsw7mdly9sbqp7z3fk07wc52kan";
    };
    opam = "${repo}/packages/orocksdb/orocksdb.0.4.0/opam";
    depends = with self; [ conf-rocksdb ctypes ctypes-foreign ocaml ];
