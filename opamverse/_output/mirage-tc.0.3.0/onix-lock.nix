...
} }:
{
  ...
  ezjsonm = {
    ...
    opam = "${repo}/packages/ezjsonm/ezjsonm.1.1.0/opam";
  ...
  mirage-tc = {
    ...
    opam = "${repo}/packages/mirage-tc/mirage-tc.0.3.0/opam";
    depends = with self; [ base-bytes bin_prot cstruct ezjsonm mstruct ocaml ];
