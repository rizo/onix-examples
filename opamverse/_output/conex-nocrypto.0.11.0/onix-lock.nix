...
} }:
{
  ...
  conex = {
    ...
    version = "0.11.0";
    src = pkgs.fetchurl {
      url = "https://github.com/hannesm/conex/releases/download/v0.11.0/conex-v0.11.0.tbz";
      sha256 = "9b64ab189a68ebb37daed618ce0c201f082469f4b4efa8cc9099442a169d924b";
    };
    opam = "${repo}/packages/conex/conex.0.11.0/opam";
  ...
  conex-nocrypto = {
    ...
    opam = "${repo}/packages/conex-nocrypto/conex-nocrypto.0.11.0/opam";
    depends = with self; [ cmdliner conex cstruct dune fmt logs nocrypto
                           ocaml rresult x509 ];
    buildDepends = with self; [ dune ocaml ];
  };
  conf-gmp = {
