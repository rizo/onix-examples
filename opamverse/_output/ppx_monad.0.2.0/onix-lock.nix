...
} }:
{
  ...
  ppx_monad = {
    ...
    version = "0.2.0";
    src = pkgs.fetchurl {
      url = "https://github.com/Niols/ppx_monad/archive/v0.2.0.tar.gz";
    ...
    opam = "${repo}/packages/ppx_monad/ppx_monad.0.2.0/opam";
    depends = with self; [ dune dune-configurator ocaml ppxlib ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppxlib = {
    name = "ppxlib";
