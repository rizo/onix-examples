...
} }:
{
  angstrom = {
    ...
    opam = "${repo}/packages/angstrom/angstrom.0.9.0/opam";
    depends = with self; [ base-bigarray jbuilder ocaml result ];
  ...
  digestif = {
    ...
    opam = "${repo}/packages/digestif/digestif.0.5/opam";
  ...
  osbx = {
    ...
    opam = "${repo}/packages/osbx/osbx.1.2.4/opam";
    depends = with self; [ angstrom cmdliner digestif hex jbuilder nocrypto
                           ocaml stdint ];
    buildDepends = with self; [ ocaml ];
  };
  parsexp = {
