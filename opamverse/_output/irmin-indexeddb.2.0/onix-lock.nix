...
} }:
{
  ...
  decompress = {
    ...
    version = "0.9.1";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/decompress/releases/download/v0.9.1/decompress-v0.9.1.tbz";
      sha256 = "4e2fe1fc285449c5ab85e42dfe5c2bb1a9dee11c85fc8550405981a79e101814";
    };
    opam = "${repo}/packages/decompress/decompress.0.9.1/opam";
  ...
  digestif = {
    ...
    opam = "${repo}/packages/digestif/digestif.0.9.0/opam";
    depends = with self; [ base-bytes bigarray-compat dune eqaf ocaml
                           stdlib-shims (self.mirage-xen-posix or null)
                           (self.ocaml-freestanding or null) ];
    buildDepends = with self; [ dune ocaml ];
  };
  duff = {
    ...
    version = "0.2";
    src = pkgs.fetchurl {
      url = "https://github.com/dinosaure/duff/releases/download/v0.2/duff-v0.2.tbz";
      sha256 = "0bi081w4349cqc1n9jsjh1lrcqlnv3nycmvh9fniscv8lz1c0gjq";
    };
    opam = "${repo}/packages/duff/duff.0.2/opam";
    depends = with self; [ bos cmdliner cstruct dune fmt fpath logs ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  dune = {
    name = "dune";
  ...
  encore = {
    ...
    version = "0.5";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/encore/releases/download/v0.5/encore-v0.5.tbz";
      sha256 = "36dd2175340a1e84e8efd8f7cdb000a47c04aee2e6e817eb81692612146dc096";
    };
    opam = "${repo}/packages/encore/encore.0.5/opam";
    depends = with self; [ angstrom bigarray-compat bigarray-overlap
                           bigstringaf dune fmt ke ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  eqaf = {
    name = "eqaf";
  ...
  git = {
    ...
    version = "2.1.3";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/ocaml-git/releases/download/2.1.3/git-2.1.3.tbz";
      sha256 = "5d614ae0404a2438c5cee98bf4aa64cee9980e2a382a437acd6ee65dcca6f4de";
    };
    opam = "${repo}/packages/git/git.2.1.3/opam";
    depends = with self; [ angstrom astring checkseum cstruct decompress
                           digestif duff dune encore fmt fpath hex ke logs
                           lru lwt ocaml ocamlgraph ocplib-endian rresult
                           stdlib-shims uri ];
    buildDepends = with self; [ dune ocaml ];
  };
  hex = {
  ...
  irmin-indexeddb = {
    ...
    version = "2.0";
    src = pkgs.fetchurl {
      url = "https://github.com/talex5/irmin-indexeddb/releases/download/v2.0/irmin-indexeddb-v2.0.tbz";
      sha256 = "9397a500f5a3f83270921d95f861af0da6174d68516ce3fade725b13428ba41d";
    };
    opam = "${repo}/packages/irmin-indexeddb/irmin-indexeddb.2.0/opam";
    depends = with self; [ base64 cstruct dune git irmin js_of_ocaml
                           js_of_ocaml-lwt js_of_ocaml-ppx lwt ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  js_of_ocaml = {
    name = "js_of_ocaml";
