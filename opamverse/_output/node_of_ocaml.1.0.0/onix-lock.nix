...
} }:
{
  ...
  node_of_ocaml = {
    ...
    version = "1.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/emilienlemaire/node_of_ocaml/archive/1.0.0.tar.gz";
    ...
    opam = "${repo}/packages/node_of_ocaml/node_of_ocaml.1.0.0/opam";
    depends = with self; [ dune js_of_ocaml ppxlib ];
