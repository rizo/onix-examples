...
} }:
{
  ...
  launchd = {
    ...
    version = "1.3";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/ocaml-launchd/releases/download/v1.3/launchd-v1.3.tbz";
      sha256 = "16s223r7l1ncslvngqpmgj5pds08mzjiji280bjcaa6fmdyxfc23";
    };
    opam = "${repo}/packages/launchd/launchd.1.3/opam";
    depends = with self; [ cstruct cstruct-lwt dune lwt ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  lwt = {
    name = "lwt";
