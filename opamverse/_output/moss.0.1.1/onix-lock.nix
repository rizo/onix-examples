...
} }:
{
  ...
  moss = {
    ...
    version = "0.1.1";
    src = pkgs.fetchurl {
      url = "https://github.com/Chris00/ocaml-moss/releases/download/0.1.1/moss-0.1.1.tbz";
      sha256 = "1pkp3nl5q9m3fcadwnghy56a1yys7vz58p4kr7aiqd48zy8j6imh";
    };
    opam = "${repo}/packages/moss/moss.0.1.1/opam";
    depends = with self; [ base-bytes base-unix dune ocaml uri ];
