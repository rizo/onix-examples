...
} }:
{
  ...
  matplotlib = {
    ...
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/LaurentMazare/ocaml-matplotlib/archive/0.1.tar.gz";
    ...
    opam = "${repo}/packages/matplotlib/matplotlib.0.1/opam";
    depends = with self; [ base dune ocaml pyml stdio ];
    buildDepends = with self; [ dune ocaml ];
  };
  ocaml = {
    name = "ocaml";
