...
} }:
{
  ...
  mvar = {
    ...
    opam = "${repo}/packages/mvar/mvar.1.0.0/opam";
    depends = with self; [ jbuilder ocaml ];
    buildDepends = with self; [ ocaml ocamlfind opam-installer ];
  };
  ocaml = {
    name = "ocaml";
    version = "4.14.0";
  ...
  opam-installer = {
    ...
    opam = "${repo}/packages/opam-installer/opam-installer.2.1.2/opam";
    depends = with self; [ cmdliner dune ocaml opam-format ];
    buildDepends = with self; [ dune ocaml ];
  };
  re = {
    name = "re";
