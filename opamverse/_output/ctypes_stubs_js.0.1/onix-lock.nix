...
} }:
{
  ...
  ctypes_stubs_js = {
    ...
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/nomadic-labs/ctypes_stubs_js/-/archive/0.1/ctypes_stubs_js-0.1.tar.gz";
      sha256 = "74ab170e064bff88eaa592efc992d24fa1665c67047fc822276eae52c0f3384d";
    };
    opam = "${repo}/packages/ctypes_stubs_js/ctypes_stubs_js.0.1/opam";
    depends = with self; [ dune integers_stubs_js ];
  ...
  integers_stubs_js = {
    ...
    version = "1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/o1-labs/integers_stubs_js/archive/1.0.tar.gz";
    ...
    opam = "${repo}/packages/integers_stubs_js/integers_stubs_js.1.0/opam";
    depends = with self; [ dune js_of_ocaml zarith_stubs_js ];
    buildDepends = with self; [ dune ];
  };
  js_of_ocaml = {
    name = "js_of_ocaml";
