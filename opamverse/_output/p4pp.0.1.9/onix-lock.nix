...
} }:
{
  ...
  menhir = {
    ...
    opam = "${repo}/packages/menhir/menhir.20211230/opam";
  ...
  menhirLib = {
    ...
    opam = "${repo}/packages/menhirLib/menhirLib.20211230/opam";
    depends = with self; [ dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  menhirSdk = {
    ...
    opam = "${repo}/packages/menhirSdk/menhirSdk.20211230/opam";
    depends = with self; [ dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  num = {
  ...
  p4pp = {
    ...
    version = "0.1.9";
    src = pkgs.fetchurl {
      url = "https://github.com/cornell-netlab/p4pp/archive/v0.1.9.tar.gz";
    ...
    opam = "${repo}/packages/p4pp/p4pp.0.1.9/opam";
    depends = with self; [ core dune menhir ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  parsexp = {
    name = "parsexp";
