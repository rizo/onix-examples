...
} }:
{
  ...
  gluten-async = {
    ...
    opam = "${repo}/packages/gluten-async/gluten-async.0.2.1/opam";
    depends = with self; [ async dune faraday-async gluten ocaml
  ...
  h2-async = {
    ...
    opam = "${repo}/packages/h2-async/h2-async.0.8.0/opam";
    depends = with self; [ async dune faraday-async gluten-async h2 ocaml
                           (self.async_ssl or null) ];
    buildDepends = with self; [ dune ocaml ];
  };
  hpack = {
