...
} }:
{
  ...
  merge-fmt = {
    ...
    version = "0.2";
    src = pkgs.fetchurl {
      url = "https://github.com/hhugo/merge-fmt/releases/download/0.2/merge-fmt-0.2.tbz";
      sha256 = "c858a8480620c8f9a07c0476872b02cdc8457fef1041635a907509468b05604d";
    };
    opam = "${repo}/packages/merge-fmt/merge-fmt.0.2/opam";
    depends = with self; [ base cmdliner dune ocaml stdio ];
    buildDepends = with self; [ dune ocaml ];
  };
  ocaml = {
    name = "ocaml";
