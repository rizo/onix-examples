...
} }:
{
  ...
  irmin = {
    ...
    version = "2.7.1";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/irmin/releases/download/2.7.1/irmin-2.7.1.tbz";
      sha256 = "fac7c032f472fb369378ad2d8fe77e7cd3b3c1c6a0d7bf59980b69528891b399";
    };
    opam = "${repo}/packages/irmin/irmin.2.7.1/opam";
  ...
  irmin-layers = {
    ...
    opam = "${repo}/packages/irmin-layers/irmin-layers.2.7.1/opam";
  ...
  irmin-pack = {
    ...
    opam = "${repo}/packages/irmin-pack/irmin-pack.2.7.1/opam";
  ...
  ppx_irmin = {
    ...
    opam = "${repo}/packages/ppx_irmin/ppx_irmin.2.7.1/opam";
  ...
  tezos-context-hash = {
    ...
    version = "1.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/tarides/tezos-context-hash/releases/download/1.0.0/tezos-context-hash-irmin-1.0.0.tbz";
      sha256 = "00bd31b1e360d9124a28fd33512a569b77afea106fc0fbeb59c5521fc5023d4a";
    };
    opam = "${repo}/packages/tezos-context-hash/tezos-context-hash.1.0.0/opam";
    depends = with self; [ digestif dune fmt repr zarith ];
    buildDepends = with self; [ dune ];
  };
  tezos-context-hash-irmin = {
    ...
    opam = "${repo}/packages/tezos-context-hash-irmin/tezos-context-hash-irmin.1.0.0/opam";
    depends = with self; [ cmdliner dune fmt irmin irmin-pack ppx_irmin
                           tezos-context-hash yojson ];
    buildDepends = with self; [ dune ];
  };
  topkg = {
    name = "topkg";
