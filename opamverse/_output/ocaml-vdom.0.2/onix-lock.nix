...
} }:
{
  ...
  ocaml-vdom = {
    ...
    version = "0.2";
    src = pkgs.fetchurl {
      url = "https://github.com/LexiFi/ocaml-vdom/archive/v0.2.tar.gz";
    ...
    opam = "${repo}/packages/ocaml-vdom/ocaml-vdom.0.2/opam";
    depends = with self; [ dune gen_js_api js_of_ocaml-compiler ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  ojs = {
    name = "ojs";
