...
} }:
{
  ...
  genspio = {
    ...
    version = "0.0.3";
    src = pkgs.fetchurl {
      url = "https://github.com/hammerlab/genspio/archive/genspio.0.0.3.tar.gz";
      sha256 = "1jgkgndsxh4qy111m8qbx6xv1ml5q20q6pac71hss00s8jfichfx";
    };
    opam = "${repo}/packages/genspio/genspio.0.0.3/opam";
    depends = with self; [ base dune fmt ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  ocaml = {
    name = "ocaml";
