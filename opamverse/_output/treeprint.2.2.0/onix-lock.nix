...
} }:
{
  ...
  treeprint = {
    ...
    version = "2.2.0";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/camlspotter/treeprint/-/archive/2.2.0/treeprint-2.2.0.tar.bz2";
      sha256 = "0jp9rm9l76s2dn67j41713iyk3231svhmwc3qyps9fvmxfbvslc6";
    };
    opam = "${repo}/packages/treeprint/treeprint.2.2.0/opam";
    depends = with self; [ jbuilder ocaml ppx_meta_conv spotlib ];
    buildDepends = with self; [ ocaml ];
  };
}
