...
} }:
{
  ...
  feather = {
    ...
    version = "0.3.0";
    src = pkgs.fetchurl {
      url = "https://github.com/charlesetc/feather/archive/0.3.0.tar.gz";
    ...
    opam = "${repo}/packages/feather/feather.0.3.0/opam";
    depends = with self; [ base dune ocaml ppx_expect spawn stdio ];
    buildDepends = with self; [ dune ocaml ];
  };
  feather_async = {
    name = "feather_async";
    ...
    opam = "${repo}/packages/feather_async/feather_async.0.3.0/opam";
    depends = with self; [ async base dune feather ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  fieldslib = {
    name = "fieldslib";
