...
} }:
{
  ...
  catala = {
    ...
    version = "0.6.0";
    src = pkgs.fetchurl {
      url = "https://github.com/CatalaLang/catala/archive/0.6.0.tar.gz";
    ...
    opam = "${repo}/packages/catala/catala.0.6.0/opam";
    depends = with self; [ ANSITerminal benchmark bindlib calendar camomile
                           cmdliner cppo dune js_of_ocaml-ppx menhir
                           menhirLib ocaml ocamlgraph re sedlex unionFind
                           visitors z3 zarith zarith_stubs_js ];
