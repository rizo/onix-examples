...
} }:
{
  ...
  shuttle = {
    ...
    version = "0.3.1";
    src = pkgs.fetchurl {
      url = "https://github.com/anuragsoni/shuttle/releases/download/0.3.1/shuttle-0.3.1.tbz";
      sha256 = "fadea3010bb0008ffa6533abefeda865162c7f66601c84256d6a459fe7317cb2";
    };
    opam = "${repo}/packages/shuttle/shuttle.0.3.1/opam";
  ...
  shuttle_http = {
    ...
    opam = "${repo}/packages/shuttle_http/shuttle_http.0.3.1/opam";
    depends = with self; [ async core dune httpaf ocaml ppx_jane shuttle ];
    buildDepends = with self; [ dune ocaml ];
  };
  spawn = {
    name = "spawn";
