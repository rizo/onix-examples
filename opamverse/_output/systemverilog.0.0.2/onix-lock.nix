...
} }:
{
  ...
  systemverilog = {
    ...
    version = "0.0.2";
    src = pkgs.fetchurl {
      url = "https://github.com/xguerin/ocaml-systemverilog/releases/download/0.0.2/systemverilog-pre-migration.0.0.2.tar.gz";
      sha256 = "1xw2iw6jb57cxh34pq8ac2hmi0rwwj717ba89l3zp0d61x9ifr1b";
    };
    opam = "${repo}/packages/systemverilog/systemverilog.0.0.2/opam";
