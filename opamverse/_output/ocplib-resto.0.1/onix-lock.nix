...
} }:
{
  ...
  ocp-build = {
    ...
    version = "1.99.21";
    src = pkgs.fetchurl {
      url = "https://github.com/OCamlPro/ocp-build/archive/v1.99.21.tar.gz";
      sha256 = "19xgksxpcpy2147skccxpfhmrzz0ws9a2hs9zqzrsvvpfbddxjgp";
    };
    opam = "${repo}/packages/ocp-build/ocp-build.1.99.21/opam";
    depends = with self; [ cmdliner ocaml ocamlfind re (self.ocaml or null)
                           (self.seq or null) ];
    buildDepends = with self; [ ocaml ocamlfind (self.ocaml or null) ];
  };
  ocplib-endian = {
    name = "ocplib-endian";
    version = "1.2";
  ...
  ocplib-json-typed = {
    ...
    opam = "${repo}/packages/ocplib-json-typed/ocplib-json-typed.0.6/opam";
    depends = with self; [ ocaml uri (self.js_of_ocaml or null)
                           (self.ocplib-endian or null) ];
    buildDepends = with self; [ ocaml ocamlfind ];
  };
  ocplib-resto = {
    name = "ocplib-resto";
    ...
    opam = "${repo}/packages/ocplib-resto/ocplib-resto.0.1/opam";
    depends = with self; [ lwt ocaml ocplib-json-typed result ];
    buildDepends = with self; [ ocaml ocamlfind ocp-build ];
  };
  re = {
    name = "re";
    version = "1.10.4";
