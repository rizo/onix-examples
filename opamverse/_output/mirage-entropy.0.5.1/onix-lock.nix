...
} }:
{
  ...
  mirage-entropy = {
    ...
    version = "0.5.1";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/mirage-entropy/releases/download/v0.5.1/mirage-entropy-v0.5.1.tbz";
      sha256 = "612b2c17f18a56ed5cacc35006be6869016c26668eeaf301fd068b6467755d40";
    };
    opam = "${repo}/packages/mirage-entropy/mirage-entropy.0.5.1/opam";
    depends = with self; [ cstruct dune lwt mirage-runtime ocaml
  ...
  mirage-runtime = {
    ...
    opam = "${repo}/packages/mirage-runtime/mirage-runtime.3.10.8/opam";
