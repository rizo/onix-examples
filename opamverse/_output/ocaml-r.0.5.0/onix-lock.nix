...
} }:
{
  ...
  ocaml-r = {
    ...
    version = "0.5.0";
    src = pkgs.fetchurl {
      url = "https://github.com/pveber/ocaml-r/releases/download/v0.5.0/ocaml-r-0.5.0.tbz";
      sha256 = "35fc05e7852e18309df75caaeb61d466d2eeaeee13bc31e509576da040b3606e";
    };
    opam = "${repo}/packages/ocaml-r/ocaml-r.0.5.0/opam";
    depends = with self; [ dune ocaml ];
    buildDepends = with self; [ base conf-r conf-r-mathlib dune ocaml stdio ];
  };
  sexplib0 = {
    name = "sexplib0";
    version = "v0.15.0";
