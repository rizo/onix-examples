...
} }:
{
  ...
  dream-accept = {
    ...
    version = "0.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/tmattio/dream-accept/releases/download/0.1.0/dream-accept-0.1.0.tbz";
      sha256 = "79634bbf78fb90f70c54c9a5903b897b84d837281dd6e90f26db6e3123057010";
    };
    opam = "${repo}/packages/dream-accept/dream-accept.0.1.0/opam";
    depends = with self; [ dream dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  dream-httpaf = {
    name = "dream-httpaf";
