...
} }:
{
  ...
  vue-jsoo = {
    ...
    version = "0.2";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/api/v4/projects/18174793/repository/archive?sha=d960c9bea36c709fdb3daaf319f047b49689ff45";
    ...
    opam = "${repo}/packages/vue-jsoo/vue-jsoo.0.2/opam";
    depends = with self; [ dune js_of_ocaml-ppx lwt ocaml
                           (self.js_of_ocaml-tyxml or null) ];
    buildDepends = with self; [ dune ocaml ];
  };
  yojson = {
    name = "yojson";
