...
} }:
{
  ...
  yices2_bindings = {
    ...
    version = "0.2";
    src = pkgs.fetchurl {
      url = "https://github.com/SRI-CSL/yices2_ocaml_bindings/archive/0.2.tar.gz";
    ...
    opam = "${repo}/packages/yices2_bindings/yices2_bindings.0.2/opam";
    depends = with self; [ containers ctypes ctypes-foreign ctypes-zarith
                           ocaml ppx_deriving ppx_optcomp sexplib sexplib0
                           zarith ];
