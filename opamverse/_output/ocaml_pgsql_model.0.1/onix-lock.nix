...
} }:
{
  ...
  ocaml_pgsql_model = {
    name = "ocaml_pgsql_model";
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/pat227/ocaml-pgsql-model/archive/0.1.tar.gz";
    ...
    opam = "${repo}/packages/ocaml_pgsql_model/ocaml_pgsql_model.0.1/opam";
    depends = with self; [ bignum core dune fieldslib ocaml pcre postgresql
