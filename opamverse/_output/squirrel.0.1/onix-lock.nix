...
} }:
{
  ...
  squirrel = {
    ...
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/squirrel-prover/squirrel-prover/archive/0.1.tar.gz";
    ...
    opam = "${repo}/packages/squirrel/squirrel.0.1/opam";
    depends = with self; [ alcotest fmt menhir ocaml ocamlgraph pcre ];
