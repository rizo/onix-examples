...
} }:
{
  ...
  ctypes-zarith = {
    ...
    version = "0.2.0";
    src = pkgs.fetchurl {
      url = "https://github.com/fdopen/ctypes-zarith/archive/0.2.0.tar.gz";
    ...
    opam = "${repo}/packages/ctypes-zarith/ctypes-zarith.0.2.0/opam";
    depends = with self; [ ctypes dune dune-configurator ppx_cstubs zarith ];
    buildDepends = with self; [ conf-pkg-config dune ];
  };
  dune = {
    name = "dune";
    version = "3.2.0";
