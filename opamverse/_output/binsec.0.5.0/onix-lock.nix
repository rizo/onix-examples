...
} }:
{
  ...
  binsec = {
    ...
    version = "0.5.0";
    src = pkgs.fetchurl {
      url = "https://github.com/binsec/binsec/releases/download/0.5.0/binsec-0.5.0.tbz";
      sha256 = "9aa038f6e45339109bdc3fbe3e87522a412cc2f4b32422c85f541b3bbd596f1e";
    };
    opam = "${repo}/packages/binsec/binsec.0.5.0/opam";
    depends = with self; [ dune dune-site ocaml ocamlgraph zarith
                           (self.bitwuzla or null) (self.llvm or null)
                           (self.unisim_archisec or null) ];
