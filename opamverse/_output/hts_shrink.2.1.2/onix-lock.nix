...
} }:
{
  ...
  bst = {
    ...
    version = "5.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/UnixJunkie/bisec-tree/archive/v5.0.0.tar.gz";
      sha256 = "1889483yfh8gan93hjkprwijnp8qmyqp6hx1x7a4r1j1cvy1alhp";
    };
    opam = "${repo}/packages/bst/bst.5.0.0/opam";
  ...
  hts_shrink = {
    ...
    version = "2.1.2";
    src = pkgs.fetchurl {
      url = "https://github.com/UnixJunkie/hts_shrink/archive/v2.1.2.tar.gz";
      sha256 = "1cw149b8sxgbb00gwaj1fybyihjydyslyjnn2wnnc1f9p82aqjr4";
    };
    opam = "${repo}/packages/hts_shrink/hts_shrink.2.1.2/opam";
    depends = with self; [ batteries bitv bst dolog dune minicli ocaml
                           ocamlgraph parany parmap ptmap ];
    buildDepends = with self; [ dune ocaml ];
  };
  jbuilder = {
    name = "jbuilder";
