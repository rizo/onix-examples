...
} }:
{
  ...
  mirage-net-solo5 = {
    ...
    version = "0.8.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/mirage-net-solo5/releases/download/v0.8.0/mirage-net-solo5-0.8.0.tbz";
      sha256 = "e9ff307dfa73bc11a2b971ba67e2e609f4bc361eda984cc6e76770f131a2e826";
    };
    opam = "${repo}/packages/mirage-net-solo5/mirage-net-solo5.0.8.0/opam";
    depends = with self; [ cstruct dune fmt logs lwt macaddr metrics
                           mirage-net mirage-solo5 ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  mirage-runtime = {
    name = "mirage-runtime";
