...
} }:
{
  ...
  conduit = {
    ...
    opam = "${repo}/packages/conduit/conduit.2.1.0/opam";
  ...
  conduit-lwt = {
    ...
    opam = "${repo}/packages/conduit-lwt/conduit-lwt.2.1.0/opam";
  ...
  conduit-lwt-unix = {
    ...
    opam = "${repo}/packages/conduit-lwt-unix/conduit-lwt-unix.2.2.2/opam";
  ...
  yurt = {
    ...
    version = "0.6";
    src = pkgs.fetchurl {
      url = "https://github.com/zshipko/yurt/releases/download/0.6/yurt-0.6.tbz";
      sha256 = "05b84smragjp8mnq8pcjgvc1wl7swa9zq2bi25nphalxx3ic7d9m";
    };
    opam = "${repo}/packages/yurt/yurt.0.6/opam";
    depends = with self; [ cohttp-lwt-unix conduit-lwt-unix dune ezjsonm
                           lwt_log ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
}
