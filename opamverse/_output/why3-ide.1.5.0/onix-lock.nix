...
} }:
{
  ...
  why3 = {
    ...
    version = "1.5.0";
    src = pkgs.fetchurl {
      url = "https://why3.gitlabpages.inria.fr/releases/why3-1.5.0.tar.gz";
      sha256 = "0qjh49pyqmg3xi09fn4lyzz23i6h18y9sgc8ayscvx3bwr3vcqhr";
    };
    opam = "${repo}/packages/why3/why3.1.5.0/opam";
  ...
  why3-ide = {
    ...
    opam = "${repo}/packages/why3-ide/why3-ide.1.5.0/opam";
    depends = with self; [ ocaml why3 (self.conf-gtksourceview or null)
                           (self.lablgtk or null) (self.lablgtk3 or null)
