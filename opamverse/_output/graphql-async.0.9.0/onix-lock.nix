...
} }:
{
  ...
  graphql = {
    ...
    opam = "${repo}/packages/graphql/graphql.0.9.0/opam";
  ...
  graphql-async = {
    ...
    opam = "${repo}/packages/graphql-async/graphql-async.0.9.0/opam";
    depends = with self; [ async_kernel dune graphql ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  graphql_parser = {
    name = "graphql_parser";
