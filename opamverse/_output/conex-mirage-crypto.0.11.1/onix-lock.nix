...
} }:
{
  ...
  conex = {
    ...
    version = "0.11.1";
    src = pkgs.fetchurl {
      url = "https://github.com/hannesm/conex/releases/download/v0.11.1/conex-v0.11.1.tbz";
      sha256 = "997966693236d1ab2930ff8bb24cce175e88279b99aaacd39fa022d5e45dd3b1";
    };
    opam = "${repo}/packages/conex/conex.0.11.1/opam";
    depends = with self; [ cmdliner dune ocaml opam-file-format stdlib-shims ];
    buildDepends = with self; [ dune ocaml ];
  };
  conex-mirage-crypto = {
    name = "conex-mirage-crypto";
    version = "0.11.1";
    src = pkgs.fetchurl {
      url = "https://github.com/hannesm/conex/releases/download/v0.11.1/conex-v0.11.1.tbz";
      sha256 = "997966693236d1ab2930ff8bb24cce175e88279b99aaacd39fa022d5e45dd3b1";
    };
    opam = "${repo}/packages/conex-mirage-crypto/conex-mirage-crypto.0.11.1/opam";
    depends = with self; [ base64 cmdliner conex cstruct dune fmt logs
                           mirage-crypto mirage-crypto-pk mirage-crypto-rng
                           ocaml rresult x509 ];
    buildDepends = with self; [ dune ocaml ];
  };
  conf-gmp = {
  ...
  x509 = {
    ...
    opam = "${repo}/packages/x509/x509.0.12.0/opam";
