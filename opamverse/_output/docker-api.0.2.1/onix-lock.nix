...
} }:
{
  ...
  docker-api = {
    ...
    version = "0.2.1";
    src = pkgs.fetchurl {
      url = "https://github.com/Chris00/ocaml-docker/releases/download/0.2.1/docker-api-0.2.1.tbz";
      sha256 = "1pk1m4z2dm7faqbxsnm85qgqz0i6i9jh99ipnki4b8kli99b335n";
    };
    opam = "${repo}/packages/docker-api/docker-api.0.2.1/opam";
    depends = with self; [ base-bytes base-unix dune ocaml yojson ];
    buildDepends = with self; [ dune ocaml ];
  };
  dune = {
    name = "dune";
