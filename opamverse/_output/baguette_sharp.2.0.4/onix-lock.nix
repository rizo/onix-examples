...
} }:
{
  baguette_sharp = {
    ...
    version = "2.0.4";
    src = pkgs.fetchurl {
      url = "https://github.com/coco33920/ocaml-baguettesharp-interpreter/archive/2.0.4.tar.gz";
    ...
    opam = "${repo}/packages/baguette_sharp/baguette_sharp.2.0.4/opam";
    depends = with self; [ dune fmt linenoise ocaml ];
