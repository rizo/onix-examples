...
} }:
{
  ...
  hiredis = {
    ...
    version = "0.8";
    src = pkgs.fetchurl {
      url = "https://github.com/zshipko/ocaml-hiredis/archive/v0.8.tar.gz";
      sha256 = "1y2afscdkmnynzv3llpp7sn9dq2n8dd5gzbz77jsdhh1a3rmcn23";
    };
    opam = "${repo}/packages/hiredis/hiredis.0.8/opam";
    depends = with self; [ conduit-lwt-unix hiredis-value jbuilder lwt ocaml ];
  ...
  hiredis-value = {
    ...
    opam = "${repo}/packages/hiredis-value/hiredis-value.0.8/opam";
