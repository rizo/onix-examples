...
} }:
{
  ...
  conf-lilv = {
    name = "conf-lilv";
    version = "1";
    opam = "${repo}/packages/conf-lilv/conf-lilv.1/opam";
    depexts = with pkgs; [ lilv ];
  };
  conf-pkg-config = {
  ...
  lilv = {
    ...
    version = "0.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/savonet/ocaml-lilv/archive/v0.1.0.tar.gz";
    ...
    opam = "${repo}/packages/lilv/lilv.0.1.0/opam";
    depends = with self; [ conf-lilv conf-pkg-config ctypes ctypes-foreign
