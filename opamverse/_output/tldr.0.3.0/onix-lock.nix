...
} }:
{
  ...
  tldr = {
    ...
    version = "0.3.0";
    src = pkgs.fetchurl {
      url = "https://github.com/RosalesJ/tldr-ocaml/archive/v0.3.0.tar.gz";
    ...
    opam = "${repo}/packages/tldr/tldr.0.3.0/opam";
    depends = with self; [ ANSITerminal angstrom cmdliner cohttp-lwt-unix
                           dune lwt_ssl stdio ];
