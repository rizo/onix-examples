...
} }:
{
  ...
  sexp_grammar = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/sexp_grammar-v0.15.0.tar.gz";
      sha256 = "f8cab97645afdbfaccab7254984c47c7ffb3cae01f0ddf66a4a0581d5c192c8b";
    };
    opam = "${repo}/packages/sexp_grammar/sexp_grammar.v0.15.0/opam";
    depends = with self; [ base dune ocaml ppx_compare ppx_sexp_conv
                           ppx_sexp_message ];
    buildDepends = with self; [ dune ocaml ];
  };
  sexplib0 = {
