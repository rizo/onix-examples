...
} }:
{
  ...
  salsa20 = {
    ...
    version = "1.2.0";
    src = pkgs.fetchurl {
      url = "https://github.com/abeaumont/ocaml-salsa20/archive/1.2.0.tar.gz";
    ...
    opam = "${repo}/packages/salsa20/salsa20.1.2.0/opam";
    depends = with self; [ cstruct dune mirage-crypto ocaml salsa20-core ];
    buildDepends = with self; [ dune ocaml ];
  };
  salsa20-core = {
    name = "salsa20-core";
