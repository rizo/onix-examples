...
} }:
{
  ...
  promise = {
    ...
    version = "1.1.2";
    src = pkgs.fetchurl {
      url = "https://github.com/aantron/promise/archive/1.1.2.tar.gz";
      sha256 = "0nvmq9fm275jh5yql11vwsqb2cmvplrz9a03afr076g4q1cwjb6h";
    };
    opam = "${repo}/packages/promise/promise.1.1.2/opam";
    depends = with self; [ dune ocaml result ];
    buildDepends = with self; [ dune ocaml reason ];
  };
  reason = {
    name = "reason";
    version = "3.8.0";
