...
} }:
{
  ...
  tezos-protocol-plugin-008-PtEdo2Zk-registerer = {
    ...
    opam = "${repo}/packages/tezos-protocol-plugin-008-PtEdo2Zk-registerer/tezos-protocol-plugin-008-PtEdo2Zk-registerer.9.7/opam";
    depends = with self; [ dune tezos-embedded-protocol-008-PtEdo2Zk
                           tezos-protocol-plugin-008-PtEdo2Zk tezos-shell ];
    buildDepends = with self; [ dune ];
  };
  tezos-protocol-updater = {
