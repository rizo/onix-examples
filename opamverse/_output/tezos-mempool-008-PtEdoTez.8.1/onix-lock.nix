...
} }:
{
  ...
  tezos-embedded-protocol-008-PtEdoTez = {
    ...
    opam = "${repo}/packages/tezos-embedded-protocol-008-PtEdoTez/tezos-embedded-protocol-008-PtEdoTez.8.1/opam";
  ...
  tezos-mempool-008-PtEdoTez = {
    name = "tezos-mempool-008-PtEdoTez";
    version = "8.1";
    src = pkgs.fetchurl {
      url = "https://github.com/ocaml/opam-source-archives/raw/main/tezos-v8.1.tar.bz2";
      sha256 = "a86de0cc02108a4d2defb67b3774c4ba9c645280908e3695d465e194bbd9dad9";
    };
    opam = "${repo}/packages/tezos-mempool-008-PtEdoTez/tezos-mempool-008-PtEdoTez.8.1/opam";
    depends = with self; [ dune tezos-embedded-protocol-008-PtEdoTez
                           tezos-shell ];
    buildDepends = with self; [ dune ];
  };
  tezos-micheline = {
