...
} }:
{
  ...
  mirage-kv-unix = {
    ...
    version = "2.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/mirage-kv-unix/releases/download/v2.1.0/mirage-kv-unix-v2.1.0.tbz";
      sha256 = "e82a93cbf2a42f2f0e8f7c615ed23f9c8edaca741a4dd875c593a849c38a3cfc";
    };
    opam = "${repo}/packages/mirage-kv-unix/mirage-kv-unix.2.1.0/opam";
    depends = with self; [ dune lwt mirage-kv ocaml ptime ];
    buildDepends = with self; [ dune ocaml ];
  };
  mmap = {
    name = "mmap";
