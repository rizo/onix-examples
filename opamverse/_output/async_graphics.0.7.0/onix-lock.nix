...
} }:
{
  ...
  async_graphics = {
    ...
    version = "0.7.0";
    src = pkgs.fetchurl {
      url = "https://github.com/lpw25/async_graphics/archive/0.7.0.tar.gz";
      sha256 = "1z4kaxqjyil95gqm9h49dza9hc0kvcrh9rwdvd3aa2532z2ml0av";
    };
    opam = "${repo}/packages/async_graphics/async_graphics.0.7.0/opam";
    depends = with self; [ async async_unix dune graphics ];
