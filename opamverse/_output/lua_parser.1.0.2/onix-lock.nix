...
} }:
{
  ...
  lua_parser = {
    ...
    version = "1.0.2";
    src = pkgs.fetchurl {
      url = "https://github.com/drjdn/ocaml_lua_parser/archive/1.0.2.tar.gz";
    ...
    opam = "${repo}/packages/lua_parser/lua_parser.1.0.2/opam";
    depends = with self; [ dune menhir ppx_deriving ppx_sexp_conv sexp_pretty
                           sexplib ];
