...
} }:
{
  ...
  coq = {
    ...
    version = "8.15.1";
    src = pkgs.fetchurl {
      url = "https://github.com/coq/coq/archive/refs/tags/V8.15.1.tar.gz";
      sha256 = "513e953b7183d478acb75fd6e80e4dc32ac1a918cf4343ac31a859cfb4e9aad2";
    };
    opam = "${repo}/packages/coq/coq.8.15.1/opam";
    depends = with self; [ dune ocaml zarith (self.coq-native or null) ];
    buildDepends = with self; [ conf-findutils dune ocaml ocamlfind ];
  };
  dune = {
    name = "dune";
    version = "3.2.0";
  ...
  why3-coq = {
    ...
    opam = "${repo}/packages/why3-coq/why3-coq.1.5.0/opam";
    depends = with self; [ coq ocaml why3 (self.coq-flocq or null) ];
    buildDepends = with self; [ ocaml ocamlfind ];
  };
  zarith = {
    name = "zarith";
