...
} }:
{
  ...
  mirage-kv-mem = {
    ...
    version = "3.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/mirage-kv-mem/releases/download/v3.0.0/mirage-kv-mem-v3.0.0.tbz";
      sha256 = "be221354bf9d0813d5006e682824ffc7a47b5b35f4994c250f65dcf372b3ec8d";
    };
    opam = "${repo}/packages/mirage-kv-mem/mirage-kv-mem.3.0.0/opam";
    depends = with self; [ dune fmt mirage-clock mirage-clock-unix mirage-kv
                           ocaml ptime rresult ];
    buildDepends = with self; [ dune ocaml ];
  };
  mmap = {
