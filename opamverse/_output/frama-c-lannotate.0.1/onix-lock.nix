...
} }:
{
  ...
  frama-c-lannotate = {
    name = "frama-c-lannotate";
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://git.frama-c.com/pub/ltest/lannotate/-/archive/0.1/lannotate-0.1.tar.bz2";
    ...
    opam = "${repo}/packages/frama-c-lannotate/frama-c-lannotate.0.1/opam";
