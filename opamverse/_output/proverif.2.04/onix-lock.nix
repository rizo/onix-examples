...
} }:
{
  ...
  proverif = {
    ...
    version = "2.04";
    src = pkgs.fetchurl {
      url = "https://proverif.inria.fr/proverif2.04.tar.gz";
      sha256 = "0xgwnp59779xc40sb7ck8rmfn620pilxyq79l3bymj9m7z0mwvm9";
    };
    opam = "${repo}/packages/proverif/proverif.2.04/opam";
