...
} }:
{
  ...
  heptagon = {
    ...
    version = "1.05.00";
    src = pkgs.fetchurl {
      url = "https://github.com/ocaml/opam-source-archives/raw/main/heptagon-1.05.00.tar.gz";
      sha256 = "1jrh8w695mym22bqh3pp1a4aa61d1abkgmw921x9h110yikq1vlh";
    };
    opam = "${repo}/packages/heptagon/heptagon.1.05.00/opam";
    depends = with self; [ ocaml (self.lablgtk or null) (self.reatk or null) ];
    buildDepends = with self; [ camlp4 menhir ocaml ocamlbuild ocamlfind
                                ocamlgraph ];
  };
  menhir = {
    name = "menhir";
