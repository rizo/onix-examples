...
} }:
{
  ...
  nacc = {
    ...
    version = "1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/codeanonorg/nacc/releases/download/1.0/nacc-1.0.tbz";
      sha256 = "bf68a6a56150e3425b53dace30472552a01503ae5a1c5b274a864d442165d69f";
    };
    opam = "${repo}/packages/nacc/nacc.1.0/opam";
    depends = with self; [ dune ocaml ppx_deriving ppx_variants_conv ];
    buildDepends = with self; [ dune ocaml ];
  };
  ocaml = {
    name = "ocaml";
