...
} }:
{
  ...
  logs-ppx = {
    ...
    version = "0.2.0";
    src = pkgs.fetchurl {
      url = "https://github.com/ulrikstrid/logs-ppx/releases/download/v0.2.0/logs-ppx-0.2.0.tbz";
      sha256 = "053f043ef959d6dc079503eab482e91ac1509685d393c4b51f6991c210c0bfb1";
    };
    opam = "${repo}/packages/logs-ppx/logs-ppx.0.2.0/opam";
  ...
  um-abt = {
    ...
    version = "0.1.7";
    src = pkgs.fetchurl {
      url = "https://github.com/shonfeder/um-abt/releases/download/v0.1.7/um-abt-v0.1.7.tbz";
      sha256 = "9472873b4f485ff1c169d950488133c79efb4b00b757526bfb14a2f043a0480f";
    };
    opam = "${repo}/packages/um-abt/um-abt.0.1.7/opam";
    depends = with self; [ dune logs logs-ppx ppx_deriving ppx_expect
