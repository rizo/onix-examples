...
} }:
{
  ...
  sys-socket = {
    ...
    version = "1.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/toots/ocaml-sys-socket/archive/1.0.0.tar.gz";
    ...
    opam = "${repo}/packages/sys-socket/sys-socket.1.0.0/opam";
    depends = with self; [ ctypes dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  sys-socket-unix = {
    name = "sys-socket-unix";
    version = "1.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/toots/ocaml-sys-socket/archive/1.0.0.tar.gz";
      sha512 = "2fbfd846baebd259a8486be2af856569ee6f056298e8cf5874ba76f5c207626cc5854abe2e091d670f9bb605eeb19a416e47b3c8474b8cbc5957f6293b3ccddb";
    };
    opam = "${repo}/packages/sys-socket-unix/sys-socket-unix.1.0.0/opam";
    depends = with self; [ ctypes dune ocaml sys-socket unix-errno ];
    buildDepends = with self; [ dune ocaml ];
  };
  unix-errno = {
    name = "unix-errno";
