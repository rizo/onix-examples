...
} }:
{
  ...
  javalib = {
    ...
    version = "3.2.1";
    src = pkgs.fetchurl {
      url = "https://github.com/javalib-team/javalib/archive/v3.2.1.tar.gz";
    ...
    opam = "${repo}/packages/javalib/javalib.3.2.1/opam";
    depends = with self; [ camlzip extlib ocaml ];
  ...
  sawja = {
    ...
    version = "1.5.8";
    src = pkgs.fetchurl {
      url = "https://github.com/javalib-team/sawja/archive/v1.5.8.tar.gz";
      sha256 = "0lcv9i8ap6nmvid81zs73av2fxbm5j5v8gsc6z2ngb49b1d57f4g";
    };
    opam = "${repo}/packages/sawja/sawja.1.5.8/opam";
    depends = with self; [ javalib ocaml ];
    buildDepends = with self; [ conf-which ocaml ocamlfind ];
  };
}
