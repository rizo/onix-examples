...
} }:
{
  ...
  ometrics = {
    ...
    version = "0.2.1";
    src = pkgs.fetchurl {
      url = "https://github.com/vch9/ometrics/archive/0.2.1.tar.gz";
    ...
    opam = "${repo}/packages/ometrics/ometrics.0.2.1/opam";
    depends = with self; [ cmdliner digestif dune ocaml ppxlib ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppx_derivers = {
    name = "ppx_derivers";
