...
} }:
{
  ...
  irmin-mirage-graphql = {
    name = "irmin-mirage-graphql";
    version = "3.2.2";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/irmin/releases/download/3.2.2/irmin-3.2.2.tbz";
      sha256 = "fde223f91b7adb0118698f210356c9965b4a7ae87f61d19c7f2892d1a2d0bcb9";
    };
    opam = "${repo}/packages/irmin-mirage-graphql/irmin-mirage-graphql.3.2.2/opam";
    depends = with self; [ cohttp-lwt dune git irmin-graphql irmin-mirage lwt
                           mirage-clock uri ];
    buildDepends = with self; [ dune ];
  };
  jsonm = {
