...
} }:
{
  ...
  incr_dom_partial_render = {
    name = "incr_dom_partial_render";
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/incr_dom_partial_render-v0.15.0.tar.gz";
      sha256 = "c5e5f8af479d54492db802227b96e757bffed3bdf5aa1453185058be8a090e86";
    };
    opam = "${repo}/packages/incr_dom_partial_render/incr_dom_partial_render.v0.15.0/opam";
    depends = with self; [ dune incr_dom js_of_ocaml js_of_ocaml-ppx ocaml
                           ppx_jane splay_tree virtual_dom ];
    buildDepends = with self; [ dune ocaml ];
  };
  incr_map = {
    name = "incr_map";
