...
} }:
{
  ...
  xen-evtchn = {
    ...
    version = "2.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/ocaml-evtchn/releases/download/v2.1.0/xen-evtchn-v2.1.0.tbz";
      sha256 = "0gzvhx9hhlcdkg9mjam9qj22y18qyfgdkcqzm5s9wcf6gqkrmm1p";
    };
    opam = "${repo}/packages/xen-evtchn/xen-evtchn.2.1.0/opam";
    depends = with self; [ cmdliner dune lwt lwt-dllist ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
}
