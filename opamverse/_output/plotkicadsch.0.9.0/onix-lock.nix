...
} }:
{
  ...
  kicadsch = {
    ...
    version = "0.9.0";
    src = pkgs.fetchurl {
      url = "https://github.com/jnavila/plotkicadsch/releases/download/v0.9.0/plotkicadsch-0.9.0.tbz";
      sha256 = "07ebe710fc9ddd2533be24dd368caf624d29ec7ae0fd74c99bc2b1b18f00e234";
    };
    opam = "${repo}/packages/kicadsch/kicadsch.0.9.0/opam";
    depends = with self; [ dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  logs = {
  ...
  plotkicadsch = {
    ...
    opam = "${repo}/packages/plotkicadsch/plotkicadsch.0.9.0/opam";
    depends = with self; [ base64 cmdliner dune git git-unix kicadsch lwt
                           ocaml sha tyxml ];
