...
} }:
{
  ...
  osnap = {
    ...
    version = "0.3.0";
    src = pkgs.fetchurl {
      url = "https://github.com/vch9/osnap/archive/0.3.0.tar.gz";
    ...
    opam = "${repo}/packages/osnap/osnap.0.3.0/opam";
    depends = with self; [ data-encoding dune ocaml ppx_deriving qcheck-core ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppx_derivers = {
    name = "ppx_derivers";
