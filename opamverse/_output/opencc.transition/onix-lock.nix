...
} }:
{
  ...
  conf-opencc1 = {
    name = "conf-opencc1";
    version = "1";
    opam = "${repo}/packages/conf-opencc1/conf-opencc1.1/opam";
    depexts = with pkgs; [ (pkgs.app-i18n/opencc or null)
                           (pkgs.libopencc2 or null) (pkgs.opencc or null) ];
  };
  conf-pkg-config = {
  ...
  opencc = {
    name = "opencc";
    version = "transition";
    opam = "${repo}/packages/opencc/opencc.transition/opam";
    depends = with self; [ ocaml opencc1 ];
    buildDepends = with self; [ ocaml ];
  };
  opencc1 = {
    name = "opencc1";
    version = "1.0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/kandu/ocaml-opencc1/archive/refs/tags/1.0.1.tar.gz";
      sha256 = "1rz8f400x13z5nn5cpjxnq2bs864sc721lw02kl52vmnzxb5gcx6";
    };
    opam = "${repo}/packages/opencc1/opencc1.1.0.1/opam";
    depends = with self; [ conf-opencc1 ctypes ctypes-foreign dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  stdlib-shims = {
    name = "stdlib-shims";
