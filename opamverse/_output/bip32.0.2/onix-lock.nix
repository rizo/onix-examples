...
} }:
{
  ...
  bip32 = {
    ...
    opam = "${repo}/packages/bip32/bip32.0.2/opam";
    depends = with self; [ cstruct hex jbuilder ocaml secp256k1 ];
  ...
  secp256k1 = {
    ...
    version = "0.4.1";
    src = pkgs.fetchurl {
      url = "https://github.com/dakk/secp256k1-ml/archive/0.4.1.zip";
    ...
    opam = "${repo}/packages/secp256k1/secp256k1.0.4.1/opam";
    depends = with self; [ base-bigarray conf-secp256k1 dune ocaml ];
    buildDepends = with self; [ base dune dune-configurator ocaml stdio ];
