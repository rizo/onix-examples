...
} }:
{
  ...
  merlin-of-pds = {
    ...
    opam = "${repo}/packages/merlin-of-pds/merlin-of-pds.1.4/opam";
    depends = with self; [ ocaml ocamlfind ];
  ...
  revops = {
    ...
    opam = "${repo}/packages/revops/revops.2.5/opam";
    depends = with self; [ containers merlin-of-pds ocaml ocamlfind ];
    buildDepends = with self; [ ocaml ocamlfind pds ];
  };
  sedlex = {
    name = "sedlex";
