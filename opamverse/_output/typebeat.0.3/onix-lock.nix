...
} }:
{
  ...
  typebeat = {
    ...
    version = "0.3";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/typebeat/releases/download/v0.3/typebeat-0.3.tbz";
      sha256 = "1sb1sbzi0mq2bgm39g6nb7k4rhdl4bq0cxc49asfnbizbgm7jild";
    };
    opam = "${repo}/packages/typebeat/typebeat.0.3/opam";
    depends = with self; [ angstrom jbuilder ocaml ];
    buildDepends = with self; [ ocaml ];
  };
}
