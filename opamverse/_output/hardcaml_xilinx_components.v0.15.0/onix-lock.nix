...
} }:
{
  ...
  hardcaml_xilinx_components = {
    name = "hardcaml_xilinx_components";
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/hardcaml_xilinx_components-v0.15.0.tar.gz";
      sha256 = "1cf266f90fec2ec7d6053289f4aa9b753d233b29ddc0c9be1e7d19b97b75f3f8";
    };
    opam = "${repo}/packages/hardcaml_xilinx_components/hardcaml_xilinx_components.v0.15.0/opam";
    depends = with self; [ base core core_unix dune hardcaml ocaml ppx_jane
                           re stdio ];
    buildDepends = with self; [ dune ocaml ];
  };
  int_repr = {
