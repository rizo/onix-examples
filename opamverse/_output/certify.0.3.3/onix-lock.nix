...
} }:
{
  ...
  certify = {
    ...
    version = "0.3.3";
    src = pkgs.fetchurl {
      url = "https://github.com/yomimono/ocaml-certify/releases/download/v0.3.3/certify-v0.3.3.tbz";
      sha256 = "86252719dcbb7af84589727193663b7c082ceaaa5c4382faae383952fb2e8459";
    };
    opam = "${repo}/packages/certify/certify.0.3.3/opam";
    depends = with self; [ cmdliner cstruct dune mirage-crypto-pk
                           mirage-crypto-rng ocaml ptime x509 ];
    buildDepends = with self; [ dune ocaml ];
  };
  cmdliner = {
    name = "cmdliner";
  ...
  x509 = {
    ...
    version = "0.15.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirleft/ocaml-x509/releases/download/v0.15.0/x509-v0.15.0.tbz";
      sha256 = "d0971862f1c0f3362eac46691f45130b3517874e0226de44eacefff85f925eb9";
    };
    opam = "${repo}/packages/x509/x509.0.15.0/opam";
    depends = with self; [ asn1-combinators base64 cstruct domain-name dune
                           ...
                           mirage-crypto-rng ocaml pbkdf ptime rresult ];
    buildDepends = with self; [ dune ocaml ];
  };
  zarith = {
    name = "zarith";
