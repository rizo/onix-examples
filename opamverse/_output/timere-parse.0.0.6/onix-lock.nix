...
} }:
{
  ...
  timedesc = {
    ...
    version = "0.6.0";
    src = pkgs.fetchurl {
      url = "https://github.com/daypack-dev/timere/releases/download/desc-v0.6.0/desc-v0.6.0.tar.gz";
      sha256 = "7ef03e42740013b2a52d5bfe553b5025376b8d33b7d8befd8d6865625505f353";
    };
    opam = "${repo}/packages/timedesc/timedesc.0.6.0/opam";
  ...
  timere = {
    ...
    version = "0.7.0";
    src = pkgs.fetchurl {
      url = "https://github.com/daypack-dev/timere/releases/download/v0.7.0/v0.7.0.tar.gz";
      sha256 = "1fee8b8201899be96982918c17a4fa2952b18343f91d97b90743a38e4eb8b792";
    };
    opam = "${repo}/packages/timere/timere.0.7.0/opam";
  ...
  timere-parse = {
    ...
    version = "0.0.6";
    src = pkgs.fetchurl {
      url = "https://github.com/daypack-dev/timere/releases/download/parse-v0.0.6/parse-v0.0.6.tar.gz";
      sha256 = "a767ff83514b540e6805f93293e8a50db3e9343184ee834f475308db12ef0629";
    };
    opam = "${repo}/packages/timere-parse/timere-parse.0.0.6/opam";
    depends = with self; [ containers dune mparser ocaml oseq re timedesc
                           timere ];
    buildDepends = with self; [ dune ocaml ];
  };
  topkg = {
