...
} }:
{
  ...
  data-encoding = {
    ...
    version = "0.5.3";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/nomadic-labs/data-encoding/-/archive/v0.5.3/data-encoding-v0.5.3.tar.gz";
    ...
    opam = "${repo}/packages/data-encoding/data-encoding.0.5.3/opam";
    depends = with self; [ dune either ezjsonm hex json-data-encoding
  ...
  ppx_deriving_qcheck = {
    ...
    version = "0.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/vch9/ppx_qcheck/archive/v0.1.0.tar.gz";
    ...
    opam = "${repo}/packages/ppx_deriving_qcheck/ppx_deriving_qcheck.0.1.0/opam";
    depends = with self; [ dune ocaml ppxlib qcheck ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppx_pbt = {
    name = "ppx_pbt";
    version = "0.2.1";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/vch9/ppx_pbt/-/archive/v0.2.1/ppx_pbt-v0.2.1.tar.gz";
    ...
    opam = "${repo}/packages/ppx_pbt/ppx_pbt.0.2.1/opam";
    depends = with self; [ data-encoding dune menhir ocaml ppx_deriving
                           ppx_deriving_qcheck qcheck qcheck-alcotest zarith ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppxlib = {
    name = "ppxlib";
