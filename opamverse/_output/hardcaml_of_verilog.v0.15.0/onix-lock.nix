...
} }:
{
  ...
  hardcaml_of_verilog = {
    name = "hardcaml_of_verilog";
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/hardcaml_of_verilog-v0.15.0.tar.gz";
      sha256 = "2548df37bf5dae8a61f6042e2bb1120272697b1b331707f9989d267890c3ee0d";
    };
    opam = "${repo}/packages/hardcaml_of_verilog/hardcaml_of_verilog.v0.15.0/opam";
    depends = with self; [ base core_unix dune hardcaml jsonaf ocaml
                           ppx_deriving_hardcaml ppx_jane ppx_jsonaf_conv
                           stdio ];
    buildDepends = with self; [ dune ocaml ];
  };
  int_repr = {
  ...
  ppx_jsonaf_conv = {
    name = "ppx_jsonaf_conv";
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/ppx_jsonaf_conv-v0.15.0.tar.gz";
      sha256 = "cf590ec1e9906d0666f063093962e4a2749609ae67a9bc54b9094e8095043763";
    };
    opam = "${repo}/packages/ppx_jsonaf_conv/ppx_jsonaf_conv.v0.15.0/opam";
    depends = with self; [ base dune jsonaf ocaml ppx_jane ppxlib ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppx_let = {
    name = "ppx_let";
