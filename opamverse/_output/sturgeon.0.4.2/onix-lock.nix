...
} }:
{
  ...
  inuit = {
    ...
    version = "0.4.1";
    src = pkgs.fetchurl {
      url = "https://github.com/let-def/inuit/releases/download/v0.4.1/inuit-0.4.1.tbz";
      sha256 = "1ma0f7z3g8hksvxg3z4dr65a89dwdky8344jbpk65hnzj0f9d2z6";
    };
    opam = "${repo}/packages/inuit/inuit.0.4.1/opam";
    depends = with self; [ grenier jbuilder ocaml ];
  ...
  sturgeon = {
    ...
    version = "0.4.2";
    src = pkgs.fetchurl {
      url = "https://github.com/let-def/sturgeon/archive/v0.4.2.tar.gz";
    ...
    opam = "${repo}/packages/sturgeon/sturgeon.0.4.2/opam";
    depends = with self; [ dune inuit ocaml result ];
    buildDepends = with self; [ dune ocaml ];
  };
}
