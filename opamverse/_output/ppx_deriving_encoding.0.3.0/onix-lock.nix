...
} }:
{
  ...
  ppx_deriving_encoding = {
    ...
    opam = "${repo}/packages/ppx_deriving_encoding/ppx_deriving_encoding.0.3.0/opam";
    depends = with self; [ dune json-data-encoding ocaml ppxlib ];
