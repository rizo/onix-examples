...
} }:
{
  ...
  mc2 = {
    ...
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/c-cube/mc2/archive/v0.1.tar.gz";
    ...
    opam = "${repo}/packages/mc2/mc2.0.1/opam";
    depends = with self; [ containers dune iter menhir ocaml smtlib-utils
                           zarith ];
    buildDepends = with self; [ dune ocaml ];
  };
  menhir = {
  ...
  smtlib-utils = {
    ...
    version = "0.2";
    src = pkgs.fetchurl {
      url = "https://github.com/c-cube/smtlib-utils/archive/v0.2.tar.gz";
    ...
    opam = "${repo}/packages/smtlib-utils/smtlib-utils.0.2/opam";
