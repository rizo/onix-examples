...
} }:
{
  ...
  win-eventlog = {
    ...
    version = "0.4";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/ocaml-win-eventlog/releases/download/0.4/win-eventlog-0.4.tbz";
      sha256 = "f67b192436e2716eaab0396643a73ca8b3af92f22510d6a5f3f43080dcdb0169";
    };
    opam = "${repo}/packages/win-eventlog/win-eventlog.0.4/opam";
    depends = with self; [ base-unix dune logs ocaml result ];
    buildDepends = with self; [ dune ocaml ];
  };
}
