...
} }:
{
  ...
  bookaml = {
    ...
    opam = "${repo}/packages/bookaml/bookaml.4.0/opam";
    depends = with self; [ batteries calendar camlp4 cryptokit ocaml
                           ocamlfind ocamlnet ppx_deriving ppx_sexp_conv
                           sexplib tyxml (self.lwt or null)
                           (self.ocsigenserver or null) ];
    buildDepends = with self; [ ocaml ocamlbuild ocamlfind ];
  };
  calendar = {
    name = "calendar";
  ...
  tyxml = {
    ...
    opam = "${repo}/packages/tyxml/tyxml.4.2.0/opam";
    depends = with self; [ base-bytes ocaml re uchar uutf
                           (self.camlp4 or null) (self.markup or null)
                           (self.ppx_tools_versioned or null) ];
    buildDepends = with self; [ ocaml ocamlbuild ocamlfind ];
  };
  uchar = {
    name = "uchar";
