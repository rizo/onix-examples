...
} }:
{
  ...
  cpdf = {
    ...
    version = "2.5";
    src = pkgs.fetchurl {
      url = "https://github.com/johnwhitington/cpdf-source/archive/v2.5.zip";
      sha256 = "03ghvjj4qnfclrd3h73y5alrw9p31cllcsqwn59hsiflljffsbji";
    };
    opam = "${repo}/packages/cpdf/cpdf.2.5/opam";
    depends = with self; [ camlpdf ocaml ];
