...
} }:
{
  ...
  dot-merlin-reader = {
    ...
    version = "4.2";
    src = pkgs.fetchurl {
      url = "https://github.com/ocaml/merlin/releases/download/v4.5-414/merlin-4.5-414.tbz";
      sha256 = "31587b422b5ebd3eebda730e946868807d829128f8dc7153fb05c0c82742058e";
    };
    opam = "${repo}/packages/dot-merlin-reader/dot-merlin-reader.4.2/opam";
    depends = with self; [ csexp dune ocaml ocamlfind yojson ];
  ...
  ecaml = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/ecaml-v0.15.0.tar.gz";
      sha256 = "89f2806dd37012b07ddbaf40c2d9cfb9de29289944d921d23f4fd9b93d5c7cba";
    };
    opam = "${repo}/packages/ecaml/ecaml.v0.15.0/opam";
    depends = with self; [ async async_kernel async_unix core core_kernel
                           core_unix dune expect_test_helpers_core ocaml
                           ppx_jane ];
    buildDepends = with self; [ dune ocaml ];
  };
  ...
  gopcaml-mode-merlin = {
    name = "gopcaml-mode-merlin";
    version = "0.0.4";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/gopiandcode/gopcaml-mode/uploads/baa1e6a4bc822774118919181f9e879e/gopcaml-mode-0.0.4-merlin.tar.gz";
      sha256 = "1kdl11rq1lwx19lmqxhw2fckkz5ayn4pl1nmh7rc8lq1vl0syzzk";
    };
    opam = "${repo}/packages/gopcaml-mode-merlin/gopcaml-mode-merlin.0.0.4/opam";
    depends = with self; [ core csexp dot-merlin-reader dune ecaml merlin
                           ocaml ocp-indent ppx_deriving ppx_here ppx_let
                           ppx_sexp_conv result yojson ];
    buildDepends = with self; [ dune ocaml ];
  };
  int_repr = {
    name = "int_repr";
  ...
  merlin = {
    ...
    version = "4.5+412";
    src = pkgs.fetchurl {
      url = "https://github.com/ocaml/merlin/releases/download/v4.5-412/merlin-4.5-412.tbz";
      sha256 = "3f3868ede63b6277bb38e4d1963a16a36a3bfd2769bfa3bc6cbcdaf85d1eac44";
    };
    opam = "${repo}/packages/merlin/merlin.4.5-412/opam";
    depends = with self; [ csexp dot-merlin-reader dune ocaml yojson ];
    buildDepends = with self; [ dune ocaml ];
  };
  num = {
    name = "num";
