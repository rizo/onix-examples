...
} }:
{
  ...
  jose = {
    ...
    version = "0.7.0";
    src = pkgs.fetchurl {
      url = "https://github.com/ulrikstrid/reason-jose/releases/download/v0.7.0/jose-v0.7.0.tbz";
      sha256 = "d831a77f805a49278ccff8b8509f95d68e71c1ffdd4eda89f909a6ff99c2248c";
    };
    opam = "${repo}/packages/jose/jose.0.7.0/opam";
    depends = with self; [ astring base64 cstruct dune eqaf mirage-crypto
                           ocaml x509 yojson zarith ];
    buildDepends = with self; [ dune ocaml ];
  };
  logs = {
    name = "logs";
  ...
  oidc = {
    ...
    version = "0.1.1";
    src = pkgs.fetchurl {
      url = "https://github.com/ulrikstrid/ocaml-oidc/releases/download/v0.1.1/oidc-v0.1.1.tbz";
      sha256 = "de551d194f2152ec48039d51710d7f66d7598e8c030214aef9321bb1e22aabd6";
    };
    opam = "${repo}/packages/oidc/oidc.0.1.1/opam";
    depends = with self; [ dune jose logs ocaml uri yojson ];
    buildDepends = with self; [ dune ocaml ];
  };
  pbkdf = {
    name = "pbkdf";
