...
} }:
{
  ...
  ffmpeg = {
    ...
    opam = "${repo}/packages/ffmpeg/ffmpeg.1.1.3/opam";
    depends = with self; [ dune ffmpeg-av ffmpeg-avcodec ffmpeg-avdevice
                           ffmpeg-avfilter ffmpeg-avutil ffmpeg-swresample
                           ffmpeg-swscale ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  ffmpeg-av = {
    name = "ffmpeg-av";
    ...
    opam = "${repo}/packages/ffmpeg-av/ffmpeg-av.1.1.3/opam";
  ...
  ffmpeg-avdevice = {
    ...
    opam = "${repo}/packages/ffmpeg-avdevice/ffmpeg-avdevice.1.1.3/opam";
    depends = with self; [ dune ffmpeg-av ocaml ];
    buildDepends = with self; [ conf-ffmpeg conf-pkg-config dune
                                dune-configurator ocaml ];
  };
  ffmpeg-avfilter = {
    ...
    opam = "${repo}/packages/ffmpeg-avfilter/ffmpeg-avfilter.1.1.3/opam";
    depends = with self; [ dune ffmpeg-avutil ocaml ];
    buildDepends = with self; [ conf-ffmpeg conf-pkg-config dune
                                dune-configurator ocaml ];
  };
  ...
  ffmpeg-swscale = {
    ...
    opam = "${repo}/packages/ffmpeg-swscale/ffmpeg-swscale.1.1.3/opam";
    depends = with self; [ dune ffmpeg-avutil ocaml ];
    buildDepends = with self; [ conf-ffmpeg conf-pkg-config dune
                                dune-configurator ocaml ];
  };
