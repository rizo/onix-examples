...
} }:
{
  ...
  radare2 = {
    ...
    version = "0.0.7";
    src = pkgs.fetchurl {
      url = "https://github.com/fxfactorial/ocaml-radare2/archive/v0.0.7.tar.gz";
    ...
    opam = "${repo}/packages/radare2/radare2.0.0.7/opam";
    depends = with self; [ base-unix conf-radare2 dune ocaml
                           (self.yojson or null)
                           (self.yojson-android or null) ];
    buildDepends = with self; [ dune ocaml ];
  };
  yojson = {
    name = "yojson";
