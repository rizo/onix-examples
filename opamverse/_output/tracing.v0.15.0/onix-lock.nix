...
} }:
{
  ...
  tracing = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/tracing-v0.15.0.tar.gz";
      sha256 = "41b85b4f6972cc6ec4c98a9d65b32a840005ad212bcf49dfa732250b43392ad1";
    };
    opam = "${repo}/packages/tracing/tracing.v0.15.0/opam";
    depends = with self; [ async core core_kernel core_unix dune ocaml
                           ppx_jane ];
    buildDepends = with self; [ dune ocaml ];
  };
  typerep = {
