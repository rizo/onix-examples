...
} }:
{
  ...
  pyml_bindgen = {
    ...
    version = "0.3.1";
    src = pkgs.fetchurl {
      url = "https://github.com/mooreryan/ocaml_python_bindgen/archive/0.3.1.tar.gz";
    ...
    opam = "${repo}/packages/pyml_bindgen/pyml_bindgen.0.3.1/opam";
    depends = with self; [ angstrom base cmdliner dune ocaml ppx_let
                           ppx_sexp_conv ppx_string re stdio ];
    buildDepends = with self; [ dune ocaml ];
  };
  re = {
    name = "re";
