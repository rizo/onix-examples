...
} }:
{
  ...
  orrandomForest = {
    ...
    version = "3.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/UnixJunkie/orrandomForest/archive/v3.0.0.tar.gz";
      sha256 = "00nq1b11mmcflgfvrdfh4w9pndr41vxp095pqn4z6q3l0fglzn69";
    };
    opam = "${repo}/packages/orrandomForest/orrandomForest.3.0.0/opam";
    depends = with self; [ batteries conf-r cpm dolog dune line_oriented
