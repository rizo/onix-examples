...
} }:
{
  ...
  travis-opam = {
    ...
    version = "1.5.0";
    src = pkgs.fetchurl {
      url = "https://github.com/ocaml/ocaml-ci-scripts/releases/download/1.5.0/travis-opam-1.5.0.tbz";
      sha256 = "4b878eccad8eb3bf0d7d3e0c144e4eacfb8075c058bafafd1a1f3c122d3ca012";
    };
    opam = "${repo}/packages/travis-opam/travis-opam.1.5.0/opam";
    depends = with self; [ dune ocaml ];
    buildDepends = with self; [ dune jsonm ocaml opam-file-format ];
  };
  uchar = {
    name = "uchar";
    version = "0.0.2";
