...
} }:
{
  ...
  tezos-embedded-protocol-alpha = {
    ...
    opam = "${repo}/packages/tezos-embedded-protocol-alpha/tezos-embedded-protocol-alpha.9.7/opam";
    depends = with self; [ dune tezos-protocol-alpha tezos-protocol-updater ];
    buildDepends = with self; [ dune ];
  };
  tezos-error-monad = {
  ...
  tezos-protocol-plugin-alpha-registerer = {
    ...
    opam = "${repo}/packages/tezos-protocol-plugin-alpha-registerer/tezos-protocol-plugin-alpha-registerer.9.7/opam";
    depends = with self; [ dune tezos-embedded-protocol-alpha
                           tezos-protocol-plugin-alpha tezos-shell ];
    buildDepends = with self; [ dune ];
  };
