...
} }:
{
  ...
  equinoxe = {
    ...
    version = "0.2.0";
    src = pkgs.fetchurl {
      url = "https://github.com/maiste/equinoxe/releases/download/0.2.0/equinoxe-0.2.0.tbz";
      sha256 = "53a77e52522f4ddc271678c5a2b3639b59519bcc7d05dc55e751f854c9f25cdb";
    };
    opam = "${repo}/packages/equinoxe/equinoxe.0.2.0/opam";
    depends = with self; [ dune ezjsonm lwt ocaml odate ];
    buildDepends = with self; [ dune ocaml ];
  };
  equinoxe-cohttp = {
    ...
    opam = "${repo}/packages/equinoxe-cohttp/equinoxe-cohttp.0.2.0/opam";
    depends = with self; [ cohttp-lwt-unix dune equinoxe ];
