...
} }:
{
  ...
  conf-llvm = {
    name = "conf-llvm";
    version = "9.0.0";
    opam = "${repo}/packages/conf-llvm/conf-llvm.9.0.0/opam";
    depexts = with pkgs; [ (pkgs.devel/llvm90 or null)
                           (pkgs.epel-release or null)
                           (pkgs.llvm-9-dev or null) (pkgs.llvm-9.0 or null)
                           (pkgs.llvm9-dev or null)
                           (pkgs.llvm9-devel or null)
                           (pkgs.llvm9.0-devel or null) (pkgs.llvm@9 or null) ];
  };
  conf-python-2-7 = {
  ...
  llvm = {
    ...
    opam = "${repo}/packages/llvm/llvm.9.0.0/opam";
    depends = with self; [ ctypes ocaml ];
    buildDepends = with self; [ conf-cmake conf-llvm conf-python-2-7 ocaml
                                ocamlfind ];
  };
  ocaml = {
    name = "ocaml";
