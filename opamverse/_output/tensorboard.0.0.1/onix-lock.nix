...
} }:
{
  ...
  tensorboard = {
    ...
    version = "0.0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/LaurentMazare/ocaml-tensorboard/archive/0.0.1.tar.gz";
    ...
    opam = "${repo}/packages/tensorboard/tensorboard.0.0.1/opam";
    depends = with self; [ base bigstringaf dune ocaml stdio ];
    buildDepends = with self; [ dune ocaml ];
  };
}
