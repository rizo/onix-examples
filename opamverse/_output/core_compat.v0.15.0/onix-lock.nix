...
} }:
{
  ...
  core_compat = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/core_compat-v0.15.0.tar.gz";
      sha256 = "79a8be8f5825513e28be756a16f4d49c2cbacc42c7eb36cfd4917cecf3391ca2";
    };
    opam = "${repo}/packages/core_compat/core_compat.v0.15.0/opam";
    depends = with self; [ core_kernel core_unix dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  core_kernel = {
    name = "core_kernel";
