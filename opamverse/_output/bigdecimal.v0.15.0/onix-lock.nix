...
} }:
{
  ...
  bigdecimal = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/bigdecimal-v0.15.0.tar.gz";
      sha256 = "d88f5c18ca9d879b3e1868db7d0c7c52b162bbd3b8323e53c9deec97611cef9b";
    };
    opam = "${repo}/packages/bigdecimal/bigdecimal.v0.15.0/opam";
    depends = with self; [ bignum core dune expect_test_helpers_core ocaml
                           ppx_jane zarith ];
    buildDepends = with self; [ dune ocaml ];
  };
  bignum = {
