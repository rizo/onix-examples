...
} }:
{
  ...
  bitcoin = {
    ...
    opam = "${repo}/packages/bitcoin/bitcoin.2.0/opam";
    depends = with self; [ cryptokit ocaml yojson (self.cohttp or null)
                           (self.ocamlnet or null)
                           (self.ocsigenserver or null) (self.ocurl or null) ];
