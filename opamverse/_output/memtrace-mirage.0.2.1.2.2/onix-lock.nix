...
} }:
{
  ...
  memtrace-mirage = {
    ...
    version = "0.2.1.2.2";
    src = pkgs.fetchurl {
      url = "https://github.com/hannesm/memtrace-mirage/releases/download/v0.2.1.2.2/memtrace-mirage-0.2.1.2.2.tbz";
      sha256 = "34b0464af8399bc8b1c9a1de907d6fcc4bab135879e1f650c63bf658cd300f8e";
    };
    opam = "${repo}/packages/memtrace-mirage/memtrace-mirage.0.2.1.2.2/opam";
    depends = with self; [ dune lwt mirage-clock mirage-flow ocaml ptime ];
    buildDepends = with self; [ dune ocaml ];
  };
  mirage-clock = {
    name = "mirage-clock";
