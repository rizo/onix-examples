...
} }:
{
  ...
  dune-expand = {
    ...
    version = "0.0.1";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/gopiandcode/dune-expand/-/archive/0.0.1/dune-expand-0.0.1.tar.gz";
      sha512 = "396f26f458d5a7091c4269c598ef130b24e37dfc840c26c93c406ff032cda9973a1169747798922c19734bae1981e850e0012c7e31395ec2ad1ea17f9591ee7d";
    };
    opam = "${repo}/packages/dune-expand/dune-expand.0.0.1/opam";
    depends = with self; [ cmdliner core dune ocaml ppx_deriving
