...
} }:
{
  ...
  tezos-011-PtHangz2-test-helpers = {
    name = "tezos-011-PtHangz2-test-helpers";
    version = "12.3";
    src = pkgs.fetchurl {
    ...
    opam = "${repo}/packages/tezos-011-PtHangz2-test-helpers/tezos-011-PtHangz2-test-helpers.12.3/opam";
    depends = with self; [ alcotest-lwt dune tezos-client-011-PtHangz2
