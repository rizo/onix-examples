...
} }:
{
  ...
  tezos-client-demo-counter = {
    ...
    opam = "${repo}/packages/tezos-client-demo-counter/tezos-client-demo-counter.9.7/opam";
  ...
  tezos-protocol-demo-counter = {
    ...
    opam = "${repo}/packages/tezos-protocol-demo-counter/tezos-protocol-demo-counter.9.7/opam";
