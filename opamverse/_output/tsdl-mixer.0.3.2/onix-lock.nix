...
} }:
{
  ...
  conf-sdl2-mixer = {
    ...
    version = "1";
    opam = "${repo}/packages/conf-sdl2-mixer/conf-sdl2-mixer.1/opam";
    buildDepends = with self; [ conf-pkg-config ];
    depexts = with pkgs; [ (pkgs.SDL2_mixer-devel or null)
                           (pkgs.libSDL2_mixer-devel or null)
                           (pkgs.libsdl2-mixer-dev or null)
                           (pkgs.libsdl2_mixer-devel or null)
                           (pkgs.sdl2-mixer or null)
                           (pkgs.sdl2_mixer or null)
                           (pkgs.sdl2_mixer-dev or null) ];
  };
  csexp = {
    name = "csexp";
    version = "1.5.1";
  ...
  tsdl-mixer = {
    ...
    version = "0.3.2";
    src = pkgs.fetchurl {
      url = "https://github.com/sanette/tsdl-mixer/archive/0.3.2.tar.gz";
    ...
    opam = "${repo}/packages/tsdl-mixer/tsdl-mixer.0.3.2/opam";
    depends = with self; [ conf-sdl2-mixer ctypes ctypes-foreign dune
