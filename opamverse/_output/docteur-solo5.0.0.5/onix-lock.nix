...
} }:
{
  ...
  art = {
    ...
    version = "0.1.1";
    src = pkgs.fetchurl {
      url = "https://github.com/dinosaure/art/releases/download/v0.1.1/art-v0.1.1.tbz";
      sha256 = "3aa83eb744f50e7e141de93eec5f3788da6160df090958ad1a10cf3645bf5497";
    };
    opam = "${repo}/packages/art/art.0.1.1/opam";
    depends = with self; [ base-bytes dune fmt ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  asn1-combinators = {
  ...
  docteur = {
    ...
    version = "0.0.5";
    src = pkgs.fetchurl {
      url = "https://github.com/dinosaure/docteur/releases/download/v0.0.5/docteur-0.0.5.tbz";
      sha256 = "41bf2d7b493276f62cbdfa394c8f574727f1dee4c266dc94b587e7cad8cbcb8b";
    };
    opam = "${repo}/packages/docteur/docteur.0.0.5/opam";
    depends = with self; [ art bigstringaf bos carton cmdliner digestif dune
                           fmt fpath git git-unix logs lwt mtime ocaml result
                           rresult ];
    buildDepends = with self; [ dune ocaml ];
  };
  docteur-solo5 = {
    ...
    opam = "${repo}/packages/docteur-solo5/docteur-solo5.0.0.5/opam";
    depends = with self; [ art bigstringaf carton digestif docteur dune git
                           hxd lwt mirage-block-solo5 mirage-kv mirage-solo5
                           ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  domain-name = {
  ...
  mirage-block-solo5 = {
    ...
    version = "0.8.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/mirage-block-solo5/releases/download/v0.8.0/mirage-block-solo5-0.8.0.tbz";
      sha256 = "0619677d13a44246383ca32dfe4c2554652e9650ca4c4a5d35b1b00c58b411e7";
    };
    opam = "${repo}/packages/mirage-block-solo5/mirage-block-solo5.0.8.0/opam";
    depends = with self; [ cstruct dune fmt lwt mirage-block mirage-solo5
                           ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  mirage-clock = {
  ...
  mirage-solo5 = {
    ...
    version = "0.8.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/mirage-solo5/releases/download/v0.8.0/mirage-solo5-0.8.0.tbz";
      sha256 = "728dbcdf38041d3efce42987349085ece82f2dac166031421575b29fec9ba44d";
    };
    opam = "${repo}/packages/mirage-solo5/mirage-solo5.0.8.0/opam";
    depends = with self; [ bheap cstruct dune duration lwt metrics
                           mirage-runtime ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  mirage-time = {
    name = "mirage-time";
