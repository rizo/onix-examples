...
} }:
{
  ...
  kyotocabinet = {
    ...
    opam = "${repo}/packages/kyotocabinet/kyotocabinet.0.2/opam";
    depends = with self; [ jbuilder ocaml ];
    buildDepends = with self; [ ocaml ];
    depexts = with pkgs; [ (pkgs.kyoto-cabinet or null)
                           (pkgs.kyotocabinet or null)
                           (pkgs.kyotocabinet-devel or null)
                           (pkgs.libkyotocabinet-dev or null) ];
  };
  ocaml = {
    name = "ocaml";
    version = "4.14.0";
