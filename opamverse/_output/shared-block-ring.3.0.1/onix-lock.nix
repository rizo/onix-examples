...
} }:
{
  ...
  mirage-block-unix = {
    ...
    version = "2.14.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/mirage-block-unix/releases/download/v2.14.0/mirage-block-unix-2.14.0.tbz";
      sha256 = "c321b924621e306c71dd7b5b225f59ad0d389e6f5a3d2bd77fa08d76df723db5";
    };
    opam = "${repo}/packages/mirage-block-unix/mirage-block-unix.2.14.0/opam";
    depends = with self; [ cstruct cstruct-lwt dune io-page logs lwt
                           mirage-block ocaml rresult uri ];
    buildDepends = with self; [ dune ocaml ];
  };
  mirage-clock = {
    name = "mirage-clock";
  ...
  shared-block-ring = {
    ...
    version = "3.0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/shared-block-ring/releases/download/v3.0.1/shared-block-ring-3.0.1.tbz";
      sha256 = "cf2ad61fbbf598f2aa6cb85fbea2e554a0a1fdaaadb0c8161eccbaa1910f3b83";
    };
    opam = "${repo}/packages/shared-block-ring/shared-block-ring.3.0.1/opam";
    depends = with self; [ cmdliner cstruct dune duration io-page logs lwt
                           lwt_log mirage-block mirage-block-unix
                           mirage-clock mirage-time mirage-time-unix ocaml
                           ppx_cstruct ppx_sexp_conv result rresult sexplib
                           sexplib0 ];
    buildDepends = with self; [ dune ocaml ];
  };
  stdlib-shims = {
