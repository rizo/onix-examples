...
} }:
{
  ...
  binaryen = {
    ...
    version = "0.9.1";
    src = pkgs.fetchurl {
      url = "https://github.com/grain-lang/binaryen.ml/releases/download/v0.9.1/binaryen-archive-v0.9.1.tar.gz";
    ...
    opam = "${repo}/packages/binaryen/binaryen.0.9.1/opam";
    depends = with self; [ dune dune-configurator js_of_ocaml
                           js_of_ocaml-compiler js_of_ocaml-ppx ocaml ];
