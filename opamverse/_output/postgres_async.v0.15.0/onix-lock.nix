...
} }:
{
  ...
  postgres_async = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/postgres_async-v0.15.0.tar.gz";
      sha256 = "9bbf2cb4fc2fcb43147591ad4996ff96b8f6173da61c518da7d5e18bb0090339";
    };
    opam = "${repo}/packages/postgres_async/postgres_async.v0.15.0/opam";
    depends = with self; [ async core core_kernel dune ocaml ppx_jane ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppx_assert = {
    name = "ppx_assert";
