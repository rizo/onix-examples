...
} }:
{
  ...
  monorobot = {
    ...
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/ahrefs/monorobot/archive/0.1.tar.gz";
    ...
    opam = "${repo}/packages/monorobot/monorobot.0.1/opam";
    depends = with self; [ atd atdgen atdgen-runtime base base64 biniou
                           cmdliner cstruct devkit dune extlib hex lwt
                           lwt_ppx nocrypto ocaml omd re2 stdio uri yojson ];
    buildDepends = with self; [ dune ocaml ];
  };
  nocrypto = {
    name = "nocrypto";
