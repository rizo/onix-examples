...
} }:
{
  ...
  opam-compiler = {
    ...
    version = "0.1.1";
    src = pkgs.fetchurl {
      url = "https://github.com/ocaml-opam/opam-compiler/releases/download/0.1.1/opam-compiler-0.1.1.tbz";
      sha256 = "ad8b2223ec760c6c6725b31e14a6aafe79d62873ef50a6cb72525ac7fad91c79";
    };
    opam = "${repo}/packages/opam-compiler/opam-compiler.0.1.1/opam";
    depends = with self; [ bos cmdliner dune github-unix lwt_ssl ocaml re ];
    buildDepends = with self; [ dune ocaml ];
  };
  parsexp = {
    name = "parsexp";
