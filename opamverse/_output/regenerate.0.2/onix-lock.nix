...
} }:
{
  ...
  regenerate = {
    ...
    version = "0.2";
    src = pkgs.fetchurl {
      url = "https://github.com/regex-generate/regenerate/releases/download/0.2/regenerate-0.2.tbz";
      sha256 = "12495bc3692524dd62e7231e956df4afd7e6b69970deb865e8feafb232e734b2";
    };
    opam = "${repo}/packages/regenerate/regenerate.0.2/opam";
    depends = with self; [ cmdliner containers dune fmt iter mtime ocaml oseq
                           qcheck ];
    buildDepends = with self; [ dune ocaml ];
  };
  result = {
