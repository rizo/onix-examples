...
} }:
{
  ...
  get_line = {
    ...
    version = "7.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/UnixJunkie/get_line/archive/v7.0.0.tar.gz";
      sha256 = "0vc1bjm19iqxs4a62vqfv6j0szvqb2b57fmh7b9xf86fmfl15bj0";
    };
    opam = "${repo}/packages/get_line/get_line.7.0.0/opam";
    depends = with self; [ batteries dune ];
