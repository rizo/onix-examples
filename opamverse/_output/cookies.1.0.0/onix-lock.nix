...
} }:
{
  ...
  cookies = {
    ...
    version = "1.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/lemaetech/cookies/releases/download/v1.0.0/cookies-v1.0.0.tbz";
      sha256 = "0a3f3de3d6fe517c176ca11761f945b4b32d5d315b1b23fc0054c3491994a1de";
    };
    opam = "${repo}/packages/cookies/cookies.1.0.0/opam";
    depends = with self; [ dune ocaml ppx_deriving ppx_fields_conv
                           ppx_sexp_conv ppx_variants_conv ptime sexplib0 ];
    buildDepends = with self; [ dune ocaml ];
  };
  cppo = {
    name = "cppo";
