...
} }:
{
  ...
  cactus = {
    ...
    version = "1.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/cactus/releases/download/1.0.0/cactus-1.0.0.tbz";
      sha256 = "2332a10e6bf52c8fd6b3a6587551271072eb77373824b18885dbb575dfe1707f";
    };
    opam = "${repo}/packages/cactus/cactus.1.0.0/opam";
    depends = with self; [ bentov dune hex logs lru mtime ocaml optint
                           ppx_repr progress repr ];
    buildDepends = with self; [ dune ocaml ];
  };
  cmdliner = {
    name = "cmdliner";
