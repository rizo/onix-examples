...
} }:
{
  ...
  pyast = {
    ...
    version = "0.1.1";
    src = pkgs.fetchurl {
      url = "https://github.com/thierry-martinez/pyast/archive/refs/tags/v0.1.1.tar.gz";
    ...
    opam = "${repo}/packages/pyast/pyast.0.1.1/opam";
    depends = with self; [ cmdliner dune menhir ocaml pyml redirect refl
                           stdcompat ];
    buildDepends = with self; [ dune ocaml ];
  };
  pyml = {
