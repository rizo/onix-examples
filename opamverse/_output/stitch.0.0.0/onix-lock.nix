...
} }:
{
  ...
  stitch = {
    ...
    version = "0.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/cryptosense/ocaml-stitch/releases/download/v0.0.0/stitch-v0.0.0.tbz";
      sha256 = "0jr7hh2d4krk84xi5lr8srhz226skbhp14p9cvf582i9qwqz99xy";
    };
    opam = "${repo}/packages/stitch/stitch.0.0.0/opam";
    depends = with self; [ containers dune ocaml ounit ppx_deriving
