...
} }:
{
  ...
  naboris = {
    ...
    version = "0.1.3";
    src = pkgs.fetchurl {
      url = "https://github.com/shawn-mcginty/naboris/archive/0.1.3.tar.gz";
    ...
    opam = "${repo}/packages/naboris/naboris.0.1.3/opam";
    depends = with self; [ base64 digestif dune httpaf httpaf-lwt-unix lwt
                           lwt_ppx ocaml re reason uri
