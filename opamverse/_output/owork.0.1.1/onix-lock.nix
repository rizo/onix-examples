...
} }:
{
  ...
  owork = {
    ...
    version = "0.1.1";
    src = pkgs.fetchurl {
      url = "https://github.com/jeffa5/owork/releases/download/0.1.1/owork-0.1.1.tbz";
      sha256 = "d35630a90700fcee9451709b1fc85ecc1381a67cd122fd7949b15e72c6c1143a";
    };
    opam = "${repo}/packages/owork/owork.0.1.1/opam";
    depends = with self; [ astring cmdliner dune duration fmt logs lwt
                           lwt_ppx ocaml ppx_deriving ppx_expect ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppx_assert = {
    name = "ppx_assert";
