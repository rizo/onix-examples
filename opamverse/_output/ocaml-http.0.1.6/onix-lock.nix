...
} }:
{
  ...
  ocaml-http = {
    ...
    version = "0.1.6";
    src = pkgs.fetchurl {
      url = "https://github.com/sacerdot/ocaml-http/archive/v0.1.6.tar.gz";
    ...
    opam = "${repo}/packages/ocaml-http/ocaml-http.0.1.6/opam";
    depends = with self; [ ocaml ocamlnet pcre ];
    buildDepends = with self; [ ocaml ocamlfind ];
  };
  ocamlbuild = {
    name = "ocamlbuild";
