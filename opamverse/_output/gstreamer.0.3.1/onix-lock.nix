...
} }:
{
  ...
  gstreamer = {
    ...
    version = "0.3.1";
    src = pkgs.fetchurl {
      url = "https://github.com/savonet/ocaml-gstreamer/archive/v0.3.1.tar.gz";
    ...
    opam = "${repo}/packages/gstreamer/gstreamer.0.3.1/opam";
    depends = with self; [ conf-gstreamer conf-pkg-config dune
