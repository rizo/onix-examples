...
} }:
{
  ...
  py = {
    ...
    version = "1.3";
    src = pkgs.fetchurl {
      url = "https://github.com/zshipko/ocaml-py/releases/download/v1.3/py-v1.3.tbz";
      sha256 = "bbba9188bf6dd1e573368918982ac07cab1cccde6a0a44382ca83aa4214fb2ee";
    };
    opam = "${repo}/packages/py/py.1.3/opam";
    depends = with self; [ conf-python-3-dev ctypes ctypes-foreign dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  stdlib-shims = {
    name = "stdlib-shims";
