...
} }:
{
  ...
  opium-graphql = {
    ...
    opam = "${repo}/packages/opium-graphql/opium-graphql.0.20.0/opam";
    depends = with self; [ dune graphql graphql-lwt lwt ocaml opium ];
    buildDepends = with self; [ crunch dune ocaml ];
  };
  ppx_derivers = {
    name = "ppx_derivers";
    version = "1.2.1";
