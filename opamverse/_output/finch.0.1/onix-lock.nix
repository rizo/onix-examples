...
} }:
{
  ...
  finch = {
    ...
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/roddyyaga/finch/archive/0.1.tar.gz";
    ...
    opam = "${repo}/packages/finch/finch.0.1/opam";
    depends = with self; [ core dune jingoo ocaml omd ppx_let yaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  fmt = {
    name = "fmt";
