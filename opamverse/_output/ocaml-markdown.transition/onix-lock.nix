...
} }:
{
  ...
  markdown = {
    ...
    opam = "${repo}/packages/markdown/markdown.0.2.1/opam";
    depends = with self; [ batteries dune ocaml tyxml ];
  ...
  ocaml-markdown = {
    name = "ocaml-markdown";
    version = "transition";
    opam = "${repo}/packages/ocaml-markdown/ocaml-markdown.transition/opam";
    depends = with self; [ markdown ocaml ];
