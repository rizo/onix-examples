...
} }:
{
  async_durable = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/async_durable-v0.15.0.tar.gz";
      sha256 = "80949fed175a0fdeac44ac57a82be0c9126a7f3482a6313aa8d5f705360e8927";
    };
    opam = "${repo}/packages/async_durable/async_durable.v0.15.0/opam";
    depends = with self; [ async_kernel async_rpc_kernel core core_kernel
                           dune ocaml ppx_jane ];
