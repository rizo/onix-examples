...
} }:
{
  ...
  genprint = {
    ...
    version = "0.4";
    src = pkgs.fetchurl {
      url = "https://github.com/progman1/genprintlib/archive/v0.4.tar.gz";
      sha256 = "1qwsqidjgw2h9l07q2hj3gmcgncwrj4v3xsy943r1xhpfz7bswcv";
    };
    opam = "${repo}/packages/genprint/genprint.0.4/opam";
  ...
  ppxlib = {
    ...
    opam = "${repo}/packages/ppxlib/ppxlib.0.14.0/opam";
