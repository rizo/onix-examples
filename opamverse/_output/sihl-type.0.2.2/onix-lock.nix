...
} }:
{
  ...
  sihl-core = {
    ...
    version = "0.2.2";
    src = pkgs.fetchurl {
      url = "https://github.com/oxidizing/sihl/releases/download/0.2.2/sihl-0.2.2.tbz";
      sha256 = "cfdbfc4b5b122d5be73480dc6050ea19f970c918d19ecfde1fe1f3b152154d28";
    };
    opam = "${repo}/packages/sihl-core/sihl-core.0.2.2/opam";
  ...
  sihl-type = {
    ...
    opam = "${repo}/packages/sihl-type/sihl-type.0.2.2/opam";
    depends = with self; [ alcotest caqti-lwt dune multipart-form-data ocaml
                           opium sihl-core ];
    buildDepends = with self; [ dune ocaml ];
  };
  ssl = {
