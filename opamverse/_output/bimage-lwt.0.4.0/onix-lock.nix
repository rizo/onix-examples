...
} }:
{
  ...
  bimage = {
    ...
    version = "0.4.0";
    src = pkgs.fetchurl {
      url = "https://github.com/zshipko/ocaml-bimage/releases/download/v0.4.0/bimage-v0.4.0.tbz";
      sha256 = "726857dcd495a35ec7be2e0fdc25473b3e39ba5f211142b4a5bc3b66ee9221ef";
    };
    opam = "${repo}/packages/bimage/bimage.0.4.0/opam";
    depends = with self; [ dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  bimage-lwt = {
    ...
    opam = "${repo}/packages/bimage-lwt/bimage-lwt.0.4.0/opam";
    depends = with self; [ bimage dune lwt ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  cppo = {
    name = "cppo";
