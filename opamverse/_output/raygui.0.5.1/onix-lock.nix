...
} }:
{
  ...
  ppx_cstubs = {
    ...
    version = "0.7.0";
    src = pkgs.fetchurl {
      url = "https://github.com/fdopen/ppx_cstubs/archive/0.7.0.tar.gz";
    ...
    opam = "${repo}/packages/ppx_cstubs/ppx_cstubs.0.7.0/opam";
    depends = with self; [ bigarray-compat containers ctypes dune integers
                           num ocaml ocamlfind ppxlib re result ];
  ...
  raygui = {
    ...
    version = "0.5.1";
    src = pkgs.fetchurl {
      url = "https://github.com/tjammer/raylib-ocaml/releases/download/0.5.1/raygui-0.5.1.tbz";
      sha256 = "ace92b528632084ef1467e97aa14e772cdca10e8f3f26f3445473f7c1dbdba88";
    };
    opam = "${repo}/packages/raygui/raygui.0.5.1/opam";
    depends = with self; [ ctypes dune dune-configurator ppx_cstubs raylib ];
    buildDepends = with self; [ dune ];
  };
  raylib = {
    name = "raylib";
    version = "0.5.1";
    src = pkgs.fetchurl {
      url = "https://github.com/tjammer/raylib-ocaml/releases/download/0.5.1/raylib-0.5.1.tbz";
      sha256 = "eec4635d39a680a26570d3498a4f683a5c2cbe0dc6b38110a578e2a8d0d08149";
    };
    opam = "${repo}/packages/raylib/raylib.0.5.1/opam";
    depends = with self; [ ctypes dune dune-configurator integers ppx_cstubs ];
    buildDepends = with self; [ dune ];
  };
  re = {
    name = "re";
