...
} }:
{
  ...
  gospel = {
    ...
    version = "0.1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/ocaml-gospel/gospel/releases/download/0.1.0/gospel-0.1.0.tbz";
      sha256 = "4435d8a8f158edbc113bab01bbf4bb5e2a874bfa0a9b6b91bebcb95452c40464";
    };
    opam = "${repo}/packages/gospel/gospel.0.1.0/opam";
    depends = with self; [ cmdliner dune fmt menhir ocaml ocaml-compiler-libs
                           ppxlib ];
