...
} }:
{
  ...
  binaryen_dsl = {
    ...
    version = "0.7";
    src = pkgs.fetchurl {
      url = "https://github.com/vincentdchan/ocaml-binaryen-dsl/archive/0.6.tar.gz";
    ...
    opam = "${repo}/packages/binaryen_dsl/binaryen_dsl.0.7/opam";
    depends = with self; [ core ctypes dune libbinaryen ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  conf-cmake = {
    name = "conf-cmake";
  ...
  libbinaryen = {
    ...
    version = "105.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/grain-lang/libbinaryen/releases/download/v105.0.0/libbinaryen-v105.0.0.tar.gz";
    ...
    opam = "${repo}/packages/libbinaryen/libbinaryen.105.0.0/opam";
    depends = with self; [ dune dune-configurator ocaml ];
    buildDepends = with self; [ conf-cmake dune ocaml ];
    depexts = with pkgs; [ (pkgs.gcc-g++ or null) ];
  };
  num = {
    name = "num";
    version = "1.4";
