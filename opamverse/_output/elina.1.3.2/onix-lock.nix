...
} }:
{
  ...
  elina = {
    ...
    version = "1.3.2";
    src = pkgs.fetchurl {
      url = "https://github.com/eth-sri/ELINA/archive/1.3.2.tar.gz";
      sha256 = "1z9spbwsz90k2f3h8jspqziwdrvivvmh08nlzgbnblrnx90bl9mr";
    };
    opam = "${repo}/packages/elina/elina.1.3.2/opam";
    depends = with self; [ apron camlidl conf-perl mlgmpidl ocaml ];
