...
} }:
{
  ...
  camlon = {
    ...
    version = "3.0.0";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/camlspotter/camlon/-/archive/3.0.0/camlon-3.0.0.tar.bz2";
      sha256 = "13574c35jm7y5syyhvp6ad907038lvxzsrgpw29b0bsh7rl6vlvb";
    };
    opam = "${repo}/packages/camlon/camlon.3.0.0/opam";
