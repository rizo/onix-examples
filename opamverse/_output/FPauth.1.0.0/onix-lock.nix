...
} }:
{
  ...
  FPauth = {
    ...
    opam = "${repo}/packages/FPauth/FPauth.1.0.0/opam";
    depends = with self; [ base dream dune FPauth-core FPauth-responses
                           FPauth-strategies ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  FPauth-core = {
    name = "FPauth-core";
  ...
  FPauth-responses = {
    ...
    opam = "${repo}/packages/FPauth-responses/FPauth-responses.1.0.0/opam";
    depends = with self; [ base dream dune FPauth-core ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  FPauth-strategies = {
