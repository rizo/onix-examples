...
} }:
{
  ...
  crowbar = {
    ...
    opam = "${repo}/packages/crowbar/crowbar.0.2.1/opam";
    depends = with self; [ afl-persistent cmdliner dune ocaml ocplib-endian ];
    buildDepends = with self; [ dune ocaml ];
  };
  dune = {
    name = "dune";
  ...
  prbnmcn-proptest = {
    name = "prbnmcn-proptest";
    version = "0.0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/igarnier/prbnmcn-proptest/archive/0.0.1.tar.gz";
      sha512 = "7dfe58a4bf3d275ac46f3cb414f298a635886dae76427ecbfc944675e971b73fda9f89dec42342b263d386d3008b1ad4d4b339b720008c7c3bb5b71ea6a898ae";
    };
    opam = "${repo}/packages/prbnmcn-proptest/prbnmcn-proptest.0.0.1/opam";
    depends = with self; [ crowbar dune ocaml prbnmcn-basic-structures zarith ];
    buildDepends = with self; [ dune ocaml ];
  };
  zarith = {
    name = "zarith";
