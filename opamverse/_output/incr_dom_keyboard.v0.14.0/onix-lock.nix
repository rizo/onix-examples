...
} }:
{
  ...
  async_js = {
    ...
    version = "v0.14.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.14/files/async_js-v0.14.0.tar.gz";
      sha256 = "0yabnb3jhsfjykn2aqix35zqxk2a7bwfvi1hf62xfnvvrbkj6nv7";
    };
    opam = "${repo}/packages/async_js/async_js.v0.14.0/opam";
  ...
  incr_dom = {
    ...
    version = "v0.14.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.14/files/incr_dom-v0.14.0.tar.gz";
      sha256 = "01fa57jlfah00jd2bxhj4hcpgiwyzc5qppy5vvd3hg6fw1lwmc2p";
    };
    opam = "${repo}/packages/incr_dom/incr_dom.v0.14.0/opam";
  ...
  incr_dom_keyboard = {
    name = "incr_dom_keyboard";
    version = "v0.14.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.14/files/incr_dom_keyboard-v0.14.0.tar.gz";
      sha256 = "0aphz9l7891q0ibj79wpnh3kl0vkir454dp036wffff2wpxn8ljw";
    };
    opam = "${repo}/packages/incr_dom_keyboard/incr_dom_keyboard.v0.14.0/opam";
    depends = with self; [ dune incr_dom js_of_ocaml js_of_ocaml-ppx ocaml
  ...
  incr_map = {
    ...
    version = "v0.14.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.14/files/incr_map-v0.14.0.tar.gz";
      sha256 = "0pp8bj75bxzgr1v8k8plcc8mdd4apy16p2mkdzbx6pxdy0l9x6ma";
    };
    opam = "${repo}/packages/incr_map/incr_map.v0.14.0/opam";
  ...
  incr_select = {
    ...
    version = "v0.14.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.14/files/incr_select-v0.14.0.tar.gz";
      sha256 = "1salk2xzywxf9f1iy1lr747yppq22qzb5bsyb7xk0875f1m1jzn1";
    };
    opam = "${repo}/packages/incr_select/incr_select.v0.14.0/opam";
    depends = with self; [ core_kernel dune incremental ocaml ppx_jane ];
    buildDepends = with self; [ dune ocaml ];
  };
  incremental = {
    ...
    version = "v0.14.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.14/files/incremental-v0.14.0.tar.gz";
      sha256 = "1242yrnh7gdr7wr6kk3pdfj52fdlxsvypkg6igi8r4jdbq0w0m30";
    };
    opam = "${repo}/packages/incremental/incremental.v0.14.0/opam";
    depends = with self; [ core_kernel dune ocaml ppx_jane ];
    buildDepends = with self; [ dune ocaml ];
  };
  jane-street-headers = {
  ...
  ppx_pattern_bind = {
    ...
    version = "v0.14.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.14/files/ppx_pattern_bind-v0.14.0.tar.gz";
      sha256 = "0vm7vr2ny7s5pwhcb17akzy9bh3s9wgbpn4rm4qnfcd6mvha062d";
    };
    opam = "${repo}/packages/ppx_pattern_bind/ppx_pattern_bind.v0.14.0/opam";
  ...
  virtual_dom = {
    ...
    version = "v0.14.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.14/files/virtual_dom-v0.14.0.tar.gz";
      sha256 = "0ssdswahjbdak3n77pl8adf7xhqisbighqqpql6drfkh7miywr39";
    };
    opam = "${repo}/packages/virtual_dom/virtual_dom.v0.14.0/opam";
    depends = with self; [ base core_kernel dune js_of_ocaml js_of_ocaml-ppx
                           lambdasoup ocaml ppx_jane tyxml ];
    buildDepends = with self; [ dune ocaml ];
  };
  yojson = {
    name = "yojson";
