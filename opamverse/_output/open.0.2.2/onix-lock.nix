...
} }:
{
  ...
  open = {
    ...
    version = "0.2.2";
    src = pkgs.fetchurl {
      url = "https://github.com/smolkaj/ocaml-open/archive/v0.2.2.tar.gz";
      sha256 = "0g71zmraz0xdzcqbc7amfsqyl7413zn6nqwmq6r8fys3hx5acn14";
    };
    opam = "${repo}/packages/open/open.0.2.2/opam";
