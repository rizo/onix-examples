...
} }:
{
  ...
  popper = {
    ...
    opam = "${repo}/packages/popper/popper.0.1.1/opam";
    depends = with self; [ dune ocaml pringo ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppx_derivers = {
    name = "ppx_derivers";
  ...
  ppx_deriving_popper = {
    name = "ppx_deriving_popper";
    version = "0.1.1";
    src = pkgs.fetchurl {
      url = "https://github.com/jobjo/popper/archive/0.1.1.tar.gz";
      sha512 = "f93e207f285dbc9e0fb946d8dc2a16453119078e10029f23663f6733992a664ed01e4b3d18d9ebf82d0571a9db0235086f468c0e79f4ecf4a109ce1aa0964372";
    };
    opam = "${repo}/packages/ppx_deriving_popper/ppx_deriving_popper.0.1.1/opam";
    depends = with self; [ dune ocaml popper ppx_deriving ppxlib ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppxlib = {
    name = "ppxlib";
