...
} }:
{
  ...
  ppx_ts = {
    ...
    version = "0.1.6";
    src = pkgs.fetchurl {
      url = "https://github.com/green-labs/ppx_ts/archive/v0.1.6-opam.tar.gz";
    ...
    opam = "${repo}/packages/ppx_ts/ppx_ts.0.1.6/opam";
    depends = with self; [ dune ocaml ppx_deriving ppx_expect ppx_inline_test
                           ppxlib ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppxlib = {
