...
} }:
{
  ...
  caqti-dynload = {
    ...
    version = "1.3.0";
    src = pkgs.fetchurl {
      url = "https://github.com/paurkedal/ocaml-caqti/releases/download/v1.3.0/caqti-v1.3.0.tbz";
      sha256 = "a15d71b6428997703273dc6d55a99045fb62c3243c751de5ae8c3fc25421f16a";
    };
    opam = "${repo}/packages/caqti-dynload/caqti-dynload.1.3.0/opam";
    depends = with self; [ caqti dune ocaml ocamlfind ];
