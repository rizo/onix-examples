...
} }:
{
  ...
  cpm = {
    ...
    version = "9.0.0";
    src = pkgs.fetchurl {
      url = "https://github.com/UnixJunkie/cpmlib/archive/v9.0.0.tar.gz";
      sha256 = "1q2mai3y8ypa05y1rsijhb9zs310nip1nig00kbws290rk230l07";
    };
    opam = "${repo}/packages/cpm/cpm.9.0.0/opam";
    depends = with self; [ batteries conf-gnuplot dune ocaml ];
