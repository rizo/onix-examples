...
} }:
{
  ...
  tidy_email = {
    ...
    version = "0.0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/jsthomas/tidy_email/archive/0.0.1.tar.gz";
      sha512 = "c3aec13f7bf58af03a9630f7479aceb300de9dc319e1d57729a175a86b1fd3e98a585ec6216918419b5ca6e187a0d9ca5c7619e7b2afacb7548c6b86d251e5c8";
    };
    opam = "${repo}/packages/tidy_email/tidy_email.0.0.1/opam";
  ...
  tidy_email_sendgrid = {
    ...
    opam = "${repo}/packages/tidy_email_sendgrid/tidy_email_sendgrid.0.0.1/opam";
    depends = with self; [ cohttp cohttp-lwt-unix dune lwt_ppx ocaml
                           tidy_email yojson ];
    buildDepends = with self; [ dune ocaml ];
  };
  topkg = {
