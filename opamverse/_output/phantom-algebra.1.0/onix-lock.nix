...
} }:
{
  ...
  phantom-algebra = {
    ...
    version = "1.0";
    src = pkgs.fetchurl {
      url = "https://github.com/Octachron/phantom_algebra/releases/download/1.0/phantom-algebra-1.0.tbz";
      sha256 = "1aprqngs8p2ffqiga5ph9skbrgydr013c9008nlxjm9mvwbr015a";
    };
    opam = "${repo}/packages/phantom-algebra/phantom-algebra.1.0/opam";
