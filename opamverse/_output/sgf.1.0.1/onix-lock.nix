...
} }:
{
  ...
  sgf = {
    ...
    version = "1.0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/vbmithr/ocaml-sgf/releases/download/1.0.1/sgf-1.0.1.tbz";
      sha256 = "9ed1bed77725b6c7858d46ce0538fbdb97ff56cc71af6ae565e0635752acfee4";
    };
    opam = "${repo}/packages/sgf/sgf.1.0.1/opam";
    depends = with self; [ dune menhir ocaml rresult sedlex ];
    buildDepends = with self; [ dune ocaml ];
  };
  stdlib-shims = {
    name = "stdlib-shims";
