...
} }:
{
  ...
  i3ipc = {
    ...
    version = "0.4";
    src = pkgs.fetchurl {
      url = "https://github.com/Armael/ocaml-i3ipc/archive/v0.4.tar.gz";
      sha256 = "35b2370da44a551b5568adb019ed2fd7fa85ea89851a446e733c247f5fa836fb";
    };
    opam = "${repo}/packages/i3ipc/i3ipc.0.4/opam";
    depends = with self; [ dune lwt lwt_ppx ocaml ppx_deriving
                           ppx_deriving_yojson result stdint ];
    buildDepends = with self; [ dune ocaml ];
  };
  lwt = {
    name = "lwt";
  ...
  order-i3-xfce = {
    ...
    version = "0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/EmileTrotignon/order-i3-xfce/archive/0.1.tar.gz";
    ...
    opam = "${repo}/packages/order-i3-xfce/order-i3-xfce.0.1/opam";
    depends = with self; [ dune i3ipc lwt lwt_ppx ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  ppx_derivers = {
    name = "ppx_derivers";
