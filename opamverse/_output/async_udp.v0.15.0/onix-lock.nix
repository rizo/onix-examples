...
} }:
{
  ...
  async_udp = {
    ...
    version = "v0.15.0";
    src = pkgs.fetchurl {
      url = "https://ocaml.janestreet.com/ocaml-core/v0.15/files/async_udp-v0.15.0.tar.gz";
      sha256 = "9afba8db184a406a83e2302803eece864815e6ea04b32ead5e22ab1e1d2c854e";
    };
    opam = "${repo}/packages/async_udp/async_udp.v0.15.0/opam";
    depends = with self; [ async core_unix dune ocaml ppx_jane ];
    buildDepends = with self; [ dune ocaml ];
  };
  async_unix = {
    name = "async_unix";
