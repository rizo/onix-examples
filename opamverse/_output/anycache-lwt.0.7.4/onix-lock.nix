...
} }:
{
  anycache = {
    ...
    opam = "${repo}/packages/anycache/anycache.0.7.4/opam";
    depends = with self; [ base-bytes lru ocaml result ];
    buildDepends = with self; [ ocaml topkg-jbuilder ];
  };
  anycache-lwt = {
    name = "anycache-lwt";
    version = "0.7.4";
    ...
    opam = "${repo}/packages/anycache-lwt/anycache-lwt.0.7.4/opam";
    depends = with self; [ anycache base-bytes lwt ocaml ];
    buildDepends = with self; [ ocaml topkg-jbuilder ];
  };
  base-bytes = {
    name = "base-bytes";
  ...
  lru = {
    ...
    opam = "${repo}/packages/lru/lru.0.2.0/opam";
    depends = with self; [ ocaml psq ];
  ...
  psq = {
    ...
    opam = "${repo}/packages/psq/psq.0.1.1/opam";
  ...
  topkg-jbuilder = {
    ...
    opam = "${repo}/packages/topkg-jbuilder/topkg-jbuilder.0.2.0/opam";
    depends = with self; [ jbuilder ocaml topkg ];
    buildDepends = with self; [ ocaml ];
  };
}
