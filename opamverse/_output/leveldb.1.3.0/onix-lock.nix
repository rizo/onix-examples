...
} }:
{
  ...
  leveldb = {
    ...
    version = "1.3.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mfp/ocaml-leveldb/releases/download/1.3.0/ocaml-leveldb-1.3.0.tar.gz";
      sha256 = "f88dd6054c3a53187535173caff2370a60ebe3e9233c6098882db74ea38a109a";
    };
    opam = "${repo}/packages/leveldb/leveldb.1.3.0/opam";
    depends = with self; [ conf-leveldb dune ocaml ];
