...
} }:
{
  ...
  coq-of-ocaml = {
    ...
    version = "2.5.2+4.13";
    src = pkgs.fetchurl {
      url = "https://github.com/foobar-land/coq-of-ocaml/releases/download/2.5.2/coq-of-ocaml-full.2.5.2+4.13.tar.gz";
      sha256 = "9dfde155240061a70b803715609246d360605d887035070b160190e21f672dbd";
    };
    opam = "${repo}/packages/coq-of-ocaml/coq-of-ocaml.2.5.2+4.13/opam";
    depends = with self; [ csexp dune ocaml ocamlfind result smart-print
                           yojson (self.coq or null) ];
