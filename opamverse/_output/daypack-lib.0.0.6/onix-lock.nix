...
} }:
{
  ...
  daypack-lib = {
    ...
    version = "0.0.6";
    src = pkgs.fetchurl {
      url = "https://github.com/daypack-dev/daypack-lib/releases/download/v0.0.6/manually-archived-v0.0.6.tar.gz";
      sha256 = "3035f6753152274c8d3c8e8e7a81fa4361927453aebdf379c8454ece0bc01ea0";
    };
    opam = "${repo}/packages/daypack-lib/daypack-lib.0.0.6/opam";
    depends = with self; [ atdgen atdgen-runtime biniou dune mparser ocaml
                           oseq ptime re yojson ];
    buildDepends = with self; [ dune ocaml ];
  };
  dune = {
    name = "dune";
