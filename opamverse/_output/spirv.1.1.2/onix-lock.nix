...
} }:
{
  ...
  spirv = {
    ...
    version = "1.1.2";
    src = pkgs.fetchurl {
      url = "https://github.com/nholland94/spirv-ocaml/archive/1.1.2.tar.gz";
      sha256 = "0i40hm9z28jj08w8b10ihmj4mfpndafbhjxp6wzcna5arw6asyca";
    };
    opam = "${repo}/packages/spirv/spirv.1.1.2/opam";
    depends = with self; [ batteries ocaml ];
    buildDepends = with self; [ ocaml ocamlfind ];
  };
}
