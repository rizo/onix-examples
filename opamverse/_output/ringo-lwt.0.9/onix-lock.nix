...
} }:
{
  ...
  ringo = {
    ...
    version = "0.9";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/nomadic-labs/ringo/-/archive/v0.9/ringo-v0.9.tar.gz";
    ...
    opam = "${repo}/packages/ringo/ringo.0.9/opam";
    depends = with self; [ dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  ringo-lwt = {
    ...
    opam = "${repo}/packages/ringo-lwt/ringo-lwt.0.9/opam";
