...
} }:
{
  ...
  mkaudio = {
    ...
    version = "1.1.2";
    src = pkgs.fetchurl {
      url = "https://github.com/johnelse/mkaudio/archive/mkaudio.1.1.2.tar.gz";
      sha256 = "ec94fa545dc004a20645c9e9746c4332f931772d79ba72887a0164b7920f0e08";
    };
    opam = "${repo}/packages/mkaudio/mkaudio.1.1.2/opam";
    depends = with self; [ cmdliner dune mm ocaml result ];
    buildDepends = with self; [ dune ocaml ];
  };
  mm = {
    name = "mm";
    version = "0.7.4";
    src = pkgs.fetchurl {
      url = "https://github.com/savonet/ocaml-mm/archive/v0.7.4.tar.gz";
    ...
    opam = "${repo}/packages/mm/mm.0.7.4/opam";
    depends = with self; [ dune dune-configurator (self.alsa or null)
