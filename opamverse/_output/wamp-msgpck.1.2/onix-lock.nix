...
} }:
{
  ...
  msgpck = {
    ...
    version = "1.7";
    src = pkgs.fetchurl {
      url = "https://github.com/vbmithr/ocaml-msgpck/releases/download/1.7/msgpck-v1.7.tbz";
      sha256 = "ff7065bf590af502a1b1622ff3b5280805c122033d68cf6b53da32c31ecb5f5d";
    };
    opam = "${repo}/packages/msgpck/msgpck.1.7/opam";
  ...
  wamp = {
    ...
    opam = "${repo}/packages/wamp/wamp.1.2/opam";
    depends = with self; [ jbuilder ocaml result uri ];
    buildDepends = with self; [ ocaml ];
  };
  wamp-msgpck = {
    name = "wamp-msgpck";
    ...
    opam = "${repo}/packages/wamp-msgpck/wamp-msgpck.1.2/opam";
    depends = with self; [ jbuilder msgpck ocaml wamp ];
    buildDepends = with self; [ ocaml ];
  };
}
