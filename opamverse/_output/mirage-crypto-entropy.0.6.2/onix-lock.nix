...
} }:
{
  ...
  functoria-runtime = {
    ...
    opam = "${repo}/packages/functoria-runtime/functoria-runtime.3.1.2/opam";
  ...
  ipaddr = {
    ...
    opam = "${repo}/packages/ipaddr/ipaddr.4.0.0/opam";
    depends = with self; [ domain-name dune macaddr ocaml sexplib0 ];
    buildDepends = with self; [ dune ocaml ];
  };
  logs = {
    name = "logs";
  ...
  macaddr = {
    ...
    opam = "${repo}/packages/macaddr/macaddr.4.0.0/opam";
    depends = with self; [ dune ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  mirage-crypto = {
    ...
    version = "0.6.2";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/mirage-crypto/releases/download/v0.6.2/mirage-crypto-v0.6.2.tbz";
      sha256 = "e2284dc0f8d37110f4713b87145a26a2bbce3e43f14be51e88de18db5922b823";
    };
    opam = "${repo}/packages/mirage-crypto/mirage-crypto.0.6.2/opam";
    depends = with self; [ cstruct dune dune-configurator ocaml ocplib-endian
                           (self.mirage-xen-posix or null)
                           (self.ocaml-freestanding or null) ];
    buildDepends = with self; [ conf-pkg-config cpuid dune ocaml ];
  };
  mirage-crypto-entropy = {
    name = "mirage-crypto-entropy";
    version = "0.6.2";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/mirage-crypto/releases/download/v0.6.2/mirage-crypto-v0.6.2.tbz";
      sha256 = "e2284dc0f8d37110f4713b87145a26a2bbce3e43f14be51e88de18db5922b823";
    };
    opam = "${repo}/packages/mirage-crypto-entropy/mirage-crypto-entropy.0.6.2/opam";
    depends = with self; [ cstruct dune lwt mirage-crypto mirage-crypto-rng
  ...
  mirage-crypto-rng = {
    ...
    opam = "${repo}/packages/mirage-crypto-rng/mirage-crypto-rng.0.6.2/opam";
    depends = with self; [ cstruct dune dune-configurator mirage-crypto ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
  mirage-runtime = {
    name = "mirage-runtime";
    ...
    opam = "${repo}/packages/mirage-runtime/mirage-runtime.3.7.6/opam";
