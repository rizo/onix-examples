...
} }:
{
  ...
  ctypes = {
    ...
    version = "0.16.0";
    src = pkgs.fetchurl {
      url = "https://github.com/ocamllabs/ocaml-ctypes/archive/0.16.0.tar.gz";
      sha256 = "0l1khjdvfp8xg711yl1inlk7h4w2gr5dgzbkflkyd3kjz9h5sf96";
    };
    opam = "${repo}/packages/ctypes/ctypes.0.16.0/opam";
    depends = with self; [ base-bytes integers ocaml
  ...
  cviode = {
    ...
    version = "0.0.4";
    src = pkgs.fetchurl {
      url = "https://github.com/mseri/ocaml-cviode/releases/download/0.0.4/cviode-0.0.4.tbz";
      sha256 = "89bf0d36db1951ba238f412d59065342f832f77968bbad688ab29e8420e88dba";
    };
    opam = "${repo}/packages/cviode/cviode.0.0.4/opam";
    depends = with self; [ dune ocaml owl owl-ode ];
    buildDepends = with self; [ dune ocaml ];
  };
  dune = {
    name = "dune";
  ...
  owl = {
    ...
    version = "0.8.0";
    src = pkgs.fetchurl {
      url = "https://github.com/owlbarn/owl/releases/download/0.8.0/owl-0.8.0.tbz";
      sha256 = "862af251e2a3e7a6b79724a4020a0c9308b36f12c85cd0a52385c4df82132c66";
    };
    opam = "${repo}/packages/owl/owl.0.8.0/opam";
  ...
  owl-base = {
    ...
    opam = "${repo}/packages/owl-base/owl-base.0.8.0/opam";
  ...
  owl-ode = {
    ...
    version = "0.3.0";
    src = pkgs.fetchurl {
      url = "https://github.com/owlbarn/owl_ode/releases/download/v0.3.0/owl-ode-v0.3.0.tbz";
      sha256 = "f15d895329d63329376421e260ae55483cf1b74d271cbce0a45ce05d20a7ea5f";
    };
    opam = "${repo}/packages/owl-ode/owl-ode.0.3.0/opam";
  ...
  owl-ode-base = {
    ...
    opam = "${repo}/packages/owl-ode-base/owl-ode-base.0.3.0/opam";
