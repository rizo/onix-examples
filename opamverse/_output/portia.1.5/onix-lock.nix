...
} }:
{
  ...
  portia = {
    ...
    version = "1.5";
    src = pkgs.fetchurl {
      url = "https://github.com/rixed/portia/archive/v1.5.tar.gz";
      sha256 = "1xkh33pak95maq0sz8pr37v7z86agh6dvblhihi6fdrq1kjcwrfv";
    };
    opam = "${repo}/packages/portia/portia.1.5/opam";
