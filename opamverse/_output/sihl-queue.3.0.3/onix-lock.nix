...
} }:
{
  ...
  conformist = {
    ...
    version = "0.8.1";
    src = pkgs.fetchurl {
      url = "https://github.com/oxidizing/conformist/archive/0.8.1.tar.gz";
    ...
    opam = "${repo}/packages/conformist/conformist.0.8.1/opam";
    depends = with self; [ dune ocaml ptime ];
    buildDepends = with self; [ dune ocaml ];
  };
  containers = {
    name = "containers";
  ...
  sihl = {
    ...
    version = "3.0.3";
    src = pkgs.fetchurl {
      url = "https://github.com/oxidizing/sihl/archive/3.0.3.tar.gz";
    ...
    opam = "${repo}/packages/sihl/sihl.3.0.3/opam";
    depends = with self; [ bos caqti caqti-lwt conformist containers cstruct
                           dune dune-build-info fmt jwto logs lwt_ppx lwt_ssl
                           nocrypto ocaml opium ppx_deriving_yojson
  ...
  sihl-queue = {
    ...
    opam = "${repo}/packages/sihl-queue/sihl-queue.3.0.3/opam";
    depends = with self; [ dune ocaml sihl tyxml-ppx ];
    buildDepends = with self; [ dune ocaml ];
  };
  ssl = {
    name = "ssl";
  ...
  tyxml-ppx = {
    ...
    opam = "${repo}/packages/tyxml-ppx/tyxml-ppx.4.5.0/opam";
    depends = with self; [ dune markup ocaml ppxlib tyxml tyxml-syntax ];
    buildDepends = with self; [ dune ocaml ];
  };
  tyxml-syntax = {
    name = "tyxml-syntax";
    ...
    opam = "${repo}/packages/tyxml-syntax/tyxml-syntax.4.5.0/opam";
    depends = with self; [ dune ocaml ppxlib re uutf ];
    buildDepends = with self; [ dune ocaml ];
  };
  uchar = {
    name = "uchar";
