...
} }:
{
  ...
  lazy-trie = {
    ...
    version = "1.2.0";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/ocaml-lazy-trie/releases/download/v1.2.0/lazy-trie-v1.2.0.tbz";
      sha256 = "0dswapjyy1841ldk7jh5cpi356rzjkhkadj9c50gk78bzkgm7pf1";
    };
    opam = "${repo}/packages/lazy-trie/lazy-trie.1.2.0/opam";
    depends = with self; [ dune ocaml ppx_sexp_conv sexplib ];
    buildDepends = with self; [ dune ocaml ];
  };
  num = {
    name = "num";
