...
} }:
{
  ...
  xen-gnt = {
    ...
    version = "4.0.1";
    src = pkgs.fetchurl {
      url = "https://github.com/mirage/ocaml-gnt/releases/download/v4.0.1/xen-gnt-4.0.1.tbz";
      sha256 = "1faef511d25047b131f2028561a9316acff66d480bae0369f8d0fdc5a645b2f9";
    };
    opam = "${repo}/packages/xen-gnt/xen-gnt.4.0.1/opam";
    depends = with self; [ cmdliner cstruct dune io-page lwt lwt-dllist
                           mirage-profile ocaml ];
    buildDepends = with self; [ dune ocaml ];
  };
}
