...
} }:
{
  ...
  jsonrpc = {
    ...
    opam = "${repo}/packages/jsonrpc/jsonrpc.1.5.0/opam";
  ...
  linol = {
    ...
    version = "0.4";
    src = pkgs.fetchurl {
      url = "https://github.com/c-cube/linol/archive/v0.4.tar.gz";
    ...
    opam = "${repo}/packages/linol/linol.0.4/opam";
    depends = with self; [ dune logs lsp ocaml yojson ];
    buildDepends = with self; [ dune ocaml ];
  };
  logs = {
    name = "logs";
  ...
  lsp = {
    ...
    opam = "${repo}/packages/lsp/lsp.1.5.0/opam";
