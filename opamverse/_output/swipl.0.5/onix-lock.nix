...
} }:
{
  ...
  conf-swi-prolog = {
    name = "conf-swi-prolog";
    version = "1";
    opam = "${repo}/packages/conf-swi-prolog/conf-swi-prolog.1/opam";
    depexts = with pkgs; [ (pkgs.pl or null) (pkgs.swi-pl or null)
                           (pkgs.swi-prolog or null) (pkgs.swipl or null) ];
  };
  cppo = {
    name = "cppo";
    version = "1.6.9";
  ...
  swipl = {
    ...
    version = "0.5";
    src = pkgs.fetchurl {
      url = "https://gitlab.com/gopiandcode/swipl-ocaml/-/archive/v0.5/swipl-ocaml-v0.5.tar.gz";
    ...
    opam = "${repo}/packages/swipl/swipl.0.5/opam";
    depends = with self; [ base conf-swi-prolog ctypes ctypes-foreign dune
                           dune-configurator ocaml ppx_deriving stdio ];
    buildDepends = with self; [ dune ocaml ];
  };
}
