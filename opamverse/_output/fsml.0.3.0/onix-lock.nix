...
} }:
{
  ...
  fsml = {
    ...
    version = "0.3.0";
    src = pkgs.fetchurl {
      url = "https://github.com/jserot/fsml/archive/0.3.0.tar.gz";
    ...
    opam = "${repo}/packages/fsml/fsml.0.3.0/opam";
    depends = with self; [ dune menhir ocaml ppx_deriving_yojson ppxlib ];
    buildDepends = with self; [ dune ocaml ];
  };
  menhir = {
    name = "menhir";
