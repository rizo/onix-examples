...
} }:
{
  ...
  mlmpfr = {
    ...
    src = pkgs.fetchurl {
      url = "https://github.com/thvnx/mlmpfr/archive/refs/tags/mlmpfr.4.1.0-bugfix1.tar.gz";
      sha256 = "08yiyfii3c402ir48ypmvs8mc3rc7nh17akc4pjzb1jb0akinjmn";
    };
    opam = "${repo}/packages/mlmpfr/mlmpfr.4.1.0+bugfix1/opam";
    depends = with self; [ conf-mpfr dune ocaml ];
