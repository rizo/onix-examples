...
} }:
{
  ...
  vcardgen = {
    ...
    version = "1.2";
    src = pkgs.fetchurl {
      url = "https://github.com/vzaliva/vcardgen/archive/v1.2.tar.gz";
      sha256 = "0n78mc2w19y44ii8k3h0ff9fisw4dicpvrnls7zaifq8v0kabi3k";
    };
    opam = "${repo}/packages/vcardgen/vcardgen.1.2/opam";
